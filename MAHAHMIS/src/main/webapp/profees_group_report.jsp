...
<title>ProFees Group Report</title>
									...
									<div class="col-sm-12">
										<div class="page-header">
											...
											<ul class="breadcrumb col-md-12-1"
												...
												<li><a href="profees_group_report.jsp">Group Wise Report </a></li>
												<li class="pull-right">
										...
										<div id="diveMain" class="col-md-12-1">
											...
											<div id="divLine1" class=" box border col-md-12">
												...
												<form class="form-horizontal col-md-12">
													...
													<div class="col-md-3">
														<div class="row">
															<label class="TextFont"> Group Name<b style="color: red;">*</b> </label>
															
															 <input
																	id="byName" class="form-control input-SmallText"
																	type="text" onkeyup="setAutoSugForGroupList(this.id)"
																	>
														</div>
														<div class="divide-20"></div>
													</div>
													...
													<div class="col-md-3">
														<div class="row">
															<label class="TextFont"> Group ID </label> <input
																id="groupId" class="form-control input-SmallText"
												...
												<form class="form-horizontal col-md-12">
													...
													<div class="col-md-3">
														...
														title="Show" onclick="profeesGroupWiseReport()" type="button">
														<b> Show </b>
														</button>
														</div>
