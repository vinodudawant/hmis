...
<body style="background: white ! important;">
	...
	<!--		<%
				Object sessionOBJ = session.getAttribute("moduleName");
				 ...
				 System.out.println("Your Current NAme idocDeskRequestLnl.jsps ************* "+CurrentuserName);
									...
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li><i class="fa fa-home"></i> <a
												href="OPDDoctorsDeskDashboard.jsp">Doctor Desk</a></li>
											<li><a href="docDeskRequestLnl.jsp">LNL</a></li>
											<!-- <li>View Database</li> -->
										</ul>
											...
											<!-- 			<li><a data-toggle="tab" href="#Recieved"
													...
													<!-- 		<li><a data-toggle="tab" href="#MrnReturn"
														...
														<li><a data-toggle="tab"
															href="#LnlReturn" id="lnlRet" onclick="LnlReturn(),getlistforReturnItems('DoctorDesk');"><span
																class="hidden-inline-mobile">LnL Receive</span></a></li>	
