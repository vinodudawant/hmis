	...
	<%
		...
		//	NumberFormat numberFormatTwoDecimal = new DecimalFormat("#0.00");
           ...
           HeaderTable15.flushContent();
			...
			HeaderTable115.addCell(new Phrase("Sub : Medical Treatment Bills", subheader));
			HeaderTable115.addCell(new Phrase("", tabletext));
			HeaderTable115.addCell(new Phrase("Dear Sir,", subheader));
			
			HeaderTable115.addCell(new Phrase("", tabletext));
			HeaderTable115.addCell(new Phrase("", tabletext));
			HeaderTable115.addCell(new Phrase("Please find enclosed herewith the medical Treatment bills of various patient reffered by you. As per details given below :-", subheader));
			...
			int[] headerwidth5 = { 7,20,30,10,20,13};
			...
			HeaderTable5.addCell(new Phrase("Hospital Reg_No", subheader));
			HeaderTable5.addCell(new Phrase("Name of Patient", subheader));
			HeaderTable5.addCell(new Phrase("NEIS NO.", subheader));
			...
			double amount=0.0;
		         ...
		         for (int i = 0; i < lstPojo1.size(); i++) {
		        	 ...
		        	 amount=amount + lstPojo1.get(i).getAmount();
						...
						HeaderTable5.addCell(new Phrase(""+ lstPojo1.get(i).getNeisNO(), tabletext));
					...
					HeaderTable5.addCell(new Phrase("", tabletext));
					HeaderTable5.addCell(new Phrase("", tabletext));
					HeaderTable5.addCell(new Phrase("Total Rs.", subheader));
					...
					String oustandingAmt=EnglishNumberToWords.convert(finalams);;					
					...
					HeaderTable115.addCell(new Phrase("", tabletext));
					HeaderTable115.addCell(new Phrase("", tabletext));
					HeaderTable115.addCell(new Phrase(""+oustandingAmt, subheader));
					...
					HeaderTable115.addCell(new Phrase("Also we are enclosing herewith investigations reports, admission/discharge certificate and original copy of reference letter is", tabletext));
					HeaderTable115.addCell(new Phrase("also enclosed for your ready reference. You are requested kindly make the payment as early as possible.", tabletext));
					HeaderTable115.addCell(new Phrase("", tabletext));
					HeaderTable115.addCell(new Phrase("", tabletext));
					
					HeaderTable115.addCell(new Phrase("Thanking you and assuring you of our best services at all time.", tabletext));
					HeaderTable115.addCell(new Phrase("", tabletext));
					
					HeaderTable115.addCell(new Phrase("Yours faithfully,", tabletext));
					HeaderTable115.addCell(new Phrase("For Jawaharlal Nehru Cancer Hospital & Research Centre,", subheader));
