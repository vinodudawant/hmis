...
<body>
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a href="">B 2 B Collection</a></li>
								...
								<div class="col-md-12">
									...
									<div class="col-md-2">
										<div class="input-group" id="divbyName"
											...
											<label for="inlineFold" class="control-label"></label> <input
												...
												onkeyup="b2BPatientAutoSuggestion(this.id, 'collection');">
										</div>
									</div>
									...
									<div class=" col-md-1">
										<input type="button" value="Search"
											...
											onclick="searchB2BRecords('collection');"
								...
								<div class="panel-group" id="accordion">
									<div class="panel">
										<div class="panel-body" style="overflow: auto; height: 460px">
											<!-- <div class="col-md-1" style="margin-left:85%;margin-top:-1%">
												<input type="button" value="Collection Done" class="btn btn-xs btn-success " data-toggle="tooltip"
													data-placement="bottom" title="Collection Done" onclick="bulkCollection()" />
											</div> -->
											...
											<table id="ehatTable" class="datatable table  table-bordered" style="margin-top:0%">
												<thead id="ehatTHead">
													<tr style="background-color: lightblue">
														...
														<th class="col-md-1 center">Collection</th>
												...
												<tbody id="collectionRecordTableBody">
												</tbody>
											</table>
										</div>
									</div>
								...
								<div style="margin-top: -1%">
									<div class="" align="right">
										<ul class="pagination pagination-blue margin-bottom-10"
											id="collectionJumpToPage">
										</ul>
										<ul class="pagination pagination-blue margin-bottom-10"
											id="collectionPagination">
										</ul>
										<ul class="pagination pagination-blue margin-bottom-10"
											id="collectionNumberOfPages">
										</ul>
									</div>
								</div>
								<!--   Ending  pagination -->
								
								<div class="modal fade" id="rejectPopup" tabindex="-1">
														...
														<div class="panel">
															<div class="panel-body" style="overflow: auto;">
																<div class="col-md-12" style="font-weight: bold;">
																	...
																	<div id="reCollectionDiv" class="form-group col-md-2"
																		style="margin-top: 0%">
																		<input type="button" value="Reject"
																			class="btn btn-xs btn-warning " title="Reject"
																			id="rejectid"
																			onclick="rejectSample('collection')" />
																	</div>
																	...
																	<div id="closeDiv" class="form-group col-md-2"
																		...
																		<input type="button" value="close"
																			...
																			id="closeId"
																			onclick="closeRejectPopup('collection')" />
																	</div>
																</div>
															</div>
														</div>
	...
	<input type="hidden" id="userCustomerList" value="<%=session.getAttribute("userCustomerList")%>">
	...
	<input type='hidden' id="collectionMasterId" value="0"/>
