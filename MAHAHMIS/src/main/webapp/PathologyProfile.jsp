...
<script>
	jQuery(document).ready(function() {
		App.setPage("PathologyProfile"); //Set current page
...
<script type="text/javascript">
	onload = function() {
		...
		getProfiles("onload");
		autoSuggestionForLab("byName", "onload","pathologyProfile");
					...
					<div class="row">
						<div id="content" class="col-lg-12">
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li><a href="PathologyProfile.jsp">Lab Profiles</a></li>
											<div class="li pull-right">
												<button class="btn btn-xs btn-success" 
												data-toggle="tooltip" data-placement="left" title="Save Pathology Profile"
							...
							<div class="col-md-12-1">
								...
								<div class="col-md-1-1"><label class="TextFont" style="margin-left: 10%;margin-top:3%;">Profile Name:</label></div>

								<!-- <div style="margin-top: 0px;" class="col-md-2-1 TextFont">
									<input class="col-md-12-1" name="strValue" type="text"
										class="typeahead form-control input-SmallText " id="strValue"
								...
								<div class="panel panel-default">
									<div class="panel-body" class="col-md-12-1">
											<div id="infoDiv" class="col-md-5-1"
												style="height: 220px; margin-top: 0%"></div>
