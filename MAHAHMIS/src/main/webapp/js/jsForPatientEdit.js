...
var bas_cal,dp_cal,ms_cal;      
  window.onload = function () {
	  var showSaveBtn = window.parent.document.getElementById("div2").innerHTML;

		if (showSaveBtn == "yes") {

			window.parent.document.getElementById("saveBtnDiv").style.visibility = "visible";

			/* window.parent.document.getElementById("printBtnDiv").style.visibility = "visible";
					window.parent.document.getElementById("discardBtnDiv").style.visibility = "visible"; */
