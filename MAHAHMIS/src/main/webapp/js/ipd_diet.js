...
function getDietTemplate(id){
   ...
   +'<div style="margin-top: 0px; margin-bottom: 0px; " class="col-md-6-1">'
	...
	+'<label id="" class="btn " style="padding-top: 0px; margin-right: 10px; margin-bottom: 0px; " onclick="saveOPDDiet();"><i class="fa fa-save"></i>Save</label>'
	/*+'<label id="" ' 
...
//	var billId=$("#billNo").text();    
  ...
  ///  var pendFlag = $("#pendingFlag").val();
    ...
    window.open("ipd_diet_print.jsp?billId="+billId+"&treatId="+treatId+"&patId="+patId+"&recId="+recId+"&pendFlag="+pendFlag+"&dietIds="+docId);
