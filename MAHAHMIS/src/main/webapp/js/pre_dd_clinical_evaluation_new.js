...
//		+ '<button class="btn btn-block btn-info" onclick=showPopUpDocterDesk1("o")>Save Physical Examination</button>'
		...
		+ '<button class="btn btn-block btn-primary" onclick = showPopUpOPDTemplate("s") disabled="disabled">Save H & P (History & Physical)</button>'
		+ '<button class="btn btn-block btn-info" onclick = showPopUpOPDTemplate("o") disabled="disabled">Save Physical Examination</button>'
		+ '</div> </div> ';
}
temp = temp
	...
	+ 'data-target="#Alerts_Allergies" onclick="fetchAllAllergyAlerts(),enableAllergyTextBoxes()" disabled="disabled">Alerts & Allergies</button>';
...
//		+ 'onclick="saveCKEditorDocterDesk1()" disabled="disabled">Save Data</button>';		//commented, aniket kanse, 09 JAN 22
		+ 'onclick="saveOPDClinicalEval()" disabled="disabled">Save Data</button>';
}
