var App = function () {
	...
	var handleSelect2 = function () {
		...
		$("#adminSrv").select2({
			 placeholder: "Select Admin Charges Services..."
		});
		$("#opgrade").select2();
		$("#e1").select2();
	...
	var handleCalendar = function () {
		...
		/*var dat = $('#idTourDateDetails').datepicker({
			dateFormat : 'dd/mm/yy',
			minDate : '+5d',
			changeMonth : true,
			changeYear : true,
		...
		/*var datNew = $('#idNewAppointment').datepicker({
			dateFormat : 'dd/mm/yy',
			minDate : '+5d',
			changeMonth : true,
			changeYear : true,
		...
		*/
		var calendar = $('#calendar').fullCalendar({
			...
			select: function(start, end, allDay) {
				...
				if (($("#selHosDept").val())=="0"||($("#selHosDept").val())==undefined) {
					alert("Please Select Speciality");
					return false;
				}else if (($("#selDoctorName").val())=="0"||($("#selDoctorName").val())==undefined) {
					alert("Please Select Doctor");
					return false;
				}else if (($("#selDoctorTime").val())=="0"||($("#selDoctorTime").val())==undefined) {
					alert("Please Select Doctor's Timing");
					return false;
				}else if($("#patientDetails").html()==""||$("#patientDetails").html()==null){
			...
			/*	{
				...
				{
					title: 'yo yo...',
					start: new Date(2014, 11, 4, 6, 0),
					end: new Date(2014, 11, 4, 8, 30),
					allDay: false,
	...
	var handleDashFlotCharts = function () {
		...
		var chart4 = window.chart = $('#dash_pie_1').data('easyPieChart');
	...
	var handleThemeSkins = function () {
        ...
        var setSkin = function (color) {
            $('#skin-switcher').attr("href", "css/" + color + ".css");
	...
	return {
        ...
        init: function () {
			...
			if (App.isPage("ReportDashboard")) {
				handleDateTimePickers(); //Function to display Date Timepicker
			}
			if (App.isPage("demo")) {
				handleTypeahead(); //Function to display Date Timepicker
			}
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="../images/12.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
...
/*<!-- COOKIE -->*/
document.write('<script type="text/javascript" src="js/jQuery-Cookie/jquery.cookie.min.js"></script>');
