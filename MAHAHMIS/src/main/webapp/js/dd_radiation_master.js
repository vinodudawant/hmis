...
function saveRadiationMaster(){
	...
	if(mould=="" || mould==undefined || mould==null || mould=="null"  ){
		alert("please enter mould number");		
		$("#mould").focus();					
		return false;
	}
	
	/*if(ct=="" || ct==undefined || ct==null || ct=="null"  ){
		alert("please enter CT");		
		$("#ct").focus();					
		return false;
	}
	
	if(planning=="" || planning==undefined || planning==null || planning=="null"  ){
		alert("please enter Planning");		
		$("#planning").focus();					
		return false;
	}
	
	if(qa=="" || qa==undefined || qa==null || qa=="null"  ){
		alert("please enter QA");		
		$("#qa").focus();					
		return false;
	}
	
	if(imaging=="" || imaging==undefined || imaging==null || imaging=="null"  ){
		alert("please enter Imaging");		
		$("#imaging").focus();					
		return false;
	}
	
	if(treatAmount=="" || treatAmount==undefined || treatAmount==null || treatAmount=="null"  ){
		alert("please enter TreatAmount");		
		$("#treatAmount").focus();					
		return false;
	}*/
...
function setAllRadiationMaster(r,CallFrom){
	...
	if(CallFrom=="All"){
		for ( var i = 0; i < r.lstradiationMaster.length; i++) {		
			...
			+ '	<button class="btn btn-xs btn-success editUserAccess" onclick=editRadiationMaster('+r.lstradiationMaster[i].radiationId+')><i class="fa fa-edit"></i></button></td>'
			+ ' <td class="col-md-1 center">'
			+ '	<button class="btn btn-xs btn-danger deleteUserAccess" onclick=deleteRadiationMaster('+r.lstradiationMaster[i].radiationId+')><i class="fa fa-trash-o"></i></button></td>'
			+ '</tr>';
			index++;
		}
