...
function setTempForInnerLoopDD(r1){
	 ...
	 for ( var j = 0; j < r1.listTreatment.length;j++) {
		 ...
		 htm=htm+ "<td style='height: 21.5px;' class='col-md-1 center'>";
		 htm=htm+ "<button style='height: 21.5px;' class='btn btn-xs btn-success' onClick='openPreviousOPDDoctorStation("+ r1.listTreatment[j].treatmentId+","+ r1.listTreatment[j].patientId+")'>";
		 htm=htm+ "<i class='fa fa-eye View'></i></button></td>";
		 htm=htm	+ "<input type='hidden' value='"+ r1.listTreatment[j].patientId+"' id='rowCount' /></tr>";
...
function openPreviousOPDDoctorStation(tid,pid){
	window.location.href = "previous_opd_doctor_station.jsp?tid="+tid+"&callfrom="+"OPDID"+"&pid="+pid;
}
