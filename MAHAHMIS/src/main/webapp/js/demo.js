									...
									if (r.proLi[pk].testli[ts].testresult == null || r.proLi[pk].testli[ts].testresult == "" || r.proLi[pk].testli[ts].testresult == "null") {
										...
										if(r.proLi[pk].testli[ts].rejecttestflag=="Y")
										{
											if(r.proLi[pk].testli[ts].microorganism=="Y")
											{
												...
												html = html + "<td id='testresultt' class='col-md-2 center'><select id='testresultt"+(pk+1)+(ts+1)+ "' style='width:100%' disabled='disabled'  type='text' tabindex=" + (pk+1) + (ts+1) + "'></select></td>";	
												...
												if(r.proLi[pk].testli[ts].textFlag=="Y"){
													html = html + "<td id='testresultt'  class='col-md-2 center'><input id='testresultt" + (pk+1) + (ts+1) + "' type='text'  tabindex=" + (pk+1) + (ts+1) + "'  value='"+(result)+"'></td>";
												}else{
													html = html + "<td id='testresultt' class='col-md-2 center'><select id='testresultt"+(pk+1)+(ts+1)+ "' style='width:100%' disabled='disabled'  type='text' onchange=getGeneralType("+(pk+1)+","+(ts+1)+",this.value),setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"') tabindex=" + (pk+1) + (ts+1) + "'></select></td>";
												}
												
												html = html + "<td class='center' style='font-weight: bold;'><input id='generalTypeIdd"+(pk+1)+(ts+1)+"' type='text' tabindex=" + (pk+1) + (ts+1) + "' disabled value=''></td>";
											}else
											{
												html = html + "<td id='testresultt' class='col-md-2 center'><input onkeyup=setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"') onkeypress='return validatenumericeAndAplhaNumerice(event,"+r.proLi[pk].testli[ts].provision+")' onfocus=setFormulaToTestResult("+(pk+1) + (ts+1) +","+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"') id='testresultt" + (pk+1) + (ts+1) + "' type='text'  disabled='disabled' tabindex=" + (pk+1) + (ts+1) + "' value=''></td>";	
											...
											if(r.proLi[pk].testli[ts].microorganism=="Y")
											{
												html = html + "<td id='testresultt' class='col-md-2 center'><select id='testresultt"+(pk+1)+(ts+1)+ "' style='width:100%'  tabindex=" + (pk+1) + (ts+1) + "' type='text'></select></td>";	
												...
												if(r.proLi[pk].testli[ts].textFlag=="Y"){
													...
													html = html + "<td id='testresultt' class='col-md-2 center'><select id='testresultt"+(pk+1)+(ts+1)+ "' style='width:100%'   type='text' onchange=getGeneralType("+(pk+1)+","+(ts+1)+",this.value),setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"') tabindex=" + (pk+1) + (ts+1) + "'></select></td>";
												}
												
												html = html + "<td class='center' style='font-weight: bold;display:none'><input id='generalTypeIdd"+(pk+1)+(ts+1)+"' type='text' tabindex=" + (pk+1) + (ts+1) + "' disabled value=''></td>";
											}else
											{
												html = html + "<td id='testresultt' class='col-md-2 center'><input onkeyup=setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"')  onkeypress='return validatenumericeAndAplhaNumerice(event,"+r.proLi[pk].testli[ts].provision+")' onfocus=setFormulaToTestResult("+(pk+1) + (ts+1) +","+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"') id='testresultt" + (pk+1) + (ts+1) + "' type='text' tabindex=" + (pk+1) + (ts+1) + "' value=''></td>";	
									   ...
									   if(r.proLi[pk].testli[ts].rejecttestflag=="Y")
										{
											...
											if(r.proLi[pk].testli[ts].microorganism=="Y")
											{
												html = html + "<td id='testresultt' class='col-md-2 center'><select id='testresultt"+(pk+1)+(ts+1)+ "' disabled='disabled' tabindex=" + (pk+1) + (ts+1) + "' style='width:100%'  type='text'></select></td>";	
												...
												if(r.proLi[pk].testli[ts].textFlag=="Y"){
													...
													html = html + "<td id='testresultt' class='col-md-2 center'><select id='testresultt"+(pk+1)+(ts+1)+ "' disabled='disabled'  style='width:100%'  type='text' onchange=getGeneralType("+(pk+1)+","+(ts+1)+",this.value),setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"') tabindex=" + (pk+1) + (ts+1) + "'></select></td>";
												}
												html = html + "<td class='center' style='font-weight: bold;display:none'><input id='generalTypeIdd"+(pk+1)+(ts+1)+"' type='text' tabindex=" + (pk+1) + (ts+1) + "'  disabled value=''></td>";

											}else
											{
												 html = html + "<td id='testresultt'  class='col-md-2 center'><input id='testresultt" + (pk+1) + (ts+1) + "' type='text' tabindex=" + (pk+1) + (ts+1) + "' disabled='disabled' onkeyup=setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"') onkeypress='return validatenumericeAndAplhaNumerice(event,"+r.proLi[pk].testli[ts].provision+")' onfocus=setFormulaToTestResult("+(pk+1) + (ts+1) +","+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"')   value='"+(result)+"'></td>";
											}	
										...
										}else
										{
											if(r.proLi[pk].testli[ts].microorganism=="Y")
											{
												html = html + "<td id='testresultt' class='col-md-2 center'><select id='testresultt"+(pk+1)+(ts+1)+ "' style='width:100%'  type='text' tabindex=" + (pk+1) + (ts+1) + "'></select></td>";	
												...
												if(r.proLi[pk].testli[ts].textFlag=="Y"){
													...
													html = html + "<td id='testresultt' class='col-md-2 center'><select id='testresultt"+(pk+1)+(ts+1)+ "' style='width:100%' tabindex=" + (pk+1) + (ts+1) + "' type='text' onchange=getGeneralType("+(pk+1)+","+(ts+1)+",this.value),setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"')></select></td>";
												}
												
												
												html = html + "<td class='center' style='font-weight: bold;display:none'><input id='generalTypeIdd"+(pk+1)+(ts+1)+"' type='text' tabindex=" + (pk+1) + (ts+1) + "' value=''></td>";

											}else
											{
												html = html + "<td id='testresultt' class='col-md-2 center'><input id='testresultt" + (pk+1) + (ts+1) + "'  tabindex=" + (pk+1) + (ts+1) + "' type='text' onkeyup=setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"') onkeypress='return validatenumericeAndAplhaNumerice(event,"+r.proLi[pk].testli[ts].provision+")' onfocus=setFormulaToTestResult("+(pk+1) + (ts+1) +","+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"')   value='"+(result)+"'></td>";	
								...
								{										
									if (r.proLi[pk].testli[ts].testresult == null || r.proLi[pk].testli[ts].testresult == "" || r.proLi[pk].testli[ts].testresult == "null") {
										...
										if(r.proLi[pk].testli[ts].rejecttestflag=="Y")
										{
											...
											if(r.proLi[pk].testli[ts].microorganism=="Y")
											{
												html = html + "<td id='testresultt' class='col-md-2 center'><select id='testresultt"+(pk+1)+(ts+1)+ "' disabled='disabled' style='width:100%'  type='text' tabindex=" + (pk+1) + (ts+1) + "'></select></td>";	
												...
												if(r.proLi[pk].testli[ts].textFlag=="Y"){
													...
													html = html + "<td id='testresultt' class='col-md-2 center'><select id='testresultt"+(pk+1)+(ts+1)+ "' disabled='disabled' style='width:100%' tabindex=" + (pk+1) + (ts+1) + "' type='text' onchange=getGeneralType("+(pk+1)+","+(ts+1)+",this.value),setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"')></select></td>";
												}
												
												html = html + "<td class='center' style='font-weight: bold;display:none'><input id='generalTypeIdd"+(pk+1)+(ts+1)+"' tabindex=" + (pk+1) + (ts+1) + "' type='text'  disabled value=''></td>";

											}else
											{
												html = html + "<td id='testresultt' class='col-md-2 center'><input onkeyup=setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"') onkeypress='return validatenumericeAndAplhaNumerice(event,"+r.proLi[pk].testli[ts].provision+")' id='testresultt" + (pk+1) + (ts+1) + "' type='text' tabindex=" + (pk+1) + (ts+1) + "'  disabled='disabled' value=''></td>";	
											...
											{
												html = html + "<td id='testresultt' class='col-md-2 center'><input onkeyup=setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"') onkeypress='return validatenumericeAndAplhaNumerice(event,"+r.proLi[pk].testli[ts].provision+")' id='testresultt" + (pk+1) + (ts+1) + "' type='text' tabindex=" + (pk+1) + (ts+1) + "' value=''></td>";
										...
										if(r.proLi[pk].testli[ts].rejecttestflag=="Y")
											...
											if(r.proLi[pk].testli[ts].microorganism=="Y")
											{
												html = html + "<td id='testresultt' class='col-md-2 center'><select id='testresultt"+(pk+1)+(ts+1)+ "' disabled='disabled' style='width:100%'  tabindex=" + (pk+1) + (ts+1) + "' type='text'></select></td>";	
											...
											{
												html = html + "<td id='testresultt'  class='col-md-2 center'><input id='testresultt" + (pk+1) + (ts+1) + "' type='text' disabled='disabled' onkeyup=setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"') onkeypress='return validatenumericeAndAplhaNumerice(event,"+r.proLi[pk].testli[ts].provision+")'  tabindex=" + (pk+1) + (ts+1) + "' value='"+(result)+"'></td>";	
												...
												if(r.proLi[pk].testli[ts].microorganism=="Y")
												{
													...
													//html = html + "<td id='testresultt' class='col-md-2 center'><select id='testresultt"+(pk+1)+(ts+1)+ "' style='width:100%'  type='text' onchange=setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"')></select></td>";	
														...
														if(r.proLi[pk].testli[ts].textFlag=="Y"){
															...
															//html = html + "<td id='testresultt' class='col-md-2 center'><select id='testresultt"+(pk+1)+(ts+1)+ "' disabled='disabled' style='width:100%'  type='text' onchange=getGeneralType("+(pk+1)+","+(ts+1)+",this.value),setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"')></select></td>";
															html = html + "<td id='testresultt' class='col-md-2 center'><select id='testresultt"+(pk+1)+(ts+1)+ "' style='width:100%'  type='text' onchange=setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"') tabindex=" + (pk+1) + (ts+1) + "'></select></td>";
														}
												
												}else
												{
													html = html + "<td id='testresultt' class='col-md-2 center'><input onkeyup=setFlagOfCritical("+(pk+1)+","+(ts+1)+",'"+quantitative+"','"+expressionConvert+"') onkeypress='return validatenumericeAndAplhaNumerice(event,"+r.proLi[pk].testli[ts].provision+")' id='testresultt" + (pk+1) + (ts+1) + "' type='text' tabindex=" + (pk+1) + (ts+1) + "' value='"+(result)+"'></td>";	
 ...
 * @Code This function is use to view outsoutsource test result
 *********************************************************/
function viewOutSourceTestforResult1() {
	$("#outSourcelabpopup").modal('show');
}
