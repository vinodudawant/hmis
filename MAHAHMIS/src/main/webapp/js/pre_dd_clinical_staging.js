function getTemForOPDStaging(id) {
	...
	var temp = '<div id="Clinical" class="tab-pane fade active in">'
			...
			+ '<label class="btn" onclick="resetTNMSatge()"  disabled="true" style="padding-top: 0px; margin-right: 20px; margin-bottom: 0px; margin-left: 20px;">'
			+ '<i class="fa fa-plus"></i> New </label>'
			+ '<label class="btn" onclick="editOPDClinicalStaging()" disabled="true" style="padding-top: 0px; margin-right: 20px; margin-bottom: 0px;" id="editClinical"> '
			+ '<i class="fa fa-edit"></i> Edit </label>'
			+ '<label class="btn" style="padding-top: 0px; margin-right: 20px; margin-bottom: 0px;" id="deleteClinical"  disabled="true" onclick="deleteOPDClinicalStaging()">'
...
function setOPDClinicalList(res){
	...
	if(res.getListOfOPDClinicalStagingDTO.length > 0){
			...
			+ "<td> <span id='snum" + rowCount + "'>" + rowCount
					...
					+ '" name="opddietforeditdelete" type="checkbox" disabled="disabled" ></td>'
