...
function setHistoryTemplate(id){
	...
	var temp = '<div class="tab-pane active" id="History">'
			...
			+ '<button onclick="prinOPDHistory();" title="Print " data-placement="left" data-toggle="tooltip" class="btn btn-xs btn-warning coversheetBtn">'
			...
			+ '<th style="height: 21.5px; width: 25px;"><input type="button" value="+" onclick="createDivIPDHistory()" disabled> <input type="button" value="-" onclick="removeChifComp(\'historyTable1\',\'chkhistory\')" disabled>'
			...
			+ '<textarea class="" cols="40" rows="3" id="provDia" style="margin-left: 3%;"></textarea></div>'
			+ '<div style="padding-left: 0.8%" id="divtempTreatId"  class="col-md-6-1"><label class="TextFont">Treatment Plan:</label>' /*display:none*/
			+ '<textarea class="" cols="40" rows="3" id="treatPlan" style="margin-left: 6%;"></textarea></div></div>'
			+ '</div></div> </div>'
			+'</div>'
			+'</div>'
...
function setHistorySlaveInfo(r){
	...
	htm = htm
			...
			+ "<td style='width: 282px; height: 41pxpx; '><textarea rows='1' cols='38'  id='chiefComp"+parseInt(rowCount)+ "'   >"+r.getListOfHistorySlaveDTO[i].chiefComplaints+" </textarea></td>"
			...
			+ "<td><input type='checkbox'   name='ovampickudocid'  class='chkhistory' id='checkbox"+ parseInt(rowCount)+"'  disabled='disabled'  value="+rowCount+"  ></td>"
