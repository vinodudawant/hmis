function getDignosisTemplate(id) {
	...
	var temp = '<div style="margin-bottom: 9px;" class="col-sm-12-1" id="row1">'
			...
			+ '<label value="New" id="enableAsmntTextBoxesProvisionalLabel" disabled="true" class="btn" style="padding-top: 0px; margin-right: 20px; margin-bottom: 0px; margin-left: 20px;"> <i class="fa fa-plus"></i> New</label>'
			+ '<label value="Edit" id="editAssesmentProvisionalLabel" disabled="true" class="btn" style="padding-top: 0px; margin-right: 20px; margin-bottom: 0px;"  onclick="editPOPDDignosis()"> <i class="fa fa-edit"></i> Edit</label>'
			+ '<label value="Delete" id="deleteAssessmentProvisionalLabel" disabled="true" class="btn" style="padding-top: 0px; margin-right: 20px; margin-bottom: 0px;" onclick="deletePOPDDignosis()" > <i class="fa fa-trash-o"></i>Delete</label>'
			+ '<label id="confirmDiagnosisProvisionalLabel" disabled="true" class="btn" style="padding-top: 0px; margin-right: 20px; margin-bottom: -5px; " onclick="updateDignosisConfirmStatus(\'Confirmed\')">'
			...
			+ '<label value="New" id="enableAsmntTextBoxesConfirmLabel" disabled="true" class="btn" style="padding-top: 0px; margin-right: 20px; margin-bottom: 0px; margin-left: 20px;" > <i class="fa fa-plus"></i> New'
			+ '</label> <label value="Edit" id="editAssesmentConfirmLabel"  disabled="true" class="btn" style="padding-top: 0px; margin-right: 20px; margin-bottom: 0px;"  onclick="editCOPDDignosis()"> <i class="fa fa-edit"></i> Edit'
			+ '</label> <label value="Delete" id="deleteAssessmentConfirmLabel" disabled="true" class="btn" style="padding-top: 0px; margin-right: 20px; margin-bottom: 0px;" onclick="deleteCOPDDignosis()"> <i class="fa fa-trash-o"></i>Delete'
			+ '</label> <label id="provisionalDiagnosisConfirmLabel" disabled="true" class="btn" style="padding-top: 0px; margin-right: 20px; margin-bottom: -5px; " onclick="updateDignosisProvisionalStatus(\'Provisional\')" > <i class="fa-check-square-o"></i> Provisional Diagnosis'
			+ '	</label> </div>'
...
function setProvisinalDataToDiagonosisTable(r) {
	...
	for ( var i = 0; i < r.length; i++) {
		...
		htm = htm + '<tr> ' + " <td class='col-md-1-1 center'>" + index + '</td>' 
				...
				+ '" type="checkbox"  style="cursor: pointer"  disabled /></td>'
				+ '</tr>';
		index++;
		}
	}
...
function setConfirmDataToDiagonosisTable(r){
	...
	for ( var i = 0; i < r.length; i++) {
		...
		htm = htm + '<tr> ' + " <td class='col-md-1-1 center'>" + index + '</td>' 
				...
				+ "<td class='col-md-2-1 center'>" + " " + "</td>"
				+ "<td class='col-md-2-1 center'>"+ r[i].comment + "</td>"
				+ '<td class="col-md-1-1 center"><input  name="diagotablecheckbox"  disabled="disabled" value="' + r[i].id+ '" id="nt' + r[i].id
