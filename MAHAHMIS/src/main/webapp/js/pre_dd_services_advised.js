...
function setOpdServicesAdvisedTemplate(id) {
	...
	temp = temp
			...
			+ '<button style="cursor: pointer; padding-top: 0px; margin-right: 20px; margin-left: 20px; margin-bottom: 0px;" id="editCPOE_TestLabel1" onclick="editOpdServicesAdvised()" disabled="disabled">'
			+ '<i class="fa fa-edit"></i> Edit</label> <label onclick="deleteOpdServicesAdvised(\'multiple\',\'DR\')" style="cursor: pointer; padding-top: 0px; margin-right: 20px; margin-left: 20px; margin-bottom: 0px;" id="muldelcp" disabled="true">'
			+ '<i class="fa fa-trash-o"></i> Multiple Delete </label>'
			+ '<label style="cursor: pointer; padding-top: 0px; margin-right: 20px; margin-left: 20px; margin-bottom: 0px;" id="editCPOE_TestLabel1" onclick="sendToLabFromOPD()" disabled="true">'
			+ '<i class="fa fa-edit"></i> Send To Lab</label>'
			
			+ '<label style="cursor: pointer; padding-top: 0px; margin-right: 20px; margin-left: 20px; margin-bottom: 0px;" id="editCPOE_TestRISLabel1" disabled="true" onclick="sendToRisFromOPD()" >'
	...
	if (r.listBillNobleServiceDto.length > 0) {
		...
		for ( var i = 0; i < r.listBillNobleServiceDto.length; i++) {
			...
			htm = htm	
					...
					+ '<input id="chkOpdBill'+r.listBillNobleServiceDto[i].billDetailsId+'" type="checkbox" name = "opdBillCheckbox" disabled="disabled" style="margin-top: 2px; margin-left: 20px; cursor: pointer;" value='+r.listBillNobleServiceDto[i].billDetailsId+'></input></td>'
					
					+'<td class="col-sm-1-1 center" style="height: 21.5px;"><button class="btn btn-xs btn-success deleteservice" onclick=deleteOpdServicesAdvised('+r.listBillNobleServiceDto[i].billDetailsId+',\'DR\') disabled="disabled"><i class="fa fa-trash-o"></i></button></td>'
