...
function printOPDMain(CallFrom){
	...
	var printTitle="OPD CASE RECORD";
	 var instructionLanguage = $("input[name='prepInstructionPopup']:checked").val();
    
   // window.open("opd_main_print.jsp?billId="+billId+"&treatId="+treatId+"&patId="+patId+"&recId="+recId+"&pendFlag="+pendFlag+"&instructionLanguage="+instructionLanguage+"&CallFrom="+CallFrom+"&unitId="+unitId);
	
	 window.open("opd_main_print.jsp?treatmentId="+treatId+"&instructionLanguage="+instructionLanguage+"&CallFrom="+CallFrom+"&unitId="+unitId+"&printTitle="+printTitle+"&patientName="+patientName);
...
function printOPDMainWithoutHistory(){
    ...
    //window.open("opd_main_print_without_history.jsp?billId="+billId+"&treatId="+treatId+"&patId="+patId+"&recId="+recId+"&pendFlag="+pendFlag+"&instructionLanguage="+instructionLanguage+"&CallFrom="+CallFrom+"&unitId="+unitId);
	 window.open("opd_main_print_without_history.jsp?treatmentId="+treatId+"&instructionLanguage="+instructionLanguage+"&CallFrom="+CallFrom+"&unitId="+unitId+"&printTitle="+printTitle+"&patientName="+patientName);
}