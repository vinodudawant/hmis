...
Code For : autoSuggestation for Ipd  Previous Treatment Bill Patients
================*/
...
/* =============
Code By  : Badrinath Wagh
Code For : get Ipd Previous Treatment Patients Info.
================*/
...
//Added By Badrinath Wagh
function sendingToPreviousGenIpdBill(treatment_id,patientId,callfrom) {
	/*var treatcloseForIpd = "treatcloseForIpd";
	window.location = "IPD_DoctorStation2.jsp?" + "tid=" + r
			+ "&treatcloseForIpd=" + treatcloseForIpd;*/
 window.location.href ="IPD_DoctorStation2.jsp?"  + "tid="
	+ treatment_id +"&callfrom=IPDID&pid="+patientId+"&callFromVal='"+callfrom+"' " ;
}