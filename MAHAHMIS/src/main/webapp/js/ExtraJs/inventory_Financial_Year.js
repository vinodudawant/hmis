var addCollectiontemp = "<div style='width: 100%; padding-top: 2.5%; padding-left: 5%'>	<div style='width: 95%;'><h4>Add  Details:</h4>	</div>	<div style='width: 95%; padding-top: 3%;'>		<div style='width: 30%; padding-right: 3%;'>Year Start Date</div><div style='width: 60%;'><input id='popup_container2' onclick='displayCalendar(document.getElementById('popup_container2'),'dd/mm/yyyy',this)'	readonly='readonly' name='dob' type='text'	placeholder='Date'	class='form-control input-SmallText'></div><div style='width: 1%; color: red; padding-left: 3%'><b>*</b></div>	</div>	<div style='width: 95%; padding-top: 3%;'>		<div style='width: 30%; padding-right: 3%;'>Year End Date</div><div style='width: 60%;'><input id='popup_container2' onclick='displayCalendar(document.getElementById('popup_container2'),'dd/mm/yyyy',this)'	readonly='readonly' name='dob' type='text'	placeholder='Date'	class='form-control input-SmallText'></div>		<div style='width: 1%; color: red; padding-left: 3%'><b>*</b></div>	</div>	<div style='width: 95%; padding-top: 3%;'>		<div style='width: 30%; padding-right: 3%;'>Financial Year</div><div style='width: 60%;'><input	 type='text'	placeholder='financail Year'	style='width: 100%;' maxlength='100'></div>		<div style='width: 1%; color: red; padding-left: 3%'></div>	</div>	<div style='width: 95%; padding-top: 3%; margin-bottom:8px;'>		<div style=' width: 60%; padding-right: 6%;'><button  class='btn btn-xs btn-success' type='button' style='padding 1px 10px;margin-left: 8px;'>Save</button><button    class='btn btn-xs btn-success' type='button' style='padding 1px 10px;margin-left: 8px;'>cancle</button></div><div style='width: 60%;'></div>		</div></div>				</div></div>";
