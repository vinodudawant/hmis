var addCollectiontemp = "<div style='width: 100%; padding-top: 2.5%; padding-left: 5%'>	<div style='width: 95%;'><h4>Tax SetUp:</h4>	</div>	<div style='width: 95%; padding-top: 3%;'>		<div style='width: 30%; padding-right: 3%;'>Id</div><div style='width: 60%;'><input  type='text' style='width: 100%;' maxlength='100'></div></div>	<div style='width: 95%; padding-top: 3%;'>		<div style='width: 30%; padding-right: 3%;'>Tax Code</div><div style='width: 60%;'><input type='text'	style='width: 100%;' maxlength='100'></div>	</div>	<div style='width: 95%; padding-top: 3%;'>		<div style='width: 30%; padding-right: 3%;'>Tax Description</div><div style='width: 60%;'><input	 type='text'	placeholder='Tax Description'	style='width: 100%;' maxlength='100'></div>		<div style='width: 1%; color: red; padding-left: 3%'></div>	</div>	<div style='width: 95%; padding-top: 3%;'>		<div style='width: 30%; padding-right: 3%;'>Rate</div><div style='width: 60%;'><input	 type='text'	placeholder='Rate'	style='width: 100%;' maxlength='100'></div>		<div style='width: 1%; color: red; padding-left: 3%;margin-bottom:8px;'></div>	</div><div style='width: 95%; padding-top: 3%;'>		<div style='width: 60%; padding-right: 6%; margin-bottom: 8px;'><button  class='btn btn-xs btn-success' type='button' style='padding 1px 10px;margin-left: 8px;'>Save</button><button    class='btn btn-xs btn-success' style='padding 1px 10px;margin-left: 8px; ' type='button' >cancle</button></div><div style='width: 60%;'></div>		</div></div>				</div></div>";
...
function ViewTaxSetUpList(fetchType, pagenm) {
