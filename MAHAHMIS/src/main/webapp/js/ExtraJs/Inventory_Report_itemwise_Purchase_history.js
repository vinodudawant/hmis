/******************************** Autocomplete function for Fetch Item Name Author :sudhir Date:1/10/2016 *****************************/
function autoSuggest(inputID, typeauto) {
 ...
 /*************  Featch All Details for Item Purchase History Date :1/10/2016 Author:sudhir *  **/
function getReportForItemWisePurchaseHistory() {
	...
	if (from == '' || to == '' || txtItemName == '' || txtItemcodeId == 0)
		...
		inputs.push('reportName=ItemWisePurchaseHistoy');
...
function setViewBtns1(ajaxResponse) {
	...
	$('#template')
	.html(
			"<button onclick='getReportForItemWisePurchaseHistory()' class='btn btn-xs btn-success' type='button'>Get"
