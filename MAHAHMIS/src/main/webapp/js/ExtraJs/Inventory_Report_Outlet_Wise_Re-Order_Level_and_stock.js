...
// function @Date:10:3:2016  @Author :sudhir
function getOutletWiseReOrderLevelandstockReport(){
	...
	var reportName ="InventoryOutletWiseReOrderLevelandstockReport"; 
...
function setResult(result) {
	...
	$('#setButtons')
			.html(
					"<button onclick='getOutletWiseReOrderLevelandstockReport()' class='btn btn-xs btn-success' type='button'>Get"
					+ "Report</button> <a title='' target='_blank' id='getPDFFile' name='getPDFFile' style='text-decoration: none;' href='/EhatEnterprise/ehat_Reports/Inventory/InventoryMajorReports/InventoryOutletWiseReOrderLevelandstockReport/"+splitResult[0]+"'> <input type='button' class='btn btn-xs btn-warning' value='View PDF' style=''></a>"
							+ "<a title='' target='_blank' id='getPDFFile' style='text-decoration: none;' name='getPDFFile' href='/EhatEnterprise/ehat_Reports/Inventory/InventoryMajorReports/InventoryOutletWiseReOrderLevelandstockReport/"+splitResult[1]+"'> <input type='button' class='btn btn-xs btn-warning' value='View Excel' style=''></a>"
							+ "");
}
