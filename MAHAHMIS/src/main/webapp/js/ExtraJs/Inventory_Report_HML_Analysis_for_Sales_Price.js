 /*************************** show HML Analysis  for sales price Author Sudhir Date:30 Dec 2015 ********************************/
function getHMLAnalysisReportforSalesPrice() {
	
	var from = $("#popup_container2").val();
	var to = $("#popup_container3").val();
	var reportName ="HMLSalesPriceReport";
...
function setResultforHMLSalesPrice(result) {
	var splitResult = result.split('$');
	$('#setButtons')
			.html(
					"<button onclick='getHMLAnalysisReportforSalesPrice()' class='btn btn-xs btn-success' type='button'>Get"	+ "Report </button><a title='' target='_blank' id='getPDFFile' name='getPDFFile' style='text-decoration: none;' href='/EhatEnterprise/ehat_Reports/Inventory/InventoryMajorReports/InventoryHMLAnalysisSalesPriceReport/"+splitResult[0]+"'> <input type='button' class='btn btn-xs btn-warning' value='View PDF' style=''></a>"
							+ "<a title='' target='_blank' id='getPDFFile' style='text-decoration: none;' name='getPDFFile' href='/EhatEnterprise/ehat_Reports/Inventory/InventoryMajorReports/InventoryHMLAnalysisSalesPriceReport/"+splitResult[1]+"'> <input type='button' class='btn btn-xs btn-warning' value='View Excel' style=''></a>"
							+ "");
}