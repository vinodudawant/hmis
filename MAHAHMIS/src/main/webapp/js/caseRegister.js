					...
					for ( var i = 0; i < pobj1.pl.length; i++) {
						...
						orderObject.document
								.writeln('<div style="width: 100%; font-size: 15px"><table width="100%" border="1" cellpadding="0" cellspacing="0"><tr style="height: 30px;"><td width="10%" align="center">DATE</td><td width="90%" align="left" style="padding-left: 10px;">'
										...
										+ '</div></td></tr></table>');
						orderObject.document
								.writeln('<table width="100%" border="1" cellpadding="0" cellspacing="0"><tr style="height: 30px;"><td width="10%" align="center">#</td><td width="50%" align="center" style="padding-left: 10px;">DRUGES	& DOSES :</td><td width="20%" align="center">SIGN.</td><td width="20%" align="center">REMARKS</td></tr>');
						var rw = 0;
				...
				success : function(r) {
					...
					WindowObject.document
							.writeln('<tr height="35px"><td  style="border: solid 1px;padding-left: 10px;" align="left">Age</td><td style="border: solid 1px;padding-left: 10px;" align="left" >'
									+ pobj.pl[0].ag
									+ ' </td><td  style="border: solid 1px;padding-left: 10px;" align="left">Gender</td><td style="border: solid 1px;padding-left: 10px;" align="left" >'
									+ pobj.pl[0].sx + ' </td></tr>');
					WindowObject.document
					...
					WindowObject.document
							.writeln('<tr height="130px"><td  style="border: solid 1px;padding-left: 10px;" align="left">Clinical Findings</td><td colspan="3" style="border: solid 1px;" align="left" ><div style="width: 98%;padding: 1%;">'
									+ pobj.pl[0].otd.cf.split("\n").join(
											"<br />") + '</div> </td></tr>');
					WindowObject.document
							.writeln('<tr><td  style="border: solid 1px;padding-left: 10px;" align="left">Investigation</td><td colspan="3" style="border: solid 1px;" align="left" ><table border="1" cellpadding="0" cellspacing="0" width="100%" style="border-color: lightgray;"><tr height="25"><td align="center">#</td><td align="center">Test Name</td><td align="center">Test Date</td><td align="center">Test Result</td><td align="center">Test Count</td></tr>');
						...
						success : function(r) {
							...
							WindowObject.document
									.writeln('<div style="width: 50%;"><b>Complications</b></div><div style="width: 80%;padding-bottom: 20px; font-family: Tahoma, Geneva, sans-serif; font-size: 13px; color: #161616; float: left;"><div style="width: 110%;padding: 1%;border: solid 1px;">'
											...
											+ '</div></div></div>');
							WindowObject.document
									.writeln('<div style="width:50%; float: left;"><div style="width: 50%;padding-top:5%; "><b>Prescription</b></div><table cellpadding="0" cellspacing="0" style="border: solid 1px;" width="100%"><tr><td style="border: solid 1px;" align="center" width="10%"><strong>#</strong></td><td style="border: solid 1px; width:45%;" align="left"><strong>Medicines</strong></td><td style="border: solid 1px;" align="center" width="10%"><strong>Mor</strong></td><td style="border: solid 1px;" align="center" width="10%"><strong>Noon</strong></td><td style="border: solid 1px;" align="center" width="10%"><strong>Nig</strong></td></tr>');
						...
						success : function(r) {
							...
							WindowObject.document
									.writeln('<html><body><div style="width: 100%; padding-top: 1%;float: left;"><div style="width: 100%; height: 45px; padding-top: 3%;"><div style="width: 100%; font-family: Tahoma, Geneva, sans-serif; font-size: 13px; color: #161616; "><b>Patient Name: '
											...
											+ note.split("\n").join("<br />")
											+ ' </div></div></div></div><div style="width: 50%; padding:%;float: left;"><div style="width: 100%; padding-top:9%;float: left;"><b>Prescription:-</b></div><table cellpadding="0" cellspacing="0" style="border: solid 1px;" width="95%"><tr><td style="border: solid 1px;" align="center" width="10%"><strong>#</strong></td><td style="border: solid 1px;width:45%" align="left"><strong>Medicines</strong></td><td style="border: solid 1px;" align="center" width="10%"><strong>Mor</strong></td><td style="border: solid 1px;" align="center" width="10%"><strong>Noon</strong></td><td style="border: solid 1px;" align="center" width="10%"><strong>Nig</strong></td></tr>');
						...
						success : function(r) {
							...
							for ( var t = 0; t < pobj1.tnl.length; t++) {
								if (dtYY == 0 || dtYY != pobj1.tnl[t].dt) {
									...
									dtYY = pobj1.tnl[t].dt;
									WindowObject.document
											.writeln('<div style="width: 98%; padding-top: 6.5%; float: left; "><div style="width: 100%; float: left;">	<div	style="width: 4%; border: 1px solid #069; text-align: center; float: left;">#</div><div	style="width: 10%; border: 1px solid #069; text-align: center; float: left;">Time</div><div	style="width: 35.1%; border: 1px solid #069; padding-left: 1%; float: left; padding-right: 1%; text-align: center;">Name of Drug</div>	<div	style="width: 13%; border: 1px solid #069; padding-left: 1%; float: left; text-align: center;">Strength</div><div	style="width: 10%; border: 1px solid #069; padding-left: 1%; float: left; padding-right: 1%; text-align: center;">Dose</div><div	style="width: 20%; border: 1px solid #069; padding-left: 1%; float: left; text-align: center;">Sign</div></div></div>');
									var count = 1;
									...
									WindowObject.document
											.writeln('<div style="width: 98%; padding-top: 6.5%; float: left; "><div style="width: 100%; float: left;">	<div	style="width: 4%; border: 1px solid #069; text-align: center; float: left;">#</div><div	style="width: 10%; border: 1px solid #069; text-align: center; float: left;">Time</div><div	style="width: 35.1%; border: 1px solid #069; padding-left: 1%; float: left; padding-right: 1%; text-align: center;">FLUIDS & DRIPS</div>	<div	style="width: 13%; border: 1px solid #069; padding-left: 1%; float: left; text-align: center;">Strength</div><div	style="width: 10%; border: 1px solid #069; padding-left: 1%; float: left; padding-right: 1%; text-align: center;">Dose</div><div	style="width: 20%; border: 1px solid #069; padding-left: 1%; float: left; text-align: center;">Sign</div></div></div>');
									count = 1;
						...
						success : function(r) {
							...
							for ( var t = 0; t < pobj1.drrl.length; t++) {
								if (dtYY == 0 || dtYY != pobj1.drrl[t].dt) {
									...
									WindowObject.document
											.writeln('<div style="width: 98%; padding-top: 6.5%; float: left; "><div style="width: 100%; float: left;">	<div	style="width: 4%; border: 1px solid #069; text-align: center; float: left;">#</div><div	style="width: 10%; border: 1px solid #069; text-align: center; float: left;">Time</div><div	style="width: 25%; border: 1px solid #069; padding-left: 1%; float: left; padding-right: 1%; text-align: center;">Clinical Notes</div>	<div	style="width: 23%; border: 1px solid #069; padding-left: 1%; float: left; text-align: center;">Treatment</div><div	style="width: 20%; border: 1px solid #069; padding-left: 1%; float: left; padding-right: 1%; text-align: center;">Investigation Advice</div><div	style="width: 10%; border: 1px solid #069; padding-left: 1%; float: left; text-align: center;">RoundBy</div></div></div>');
									var count = 1;
			...
			jQuery
					.ajax({
						...
						success : function(r) {
							...
							WindowObject.document
									.writeln('<div style="width: 98%; padding-top: 6.5%; float: left; "><div style="width: 100%; float: left;">	<div	style="width: 4%; border: 1px solid #069; text-align: center; float: left;">#</div><div	style="width: 10%; border: 1px solid #069; text-align: center; float: left;">Time</div><div	style="width: 25.1%; border: 1px solid #069; padding-left: 1%; float: left; padding-right: 1%; text-align: center;">MaterialUsed</div>	<div	style="width: 13%; border: 1px solid #069; padding-left: 1%; float: left; text-align: center;">Quantity</div><div	style="width: 20%; border: 1px solid #069; padding-left: 1%; float: left; padding-right: 1%; text-align: center;">UsedBy</div><div	style="width: 20%; border: 1px solid #069; padding-left: 1%; float: left; text-align: center;">Billable/Replaceable</div></div></div>');
							var count = 0;
				...
				.ajax({
					...
					success : function(r) {
						...
						WindowObject.document
								.writeln('<tr height="35px"><td  style="border: solid 1px;padding-left: 10px;" align="left">Age</td><td style="border: solid 1px;padding-left: 10px;" align="left" >'
										+ pobj.pl[0].ag
										+ 'Yrs </td><td  style="border: solid 1px;padding-left: 10px;" align="left">Gender</td><td style="border: solid 1px;padding-left: 10px;" align="left" >'
										+ pobj.pl[0].sx + ' </td></tr>');
