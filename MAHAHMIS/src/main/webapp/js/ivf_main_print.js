...
function printOPDMain(CallFrom){
    ...
    window.open("ivf_main_print.jsp?billId="+billId+"&treatId="+treatId+"&patId="+patId+"&recId="+recId+"&pendFlag="+pendFlag+"&instructionLanguage="+instructionLanguage+"&CallFrom="+CallFrom+"&unitId="+unitId+"&ivfTreatId="+ivfTreatId);
