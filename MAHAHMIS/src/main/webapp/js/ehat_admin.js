...
"<option value='select'>Select</option><option value='1'>1</option><option value='2'>2</option><option value='3'>3</option><option value='4'>4</option><option value='5'>5</option><option value='6'>6</option><option value='7'>7</option><option value='8'>8</option><option value='9'>9</option><option value='10'>10</option><option value='11'>11</option><option value='12'>12</option><option value='13'>13</option><option value='14'>14</option><option value='15'>15</option><option value='16'>16</option><option value='17'>17</option><option value='18'>18</option><option value='19'>19</option><option value='20'>20</option><option value='21'>21</option><option value='22'>22</option><option value='23'>23</option><option value='24'>24</option><option value='25'>25</option><option value='26'>26</option><option value='27'>27</option><option value='28'>28</option><option value='29'>29</option><option value='30'>30</option><option value='12A'>12A</option><option value='12B'>12B</option><option value='Special'>Special</option></select>" +
"<b	style='color: red;'>*</b></div></div>" +
"<div class='col-md-12-1' style='padding-top: 5%;'>" +
...
function saveOperationDetails() {
	...
	if($('#iFlag').attr('checked'))
		...
		}else
		{
			...
			inputs.push('queryType=' + queryType);
			inputs.push('oid=' + oid);
			inputs.push('oname=' + encodeURIComponent(oname));
			inputs.push('opType=' + opType);
			inputs.push('risk=' + risk);
			inputs.push('list=' + list);
			inputs.push('tCharge=' + tCharge);
			inputs.push('ePrice=' + ePrice);
			inputs.push('eCharge=' + eCharge);

			inputs.push('flag=' + flag);
			inputs.push('opstate=' + opstate);
			inputs.push('opgrade=' + opgrade);
			inputs.push('speName=' + encodeURIComponent(speName));
...
var defaultViewHallTemp = "<table style='margin-bottom: 9px; background: #fff; width:100%;'	class='table table-bordered table-condensed cf'>" +
		...
		"<th style='' class='col-md-3-1'> Ward Name </th>" +
		"<th style='' class='col-md-3-1'> Ward Type </th>" +
		...
		"<th style='padding-left: 0px; padding-right: 0px;' class='numeric col-md-1-1 center'> Delete Ward </th>" +
...
var editHallDetailsTemp = "<div style='height: 120%; padding-left: 5%;'>" +
						...
						" <div class='col-md-3-1' style='padding-top: 7%;margin-left:2%;'>Ward Name</div>" +
						" <div class='col-md-9-1' style='padding-top: 5%; padding-left: 6%;'> " +
						" <select name='listmstr' id='hallNames' style='width: 190px' " +
						" onchange=setDyanamicHallTypeNames()> " +
						" <option id='4'>Ward Name</option> </select> </div> </div>" +
						" <div class='col-md-12 select2Add Ward Type-container select2-container-multi' style='margin-top: 2%; display:none'> " +
						...
						"<div class='col-md-1-1' style='color: red; padding-left: 3px;'><b>*</b></div></div></div>" +
						"<input type='hidden' id='hall_ID' value='{$T.hi}'><input type='hidden' id='nbed' value='{$T.bn}'>{#foreach $T.bl as bl}<input type='hidden' id='bed_ID' value='{$T.bl.bi}'>{#/for}<input type='hidden' id='queryType' value='update'>" +
						
						//added by kishor for show unit list on wardType
						
						" <div class='form-group col-md-12-1'> " +
						" <div class='divide-20' style='margin-top: 11px;'></div> " +
						" <div class='form-group'> " +
						" <div class='col-md-3-1'>Select Unit</div>" +
						" <div class='col-md-9-1' style='padding-left: 8%;'> " +
						" <select name='txtUnit' id='txtUnit' style='width: 184px' " +		
						" <option id='0'>Unit Type</option> </select> </div> </div>" +
						" <div class='col-md-12 select2-container select2-container-multi' style='margin-top: 2%; display:none'> " +
						" <ul id='dynamicItem' class='select2-choices' " +
						" style='overflow-y: scroll;'> </ul> </div> </div>" + 
...
function editHall(hi) {
	...
	setTimeout(function() {
		//addHallTypeDetails();
		//setDyanamicHallTypes('dynamicItem','listmstr_select');
		fetchAllEhatHalls();
		$("#hallNames").select2();
		unitMasterListOnWard();
		}, 10);
	...
	for ( var i = 0; i < myArray.hl.length; i++) {
		if (myArray.hl[i].hi == hi) {
			myObj = myArray.hl[i];
			uId=myArray.hl[i].unitId;
			wardT=myArray.hl[i].ehat_hallId;
			//wardT=myArray.hl[i].hn;
			break;
		}
	}
	myObj = JSON.stringify(myObj);
	...
	setTimeout(function() {
		...
		$("#ehat_hallId").val(wardT);
		$("#unitId").val(uId);
		
		$("#hallNames").select2('val',wardT);
		$("#txtUnit").select2('val',uId);
		}, 100);
	var a = 0;
	var b = 0;
...
function saveHallDetails() {
	...
	var ehat_hallId=$("#ehat_hallId").val(); // added by vinod
	
	var txtUnit = $('#txtUnit').val();// added by Kishor
	...
	if (!pattern.test(nbed)) {
		...
		inputs.push('ehat_hallId=' + ehat_hallId); // added by vinod
		inputs.push('txtUnit=' + txtUnit); // added by Kishor
				...
				.ajax({
					...
					success : function(r) {
						...
						if (ajaxResponse != "Hall Name is Already Present In The database.")
							window.location = "ehat_bedwardmgt.jsp";
					}
				});
	}
}
...
var addHallDetailsTemp = "<div style='height: 120%; padding-left: 5%;'>" +
		"<div class='col-md-12-1 center' style='padding-top: 5%;'><h4>Add Ward</h4></div>	" +
		...
		"<div class='col-md-12-1'><div class='col-md-3-1' style='padding-top: 7%;margin-left:2%;'>Ward Name</div>" +
		"<div class='col-md-9-1' style='padding-top: 8%; padding-left: 6%;'>" +
		"<input type='text' id='hname' name='hname' class='col-md-10-1'	maxlength='150' readonly='readonly' />" +
		"<div class='col-md-1-1' style='color: red; padding-left:3px;'><b>*</b></div></div></div>" +
		"<div class='col-md-12-1'style='margin-top:9px'><div class='col-md-3-1' style='margin-top:4px;margin-left:2%;'>Ward Type</div>" +
		"<div class='col-md-9-1' style='margin-top:9px; padding-left: 6%;'>" +
		"<select class='col-md-10-1' id='btype' name='btype' disabled='disabled'></select>" +
		"<div class='col-md-1-1' style='color: red; padding-left:3px;'><b>*</b></div></div></div>" +
		"<div class='col-md-12-1' style='margin-top:9px'><div class='col-md-3-1' style='margin-top:4px;margin-left:2%;'>Lease/ Bed Normal</div>" +
		"<div class='col-md-9-1' style='margin-top:9px; padding-right: 6%;'><p class='col-md-1-1'>Rs.</p>" +
		...
		"<div class='col-md-1-1' style='color: red; padding-left:3px;'><b>*</b></div></div>" +
...
function SaveUserDetails(updateFrom) {
	...
	if(mulSelunit!=null && mulSelunit!=""){
		...
		alert("Please Enter Unit Master!");
	}
    //end
...
function defaultViewUserNew() {
	alert("2");
	jQuery.ajax({
		async : true,
		type : "GET",
		url : "ehat/users/getUserDetailsList",
		//data	: str + "&reqType=AJAX",
		dataType: 'json',
		timeout : 1000 * 60 * 5,
		catche : false,
...
function editOperation(oid) {
	...
	setSaveOperationButtonTemp();
	ajaxResponse = $("#operationDataDiv").html();
...
function deleteOperation(oid) {
	...
	if (r == true) {
		var inputs = [];
		inputs.push('action=deleteOperation');
		inputs.push("oid=" + oid);
		var str = inputs.join('&');
...
var editHallTypeDetailsTemp = "<div style='height: 90%; border: 1px solid #ddd; padding-left: 5%;'>" +
							...
							" <div class='divide-20'></div> " +
							" <div class='form-group'> " +
							" <div class='col-md-4-1'>Select Ward Type</div>" +
							" <div class='col-md-8-1'> " +
							" <select name='listmstr' id='listmstr_select' style='width: 184px' " +
							" onchange=setDyanamicHallTypes('dynamicItem',this.id)> " +
							" <option id='4'>Ward Type</option> </select> </div> </div>" +
							" <div class='col-md-12 select2-container select2-container-multi' style='margin-top: 2%; display:none'> " +
							" <ul id='dynamicItem' class='select2-choices' " +
							" style='overflow-y: scroll;'> </ul> </div> </div>" +
							...
							"<div class='col-md-1-1' style='color: red; padding-left:13px;'><b>*</b></div></div></div>" +
							"<div class='col-md-12-1' style='margin-top:9px;'>" +
							...
							" <div class='form-group'> " +
							" <div class='col-md-3-1'>Select Unit</div>" +
							" <div class='col-md-9-1' style='padding-left: 13%;'> " +
							" <select name='txtUnit' id='txtUnit' style='width: 184px' " +		
							" <option id='0'>Unit Type</option> </select> </div> </div>" +
							" <div class='col-md-12 select2-container select2-container-multi' style='margin-top: 2%; display:none'> " +
							" <ul id='dynamicItem' class='select2-choices' " +
...
function editHallType(idht) {
	...
	for ( var i = 0; i < myArray.htli.length; i++) {
		if (myArray.htli[i].idht == idht) {
			...
			uId=myArray.htli[i].unitId;
			wardT=myArray.htli[i].hallTypeId;
			break;
		}
	}
	myObj = JSON.stringify(myObj);
	...
	for ( var i = 0; i < hallBean.lihtchr.length; i++) {
		if (hallBean.lihtchr[i].isoflg == "Y") {
			...
			setTimeout(function() {
				...
				$('#hallTypeId').val(wardT);
				$('#txtUnit').select2('val',uId);
				$('#listmstr_select').select2('val',wardT);
		}, 100);
...
function saveHallTypeDetails() {
	...
	var hallTypeId = $("#hallTypeId").val(); //added by vinod
	// added by kishor
	...
	inputs.push('hallTypeId=' + hallTypeId); //added by vinod
	inputs.push('txtUnit=' + txtUnit); //added by Kishor
			...
			.ajax({
				...
				success : function(r) {
					...
					if (ajaxResponse != "Hall Type Name is Already Present In The database.")
						...
						window.location = "ehat_halltypemgt.jsp";
				}
			});
	// defaultViewHall();
	// location.reload();
...
var addHallTypeDetailsTemp = "<div style='height: 90%; border: 1px solid #ddd; padding-left: 5%;'>" +
		"<div class='col-md-12-1 center' style='padding-top: 2%;'><h4>Add Ward Type</h4></div>" +
		...
		"<div class='col-md-12-1'><div class='col-md-4-1' style='padding-top: 7.5%;'>Ward Type Name</div>" +
		"<div class='col-md-8-1' style='padding-top: 7%;'><div class='divide-10'></div>" +
		"<input type='text' id='hname' name='hname' class='col-md-10-1'	maxlength='150' readonly='readonly' />" +
		"<div class='col-md-1-1' style='color: red; padding-left:5px;'><b>*</b></div></div></div>" +
		"<div class='col-md-12-1' style='margin-top:9px;'>" +
		...
		" <div class='divide-20' style='margin-top: 11px;'></div> " +
		" <div class='form-group'> " +
		" <div class='col-md-4-1'>Select Units</div>" +
		" <div class='col-md-8-1'> " +
		" <select name='txtUnit' id='txtUnit' style='width: 184px' " +		
		" <option id='0'>Unit Type</option> </select> </div> </div>" +
		" <div class='col-md-12 select2-container select2-container-multi' style='margin-top: 2%; display:none'> " +
...
var defaultViewOTTemp = "<div class='col-sm-12-1' style='margin-top:-12px; border: 1px solid #ddd; overflow-y:scroll; height: 300px; max-height: auto;'>"
		+ "<table class='table table-bordered table-striped table-condensed cf'>"
		+ "<tbody>"
	...
	jQuery
			.ajax({
				...
				success : function(r) {
					...
					if (ajaxResponse == "Visiting Doctor Fee Details Is Updated Successfully...") {
	...
	jQuery
			.ajax({
				...
				success : function(r) {
					...
					if (ajaxResponse == "Anesthetist Doctor Fee Details Is Updated Successfully...") {
...
/** ********** Procedure Type ***************** */
var addProcedureTypeDetailsTemp = "<div class='col-md-12-1'	style='height: 345px; border: 1px solid #ddd; padding-left: 10%'>" +
					"<div class='divide-20'></div>" +
...
var defaultViewPTTemp = "<div class='col-sm-12-1' style='margin-top:-13px; overflow-y: scroll; height: 350px; max-height: auto;border:1px solid #ddd;'>"
		+ "<table class='table table-bordered table-striped table-condensed cf'>"
		+ "<tbody class='cf'>"
...
function fetchDoctorSpecilizations(page) {
			...
			.ajax({
				...
				success : function(r) {
					...
					if (pobj1.listHosDetail.length > 0) {
						...
						$("#txtState").val(pobj1.listHosDetail[0].hs);
...
function fetchICD10Level1(type) {
	var icd10Codes;
	count = 1;
	if(type == "") {
		alert("Please enter name");
...
var defaultChartViewTempNew = 
	 ...
	 */
		...
		+ "<input type='text' class='form-control input-SmallText' id='8am{count}' value='{$T.lict.am8}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='9am'>"
		+ "<input type='text' class='form-control input-SmallText' id='9am{count}' value='{$T.lict.am9}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='10am'>"
		+ "<input type='text' class='form-control input-SmallText' id='10am{count}' value='{$T.lict.am10}'/>"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='11am'>"
		+ "<input type='text' class='form-control input-SmallText' id='11am{count}' value='{$T.lict.am11}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='12am'>"
		+ "<input type='text' class='form-control input-SmallText' id='12am{count}' value='{$T.lict.am12}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='1pm'>"
		+ "<input type='text' class='form-control input-SmallText' id='1pm{count}' value='{$T.lict.pm1}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='2pm'>"
		+ "<input type='text' class='form-control input-SmallText' id='2pm{count}' value='{$T.lict.pm2}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='3pm'>"
		+ "<input type='text' class='form-control input-SmallText' id='3pm{count}' value='{$T.lict.pm3}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='4pm'>"
		+ "<input type='text' class='form-control input-SmallText' id='4pm{count}' value='{$T.lict.pm4}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='5pm'>"
		+ "<input type='text' class='form-control input-SmallText' id='5pm{count}' value='{$T.lict.pm5}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='6pm'>"
		+ "<input type='text' class='form-control input-SmallText' id='6pm{count}' value='{$T.lict.pm6}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='7pm'>"
		+ "<input type='text' class='form-control input-SmallText' id='7pm{count}' value='{$T.lict.pm7}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='8pm'>"
		+ "<input type='text' class='form-control input-SmallText' id='8pm{count}' value='{$T.lict.pm8}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='9pm'>"
		+ "<input type='text' class='form-control input-SmallText' id='9pm{count}' value='{$T.lict.pm9}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='10pm'>"
		+ "<input type='text' class='form-control input-SmallText' id='10pm{count}' value='{$T.lict.pm10}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='11pm'>"
		+ "<input type='text' class='form-control input-SmallText' id='11pm{count}' value='{$T.lict.pm11}'/>"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='12pm'>"
		+ "<input type='text' class='form-control input-SmallText' id='12pm{count}' value='{$T.lict.pm12}'/>"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='1am'>"
		+ "<input type='text' class='form-control input-SmallText' id='1am{count}' value='{$T.lict.am1}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='2am'>"
		+ "<input type='text' class='form-control input-SmallText' id='2am{count}' value='{$T.lict.am2}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='3am'>"
		+ "<input type='text' class='form-control input-SmallText' id='3am{count}' value='{$T.lict.am3}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='4am'>"
		+ "<input type='text' class='form-control input-SmallText' id='4am{count}' value='{$T.lict.am4}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='5am'>"
		+ "<input type='text' class='form-control input-SmallText' id='5am{count}' value='{$T.lict.am5}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='6am'>"
		+ "<input type='text' class='form-control input-SmallText' id='6am{count}' value='{$T.lict.am6}' />"
		+ "</td>"
		+ "<td class='center' style='height: 21.5px; width: 100px;' id='7am'>"
		+ "<input type='text' class='form-control input-SmallText' id='7am{count}' value='{$T.lict.am7}' />"
		+ "</td>"
...
function setDefaultViewChartSlaveNew() {
	...
	jQuery.ajax({
		...
		success : function(r) {
			...
			if (pageName == "Admin") {
				...
				$("#selCustomizeTemp").setTemplate(fetchCustomizeTemplateListipdConsentForm);
...
function setCustomizeTemplate(templateId) {
	...
	for ( var i = 0; i < myArray.pattemplist.length; i++) {
		if (myArray.pattemplist[i].idpattemp == templateId) {
	...
	if (myObj.type == "h") {
		...
		CKEDITOR.instances['editorSubjective'].setData(myObj.tempdata);
...
function saveCustomizeTemplate(Type) {
	...
	if ($("#ipdFlag").attr('checked') && $("#opdFlag").attr('checked')) {
...
function SearchPathologyOnEnter(key, callFrom) {
	...
	if ((keycode > 64 && keycode < 91) || (keycode > 96 && keycode < 123)
		...
		if (callFrom == "search") {
			...
			getLabTestPatientSearch('search', 'labTestResults')
		}else {
...
function defaultCheckListView(callFrom,type) {
	var byName;
	if(type == "search"){
...
function fetchAllEhatHalls() {
	
	var inputs = [];
	inputs.push('action=fetchAllEhatHalls');
	var str = inputs.join('&');
	jQuery.ajax({
		async : true,
		type : "POST",
		...
		success : function(r) {
			...
			for(var i=0;i<pobj1.lstSubService.length;i++){
				
				hallNames=hallNames+"<option value="+pobj1.lstSubService[i].subId+">"+pobj1.lstSubService[i].categoryName+"</option>";				
			}
			
			$("#hallNames").html(hallNames);
			// parsebcObj = JSON.stringify(pobj1);
			// $("#objDiv").html(parsebcObj);
		}
	});
...
function setDyanamicHallNames(){
	
	var hNames=$("#hallNames").val();	
	var hallNameId = $("#hallNames").children(":selected").attr("id");
	$("#hallNameId").val(hallNameId);
	$("#hname").val(hNames);	
	/*$("#hname").val(hNames);*/	
}

function setDyanamicHallTypeNames(){
	
	var id=$('#hallNames option:selected').attr("id");	
	var hid=$('#hallNames').val();	
	$("#ehat_hallId").val(hid);
	var hn=$('#hallNames  option:selected').text();
	$("#hname").val(hn);
	var inputs = [];
	inputs.push('action=fetchMappedHallType');
	inputs.push('id='+hid);
	var str = inputs.join('&');
	jQuery.ajax({
		async : true,
		...
		success : function(r) {
			ajaxResponse = r;
			pobj1 = eval('(' + ajaxResponse + ')');
			var selected=pobj1.htli[0].idht;
			$('#btype option[value="'+selected+'"]').prop("selected", "selected");
		}
	});	
}
 ...
 *@author	: Kishor Lokhande
 *@date		: 28-March-2018
 *@code		:Disply unit list on Ward type management
 ***********/

function unitMasterListOnWard()
{
		//var ulogin ="userName";
		...
		jQuery.ajax({
			...
			{
					//refreshUnitMaster();		
				setTemplateForunitMasterListOnWard(r);	
		}
	});	
...
function setTemplateForunitMasterListOnWard(r){
	//alert("hi");
	var list="";
