	...
	if (testObj.listOPDPrescriptionDtoSP.length > 0) {
		...
		for ( var int = 0; int < testObj.listOPDPrescriptionDtoSP.length; int++) {
			...
			prescriptionContentTemp = prescriptionContentTemp
					...
					+ "<td class='col-md-2-1'>"
					+ testObj.listOPDPrescriptionDtoSP[int].drugName
					+ "</td>"
...
function printPrescriptionHF(callFrom){
	...
	var patId = $("#pt_Id").val();
	 var unitId = $("#unitId").val();
	 var ShradhhaFlag = $("#ShradhhaFlag").val();
	 var patientName = $("#patientName").text();
	 var printTitle="PRESCRIPTION";
	 ...
	 if(ShradhhaFlag == "ON")
	{
		 if (callFrom == "HF") {
			 ...
			 window.open("OPDPrescriptionPrintEhatnew.jsp?"+"patID=" +
						encodeURIComponent(patId) + "&treatID=" + encodeURIComponent(treatId)+"&instructionLanguage="+encodeURIComponent(instructionLanguage) +"&call="+callFrom);
			...
			if (callFrom == "Plain") {
				 ...
				 window.open("OPDPrescriptionPrintEhatnew.jsp?"+"patID=" +
				    ...
				    window.open("opd_prescription_hf_english_print.jsp?treatmentId=" + treatId + "&instructionLanguage=" + instructionLanguage + "&unitId=" + unitId + "&printTitle=" + printTitle + "&patientName=" + patientName);
	...
	}else
	{
	 ...
	 if (callFrom == "HF") {
		...
		if (callFrom == "Plain") {
		    ...
		    window.open("opd_prescription_plain_print.jsp?treatmentId=" + treatId + "&instructionLanguage=" + instructionLanguage + "&unitId=" + unitId + "&printTitle=" + printTitle + "&patientName=" + patientName);

		} else if (callFrom == "OPD") {

		    window.open("opd_prescription_print.jsp?treatmentId=" + treatId + "&instructionLanguage=" + instructionLanguage + "&unitId=" + unitId + "&printTitle=" + printTitle + "&patientName=" + patientName);
		}
	}	
}
...
//added by vishant
function editSequenceOPD(){
	
	$("#editSequence2").modal('show');
	getAllPrescriptionsForSequenceOPD();
...
//added by vishant
function getAllPrescriptionsForSequenceOPD(){
	...
	if(treatmentId !=undefined && treatmentId !=null && treatmentId !="" && treatmentId !="null"){
		...
		jQuery.ajax({
			...
			success : function(r) {
				...
				setAllPrescriptionsForSequenceOPD(r);
			}
		});
	}
}
//added by vishant
function setAllPrescriptionsForSequenceOPD(r){
...
function saveOPDPrescriptionSequence(){
...
function printPrescription(){
	...
	var patId = $("#pt_Id").val();
	 ...
	 var printTitle="PRESCRIPTION";
		    ...
		    window.open("opd_prescription_print_new.jsp?treatmentId=" + treatId + "&instructionLanguage=" + instructionLanguage + "&unitId=" + unitId + "&printTitle=" + printTitle + "&patientName=" + patientName);
		

}

function getGenMedicineData(id, callfrom){
	if ($("#medicineNotAvailableCheckbox").is(":checked")){
		//$("#divTagname ul").remove();
		return false;
	}else{
