...
//			+ '<th style="height: 21.5px; padding-left: 30px;" class="center"><div class="TextFont"></div></th></tr></thead>'
			...
			+ '</label> <label id="provisionalDiagnosisConfirmLabel" class="btn" style="padding-top: 0px; margin-right: 20px; margin-bottom: -5px; " onclick="updateDignosisProvisionalStatus(\'Provisional\')" > <i class="fa fa-check-square-o"></i></i> Provisional Diagnosis'
			+ '	</label> </div>'
		...
		//	+ '</table></div></div></div></div></div></div></div>';
			...
			+ '	<th style="height: 21.5px; padding-left: 0px;" class="col-md-2-1 center"><div class="TextFont">Comment</div></th>'
			+ '<th style="height: 21.5px; padding-left: 30px;" class="center"><div class="TextFont"></div></th></tr></thead>'
			+ '<tbody id="assesmentContentConfirmaed"></tbody></table>'
			+ '</div></div></div></div></div></div>'
	/* userAccess(); */
...
//	var userId = $("#userId").val();
	...
	jQuery.ajax({
		...
		success : function(r) {
			...
			refreshICDDiagnosisLevelOPD();//Added by Annapurna
...
//Added By Annapurna
function refreshICDDiagnosisLevelOPD(){
	$("#idIcd10L").val(0);
	$("#txtIcdCode").val('');
	$("#txtIcdDiagnosis").val('');
	$("#txtIcdDiagnosis1").val('');
