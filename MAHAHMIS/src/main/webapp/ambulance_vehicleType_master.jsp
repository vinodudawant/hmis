...
<title>Ambulance vehicle Type</title>
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><a href="ambulance_vehicleType_master.jsp">Ambulance Vehicle Type</a></li>
									...
									<div class="panel panel-default">
										<div class="panel-body">										
											...
											<div class="panel panel-primary">
												<div class="panel-heading">Ambulance Vehicle Type
													:</div>
												<div class="panel-body">
														...
														<!-- 	<div class="col-md-2">
															...
															<div class="col-md-2">
																<div class="form-group" >
																	<input type="text" name="vehicleType_id" id="vehicleTypeId"
																		placeholder="VehicleType Id" class="form-control">
																</div>
															</div> -->
																<div class="col-md-2">
																Vehicle Type
															...
															<div class="col-md-2">
																<div class="form-group" >
																	<input type="text" name="vehicle_type" id="vehicleType"
																		placeholder="Vehicle Type" class="form-control">
																</div>
															</div>
														...
														<div class="function-buttons" style="float: center;">
															<div class="buttons">
																<button type="submit" class="btn btn-success"
																	onclick="saveVehicleTypeMaster()">
																	<i class="fa fa-save"></i> Save
																</button>
																<button type="button" class="btn btn-warning"
																	onclick="clearVehicleTypeMasterDetails()">Clear</button>
															</div>
														</div>																					
													</div>
													</form>
											...
											<thead id="">
												<tr>
													<th class="col-md-1 center" >Vehicle Type ID</th>
											...
											<tbody id="vehicleTypeMasterList">
