...
<meta charset="utf-8">
<title>Pathology Doctor Charge Type</title>
<meta name="viewport"
...
<script type="text/javascript">
	onload = function() {
		...
		autoSuggestionForLab("byName", "onload","pathologyDocChargeType");
	}
</script>
						...
						<div class="row">
							<div id="content" class="col-lg-12">
									...
									<div class="col-sm-12">
										<div class="page-header">
											...
											<ul class="breadcrumb col-md-12-1"
												...
												<li><a href="PathologyDocChargeType.jsp">Lab Doctor Charge Type</a></li>
												<div class="li pull-right">
													<button class="btn btn-xs btn-success" 
													data-toggle="tooltip" data-placement="left" title="Save Doctor Charges"
													onclick="saveDocChargeTypes()">
								...
								<div class="col-md-12-1">
									...
									Doctor Charges Type Name:</label></div>
