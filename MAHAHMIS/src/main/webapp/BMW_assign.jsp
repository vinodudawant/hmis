...
<script type="text/javascript" src="js/bmw_assigned.js"></script>
				...
				<div class="row">
					<div id="content" class="col-lg-12">
							...
							<div class="col-sm-12">
								<div class="page-header">
									...
									<ul class="breadcrumb">
										...
										<li><a href="BMW_assign.jsp">BMW Assign  Form</a></li>
									</ul>
						...
						<div class="function-buttons" style="float: right;">
							<div class="buttons">
								<button type="submit" class="btn btn-success" onclick="assignBmwRequisition()"><i class="fa fa-save"></i> Assign</button>
							...
							<div class="col-md-12">
								<div class="panel panel-default">
										...
										<div class="row">			
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<select class="form-control" name="status" id="bag_Status" >
									...
									<!-- <div class="col-md-1">
										 ...
										 <div class="col-md-2">	
											<div class="form-group">
												<select class="form-select" name="assign_to" id="assign" >
		                         ...
		                         <!-- ============================ End :Requisition Search ====================== -->
 									
									<div class="clearfix"></div>
								</div>		
													
					<!-- <div class="panel panel-primary">
						<div class="panel-heading">BMW Assign :</div>
							<div class="panel-body">								
								...
								<div class="row" style="margin-top: 10px">
									<div class="col-md-12">
										...
										<div class="panel panel-primary"
											...
											<div class="panel-heading" id="divEhatContent"> BMW  Assign :</div>
											<div class="panel-body"
											...
											<thead id="">
												<tr>
													...
													<th class="col-md-1 center">Assign</th>
													<th class="col-md-1 center">Assign To</th>
