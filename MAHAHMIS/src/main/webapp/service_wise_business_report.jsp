...
<meta charset="utf-8">
<title>Service Wise Business Report </title>
...
<script>
	...
	jQuery(document).ready(function() {		
      ...
      $('#chkRquisitionDate').change(function() {
		...
		getAllDept();
		fetchServiceWiseBusinessReport('new');
		getAllServices();
		fetchChargesSlave();
									...
									<form class="form-horizontal col-md-12 ">
										...
										<div class="col-md-1">
											...
											<button class="btn btn-xs btn-primary" type="button"
												...
												onclick="fetchServiceWiseBusinessReport('new')" type="button">
												<b>Show</b>
											</button>
										</div>
										</form>
													...
													<table  border="1"  id="printTable" style="margin-top:20px;width: 2000px;">
														...
														<thead id="headServiceWiseReport">
															<tr class="sticky-header" style="background-color: #FFFFE0;">
																...
																<th id="nameChange" class='col-md-2 center'>Requisition Date </th>
																<th class='col-md-1 center'>Bill No</th>
																<th class='col-md-2 center'>Patient Id</th>
																...
																<th class='col-md-1 center'>Package Name</th>
...
<input type="hidden" id="packageType" value="0">
</body>
</html>