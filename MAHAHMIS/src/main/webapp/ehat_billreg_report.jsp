								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="ehat_billreg_report.jsp">Bill Register Report</a></li>
											<li class="pull-right">
												...
												<button id="btnPrint" class="btn btn-xs btn-warning"
													...
													<script type="text/javascript">
														 ...
														 $(document).on('click', '#btnPrint', function (e) {
														    ...
														    link.download = "Bill Register Report.xls";
														    link.href = result;
														    link.click();
														});
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-3">	
												<button id="btnPrint1" class="btn btn-xs btn-primary" onclick="getBillRegisterReport();"
													data-placement="left" data-toggle="tooltip" data-original-title="Print">Show</button> 
										</div>
										
										<div class="col-md-3" style="margin-top: 2px">
											
										<!-- 	<div class="col-md-10">
												<select id="filterBy" class="form-control" onchange="setFilterType()">
													<option value="0">---- Filter By ----</option>
													<option value="1">Speciality Wise</option>
													<option value="2">Consulting Doctor Wise</option>
													<option value="3">Reason Of Visit Wise</option>
												</select>
											</div> -->
										</div>	
										
										<div id="divSpeciality" class="col-md-3" style="margin-top: 2px;display: none;">
											
											<div class="col-md-10">
												<select id="iConsSpec" class="form-control" style="width: 200px"></select>
											</div>
										</div>
										
										<div id="divConsult" class="col-md-3" style="margin-top: 2px;display: none;">
											
											<div class="col-md-10">
												<select id="iConsDoc" class="form-control" style="width: 200px"></select>
											</div>
										</div>												
										
										<div id="divreasonOfVisit" class="col-md-3" style="margin-top: 2px;display: none;">
											
											<div class="col-md-10">
												<select id="reasonofvisit" class="form-control" style="width: 200px"></select>
											</div>
										</div>	
																...
																<table class="table table-bordered table-striped table-condensed cf"
																	...
																	<thead class="cf">
																		<tr>
																			...
																			<th style="height: 21.5px;width: 4%">Treatment ID</th>
																			<th style="height: 21.5px;width: 10%">Patient Name</th>																		
																			<th style="height: 21.5px;width:  6%">OPD No.</th>	
																			<th style="height: 21.5px;width:  6%">Bill No.</th>																	
																			<th style="height: 21.5px;width:  7%">Bill Date</th>	
																			<th style="height: 21.5px;width: 10%">Ref. Dr.</th>	
																			<th style="height: 21.5px;width: 10%">Doctor's Name</th>		
																			<th style="height: 21.5px;width: 10%">Service Name</th>	
																			<th style="height: 21.5px;width: 7%">Bill Amt</th>	
																			<th style="height: 21.5px;width: 5%">Discount Amt</th>																																							
																			<th style="height: 21.5px;width: 5%">Recd Amt</th>
																			<th style="height: 21.5px;width: 6%">Balance Amt</th>
																			<th style="height: 21.5px;width: 5%">Source</th>	
																			<th style="height: 21.5px;width: 4%">Unit Name</th>																																						
																		</tr>
																	</thead>
