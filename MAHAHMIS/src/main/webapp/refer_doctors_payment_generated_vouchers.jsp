...
<title>Referal Doctor  Voucher</title>
...
<script type="text/javascript">
	onload = function() {
		...
		setAutoSuggestDocNameForRefer("byName", "onload", "proFees");
									...
									<!-- ----------------------------------------- -->
										...
										<div class="col-md-12 row"
											...
											<br>
												<button class="btn btn-xs btn-primary" data-toggle="tooltip"
													...
													title="Show" onclick="fetchReferDoctorsVouchers('search')" type="button">
													<b> Show </b>
												</button>
											</div>
										...
										<div class="tabbable col-md-12" style="margin-top:0px;">
											<ul class="nav nav-tabs">
												<li class="active">
													<a id="ct" href="#CT" data-toggle="tab" onclick="fetchReferDoctorsVouchers('onload');">
												 ...
												 <li class="">
													<a id="pt" href="#PT" data-toggle="tab" style="" onclick="fetchReferDoctorsVouchers('cancel');">
														<span class="hidden-inline-mobile">
															<b>
