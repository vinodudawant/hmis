...
<title>User Entry Log Report</title>
									...
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><i class="fa fa-home"></i> <a
												href="">Finance</a></li>
											<li><a href="user_entry_log_report.jsp">User Entry Log Report</a></li>
											<li class="pull-right">
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getUserEntryLogReport(); updateDynamicDateLabel();"
													...
													<div id="divLine2" class=" box border col-md-12" style="overflow: auto;">
														<form class="form-horizontal col-md-12"
														    ...
														    <label id="businessSheetLabel">
														        <i class="fa fa-arrow-down"></i> User Entry Log Report sheet from
    ...
    <table class="table">
      <thead>
        <tr style="background-color: lightyellow; font-size: 12px; border: 2px solid darkgray; font-weight: bold;">
          ...
          <th>Output</th>         
          <th>Services</th>
          <th>Doctor Medicines Entry</th>
           <th>Nursing Medicine Entry</th>
          <th>Ot Schedule</th>
          <th>Manage Operation</th>
          <th>Registration</th>
          <th>OPD Bill</th>
          <th>Diagnostics  Bill</th>
          <th>IPD Bills</th>
        </tr>
      </thead>
      <tbody id="userEntryLogReport">      </tbody>
    </table>
  </div>
