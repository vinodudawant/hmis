...
<%@page import="com.hms.ivf.dto.OvamPickUpSlaveDTO"%>
...
<body>
	<%
		...
		/* 	p.add(new Chunk(" \nCIN: "+cinNo+", GST : "+gstNo , tabletext));	
			...
			HeaderTable2.addCell(new Phrase("    Ovum PickUp Form ", header));
			HeaderTable2.addCell(new Phrase("", subheader));
			HeaderTable2.addCell(new Phrase("", subheader));
...
OvamPickMasterDTO ovamobj=	obj1.getOvamPickUpMasterInfoOnPrint(patId, cycleNo);

OvamPickUpSlaveDTO slaveobj=	obj1.getOvamPickUpSalveList(patId, cycleNo);
...
if(ovamobj !=null){
	...
	HeaderTableOvamBasicInfo.addCell(new Phrase("Date Of Ovum Pick Up:", subheader));
	HeaderTableOvamBasicInfo.addCell(new Phrase(""+ovamobj.getDateOfOvamPickUp(), tabletext));
	HeaderTableOvamBasicInfo.addCell(new Phrase("", tabletext));
	HeaderTableOvamBasicInfo.addCell(new Phrase("", tabletext));
	HeaderTableOvamBasicInfo.addCell(new Phrase("", tabletext));
	HeaderTableOvamBasicInfo.addCell(new Phrase("", tabletext));
	...
	PdfPTable HeaderTableovamPickupLine = new PdfPTable(1);
	int[] headerovamPickupLine = {20};
	HeaderTableovamPickupLine.setWidths(headerovamPickupLine);
	HeaderTableovamPickupLine.setWidthPercentage(95f);
	HeaderTableovamPickupLine.getDefaultCell().setBorder(Rectangle.NO_BORDER);
	
	
	HeaderTableovamPickupLine.addCell(new Phrase("", header));
	HeaderTableovamPickupLine.addCell(new Phrase("", header));
	document.add(HeaderTableovamPickupLine);
	HeaderTableovamPickupLine.flushContent();
	
	

	PdfPTable HeaderTableovamPickup = new PdfPTable(3);
	int[] headerovamPickup = {20,20,20 };
	HeaderTableovamPickup.setWidths(headerovamPickup);
	HeaderTableovamPickup.setWidthPercentage(95f);
	HeaderTableovamPickup.getDefaultCell().setBorder(Rectangle.BOX);
	
	HeaderTableovamPickup.addCell(new Phrase("Sperum Source", subheader));
	HeaderTableovamPickup.addCell(new Phrase("", subheader));
	HeaderTableovamPickup.addCell(new Phrase("Date", subheader));
	//HeaderTableovamPickup.addCell(new Phrase("TESA", subheader));
	
	HeaderTableovamPickup.addCell(new Phrase("No Of oocytes retrieved", subheader));
	HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getOocytesretrievedEjaculate(), tabletext));
	HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getOocyteEjaculateDate(), tabletext));
//	HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getOocytesretrievedPesa(), tabletext));
	//HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getOocytesretrievedTesa(), tabletext));
	
	
	HeaderTableovamPickup.addCell(new Phrase("No Of mature oocytes ", subheader));
	HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getMatureoocytesEjaculate(), tabletext));
	HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getMatureoocytesDate(), tabletext));
	//HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getMatureoocytesPesa(), tabletext));
	//HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getMatureoocytesTesa(), tabletext));
	
	HeaderTableovamPickup.addCell(new Phrase("No Of oocytes injected ", subheader));
	HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getOocytesinjectedEjaculate(), tabletext));
	HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getOocytesinjectedDate(), tabletext));
	//HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getOocytesinjectedPesa(), tabletext));
	//HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getOocytesinjectedTesa(), tabletext));
	
	HeaderTableovamPickup.addCell(new Phrase("Embroys Formed ", subheader));
	HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getEmbroysformedEjaculate(), tabletext));
	HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getEmbroysformedDate(), tabletext));
	//HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getEmbroysformedPesa(), tabletext));
	//HeaderTableovamPickup.addCell(new Phrase(""+ovamobj.getEmbroysformedTesa(), tabletext));
	
	document.add(HeaderTableovamPickup);
	HeaderTableovamPickup.flushContent();
	...
	PdfPTable HeaderTableovamsalveInfo = new PdfPTable(13);
	int[] headerovamsalveInfo = {10, 45, 45, 45, 45, 45,45,45,45,45,45,45,45 };
	...
	HeaderTableovamsalveInfo.addCell(new Phrase("Egg Number", subheader));
	HeaderTableovamsalveInfo.addCell(new Phrase("Appearance", subheader));
	HeaderTableovamsalveInfo.addCell(new Phrase("Date", subheader));
	HeaderTableovamsalveInfo.addCell(new Phrase("Maturity", subheader));
	HeaderTableovamsalveInfo.addCell(new Phrase("PB Appearance", subheader));
	HeaderTableovamsalveInfo.addCell(new Phrase("PN Score", subheader));
	HeaderTableovamsalveInfo.addCell(new Phrase("Day 2", subheader));
	HeaderTableovamsalveInfo.addCell(new Phrase("Day 3", subheader));
	HeaderTableovamsalveInfo.addCell(new Phrase("Day 4", subheader));
	HeaderTableovamsalveInfo.addCell(new Phrase("Day 5", subheader));
	HeaderTableovamsalveInfo.addCell(new Phrase("Transper", subheader));
	HeaderTableovamsalveInfo.addCell(new Phrase("Rate", subheader));
...
int index=1;
	if(slaveobj.getGetListOfOvamPickUpSlaveDTO().size() > 0){
		for(int i=0;i<slaveobj.getGetListOfOvamPickUpSlaveDTO().size();i++){
		HeaderTableovamsalveInfo.addCell(new Phrase(""+index, tabletext));
		HeaderTableovamsalveInfo.addCell(new Phrase(""+index, tabletext));
		HeaderTableovamsalveInfo.addCell(new Phrase(""+slaveobj.getGetListOfOvamPickUpSlaveDTO().get(i).getAppearance(), tabletext));
		HeaderTableovamsalveInfo.addCell(new Phrase(""+slaveobj.getGetListOfOvamPickUpSlaveDTO().get(i).getOvampickupslavedate(), tabletext));
		HeaderTableovamsalveInfo.addCell(new Phrase(""+slaveobj.getGetListOfOvamPickUpSlaveDTO().get(i).getMaturity(), tabletext));
		HeaderTableovamsalveInfo.addCell(new Phrase(""+slaveobj.getGetListOfOvamPickUpSlaveDTO().get(i).getPbappearance(), tabletext));
		HeaderTableovamsalveInfo.addCell(new Phrase(""+slaveobj.getGetListOfOvamPickUpSlaveDTO().get(i).getPnscore(), tabletext));
		HeaderTableovamsalveInfo.addCell(new Phrase(""+slaveobj.getGetListOfOvamPickUpSlaveDTO().get(i).getDay2(), tabletext));
		HeaderTableovamsalveInfo.addCell(new Phrase(""+slaveobj.getGetListOfOvamPickUpSlaveDTO().get(i).getDay3(), tabletext));
		HeaderTableovamsalveInfo.addCell(new Phrase(""+slaveobj.getGetListOfOvamPickUpSlaveDTO().get(i).getDay4(), tabletext));
		HeaderTableovamsalveInfo.addCell(new Phrase(""+slaveobj.getGetListOfOvamPickUpSlaveDTO().get(i).getDay5(), tabletext));
		HeaderTableovamsalveInfo.addCell(new Phrase(""+slaveobj.getGetListOfOvamPickUpSlaveDTO().get(i).getTransper(), tabletext));
		HeaderTableovamsalveInfo.addCell(new Phrase(""+slaveobj.getGetListOfOvamPickUpSlaveDTO().get(i).getRate(), tabletext));
		document.add(HeaderTableovamsalveInfo);
		HeaderTableovamsalveInfo.flushContent();
		index++;
		}
