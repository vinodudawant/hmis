...
//start condition Discharge 
			...
			//  HttpServletRequest request = new HttpServletRequest();
			  ...
			  IPD_AutoSummaryService uss3  =(ApplicationContextUtils.getApplicationContext()).getBean(IPD_AutoSummaryService.class);
	      	List<DischargeSummery> listPrescriptionsSP = new ArrayList<>();	
	      	listPrescriptionsSP =  uss3.fetchAutoDischargeSummery(treatmentId);  // data by stored procedure
	      	 ...
	      	 PdfPTable HeaderTableSpace1 = new PdfPTable(1);
	      		...
	      		PdfPTable HeaderTableH1 = new PdfPTable(4);
	      				...
	      				HeaderTableCh1.addCell(new Phrase("Condition At Discharge", subheader));
	      				...
	      				for(int i=0;i<listPrescriptionsSP.size();i++ ){
	      					...
	      					HeaderTableCh1.addCell(new Phrase(""+listPrescriptionsSP.get(i).getConditionAtDischarge()));
