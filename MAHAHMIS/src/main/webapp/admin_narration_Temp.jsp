...
<!-- 	<script type="text/javascript" src="js/UserAccess.js"> -->
	<script type="text/javascript" src="js/narrationTemp.js"></script>
								...
								<div class="col-md-12">
									...
									<div class="col-md-4">
										<div class="input-group" id="byNamee">
											<input class="form-control" title="Please enter Narration name" id="byName"
												type="text" placeholder="Narration Name" onkeyup="setAutoCompleteForNarrationMaster(this.id,'search')">
												...
												<div class="col-md-12" id="divForEntry">
													<div class="container">
														<div class="panel panel-primary">
															<div class="panel-heading" id="divEhatContent">Narration Master</div>
															<div class="panel-body">
																<div class="form-row">
																	...
																	<div
																		...
																		<label class='TextFont col-md-4-1'>Narration
																			ID</label> <input id='narrId' type='text'
																			placeholder='Narration ID'
																	...
																	<div class="form-group col-md-3"> 
																		<label for="inputEmail4">Narration Name</label>
																		 <input validateAlphabetsByRegEx(this.id)' class="form-control tip-focus" title="Please enter module name" id="narrName" type="text" placeholder="Narration Name">
																	</div>
																	
																	<div class="form-group col-md-3"> 
																		<label for="inputEmail4">Narration Code</label>
																		 <input validateAlphabetsByRegEx(this.id)' class="form-control tip-focus" title="Please enter module name" id="narrCode" type="text" placeholder="Narration Code">
																	</div>
																</div>
																<button type="button" class="btn btn-success" onclick="saveNarrationMaster()" style="margin-top: 15px;">Save</button>
																<button type="button" class="btn btn-warning" onclick="refreshNarrMaster()" style="margin-top: 15px;">Clear</button>
															</div>
														</div>
													</div>
												</div>
