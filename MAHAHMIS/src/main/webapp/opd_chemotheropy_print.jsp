...
<body>
	<%
		...
		if((age.split("/")[0]).equalsIgnoreCase("0Y")){ 
			...
			//int TokenNo = ltRegMasterDto.get(0).getToken();
		...
		/* 	p.add(new Chunk(" \nCIN: "+cinNo+", GST : "+gstNo , tabletext));	
			...
			HeaderTable2.addCell(new Phrase("    Chemotheropy Print ", header));
			HeaderTable2.addCell(new Phrase("", subheader));
			HeaderTable2.addCell(new Phrase("", subheader));
		...
		/* 	if(chargesSlaveId > 0){
			...
			/* if(totRemain==0){
				...
				HeaderTable3.addCell(new Phrase("Print Date ",subheader));
				...
				HeaderTable3.addCell(new Phrase("Print Time ",subheader));
		...
		PatientHeaderInfoDto rtd1 = new PatientHeaderInfoDto();	
		rtd1.setTreatmentId(treatmentId);
		List<PatientHeaderInfoDto> ltPatientRecord1 = null;
		rtd1=uss.getPatientInfoByTreatmentId(rtd1);
		...
		HeaderTable5.addCell(new Phrase(": "+rtd1.getCenterPatientId(),tabletext));
		...
		HeaderTable5.addCell(new Phrase(": "+ rtd1.getPatientName(), tabletext));			
		HeaderTable5.addCell(new Phrase("Gender", subheader));
		HeaderTable5.addCell(new Phrase(": "+rtd1.getGender(), tabletext));
		
		
		
		HeaderTable5.addCell(new Phrase("Ref. By Dr.", subheader));
		HeaderTable5.addCell(new Phrase(": "+ rtd1.getRefDocName(), tabletext));			
		HeaderTable5.addCell(new Phrase("Mobile No.", subheader));
		HeaderTable5.addCell(new Phrase(": "+rtd1.getMobile(), tabletext));
		...
		HeaderTable5.addCell(new Phrase(": "+rtd1.getAge(), tabletext));	
		...
		HeaderTable5.addCell(new Phrase(": "+rtd1.getConsultingDocName(), tabletext));			
		/* HeaderTable5.addCell(new Phrase("", subheader));
