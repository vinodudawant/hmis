...
<title>Ipd Bill Register With Patient Type</title>
									...
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><i class="fa fa-home"></i> <a
												href="">Finance</a></li>
											<li><a href="ehat_patienttypewise_report.jsp">Ipd Bill Register With Patient Type</a></li>
											<li class="pull-right">
												...
												<script type="text/javascript">
														...
														$(document).on('click', '#btnPrint', function (e) {
														    ...
														    link.download = "Ipd Bill Register With Patient Type.xls";
														    link.href = result;
														    link.click();
														});
														...
														function receiptBillPrintSourceWisePdfPrint(){
															...
															window.open("ehat_patienttypewise_report_pdf.jsp?unitId="+unitId+"&userId="+userId+
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-5" style="margin-top: 2px;display: none;">
																...
																<table class="datatable table table-bordered table-striped table-condensed cf" id="hisabTbl"
																	...
																	<thead class="cf">
																		<tr>
																			...
																			<th style="height: 21.5px;width: 8%">Bill No</th>			
																			<th style="height: 21.5px;width: 8%">Date</th>																		
																			<th style="height: 21.5px;width: 25%">Patient Name</th>																			
																			<th style="height: 21.5px;width: 7%">Sub Total</th>	
																			<th style="height: 21.5px;width: 7%">Concession</th>		
																			<th style="height: 21.5px;width: 7%">Tax Amt</th>	
																			<th style="height: 21.5px;width: 7%">Net Amt</th>	
																			<th style="height: 21.5px;width: 7%">Advance</th>		
																			<th style="height: 21.5px;width: 7%">Bill Paid</th>
