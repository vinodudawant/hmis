...
<title>Billed Register Report</title>
								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="ehat_generated_bill.jsp">Bill History Report</a></li>
											<li class="pull-right">
													...
													To Excel</button> 
														<script type="text/javascript">
															...
															$(document).on('click','#btnPrint',function(e) {
														        ...
														        link.download = "Billed Report.xls"; //You need to change file_name here.
														        link.href = result;
														        link.click();
														    });
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-3" style="margin-top: 3px">
											...
											<div class="col-md-6">
												<input id="patId" class="form-control input-SmallText"
													type="text" name="patId" value="0" placeholder="UHID">
											</div>
										</div>		
										...
										<div class="col-md-2" style="margin-top: 2px">
											<input type="button" onclick="getGeneratedBillHistory();"
																...
																<table class="datatable table table-bordered table-striped table-condensed cf" id="hisabTbl"
																	...
																	<thead class="cf">
																		<tr>
																			...
																			<!-- <th style="height: 21.5px;width: 10%" id="thCenterPatientId">UHID</th>										 -->																																													
