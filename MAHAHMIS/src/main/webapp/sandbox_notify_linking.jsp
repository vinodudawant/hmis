	...
	<c:if test="${ sessionScope.userType != null }"> 
		...
		<section id="page">
			...
			<div id="main-content">
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><a href="sandbox_notify_linking.jsp">Notify Via SMS</a></li>
												...
												<div class="col-md-12">
													<div class="container">
														<div class="panel panel-primary">
															<div class="panel-heading" id="divEhatContent">Notify Via SMS
															</div>
															<div class="panel-body">
																...
																<div class="row">
																	<div class="col-md-6">
																		...
																		<div class="form-group">
																					...
																					<div class="" style="width: 90%;">
																						<input class="form-control tip-focus" id="mobileNo" name="headNm" type="text" placeholder="Please enter mobile number">
																	...
																	<div class="col-md-6">
																		...
																		<div class="form-group">
																					<label for="organName">Hospital Name</label> 
																					<div class="" style="width: 90%;">
																						<input class="form-control tip-focus" id="hospitalName" value="Hospital Name" type="text" disabled>
																						<input type = 'hidden' id = 'idHed' value = '0' />
																					</div>
																		</div>
																	...
																	<div class="col-md-12 text center">
																			...
																			<div class="" style="width: 90%;">
																				<div style="margin-top: 50px;" class="col-sm-3-1" id="col10">		
																					...
																					<button id="notifyViaSMS" onclick="notifyViaSMS();" class="btn btn-xs btn-success">Notify</button>
																												</div></div></div>	
																				</div>
				...
				<div class="row" id="linkNewRecord">
						<div id="content" class="col-lg-12">
							<!-- PAGE HEADER-->
							<div class="row">
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											<li><i class="fa fa-home"></i> <a href="Dashboard.jsp">Home</a></li>
											<li><a href="sandbox_notify_linking.jsp">Link New Record</a></li>
