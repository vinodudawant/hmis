		...
		/* 	p.add(new Chunk(" \nCIN: "+cinNo+", GST : "+gstNo , tabletext));	
			...
			//start dignosis info
						       ...
						       //start invest 
								  ...
								  HeaderTable5.addCell(new Phrase(" Diagnosis Info:", subheader));
								  HeaderTable5.addCell(new Phrase("", tabletext));
						      	...
						      	listPrescriptionsSP =  uss3.getlistservciesipdcopenew(treatmentId,callform,request);  // data by stored procedure
						      	 ...
						      	 PdfPTable HeaderTableSpace1 = new PdfPTable(1);
						      		...
						      		PdfPTable HeaderTableH1 = new PdfPTable(4);
						      				...
						      				PdfPTable HeaderTableCh1 = new PdfPTable(3);
						      				int[] headerwidthCh1 = {5,5,5 };
						      				HeaderTableCh1.setWidths(headerwidthCh1);
						      				HeaderTableCh1.setWidthPercentage(95f);
						      				HeaderTableCh1.getDefaultCell().setBorder(Rectangle.NO_BORDER);
						      			
						      				HeaderTableCh1.addCell(new Phrase("Sr. No", subheader));
						      				HeaderTableCh1.addCell(new Phrase("Service Name", subheader));
						      				HeaderTableCh1.addCell(new Phrase("QTY", subheader));
						      				int countp=1;
						      				
						      				for(int i=0;i<listPrescriptionsSP.size();i++ ){
						      					System.out.println("listPrescriptionsSP="+listPrescriptionsSP);
						      					HeaderTableCh1.addCell(new Phrase(""+countp, tabletext));
						      					HeaderTableCh1.addCell(new Phrase(""+listPrescriptionsSP.get(i).getCategoryName()+ ". "+listPrescriptionsSP.get(i).getServicename(),tabletext));
						      					HeaderTableCh1.addCell(new Phrase(""+listPrescriptionsSP.get(i).getQuantity(), tabletext));
						      					//String pdays=listPrescriptionsSP.get(i).getCreated_date_time();

						      					
						      			
						      				
						      				String instructions=listPrescriptionsSP.get(i).getServicename();
						      				...
						      				/* HeaderTableCh1.addCell(new Phrase("", tabletext));
						      				HeaderTableCh1.addCell(new Phrase(""+moName+"   "+anName+"   "+evName+"    "+ntName, tabletext));
						      				HeaderTableCh1.addCell(new Phrase("", tabletext));
					...
					//end invest
						      			  ...
						      			  HeaderTable5.addCell(new Phrase(" ", subheader));
						      			  HeaderTable5.addCell(new Phrase("", tabletext));
						      	      	PrescriptionService uss31  =(ApplicationContextUtils.getApplicationContext()).getBean(PrescriptionService.class);
						      	      	List<OPDPrescriptionDtoSP> listPrescriptionsSP1 = new ArrayList<>();	
						      	      	listPrescriptionsSP1 =  uss31.getAllPrescriptionsByTreatmentId(treatmentId, unitId);  // data by stored procedure
						      	      	
						      	      	
						      	      	 PdfPTable HeaderTableSpace12 = new PdfPTable(1);
						      	      		int[] headerwidthSpace12 = {40 };
						      	      		HeaderTableSpace12.setWidths(headerwidthSpace12);
						      	      		HeaderTableSpace12.setWidthPercentage(95f);
						      	      		HeaderTableSpace12.getDefaultCell().setBorder(Rectangle.NO_BORDER);
						      	      		HeaderTableSpace12.setSpacingAfter(5.0f);
						      	      	
						      	      		PdfPTable HeaderTableH12 = new PdfPTable(4);
						      	      				int[] headerwidthChemo12 = {20,20,20,20 };
						      	      				HeaderTableH12.setWidths(headerwidthChemo12);
						      	      				HeaderTableH12.setWidthPercentage(95f);
						      	      				HeaderTableH12.getDefaultCell().setBorder(Rectangle.NO_BORDER);
						      	      				
						      	      				PdfPTable HeaderTableCh11 = new PdfPTable(3);
						      	      				int[] headerwidthCh11 = {5,5,5 };
						      	      				HeaderTableCh11.setWidths(headerwidthCh11);
						      	      				HeaderTableCh11.setWidthPercentage(95f);
						      	      				HeaderTableCh11.getDefaultCell().setBorder(Rectangle.NO_BORDER);
						      	      			
						      	      				HeaderTableCh11.addCell(new Phrase("Sr. No", subheader));
						      	      				HeaderTableCh11.addCell(new Phrase("Medicine Name", subheader));
						      	      				HeaderTableCh11.addCell(new Phrase("QTY", subheader));
						      	      				int countp1=1;
						      	      				
						      	      				for(int i=0;i<listPrescriptionsSP1.size();i++ ){
						      	      					HeaderTableCh1.addCell(new Phrase(""+countp, tabletext));
						      	      					HeaderTableCh1.addCell(new Phrase(""+listPrescriptionsSP1.get(i).getPrepName() + ". "+listPrescriptionsSP1.get(i).getMedicineName(), tabletext));
						      	      					HeaderTableCh1.addCell(new Phrase(""+listPrescriptionsSP1.get(i).getQty(), tabletext));
						      	      					String pdays=listPrescriptionsSP1.get(i).getDayPrescription();
						      	      				...
						      	      				String instructions=listPrescriptionsSP1.get(i).getInstructionName();
						      	      				String instArray[]=instructions.split("/");
						      	      				System.err.println("instructions........."+instructions);
	       ...
	       //End Code For OT Notes
			...
			//  HttpServletRequest request = new HttpServletRequest();
			  ...
			  IPD_AutoSummaryService uss32  =(ApplicationContextUtils.getApplicationContext()).getBean(IPD_AutoSummaryService.class);
	      	List<DischargeSummery> listPrescriptionsSP2 = new ArrayList<>();	
	      	listPrescriptionsSP2 =  uss32.fetchAutoDischargeSummery(treatmentId);  // data by stored procedure
	      	
	      	
	      	 PdfPTable HeaderTableSpace11 = new PdfPTable(1);
	      		int[] headerwidthSpace11 = {40 };
	      		HeaderTableSpace11.setWidths(headerwidthSpace11);
	      		HeaderTableSpace11.setWidthPercentage(95f);
	      		HeaderTableSpace11.getDefaultCell().setBorder(Rectangle.NO_BORDER);
	      		HeaderTableSpace11.setSpacingAfter(5.0f);
	      	
	      		PdfPTable HeaderTableH11 = new PdfPTable(4);
	      				int[] headerwidthChemo11= {20,20,20,20 };
	      				HeaderTableH11.setWidths(headerwidthChemo11);
	      				HeaderTableH11.setWidthPercentage(95f);
	      				HeaderTableH11.getDefaultCell().setBorder(Rectangle.NO_BORDER);
	      				
	      				PdfPTable HeaderTableCh12 = new PdfPTable(3);
	      				int[] headerwidthCh12 = {5,5,5 };
	      				...
	      				HeaderTableCh12.addCell(new Phrase("Sr. No", subheader));
	      				HeaderTableCh12.addCell(new Phrase("Condition At Discharge", subheader));
	      				HeaderTableCh12.addCell(new Phrase("", subheader));
	      				int countp2=1;
	      				
	      				for(int i=0;i<listPrescriptionsSP2.size();i++ ){
	      					System.out.println("listPrescriptionsSP2="+listPrescriptionsSP2);
	      					HeaderTableCh1.addCell(new Phrase(""+countp, tabletext));
	      					HeaderTableCh1.addCell(new Phrase(""+listPrescriptionsSP2.get(i).getConditionAtDischarge()));
