...
<meta charset="utf-8">
<title>IPD Discount Approval</title>
<meta name="viewport"
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a href="ipd_discount_approval.jsp">Discount Approval</a></li>
										...
										<div class="box-body">
											<div class="tabbable header-tabs">
												<ul class="nav nav-tabs">
													<li class="ehatList" style="float: left;" id="subChrgsMaster" onclick="fetchIpdbilDiscount('Hospital');"><a data-toggle="tab" href="#Hospital_Discount"><i
													...
													<li class="ehatList" style="float: left;" id="chrgsMaster" onclick="fetchIpdbilDiscount('ApprovedDiscount');"><a data-toggle="tab" href="#Approved_Discount"><i
													...
													<div id="Approved_Discount" class="tab-pane fade in">
														<div class="panel-default">
															...
															<div class="col-md-12">
																...
																<div id="divbyName" class="col-md-2 TextFont">
																	<input type="text" onkeyup="autosuggesstionDiscApproved(this.id,'auto')" id="byName2" name="byName2" 
																	class="typeahead form-control input-SmallText ui-autocomplete-input" autocomplete="off">
																</div>
																
																<div class="col-md-1" style="text-align: center;">
																	<input type="button" value="search"	class="btn btn-xs btn-primary" class="btn btn-xs btn-primary"
																		onclick="discountApprovalSearch('search','ApprovedDiscount')" />
																</div>
															</div>
