...
<meta charset="utf-8">
<title>B2B Sample Transfer</title>
<meta name="viewport"
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a href="">B2B Sample Assignment</a></li>
								...
								<div class="col-md-12">
									...
									<div class="col-md-2">
										<div class="input-group" id="divbyName"
											...
											<label for="inlineFold" class="control-label"></label> <input
												...
												onkeyup="b2BAssignAndTransferAutoSuggestion(this.id, 'runnerTransfer');">
										</div>
									</div>
									...
									<div class=" col-md-1">
										<input type="button" value="Search"
											...
											onclick="searchB2BAssignAndTransferRecords('runnerTransfer');"
									...
									<div class="panel panel-default">
										<div class="panel-body">
													...
													<div class="tab-content">
														<div id="runnerWiseTab" class="tab-pane fade in active">
															<div class="panel-group" id="accordion1">
																<div class="col-md-12" style="margin-bottom: 1%">
																	<div class="col-md-2">
																		<div class="input-group" id="patchNames">
																			<label for="inlineFold" class="control-label">Patch
																				Name</label> <b style="color: red;">*</b>
																			<select id="patchId" style="width: 150px"
																				onchange="getRunnerBoysByPatch('transfer');">
																				<option value="0">Select Patch</option>
																			</select>
																		</div>
																	</div>
																	<div class="col-md-2">
																		<div class="input-group" id="transferrer">
																			<label for="inlineFold" class="control-label">Transferrer</label><b style="color: red;">*</b>
																			<select id="transferrerId" style="width: 150px"
																				onchange="getTransferee(); getB2BSamplesByRunnerBoy();">
																				<option value="0">Select Transferrer</option>
																			</select>
																		</div>
																	</div>
																	<div class="col-md-2">
																		<div class="input-group" id="transferee">
																			<label for="inlineFold" class="control-label">Transferee</label> <b style="color: red;">*</b>
																			<select id="transfereeId" style="width: 150px">
																				<option value="0">Select Transferee</option>
																			</select>
																		</div>
																	</div>
...
<!-- 																	<div class="col-md-2">
																		<div class="input-group" id="date">
																			<span class="input-group-btn"> <label
																				for="inlineFold" class="control-label">From
																					Date</label><b style="color: red;">*</b>
																				<input type="text"
																					class="input-group input-SmallText"
																					onclick="displayCalendar(document.getElementById('fDate'),'dd/mm/yyyy',this)"
																					readonly="readonly" id="fDate" placeholder="Date">
																			</span>
																		</div>
																	</div>

																	<div class="col-md-2">
																		<div class="input-group" id="toDays">
																			<label for="inlineFold" class="control-label">Days</label> <b style="color: red;">*</b>
																			<input type="text" class="input-group input-SmallText"
																				id="days" placeholder="Days" onkeypress="return validateNumber(event);">
																		</div>
																	</div> -->
																	
																	<div class="col-md-2">
																		<button class="btn btn-info btn-xs" style="margin-top: 13%; margin-left: 40%;"
																			value="Transfer" onclick="transferSamples()">Transfer Samples</button>
																	</div>
																</div>
																<div class="panel">
																	<div class="panel-body"
																		style="overflow: auto; height: 300px; margin-top: -2%">
																		<table id="ehatTable"
																			...
																			<thead id="ehatTHead">
																				<tr style="background-color: lightblue">
																					...
																					<th class="col-md-1 center">Assigned Date
																						Time</th>
																					<th class="col-md-1 center">Assigned To</th>
																					<th class="col-md-1 center">Transfered From</th>
																					<th class="col-md-1 center">Transfered To</th>
																				...
																				<tr style="background-color: lightcyan">
																					...
																					<th class="col-md-1 center"><input id="selectAll" type="checkbox" style="margin-right: 70%;"></th>
																				</tr>
																			</thead>

																			<tbody id="runnerWiseTableBody">
																			</tbody>
																		</table>
																	</div>
																</div>
															...
															<div style="margin-top: -1%">
																<div class="pull-right">
																	<ul class="pagination pagination-blue margin-bottom-10"
																		id="runnerTransferJumpToPage">
																	</ul>
																	<ul class="pagination pagination-blue margin-bottom-10"
																		id="runnerTransferPagination">
																	</ul>
																	<ul class="pagination pagination-blue margin-bottom-10"
																		id="runnerTransferNumberOfPages">
																	</ul>
																</div>
															</div>
															<!--   Ending  pagination -->
	...
	<input type='hidden' id="collectedMasterId" value="0"/>
	<input type='hidden' id="runnersList" value=""/>
