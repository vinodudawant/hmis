										...
										<div class="li pull-right">
											<div class="form-group"> 
												<div class="col-md-12"> 													
													...
													value="" onclick="printCssdReport()" title="" 
...
<!-- 																				<div class="col-md-3">
															 ...
															 <input type="button" class="btn btn-xs btn-warning"
																value="show" onclick="getCssdReport();" />
														</div> 
																...
																<table class="datatable table table-bordered table-striped table-condensed cf" id="hisabTbl"
																	...
																	<thead class="cf">
																		<tr>
																						...
																						<!-- <th class='center TextFont' style="width: 10%;">Reg No.</th> -->																						
																						<th class='center TextFont' style="width: 15%;"> Name Of Drum/Tray</th>																						
																						<th class='center TextFont' style="width: 15%;">Qty</th>
																						<th class='center TextFont' style="width: 15%;">From</th>
																						<th class='center TextFont' style="width: 15%;">Autoclave/ETO </th>
																						<th class='center TextFont' style="width: 15%;">Receiver</th>
																						<th class='center TextFont' style="width: 15%;">Issuer</th>	
