...
<script>
	jQuery(document).ready(function() {
		App.setPage("expenceVoucherDatabase"); //Set current page
...
<body style="background: white ! important;">
										...
										<div class="page-header">
											<ul class="breadcrumb col-md-12-1"
												...
												<div class="li pull-right">
													...
													data-toggle="tooltip" data-placement="left" title="Save Expense Voucher"
														onclick="saveExpenseVoucher()" disabled="disabled">
														<i class="fa fa-save"></i>
														</button>
													<!-- <button class="btn btn-xs btn-warning"
													data-toggle="tooltip" data-placement="left" title="Print"
														onclick="printExpenseVoucher()">
										...
										<div
											...
											<div style="width: 96.80%; border: 1px solid #436a9d;"
												...
												<div
													...
													<div style="width: 97%;" align="center" id="skhead">
														<div style="width: 20%; float: left;">
															<img src="images/Hospital/logo.png" width="150" id="hospitalLogo" height="60"
																alt="" />
														</div>
													...
													<div style="width: 100%; height: 9%; text-align: center;">
														<h4 style="margin-right: 192px;">Expense Voucher</h4>
													</div>
													<div style="width: 97%;" align="right">
														<div
															...
															<!-- <label style="width: 50%;">Voucher No.:</label> 0<label
																id="recNo" style="padding-right: 50px; width: 40%;"></label> -->
															<label style="width: 20%;">Date:</label> <label
													...
													<div style="width: 97%;">
														<div
															...
															align="left">
															<label style="width: 20%;">Payment to: <b style="color: red; padding-left: 3px;">*</b></label> <label
																id="patientname"
																style="font-size: 14px; font-family: monospace; width: 50%; padding-left: 10px"><input
																type="text" onkeyup=""
																style="width: 100%; height: 28px;" id="paymentTo"
																onkeypress="return" /></label>
													...
													<div style="width: 97%; height: 43px">
														<div class="col-md-6-1"
															...
															<div style="padding-top: 1px; padding-left: 35px;"
																class="col-md-8-1">
																<select onchange="getLedgerHeads11(this.value)" style="width: 100%"
																	name="select" id="vouchername">
																</select>
															</div>
														</div>
														<div class="col-md-6-1" id="ledHedNo"
															...
															<div style="padding-top: 1px; padding-left: 0px; padding-right: 100px"
																class="col-md-8-1">
																<select style="width: 100%"
																	name="select" id="leadgerHeadsId">
																</select>
															</div>
														</div>
													</div>
												...
												<div class="col-md-12-1">
													<div class="col-md-6-1"
															style="width: 90%; padding-left: 80px; padding-bottom: 10px; padding-top: 15px;"
															align="left">
															<label style="width: 19%;">In Words: </label> <label
																id="patientname"
											...
											<div style="margin-top: 25px;" class="col-md-12-1">
														...
														<div style="text-align: center;" class="col-md-1-1">
															<input type="button"
																onclick="getExpenceVoucher('byType')"
														...
														<button class="btn btn-warning btn-xs deleteUserAccess" type="button" style="float: right;"
															value="Delete" onclick="removeExpenseVoucher()" disabled="disabled">Delete</button>
													</div> -->
	...
	<script>
		$('#vouchername').select2();
		$('#leadgerHeadsId').select2();
		$('#selRefTo').select2();
		$('#selAmountType').select2();
	</script>
</body>
</html>
