								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><a href="sandbox_add_care_contex.jsp">Add Care Context</a></li>
														...
														<div class="panel panel-primary">
															...
															<div class="row">
																<div class="col-md-2">
																			  ...
																			  <input type="radio" onclick="changeFlowId(3)">
																	...
																	<div class="col-md-4">
																		...
																		<div class="form-group">
																					<label for="organName">Care Context </label> 
																					<div class="" style="width: 90%;">
																						<input class="form-control tip-focus" id="careContext" 
																					placeholder="Enter Care Context" type="text" >
																	...
																	<div class="col-md-12 text center">
																			...
																			<div class="" style="width: 90%;">
																				<div style="margin-top: 50px;" class="col-sm-3-1" id="col10">		
																					...
																					<button id="savecarecontext" onclick="saveCareContext();" class="btn btn-xs btn-success">Save</button>
																												</div></div></div>	
																				</div>
