...
<script type="text/javascript" src="js/diagnotic_queue.js"></script>
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a href="diagnotic_queue.jsp">Diagnostic Queue</a></li>
										</ul>
										<!-- /BREADCRUMBS -->
																	...
																	<div class="row" style="margin-top: 2px">
																		<div class="col-sm-12">
																			...
																			<!-- <div class="col-md-2">
																				<div class="input-group date col-md-12">
																					<select name="drDeptId" id="drDeptId" class="col-md-12 full-width-fix"
																						onchange="getDoctorBySpecialization('speciality','doctorName'),disableDocNameInMultiSelect(),fetchOpdQueuePatient(0,'-','-')"
																						style="width: 95%;">
																					</select>
																				</div>
																			</div>
																			<div class="col-md-2">
																				<div class="input-group date col-md-12">
																					<div>
																						<select id="doctorName" name="doctorName" onchange="fetchOpdQueuePatient(0,'-','-')" class="col-md-12" style="width: 98%;">	</select>
																					</div>
																				</div>
																			</div> -->
																			
																			<div class="form-group col-md-3">
																				<select class="input-group" onchange="setPatientSearchType()"
																			...
																			<div class="form-group col-md-3" id="divpatientopd">
																				<input class="typeahead form-control input-SmallText"
																					...
																					name="patientopd" onkeyup="setAutoPatientName(this.id,'diag',event);"
																					...
																					<table id="opdlistpage"
																						...
																						<thead id="ehatTHead">
																							<tr style="background-color: #EEEEEE; height: 30px;">
																								...
																								<th class='' id="thCenterPatientId">Patient ID</th>
																								<th class='' >Mobile No</th>																
																								<th class='' >App.Date</th>
																								<th class='' >Diag No</th>
																								<th class ='' >Bill</th>
																							</tr>
																						</thead>
