...
<body>
	<%
		...
		/* 	p.add(new Chunk(" \nCIN: "+cinNo+", GST : "+gstNo , tabletext));	
			...
			HeaderTable2.addCell(new Phrase("    FM Study  ", header));
			HeaderTable2.addCell(new Phrase("", subheader));
			HeaderTable2.addCell(new Phrase("", subheader));
...
PdfPTable HeaderTableSpace = new PdfPTable(1);
	...
	HeaderTableBorder.getDefaultCell().setBorder(Rectangle.BOTTOM);
		...
		HeaderTable5ivf.addCell(new Phrase("AMH", header));
		HeaderTable5ivf.addCell(new Phrase("FSH", header));
		HeaderTable5ivf.addCell(new Phrase("TSH", header));
		HeaderTable5ivf.addCell(new Phrase("PRL", header));
		HeaderTable5ivf.addCell(new Phrase("E2", header));
		HeaderTable5ivf.addCell(new Phrase("P4", header));
		HeaderTable5ivf.addCell(new Phrase("LH", header));
		...
		if(bobj.size() > 0){
			...
			for(int i=0;i<bobj.size();i++){
				...
				HeaderTable5ivf.addCell(new Phrase(""+bobj.get(i).getDateF(), tabletext));
				HeaderTable5ivf.addCell(new Phrase(""+bobj.get(i).getAmhF(), tabletext));
				HeaderTable5ivf.addCell(new Phrase(""+bobj.get(i).getFshF(), tabletext));
				HeaderTable5ivf.addCell(new Phrase(""+bobj.get(i).getTshF(), tabletext));
				HeaderTable5ivf.addCell(new Phrase(""+bobj.get(i).getPrlF(), tabletext));
				HeaderTable5ivf.addCell(new Phrase(""+bobj.get(i).getE2F(), tabletext));
				HeaderTable5ivf.addCell(new Phrase(""+bobj.get(i).getP4F(), tabletext));
				HeaderTable5ivf.addCell(new Phrase(""+bobj.get(i).getLhF(), tabletext));
				document.add(HeaderTable5ivf);
				HeaderTable5ivf.flushContent();
				countt++;
			}
	...
	IvfFmStudyService fmRService=(ApplicationContextUtils.getApplicationContext()).getBean(IvfFmStudyService.class);
			
			List<IVFFollicularSutdyRecord> studyList = fmRService.fetchStudyRecord(inidate,patId);
			
			HeaderTable5.addCell(new Phrase("Study Record", header));
			HeaderTable5.addCell(new Phrase("", header));
			HeaderTable5.addCell(new Phrase("", header));
			HeaderTable5.addCell(new Phrase("", header));
			HeaderTable5.addCell(new Phrase("", header));
			...
			HeaderTable5.flushContent();
				...
				HeaderTable5ivf.addCell(new Phrase("#", subheader));
				HeaderTable5ivf.addCell(new Phrase("Date", subheader));
				HeaderTable5ivf.addCell(new Phrase("Days", subheader));
				HeaderTable5ivf.addCell(new Phrase("RTOV", subheader));
				HeaderTable5ivf.addCell(new Phrase("LTOV", subheader));
				HeaderTable5ivf.addCell(new Phrase("ENDO", subheader));
				HeaderTable5ivf.addCell(new Phrase("Drugs", header));
				HeaderTable5ivf.addCell(new Phrase("Dose", header));
				HeaderTable5ivf.addCell(new Phrase("POD/Remark", header));
				document.add(HeaderTable5ivf);
				HeaderTable5ivf.flushContent();
				
				if(studyList.size() > 0){
					for (int i = 0; i < studyList.size(); i++) {
						HeaderTable5ivf.addCell(new Phrase("" + (i + 1) + ".",
								tabletext));
						/* HeaderTable5.addCell(new Phrase(""
								+ studyList.get(i).getLmpdate(),
								tabletext)); */

								HeaderTable5ivf.addCell(new Phrase(""
										+ ((studyList.get(i).getStudy_date())),
										tabletext));
								
								HeaderTable5ivf.addCell(new Phrase(""
								+ studyList.get(i).getDays(),
								tabletext));

								HeaderTable5ivf.addCell(new Phrase(""
										+ studyList.get(i).getRtov(),
										tabletext));
								HeaderTable5ivf.addCell(new Phrase(""
										+ studyList.get(i).getLtov(),
										tabletext));
								HeaderTable5ivf.addCell(new Phrase(""
										+ studyList.get(i).getEndo(),
										tabletext));
								HeaderTable5ivf.addCell(new Phrase(""
										+ studyList.get(i).getDrug(),
										tabletext));
								HeaderTable5ivf.addCell(new Phrase(""
										+ studyList.get(i).getDose(),
										tabletext));
								HeaderTable5ivf.addCell(new Phrase(""
										+ studyList.get(i).getPod(),
										tabletext));
				...
				HeaderTableSpace.flushContent();
					...
					HeaderTableBorder.addCell(new Phrase("", tabletext));
			   		...
			   		PdfPTable HeaderTableC = new PdfPTable(2);
					int[] headerwidthC = { 27, 40 };
					HeaderTableC.setWidths(headerwidthC);
					HeaderTableC.setWidthPercentage(95f);
					HeaderTableC.getDefaultCell().setBorder(Rectangle.NO_BORDER);
				
         if(studyList.size()>0){
        	 HeaderTableC.addCell(new Phrase("Comment", tabletext));	
        	 HeaderTableC.addCell(new Phrase("", tabletext));
				...
				for (int i = 0; i < studyList.size(); i++) {
					...
					try {
						...
						HeaderTableC.addCell(new Phrase("", tabletext));	
						HeaderTableC.addCell(new Phrase(""+ studyList.get(i).getStudyComment(),tabletext)); 
