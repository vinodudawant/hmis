...
<title>Waiting For Billing Time</title>
									...
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><i class="fa fa-home"></i> <a
												href="">Finance</a></li>
											<li><a href="ehat_waiting_bill.jsp">Waiting For Billing Time</a></li>
											<li class="pull-right">
													...
													To Excel</button>
													 <script type="text/javascript">
														 ...
														 $(document).on('click', '#btnPrint', function (e) {
														    ...
														    link.download = "Waiting For Billing Time.xls";
														    link.href = result;
														    link.click();
														});
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getIpdWaitingBill();"
												...
												<div id="diveMain" class="col-md-12" style="margin-top: 5px">
													...
													<div id="divLine2" class=" table table-condensed table-bordered table-responsive table-striped" style="overflow: auto;height: 450px;">
														<form class="form-horizontal col-md-12"
															...
															<div class ="dynamicstructurescroll"  style="width: 1400px">
