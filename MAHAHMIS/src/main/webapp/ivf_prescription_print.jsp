...
<%
	try{
		...
		HeaderTable2.addCell(new Phrase(" Ivf Prescription Receipt ", header));
	...
	/* 	AdminModel admodel1 = new AdminModel();
		...
		PdfPTable HeaderTable5ivf = new PdfPTable(8);
		int[] headerwidth5ivf = { 5, 15, 10, 20,20,15,15,15};
		...
		List<IvfPrescriptionDto> obj1 = obj.getListPrintForIvfPrescription(ivftreatmentId);
		if (obj1.size() > 0) {
			...
			HeaderTable5.addCell(new Phrase("Ivf Prescription Information ", header));
			...
			HeaderTable5ivf.addCell(new Phrase("  Prep. ", header));
			HeaderTable5ivf.addCell(new Phrase("  Dose", header));
			HeaderTable5ivf.addCell(new Phrase(" Instructions ", header));
			HeaderTable5ivf.addCell(new Phrase("  Frequency", header));
			
			HeaderTable5ivf.addCell(new Phrase(" Duration ", header));
			HeaderTable5ivf.addCell(new Phrase("  Quantity", header));

			if (obj1.size() > 0) {
				int countt = 1;
				for (int i = 0; i < obj1.size(); i++) {
					HeaderTable5ivf.addCell(new Phrase(" " + countt, tabletext));
					HeaderTable5ivf.addCell(new Phrase(" " + obj1.get(i).getMedicineId(), tabletext));
					HeaderTable5ivf.addCell(new Phrase(" " + obj1.get(i).getPrepName(), tabletext));
					HeaderTable5ivf.addCell(new Phrase(" " + obj1.get(i).getDoseType(), tabletext));
					HeaderTable5ivf.addCell(new Phrase(" " + obj1.get(i).getInstructionName(), tabletext));
					
					String Frequency = "";
					if(obj1.get(i).getMorning().equals("Morning")){
						Frequency = "1 - ";
					...
					if(obj1.get(i).getAfternoon().equals("Afternoon")){
	                ...
	                if(obj1.get(i).getEvening().equals("Evening")){
	             ...
	             if(obj1.get(i).getNight().equals("Night")){
					...
					////
					HeaderTable5ivf.addCell(new Phrase(" " +Frequency, tabletext));
					
					HeaderTable5ivf.addCell(new Phrase(" " + obj1.get(i).getDays(), tabletext));
					HeaderTable5ivf.addCell(new Phrase(" " + obj1.get(i).getQuantity(), tabletext));
