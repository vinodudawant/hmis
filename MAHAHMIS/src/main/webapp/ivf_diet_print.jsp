...
<%@ page import="com.hms.ivf.controller.IvfDietController"%>
<%@ page import="com.hms.ivf.service.IvfDietService"%>
...
IvfDietController uss1=(ApplicationContextUtils.getApplicationContext()).getBean(IvfDietController.class);
			IvfDietService uss2=(ApplicationContextUtils.getApplicationContext()).getBean(IvfDietService.class);
			
			IVFDietDTO dm = new IVFDietDTO();
			List<IVFDietDTO> lstmaster1 = uss2.getIVFietListByDietIds(dietIds);
