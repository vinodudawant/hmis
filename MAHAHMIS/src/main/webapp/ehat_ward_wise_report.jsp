							...
							<div class="col-sm-12">
								<div class="page-header">
									...
									<ul class="breadcrumb">
										...
										<li><a href="ehat_ward_wise_report.jsp">Ward Wise Reports</a></li>
										...
										<div class="li pull-right">
											<div class="form-group"> 
												<div class="col-md-12"> 													
													...
													value="" onclick="printHallWisePatients()" title="" 
													...
													To Excel</button> </div> 	
													 <script type="text/javascript">
														...
														$(document).on('click', '#btnPrint', function (e) {
															var clonedContent = $('div[id$=printDiv]').clone();
														    ...
														    link.download = "Ward Wise Report.xls";
														    link.href = result;
														    link.click();
														});
													</script> 
																	...
																	<div id="OPD" class="tab-pane fade in active">
																		<div class="col-md-12 box border" style="padding: 5px">
																			...
																			<!-- <div class="col-md-3 TextFont"> -->
																				...
																				<div class="col-md-3">
																					<div class="col-md-8" style="margin-top: 5px"><label>Ward Type:</label>
																						<select
																							name='listmstr' class="form-control input-SmallText" id="wardTypeHall"
																							 onchange="getWardTypeList(),getIpdBillPatientsBlockBeds('onload'),getIpdBillPatients2('onload')">
																				...
																				<div class="col-md-2">
																					...
																					<div class="col-md-8"> 
																						 <input type="button" class="btn btn-xs btn-warning" value="show" onclick="getWardWisePatientsDetails();" />
																					</div> 
																				...
																				<div class="panel panel-default"
																					...
																					<div class="panel-body">
																						...
																						<div id="printDiv" class="col-md-12" style="margin-top: 5px">
																							...
																							<div id="divLine2" class=" box border col-md-12" style="overflow: auto;height: 400px">
																								
																								<form class="form-horizontal col-md-12" style="margin-top: 10px">
																								
																								<div class="col-md-12">
																									<label> <i class="fa fa-arrow-down"></i>Wardwise Patient Details :
																									</label>
																								</div>
																								<br>
																									
																								<div style="margin-top: -7px; width: 1500px" class="col-md-12-1 box border">
																									<table class="table table-bordered table-striped table-condensed cf">
																										
																										<thead class="cf">
																											<tr>
																												<th class='center TextFont' style="width: 5%;">Sr.No.</th>
																												<th class='center TextFont' style="width: 10%;">IPD No</th>
																												...
																												<th class='center TextFont' style="width: 15%;">Ward Type</th>
																												<th class='center TextFont' style="width: 15%;">Admitted Under</th>
																												<th class='center TextFont' style="width: 15%;">Company </th>
																												<th class='center TextFont' style="width: 7%;">Patient Type</th>
																												<th class='center TextFont' style="width: 7%;">Self /Mediclaim</th>	
																												<th class='center TextFont' style="width: 6%;">Total Days</th>																																																						
																											</tr>
																										</thead>
