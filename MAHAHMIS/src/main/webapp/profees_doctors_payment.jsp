									...
									<div class="col-sm-12">
										<div class="page-header">
											...
											<ul class="breadcrumb col-md-12-1"
												...
												<li><a href="profees_doctors_payment.jsp">Doctor's Payment </a></li>
												<li class="pull-right">
															...
															<div class="row">
																<label class="TextFont"> Doctor Name<b style="color: red;">*</b> </label>
																 ...
																 <input
																	...
																	type="text" onkeyup="setAutoSugForDoctorList(this.id,'profees')"
																	>
																...
																<div class="col-md-12 col-xs-12">
																	<div class="row">
																		<button class="btn btn-xs btn-success" type="button"
																			title="Save" style="width: 100%" onclick="saveDrPaymentVoucher();">
																			<b>Save</b>
																		</button>
																	</div>
																	<div class="divide-20"></div>
