...
<meta charset="utf-8">
<title>Item Minimum Level Report</title>
<meta name="viewport"
...
<body>
	<c:if test="${ sessionScope.userType != null }">
									...
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a
												href="inv_item_min_level_report.jsp">Item stock below minimum quantity</a></li>
										</ul>
										<!-- /BREADCRUMBS -->
											...
											<script type="text/javascript">
												$("[id$=btnExportReport]").click(
																function(e) {
															        ...
															        var table_div = document.getElementById('itemStockDetailMasterInfo');
															        var table_html = table_div.outerHTML.replace(/ /g, '%20');
															        a.href = data_type + ', ' + table_html;
															        //setting the file name
															        a.download = 'Item_Min_Level_Report_' + postfix + '.xls';
														...
														<div class="row" style="margin-top: 5px">
															<div class="col-md-12">
																...
																<div class="panel panel-primary" style="overflow: auto; ">
																	<div class="panel-heading" id="divEhatContent">Item stock below minimum quantity</div>
																	<div class="panel-body"
																		style="height: 300px"
																		id="itemStockDetailMasterInfo">
																		<table
																			...
																			<thead id="ehatTHead">
																				<tr>
																					...
																					<th class="col-md-1 center"> Batch Exp Date</th> -->
																					<th>Below min quantity</th>
																					<th>Max Qty</th>
																					<th>Order Qty</th>
		...
		jQuery(document).ready(function() {		
			...
			getAllItemStockBelowMinimumLevel();
		});
		</script>
		<script>
		onload = function() {
