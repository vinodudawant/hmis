...
<script>
	...
	function getReportDeletedChequePaid() {
		jQuery.ajax({
			type : "GET",
			...
			success : function(r) {
				setDeletedChequePaidListResult(r);
			}
		});

	}

	function getDeletedRecordChequePaidReport() {
				jQuery.ajax({
					async : true,
					type : "POST",
					url : "getDeletedChequePaidReport",
	...
	function setDeletedChequePaidListResult(result) {
		var data = result;
		// prepare the data
		var source = {
			datatype : "json",
	...
	function setResult(result) {
		...
		$('#template')
				.html(
						"<button onclick='getDeletedRecordChequePaidReport()' class='btn btn-xs btn-success' type='button'>Get"
									...
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li id="template" class="pull-right">
												<button onclick="getDeletedRecordChequePaidReport();"
							...
							<div class="col-md-12-1">
								<div class="col-md-12"
									...
									<div class="col-md-12-1" style="margin-top: 2%;">
										<div class="col-md-12-1">
											<h4 id="title" class="center">Deleted Cheque Paid Report</h4>
										</div>
