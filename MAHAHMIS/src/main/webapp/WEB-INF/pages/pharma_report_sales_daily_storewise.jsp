...
<script>
	...
	function getCounterSaleData() {
		...
		if (from != '') {
			...
			jQuery.ajax({
				...
				url : "../report/getDailyTotalSaleDataStorewise",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
	...
	function setPartyResult(result) {
		...
		for ( var i = 0; i < r.length; i++) {
			...
			divContent = divContent + "<tr><td>" + r[i].vouNo + "</td><td>"
					+ r[i].date + "</td><td>" + r[i].type + "</td><td>"
					+ r[i].patientName + "</td><td>" + r[i].vendorAddress
					+ "</td><td>" + r[i].transType + "</td><td>" + r[i].amount
					+ "</td><td>" + r[i].amtReceive + "</td><td>"
					+ r[i].amtBalance + "</td><td>" + r[i].currentAmtBal
					+ "</td></tr>";
	...
	function getDailySaleData() {
		...
		jQuery.ajax({
			...
			type : "GET",
			data : str + "&reqType=AJAX",
			url : "../../pharmacy/report/getDailySaleReportStorewise",
			timeout : 1000 * 60 * 5,
			catche : false,
			error : function() {
...
<body style="background: white ! important;">
	<section id="page">
		...
		<div id="outer" class="container-main" style="width: 100%;">
			...
			<%@include file="pharma_report_sales_daily_sale_storewise_pop_up.jsp"%>
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>Daily Sale Report Storewise</li>
							...
							<div class="col-md-12-1">
									...
									<div id="companyReport" class="col-md-6-1"
										...
										<div class="box border purple">
											<div class="box-title">
												<h4>
													<i class="fa fa-user"></i>Daily Sale Report Storewise
												</h4>
												<div class="tools">
															...
															<tbody>
																<%
																	File folder = new File(
																			request.getRealPath("/ehat_Reports/Pharmacy/Sales/userwise/"));
																...
																<tr>
																	...
																	<td>
																		...
																		%> <a
																		href='/MAHAHMIS/ehat_Reports/Pharmacy/Sales/userwise/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
																	</td>
																	<td>
																		<%
