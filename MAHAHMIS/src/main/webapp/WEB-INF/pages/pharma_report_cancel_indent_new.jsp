...
<script>
	 ...
	 * *******/
		 ...
		 var from = $("#popup_container2").val();
			...
			jQuery
					.ajax({
						...
						url : "../pharmacyReport/getCancelIndentList",
						timeout : 1000 * 60 * 5,
						cache : false,
						error : function() {
							alert('error');
	 ...
	 function setCancelListResult(result){
		var r = result;
		var divContent = "";
		total=0;
		...
		if (r.length > 0) {
			...
			for ( var i = 0; i < r.length; i++) {
				divContent = divContent + "<tr><td class='col-md-1-1'>" + r[i].indent_store_name + "</td><td class='col-md-1-1'>"
						+ r[i].indent_time + "</td><td class='col-md-1-1'>" + r[i].indent_add_date + "</td>"
					 	+ "<td class='col-md-1-1'>" + r[i].indent_sale_deleted_time + "</td><td class='col-md-1-1'>"
					 	+ r[i].indent_delete_date + "</td><td class='col-md-1-1'>" + r[i].indent_comment + "</td><td class='col-md-1-1'>" + r[i].user_name + "</td></tr>"; 
		...
		$("#getCancelIndentList").html(divContent);
							...
							<div class="col-md-12-1">
										...
										<div style="margin-top: 0px; margin-bottom: 10px"
											...
											<div class="col-md-4-1" style="margin-top: 9px;">
												<button style="margin-left: 5%;"
													onclick="getCancelIndentList()" id="getproductData"
								...
								<div class="col-md-12-1 panel-body"
									...
									<div class="col-md-12-1 center" style="margin-bottom: 10px;">
										...
										<table>
										<thead>
										<tr><th colspan="7" align="center"><h4 id="titlesalewithgst" align="center">Cancel Indent List</h4></th></tr>
