...
<script>
	...
	function loadPopUp() {
		...
		if (productId != '' && from != '' && to != '') {
			...
			jQuery.ajax({
				...
				url : "../report/getProductWisePartyList",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
		...
		if (productId != '' && from != '' && to != '') {
			...
			jQuery
					.ajax({
						...
						type : "GET",
						data : str + "&reqType=AJAX",
						url : "/EhatEnterprise/pharmacy/report/getProductWisePartyListForReport",
						timeout : 1000 * 60 * 5,
						catche : false,
						error : function() {
	...
	function setBatchWiseSaleResult(result) {
		...
		if (r.length > 0) {
			...
			for ( var i = 0; i < r.length; i++) {
				divContent = divContent + "<tr><td>" + r[i].vouNo + "</td><td>"
						...
						+ r[i].batchCode + "</td><td>"+ r[i].vendorName +"</td><td>" + r[i].qty
		...
		$("#partyWiseProductData").html(divContent);
	}
...
<body style="background: white ! important;">
	<section id="page">
		...
		<div id="outer" class="container-main" style="width: 100%;">
			...
			<%@include file="pharma_report_sales_product_partywise_pop_up.jsp"%>
								...
								<div class="col-md-12-1">
									...
									<div id="companyReport" class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Product Partywise Report</h4>
										</div>
									...
									<div class="col-md-6-1"
										...
										<div class="box border purple">
											<div class="box-title" style="background-color: #a696ce">
												<h4>
													<i class="fa fa-bitbucket"></i>Product Partywise Report
												</h4>
												<div class="tools">
															...
															<tbody>
																<%
																	File folder = new File(
																			request.getRealPath("/ehat_Reports/Pharmacy/Sales/productpartywise/"));
																...
																<tr>
																	...
																	<td>
																		...
																		%> <a
																		href='/EhatEnterprise/ehat_Reports/Pharmacy/Sales/productpartywise/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
																	</td>
																	<td>
																		<%
