...
<div id="vatMonthWisePurchase" class="modal fade in"
	style="height: 500px;">
				...
				<div class="modal-header  col-md-12">
					<div class="box-title  col-md-12 center">
						<div class="col-md-8-1" style="margin-top: 11px;">
							<h4>
								<i class="fa fa-calendar"></i>MonthWise GST Purchase
							</h4>
						</div>

						<div class="col-md-4-1" style="margin-top: 11px;" id='setButtons'>
							<button onclick="getMonthWiseVatPurchaseReport()"
								class="btn btn-xs btn-success" type="button">Get Report</button>
                                   <button id="btnExport" class="btn btn-xs btn-success" value="Excel"  title="" data-placement="left" data-toggle="tooltip" data-original-title="Excel">
													...
													$("[id$=btnExport]").click(function(e) {
													    window.open('data:application/vnd.ms-excel,' + encodeURIComponent( $('div[id$=gstmonthwise]').html()));
													    e.preventDefault();
													});
				...
				<div class="modal-body col-md-12">
					...
					<div id="gstmonthwise"
						...
						<table class='table  table-bordered table-striped header-fixed cf'
							...
							<tbody id="vatMonthWisePurchaseResult" class="success">
							</tbody>
							<!-- <tfoot>
								<tr>
									<td>Total</td>
									...
									<td><span style="float: right"><input type="text"
											id="vat5" readonly style="float: right"></span></td>
									<td><span style="float: right"><input type="text"
											id="amt5" readonly style="float: right"></span></td>
									<td><span style="float: right"><input type="text"
											id="vat12" readonly style="float: right"></span></td>
									<td><span style="float: right"><input type="text"
											id="amt12" readonly style="float: right"></span></td>
