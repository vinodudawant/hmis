...
<%-- 	<%
	...
	<%-- <c:forEach items="${indentData}" var="row" varStatus="count"> --%>
       ...
       <%--  <c:set var="patientName" value="${row.patientName }" /> --%>
		...
		<%
					...
					HeaderTable2
							.addCell(new Phrase("Final Indent Bill", subheader));
	...
	<%-- </c:forEach> --%>
	<%-- <c:forEach items="${indentSalePatientData}" var="row1" varStatus="count">
  <c:set var="pName" value="${row1.patientName}" />
  <%
  String patientFirstName= "";
	...
	PdfPTable HeaderTable3 = new PdfPTable(6);
	int[] headerwidth4 = { 18, 30, 20, 20, 20, 20 };
	HeaderTable3.setWidths(headerwidth4);
	HeaderTable3.setWidthPercentage(95f);
	HeaderTable3.getDefaultCell()
			.setBorder(Rectangle.NO_BORDER);
	...
	HeaderTable3
			.addCell(new Phrase("Patient Name:", subheader));
	HeaderTable3.addCell(new Phrase(patientFirstName, tabletext));
%>
