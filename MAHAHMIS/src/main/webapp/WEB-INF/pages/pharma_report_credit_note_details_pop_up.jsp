				...
				<div class="modal-header  col-md-12">
					<div class="box-title  col-md-12 center">
						<div class="col-md-8-1" style="margin-top: 11px;">
							...
							<h4>
								Treatment Id:-<span id="treatmentIdSpan"></span>
							</h4>
					...
					<div class="col-md-4-1" style="margin-top: 11px;" id='setButtons'>
						...
						<div style="float:right;margin-top:10px;"><strong>Total Amount is</strong><input type="text" id="totalAmount" readonly></div>
