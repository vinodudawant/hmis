						...
						<div id="content" class="col-lg-12">
							...
							<div class="col-md-12-1">
									...
									<div class="col-md-12-1">
										...
										<div class="col-md-4-1 "
											...
											<div style="margin-top: 0px; margin-bottom: 10px"
												...
												<div class="col-md-4-1" style="margin-top: 9px;">
													<button style="margin-left: 5%;" onclick="getpurchaseReturndata()"
								...
								<div class="col-md-12-1 panel-body"
									style="border: 2px solid; margin-top: 2%;" id="reportpurchasereturn">
									<div class="col-md-12-1 center" style="margin-bottom: 10px;">
										

                                      <table>
										<thead>
										<tr><th colspan="7" align="center"><h4 id="titlepurreturn" align="center">Purchase Return Report(DebitNote)</h4></th></tr>
										...
										<div class="tab-content">
											...
											>
												<table
													...
													<thead style="background-color: lightgray;" id="purchasereturnh">
														<tr>
														<th>Sr No</th>
														<th>Bill Date </th>
														<th>Party Name</th>
													...
													<tbody id="purchasereturntable" class="table-striped">
													</tbody>
												</table>
											</div>
										</div>
