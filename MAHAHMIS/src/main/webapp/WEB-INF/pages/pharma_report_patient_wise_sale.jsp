...
<script>
	...
	function getPharmacyTotalSale() 
	{
		...
		var to = $("#popup_container3").val();
			...
			window.open("/EhatEnterprise/pharmacy/report/getPharmacyPatientWiseSaleReport?fromDMY="+from+"&toDMY="+to);
	}
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>Pharmacy Patient_Wise Sale Report</li>
										</ul>
								...
								<div class="col-md-12-1">
									...
									<div id="companyReport" class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Patient_Wise Sale Report</h4>
										</div>
