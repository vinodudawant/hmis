...
<script>
	...
	var total=0;
		...
		for ( var i = 0; i < r.lstpurc.length; i++) {
			...
			+ "</td><td align='right'>" 
			+ parseFloat(r.lstpurc[i].amnt).toFixed(2)
			+ "</td><td align='right'>" 
			+ parseFloat(r.lstpurc[i].discount).toFixed(2)
			+ "</td><td align='right'>" 
			+ parseFloat(r.lstpurc[i].vat).toFixed(2)
			/* + "</td><td align='right'>" 
			+ r[i].amount 
			+ "</td><td align='right'>" 
			+ r[i].billDate  
 ...
 -->
								...
								<div class="col-md-12-1 panel-body"
									...
									<div class="col-md-12-1 center" style="margin-bottom: 10px;">
										...
										<table>
										<thead>
										<tr><th colspan="7" align="center"><h4 id="titlesalewithgst" align="center">Purchase Day Book</h4></th></tr>
