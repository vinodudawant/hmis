...
<div id="Purchse_Batch_Pop_Up" class="modal fade in" style="height:500px;">
						...
						<table id="ItemInfoTable" border="1"
							...
							<thead>
								<tr>
									...
									<th class=' col-md-1-1 center' style='height: 21.5px;'><div
											class='TextFont'>Closing Stock</div></th>

									<th class=' col-md-1-1 center' style='height: 21.5px;'><div
											class='TextFont'>Last Purchase From</div></th>

									<th class=' col-md-1-1 center' style='height: 21.5px;'><div
											class='TextFont'>Bill number</div></th>
