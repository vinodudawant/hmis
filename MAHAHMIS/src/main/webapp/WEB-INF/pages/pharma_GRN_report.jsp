...
<script>
	...
	var total=0;
		...
		$("#saletableFooter").append("<tr style='font:bold'><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td align='center' id='totalAmount'>Total</td><td align='right'>"+total.toFixed(2)+"</td><td></td></tr>");
		...
		if (productId != '' && from != '' && to != '') {
			...
			jQuery
					.ajax({
						...
						type : "GET",
						data : str + "&reqType=AJAX",
						url : "../../pharmacy/report/getGRNdataReport",
						timeout : 1000 * 60 * 5,
						catche : false,
						error : function() {
	...
	function setResult(result) {
		...
		$('#setButtons')
				.html(
						"<button onclick='getNewGRNReport()' class='btn btn-xs btn-success' type='button'>Get"
				...
				<div class="modal-header  col-md-12">
					<div class="box-title  col-md-12 center">
						<div class="col-md-8-1" style="margin-top: 11px;">
							<h4>
								<i class="fa fa-calendar"></i>GRN(Goods Receipt Note) Report
							</h4>
						</div>

						<div class="col-md-4-1" style="margin-top: 11px;" id="setButtons">
							<button onclick="getNewGRNReport()" class="btn btn-xs btn-success" type="button">Get Report</button>
					...
					<div class="col-md-12-1">
						<div class="col-md-12-1" style="margin-top: 0px; margin-left: 1%;">
							...
							<table id="saleReportTable" class="table  table-bordered table-striped header-fixed cf" border="1">
								...
								<tfoot id="saletableFooter" style="background-color: peachpuff;font-weight: bold;"></tfoot>
							</table>
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>GRN(Goods Receipt Note) Report</li>
								...
								<div class="col-md-12-1">
									<div id="companyReport" class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">GRN(Goods Receipt Note) Report</h4>
										</div>
										...
										<div class="col-md-12-1"
											...
											<div style="margin-top: 9px;" class="col-md-4-1">
												<button class="btn btn-xs btn-success" type="button"
													id="getGRNData" onclick="GRNloadPopUp()"
									...
									<div class="col-md-6-1"
										...
										<div class="box border purple">
											<div class="box-title" style="background-color: #a696ce">
												<h4>
													<i class="fa fa-bitbucket"></i>GRN(Goods Receipt Note) Report
												</h4>
												<div class="tools">
															...
															<tbody>
																<%
																	File folder = new File(
																			request.getRealPath("/ehat_Reports/Pharmacy/purchase/daywise/"));
																...
																<tr>
																	...
																	<td>
																		...
																		%> <a
																		href='/MAHAHMIS/ehat_Reports/Pharmacy/purchase/daywise/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
																	</td>
																	<td>
																		<%
