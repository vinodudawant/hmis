...
<script>
	...
	function getCurrentStockDrugWiseReport() {
		
		var selectedrowindex = $("#drugData").jqxGrid('getselectedrowindex');
		
		var datarow = $("#drugData").jqxGrid('getrowdata', selectedrowindex);
		
		if(datarow!='' && datarow!=null)
		{
			var drugId = datarow['drugId'];
			var drugName = datarow['drugName'];
			var inputs = [];
	...
	function setProductListResult(result) {
				...
				.jqxGrid(
						{
							...
							renderstatusbar : function(statusbar) {
								...
								deleteButton.click(function(event) {
									var selectedrowindex = $("#drugData")
											.jqxGrid('getselectedrowindex');
									var rowscount = $("#drugData").jqxGrid(
							...
							columns : [ {
								...
								text : 'Therauptic Use',
								datafield : 'drugTheraupticUse',
								width : 150
							}, ],

						});

		$("#drugData").bind('rowselect', function (event) {
	        var row = event.args.rowindex;
	        var datarow = $("#drugData").jqxGrid('getrowdata', row);
	        
	        getStockDataByDrugId(datarow['drugId']);
	    });
		...
		$("#findButton").click(
				function() {
					...
					$("#drugData").jqxGrid('addfilter', datafield,
							filtergroup);
					// apply the filters.
					$("#drugData").jqxGrid('applyfilters');
				});

	}
	
	function getStockDataByDrugId(value)
	{
		var drugId = value;
		...
		if (drugId != '') {
			...
			jQuery.ajax({
				...
				type : "POST",
				data : str + "&reqType=AJAX",
				url : "/MAHAHMIS/pharmacy/report/getDrugWiseStockByDrugId",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
	...
	function setResult(result) {
		...
		$('#template')
				.html(
						"<button onclick='getCurrentStockDrugWiseReport()' class='btn btn-xs btn-success' type='button'>Get"
									...
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li id="template" class="pull-right">
												<button onclick="getCurrentStockDrugWiseReport();"
							...
							<div class="col-md-12-1">
								<div class="col-md-12"
									...
									<div class="col-md-4"
										...
										<div id='jqxWidget'>
											<div class="col-md-12-1" id='drugData'
										...
										<table
											...
											<thead style="">
												<tr>
													...
													<th class="col-md-1">Amount(Pur Rate)</th>
												</tr>
											</thead>
											<tbody id='productStockData' class="success">
											</tbody>
											<tr>
												<td colspan="6"><span style="float: right"><strong>Total
