...
<script>
	...
	function getPharmacyTotalSale() 
	{
		...
		var to = $("#popup_container3").val();
			...
			window.open("../../pharmacy/report/getPharmacyDuesReport?fromDMY="+from+"&toDMY="+to,'_blank');
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>Pharmacy dues collection Report</li>
								...
								<div class="col-md-12-1">
									...
									<div id="companyReport" class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Pharmacy Total Due Collection</h4>
										</div>
