...
<script src="<c:url value="../../js/webcam.min.js"/>"></script>
...
function hideCameraPopUp()
{
	...
	onload = function() {
		...
		setAutoDoctorNameNew("searchBox1", "onload", "OPD_Appoinment");
...
<input type='hidden' value='0' id='totalAmountReceive' />
<%
	}
		else{
%>
										...
										<li class="li pull-right">
												<div class="li pull-right" style="margin-left: 9px;">
													...
													<button class="btn btn-xs btn-success" type="button"
														id="saveBtn" onclick="savePatientSale()">Save and
														Print(Ctrl+S)</button>
												</div>
												<div class="li pull-right" style="margin-left: 9px;">
										...
										<div class="panel-body">
											<div id="patientSalesBill" class="col-md-4-1"
												...
												<div class="col-md-4-1" style="margin-top: -3px;"
														...
														<c:when test="${slaveCount !=0}">
															<c:if
																...
																<div
																	class="radio clip-radio radio-primary radio-inline col-md-3-1">
																	<input id="OPDchkC" type="radio" value="opd"
																		disabled="disabled" name="typeOfpatient"
																		style="margin-top: 0px !important;"> <label
																...
																<div
																	...
																	<input id="chkEntireDatabaseC" type="radio"
																		disabled="disabled" value="all" name="typeOfpatient"
																		style="margin-top: 0px !important;" checked="checked">
																	<label for="chkEntireDatabaseC"> Entire
																		Database </label>
																</div>
															</c:if>
															<c:if
													...
													<div class="col-md-3-1" style="margin-top: 0px;">
														<b>Patient_Id Search: </b>
													</div>
													<div class="col-md-3-1" style="margin-top: 0px;">
														<input type="text" id="searchPId"
															onblur="splitContentOfPatientById()">
													</div>
													<div class="col-md-12-1" style="margin-top: 11px;">
														...
														<div class="col-md-7-1" style="margin-top: 0px;">
															...
															<input type="hidden" id="hiddenPoType"
																...
																type="hidden" id="hiddenTreatmentFlag" value="0" />
															<form:input type="hidden" id="hiddenCategoryName"
																value="0" path="patientSaleCategoryName" />
																...
																<c:choose>
																	...
																	<c:when test="${slaveCount !=0}">
																		<input name="txtPatientName" type="text"
																			...
																			onkeypress="autoSuggestionForPateintName('txtPatientName', 'onchange');" />
																		<%--     <form:hidden value="${patientSalesBill.patientSalesBillId}" path="" id="hiddenPatientSalesBillId" />
																 <form:hidden type="hidden" id="billCategoryId" path="patientSaleTreatmentId" value="${patientSalesBill.patientSaleBillCatId}" />
																 <form:hidden id="hiddenTreatmentId" path="patientSaleTreatmentId" value="${patientSalesBill.patientSaleTreatmentId}"/> --%>
													...
													<div class="col-md-12-1" style="margin-top: 9px;">
														...
														<div class="col-md-7-1" style="margin-top: 9px;">
															...
															<form:hidden id="hiddenTotalTax" path="patientTotalVat" />
																...
																<c:choose>
																	...
																	<c:when test="${slaveCount ==0}">
																		<form:input path="doctorName" type="text"
																			...
																			class="typeahead form-control input-SmallText "
																			placeholder=" Doctor Name" required="true"
																			onkeypress="setAutoDoctorNameNew('searchBox1','onload','OPD_Appoinment');" />
																		<form:hidden path="doctorId" id="hiddenDoctorId" />
																	</c:when>
																	<c:when test="${slaveCount !=0}">
												...
												<div class="col-md-4-1 " style="margin-top: 9px;">
													...
													<div class="col-md-12-1 center" style="margin-top: 9px;">
                                                        ...
                                                        Cash
                                                        <form:radiobutton
																	path="patientBillMode" id="radioCredit" value='1'
																	name="radioCashCredit"
																	onclick="hideDetails(),checkSponserDisc();" />
                                                        Credit
                                                        <form:radiobutton
																	path="patientBillMode" id="radioCheque" value='2'
																	name="radioCashCredit"
																	onclick="hideCardDetails(),showDetails(),checkSponserDisc();" />
                                                        Cheque
                                                        <form:radiobutton
																	path="patientBillMode" id="radioCard" value='3'
																	name="radioCashCredit"
																	onclick="hideChequeDetails(),showcardDetails();" />
                                                        Card
                                                       <%--  <form:radiobutton path="patientBillMode" id="radioPaytm" 
                                                                    value='4' name="radioCashCredit" onclick="hideDetails();" />
                                                        Paytm
 --%>
															</c:when>
															<c:when test="${slaveCount !=0}">
														...
														<div class="col-md-12-1" style="margin-top: 0px;">
															...
															<div class="col-md-5-1" style="margin-top: 5px;">
																<c:choose>
																	<c:when test="${slaveCount ==0}">
																		<form:input path="patientSaleBankName"
																			id="txtBankNameForcard"
																			class="form-control input-SmallText" requird="true"
																			type="text" placeholder="Bank Name"
																			name="txtBankNameForcard" />

																	</c:when>
																	<c:when test="${slaveCount !=0}">
																		<input id="txtBankNameForcard"
																			name="txtBankNameForcard"
																			class="form-control input-SmallText" type="text"
																			value="${patientSalesBill.patientSaleBankName}"
																			placeholder="Bank Name" style="width: 97%;"
													...
													<div class="col-md-12-1"
														style="margin-top: 9px; display: none;" id="DivNoforcard">
														<div class="col-md-12-1" style="margin-top: 0px;">
															<div class="col-md-2-1" style="margin-top: 0px;">
																<b> Card No </b>
															</div>
															<div class="col-md-5-1" style="margin-top: 0px;">
																<c:choose>
																	<c:when test="${slaveCount ==0}">
																		<form:input path="patientSaleCardNum"
																			id="txtCardNumber"
																			class="form-control input-SmallText" requird="true"
																			type="text" placeholder="Card No"
																			name="txtCardNumber" />
																	</c:when>
																	<c:when test="${slaveCount !=0}">
																		<input id="txtCardNumber" name="txtCardNumber"
																			class="form-control input-SmallText" type="text"
																			value="${patientSalesBill.patientSaleCardNum}"
																			placeholder="Card No" style="width: 97%;"
																			maxlength="100" required readonly />
																	</c:when>
																</c:choose>
															</div>
													...
													<tr id="remove1">
														...
														<td><form:hidden id="patientSlaveId0"
															...
															<form:input type='text'
																...
																maxlength='150' data-target="" onkeypress="load(1, 1)"
															...
															<input type="hidden" id="hiddenCategoryId1" value="0" />

															<form:hidden id="textPurchaseRate1"
																path="ltPatientSaleBill[0].patientSlavePurchaseRate" />
														</td>
														...
														<td><form:input type='text'
																...
																readonly="true" tabindex="-1" /> <form:input
																type="hidden"
																class='form-control input-SmallText # deleteGroup1 # textNo'
																path="ltPatientSaleBill[0].patientSlavvatid" style=''
																id='hiddenvatId1' name='hiddenvatId1' maxlength='6'
																readonly="true" tabindex="-1" /></td>
														...
														<td><form:input type='text'
																...
																onblur="isNumber('txtQty1'),calculateAmt(1)" /></td>
														...
														<td><form:input type='text'
																...
																onblur="isNumber('txtQty1'),calculateAmt(1),calculatet();"
																maxlength='6' /></td>
												...
												<c:when test="${slaveCount !=0}">
														...
														<tr id="remove${count.index+1}">
															...
															<td><form:hidden id="patientSlaveId${count.index+1}"
																...
																<form:input type='text'
																	...
																	name='txtProName${count.index+1}' maxlength='150'
																...
																<form:hidden id="textDisAmt${count.index+1}" path="" />

																<form:hidden id="textDisAmtPerQty${count.index+1}"
																	path="ltPatientSaleBill[${count.index}].patientSaleSlaveDiscAmt" />

																<%-- 	<form:hidden
																id="textPurchaseRate${count.index+1}" path="ltPatientSaleBill[${count.index}].patientSlavePurchaseRate"
																readonly/> --%></td>
															...
															<td><form:input type='text'
																	...
																	class='form-control input-SmallText'
																	path="ltPatientSaleBill[${count.index}].patientSlavvatid"
																	style='' id='hiddenvatId${count.index+1}'
																	name='hiddenvatId${count.index+1}' maxlength='6'
																	readonly="true" /></td>
															...
															<%-- 	<td><form:input id="textClStk${count.index+1}"
																class="form-control input-SmallText" type="text" path="ltPatientSaleBill[${count.index}].productMaster.batchMaster[${count.index}].stockMaster.stockQtyInHand"
																readonly/></td> --%>
															...
															<td><input type="checkbox" name="deleteGroup"
																value="1" readonly id="deleteGroup${count.index}"></td>
															...
															<td style="display: none;"><input
																...
																class="form-control input-SmallText" type="text"
																readonly> <input
																id="textRatePerUnit${count.index+1}"
																class="form-control input-SmallText" type="text"
													...
													<tr id="remove${slaveCount+1}">
														...
														<td><form:hidden id="patientSlaveId${slaveCount+1}"
															...
															<form:input type='text'
																class='form-control input-SmallText # deleteGroup1 # textNo'
																path="ltPatientSaleBill[${slaveCount}].productMaster.productName"
															...
															<form:hidden id="textDisAmt${slaveCount+1}" path="" /> <form:hidden
																id="textDisAmtPerQty${slaveCount+1}"
																path="ltPatientSaleBill[${slaveCount}].patientSaleSlaveDiscAmt" />

															<%-- 	<form:hidden path=""
																id="textPurchaseRate${slaveCount+1}"
																class="form-control input-SmallText" type="text"
																readonly/> --%></td>
														...
														<td><form:input type='text'
																...
																name='textDis${slaveCount+1}' maxlength='6'
																readonly="true" /></td>
														...
														<td><form:input type='text'
																...
																onblur="calculateAmt(${slaveCount+1})" /></td>
														...
														<td style="display: none;"><form:input
															...
															<form:input
																...
																type="text" id="textStockQtyInHand${slaveCount+1}"
														...
														<td><input type="checkbox" name="deleteGroup"
															value="1" id="deleteGroup${slaveCount+1}"></td>
												...
												<c:choose>
													<c:when test="${slaveCount ==0}">
														<form:input path="patientSalesBillSurcharge"
															...
															name="txtSurCharge" readonly="true"
															onblur="isFloatingPoint('txtSurCharge'),calculateSurcharge();" />
													</c:when>
													<c:when test="${slaveCount !=0}">
														<form:input path="" id="txtSurCharge" readonly="true"
															class="form-control input-SmallText" requird="true"
