...
<<%-- link rel="stylesheet" type="text/css"
	href="<c:url value="/css/ehat_general.css"/>">
<link rel="stylesheet" type="text/css"
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li class="pull-right" id="template">
												<button type="submit" class="btn btn-xs btn-success"
													...
													Company Report</button> <!-- <button class="btn btn-xs btn-danger">Discard</button> -->
											</li>
										</ul>
							...
							<div class="col-md-12-1">
								<div class="col-md-12-1">
									...
									<div class="col-md-6-1 panel-body" style="border: 2px solid;margin-top: 2%;" id="reportList">
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Company Report List</h4>
												...
												<tbody>
													<%
														File folder = new File(
																request.getRealPath("/ehat_Reports/Pharmacy/Company/"));
													...
													<tr>
														...
														<td>
															...
															%> <a
															href='/EhatEnterprise/ehat_Reports/Pharmacy/Company/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
														</td>
														<td>
															<%
													...
													<%
															...
															System.out.println("After Format : "+listofcountries);
														}
														}
													%>
												</tbody>
