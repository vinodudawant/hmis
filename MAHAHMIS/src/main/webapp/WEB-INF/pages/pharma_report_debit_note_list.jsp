								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>Debit Note Report</li>
											<!-- <li><i class="fa fa-question"></i></li>
											<li><i class="fa fa-exclamation-circle"
												style="color: red;">12</i></li> -->
											<li class="pull-right" id="template">
												<button type="submit" class="btn btn-xs btn-success"
													onclick="getReportForPharmacyDebitNoteList();">Get
													Debit Note Report</button> <!-- <button class="btn btn-xs btn-danger">Discard</button> -->
											</li>
										</ul>
								...
								<div class="col-md-12-1">
									<div id="companyReport" class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Debit Note Report</h4>
										</div>
									...
									<div class="col-md-6-1 panel-body" style="border: 2px solid;margin-top: 2%;" id="reportList">
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Debit Note Report List</h4>
												...
												<tbody>
													<%
														File folder = new File(
																request.getRealPath("/ehat_Reports/Pharmacy/DebitNote/"));
													...
													<tr>
														...
														<td>
															...
															%> <a
															href='/EhatEnterprise/ehat_Reports/Pharmacy/DebitNote/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
														</td>
														<td>
															<%
