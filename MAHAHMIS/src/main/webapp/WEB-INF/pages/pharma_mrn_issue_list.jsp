...
<script
	src="<c:url value="/pharmacy/resources/js/app_js/pharma_mrn_issue.js"/>"></script>
<script src="<c:url value="/auto/jquery.mockjax.js"/>"></script>
<%-- <script
	src="<c:url value="/js/patient.js"/>"></script>  --%>
<script src="<c:url value="/auto/bootstrap-typeahead.js"/>"></script>
						...
						<div id="content" class="col-lg-12">
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>MRN Issue Bill Entry</li>
											<div class="li pull-right" style="margin-left: 9px;">
												<a href="/EhatEnterprise/pharmacy/mrn/view.htm"
													class="btn btn-xs btn-info">Issue New MRN</a>
											</div>
										</ul>
							...
							<div id="SearchContent" class="col-md-12-1"
								...
								<div class="form-group col-md-2-1" id="divbyName">
									<input name="txtMRNIssueNo" type="text" id="txtMRNIssueNo"
										...
										$("#txtMRNIssueNo").autocomplete({
											 source : function(request, response) {
													...
													jQuery.ajax({
														...
														url : "/EhatEnterprise/pharmacy/mrn/autoSuggestionMRNIssueNumber",
														timeout : 1000 * 60 * 5,
														catche : false,
														error : function() {
															/* alert('error'); */
										...
										$("#txtStoreName").autocomplete({
											 source : function(request, response) {
													...
													jQuery.ajax({
														...
														type : "GET",
														data : str + "&reqType=AJAX",
														url : "/EhatEnterprise/pharmacy/store/autoSuggestionStore",
														timeout : 1000 * 60 * 5,
														catche : false,
														error : function() {
															/* alert('error'); */
								...
								<div class="container-main col-md-7-1"
									...
									<table
										...
										<tbody id="divHospitalSaleList">
											<c:forEach items="${mrnIssueMasters}" var="row"
												varStatus="count">
												<tr>
													<td class="col-md-1 center">${(count.index)+1} <input
														type="hidden"
														id="hiddenHospitalSaleBillId${row.mrnIssueId}"
														value="${row.mrnIssueId}">
													</td>
													<td class="col-md-2 center">${row.mrnMaster.mrnId}<input
														type="hidden" id="InwardNo${row.mrnIssueId}"
														value="${row.mrnMaster.mrnId}"></td>
													...
													<td class="col-md-2 center">${row.mrnIssueId}<input
														type="hidden" id="HospitalBillNum${row.mrnIssueId}"
														value="${row.mrnIssueId}"></td>
													...
													<td class="col-md-2 center">
														<%-- <button
																...
																onclick="edit(${row.patientSalesBillId})" value="PRINT">
																<i class="fa fa-print"></i>
															</button> --%> <a id="btnPrint${row.mrnIssueId}"
														class="btn btn-xs btn-success"
														href="/EhatEnterprise/pharmacy/indentSale/printView?indentSalelId=${row.mrnIssueId}">
															<i class="fa fa-print"></i>
													</a>
													...
													<td class="col-md-1 center">
														<button id="btnDelete2" class="btn btn-xs btn-success"
															onclick="deleteIndent(${row.mrnIssueId})" value="DELETE">
