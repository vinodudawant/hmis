...
<script>
	 ...
	 * *******/
	 function getShelfList() {
			...
			jQuery
					.ajax({
						...
						url : "../../pharmacy/report/getShelfWiseBatchExpiry",
						timeout : 1000 * 60 * 5,
						cache : false,
						error : function() {
							alert('error');
						...
						success : function(r) {
							...
							divContent = divContent
									+ "<select id='shelf' name='shelf' class='form-control form-control-sm text-center' style='width:100%;height:30px'>";
							...
							$("#shelfData").html(divContent);
							$("#shelfData").show('show'); 
						}
					});

		}
	 function getExpiryDataByShelfId()
		{
	 ...
	 function setShelfWiseExpiryResult(result){
		...
		$("#expiryshelfwiseproducts").html(divContent);
						...
						<div id="content" class="col-lg-12">
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>Near Expiry Shelf-wise Products</li>
																...
																function(e) {
																	window
																			.open('data:application/vnd.ms-excel,'
																					+ encodeURIComponent($(
																							'div[id$=expiryshelfwiseProductsList]')
																							.html()));
																	e
																			.preventDefault();
																});
							...
							<div class="col-md-12-1">
									...
									<div class="col-md-12-1" style="margin-top: 0%">
										...
										<div class="col-md-4-1 "
											...
											<!-- <div class="col-md-4-1" style="margin-top: 10px;"> -->
												<div class="col-md-4-1" style="margin-top: 10px;" id="shelfData"></div> 
										...
										<div style="margin-top: 0px; margin-bottom: 10px"
											...
											<div class="col-md-4-1" style="margin-top: 9px;">
												<button style="margin-left: 5%;"
													onclick="getExpiryDataByShelfId()" id="getproductData"
								...
								<div class="col-md-12-1 panel-body"
									style="border: 2px solid; margin-top: 2%;" id="expiryshelfwiseProductsList">
									<div class="col-md-12-1 center" style="margin-bottom: 10px;">
										

										<table>
										<thead>
										<tr><th colspan="7" align="center"><h4 id="titlesalewithgst" align="center">Near Expiry Shelf-Wise Products</h4></th></tr>
										...
										<div class="tab-content">
											...
											>
												<table
													...
													<tbody id="expiryshelfwiseproducts">
													</tbody>
												</table>
											</div>
										</div>
