								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>product report(All)</li>
											<!-- <li><i class="fa fa-question"></i></li>
											<li><i class="fa fa-exclamation-circle"
												style="color: red;">12</i></li> -->
											<li class="pull-right" id="template">
												<button type="submit" class="btn btn-xs btn-success"
													onclick="getReportForPharmacyAllProductList();">Get
							...
							<div class="col-md-12-1">
								<div class="col-md-12-1">
									...
									<div class="col-md-6-1 panel-body" style="border: 2px solid;margin-top: 2%;" id="reportList">
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">All Product Report List</h4>
										</div>
												...
												<tbody>
													<%
														File folder = new File(
																request.getRealPath("/ehat_Reports/Pharmacy/Product/"));
													...
													<tr>
															...
															%><td><%=i+1%></td>
														<td> <a
															href='/MAHAHMIS/ehat_Reports/Pharmacy/Product/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
														</td>
														<td>
															<%
