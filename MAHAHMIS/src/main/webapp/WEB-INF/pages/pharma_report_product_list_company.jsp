								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>Product Report(companywise)</li>
							...
							<div class="col-md-12-1">
								<div class="col-md-12-1">
									<div id="companyReport" class="col-md-5-1"
										style="height: 100%; margin-top: 2%; padding-left: -6px; border: 1px solid #b8b8b8;">

										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Product CompanyWise Report</h4>
										</div>
										...
										<div class="col-md-12-1" style="margin-top:10px;">
											<div class="col-md-4-1" style="margin-top:2%;">
												<b>Select Company</b>
											</div>
											
											<div class="col-md-7-1" style="margin-top:2%;">
											<select id="companyId" name="companyId">
												<c:forEach items="${companyMasters}" var="row"
													varStatus="count">
													<option value="${row.compId}">${row.compName}</option>
												</c:forEach>
											</select>
											</div>
										</div>
									...
									<div class="col-md-6-1 panel-body"
										style="border: 2px solid; margin-top: 2%;" id="reportList">
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">CompanyWise Product Report List</h4>
										</div>
										<div class="col-md-12-1"
												...
												<tbody>
													<%
														File folder = new File(
																request.getRealPath("/ehat_Reports/Pharmacy/Product/CompanyWise/"));
													...
													<tr>
														...
														<td>
															...
															%> <a
															href='/EhatEnterprise/ehat_Reports/Pharmacy/Product/CompanyWise/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
														</td>
														<td>
															<%
