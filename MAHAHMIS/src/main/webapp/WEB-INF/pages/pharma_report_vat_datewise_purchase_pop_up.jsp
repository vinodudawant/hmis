...
<div id="vatDateWisePurchase" class="modal fade in"
	style="height: 500px;">
				...
				<div class="modal-header  col-md-12">
					<div class="box-title  col-md-12 center">
						<div class="col-md-8-1" style="margin-top: 11px;">
							<h4>
								<i class="fa fa-calendar"></i>DateWise GST Purchase
							</h4>
						</div>
...
<button id="btnExport" class="btn btn-xs btn-success" value="Excel"  title="" data-placement="left" data-toggle="tooltip" data-original-title="Excel">
													...
													$("[id$=btnExport]").click(function(e) {
													    window.open('data:application/vnd.ms-excel,' + encodeURIComponent( $('div[id$=gstDatewise]').html()));
													    e.preventDefault();
													});
				...
				<div class="modal-body col-md-12">
					...
					<div id="gstDatewise"
						...
						<table class='table  table-bordered table-striped header-fixed cf'
							...
							<tbody id="vatDateWisePurchaseResult" class="success">
							</tbody>
							<!-- <tfoot>
								<tr>
									<td>Total</td>
									...
									<td><span style="float: right"><input type="text"
											id="vat5" readonly style="float: right"
											placeholder="Total Vat 5.00%"></span></td>
									<td><span style="float: right"><input type="text"
											id="amt5" readonly style="float: right"
											placeholder="Total amt 5.00%"></span></td>
									<td><span style="float: right"><input type="text"
											id="vat12" readonly style="float: right"
											placeholder="Total Vat 12.50%"></span></td>
									<td><span style="float: right"><input type="text"
											id="amt12" readonly style="float: right"
