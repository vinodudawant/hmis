									...
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<div class="li pull-right" style="margin-left: 9px;">
												<a href="/EhatEnterprise/pharmacy/productWithZeroStk/view-frm"
							...
							<div id="SearchContent" class="col-md-12-1"
								...
								<div class='col-md-2-1'>
									<input type="text" id='txtPartyName1' name='txtPartyName1'
										...
										onblur="splitVendorProductWithZero($('#txtPartyName1').val())" />
												...
												<%-- 	<td class="col-md-2 center">
													...
													<td class="col-md-2 center">
													 <a id="btnPrint${row.poId}"
														class="btn btn-xs btn-success"
														onclick="productWithZeroLevelPrint(${row.poId});">
															<i class="fa fa-print"></i>
													</a>
													</td>
													<%-- <c:choose>
													...
													<td class="col-md-1 center">
														<button id="btnDelete2" class="btn btn-xs btn-success"
															onclick="deleteProductWithZeroLevel(${row.poId})" value="DELETE">
