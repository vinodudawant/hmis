...
<div id="pendingBillPurchase" class="modal fade in"
	style="height: 500px;">
				...
				<div class="modal-header  col-md-12">
					<div class="box-title  col-md-12 center">
						<div class="col-md-8-1" style="margin-top: 11px;">
							<h4>
								<i class="fa fa-calendar"></i>Purchase Pending Bill Information
							</h4>
						</div>
								...
								<table
									...
									<thead style="background-color: peachpuff;">
										<tr>
											...
											<th class="col-md-1-1">Net Amount</th>
											<th class="col-md-1-1">Pending Days</th>
										</tr>
									</thead>
