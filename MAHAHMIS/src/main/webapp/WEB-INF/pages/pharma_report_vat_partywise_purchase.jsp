...
<script>
	...
	function loadPopUp() {
		...
		if (from != '' && to != '') {
			...
			jQuery.ajax({
				...
				url : "../report/getPartyWiseVatPurchase",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
				...
				success : function(r) {
					$("#vatPartyWisePurchase").show();
					setVatPartyWiseResult(r);
	...
	function setVatPartyWiseResult(r) {
		var divContent = "";
		var totalAmt = 0;
		var totalCGST = 0;
		var totalIGST = 0;
		...
		$("#vatPartyWisePurchaseResult").html(divContent);
	}

	function getDateWiseVatPurchaseReport() {
		...
		if (from != '' && to != '') {
			...
			jQuery
					.ajax({
						...
						type : "GET",
						data : str + "&reqType=AJAX",
						url : "/EhatEnterprise/pharmacy/report/getPartyWiseVatPurchaseReport",
						timeout : 1000 * 60 * 5,
						catche : false,
						error : function() {
	...
	function setResult(result) {
		...
		$('#setButtons')
				.html(
						"<button onclick='getDateWiseVatPurchaseReport()' class='btn btn-xs btn-success' type='button'>Get"
...
<body style="background: white ! important;">
	<section id="page">
		...
		<div id="outer" class="container-main" style="width: 100%;">
			...
			<%@include file="pharma_report_vat_partywise_purchase_pop_up.jsp"%>
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>DateWise GST Purchase Report</li>
								...
								<div class="col-md-12-1">
									<div class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">PartyWise GST Purchase Report</h4>
										</div>
									...
									<div class="col-md-6-1"
										...
										<div class="box border purple">
											<div class="box-title" style="background-color: #a696ce">
												<h4>
													<i class="fa fa-bitbucket"></i>PartyWise GST Purchase
													Report
												</h4>
												<div class="tools">
															...
															<tbody>
																<%
																	File folder = new File(
																			request.getRealPath("/ehat_Reports/Pharmacy/vat/partywise/"));
																...
																<tr>
																	...
																	<td>
																		...
																		%> <a
																		href='/EhatEnterprise/ehat_Reports/Pharmacy/vat/partywise/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
																	</td>
																	<td>
																		<%
