...
<div id="product_partywise_report" class="modal fade in" style="height: 500px;">
				...
				<div class="modal-header  col-md-12">
					<div class="box-title  col-md-12 center">
						<div class="col-md-8-1" style="margin-top: 11px;">
							<h4>
								<i class="fa fa-calendar"></i>Product Wise Party Information
							</h4>
						</div>

						<div class="col-md-4-1" style="margin-top: 11px;" id='setButtons'>
							<button onclick="getProductSaleDataByBatchIdForReport()" class="btn btn-xs btn-success" type="button">Get Report</button>
					...
					<div class="col-md-12-1">
						<div class='col-md-12-1' style='margin-top: 0px; margin-left: 1%;'>
							<table
								...
								<tbody id="partyWiseProductData" class="success">
								</tbody>
