	...
	function setBatchWiseSaleResult(result) {
		...
		if (r.length > 0) {
			divContent = divContent
					...
					+ "<table class='table  table-bordered table-striped header-fixed cf' border=1> <thead style='background-color: peachpuff;'><tr><th>Store Name</th><th>Generated Time</th><th>Generated Date</th><th>Deleted Time</th><th>Deleted Date</th><th>Comment</th><th>Deleted By</th></tr></thead>"
					+ "	<tbody id='patientSaleData' class='success'> ";
			for ( var i = 0; i < r.length; i++) {

				divContent = divContent + "<tr><td>" + r[i].indentStoreName
						+ "</td><td>" + r[i].indentStatus + "</td><td>"
						+ r[i].indentDate + "</td><td>" + r[i].indentDeletedTime
						+ "</td><td>" + r[i].indentDeletedDate
						+ "</td><td>" + r[i].indentComment
						+ "</td><td>" + r[i].indentDeletedBy + "</td></tr>";
		...
		var inputs = [];
			...
			jQuery
					.ajax({
						...
						type : "GET",
						data : str + "&reqType=AJAX",
						url : "/EhatEnterprise/pharmacy/report/getCancelIndentReport",
						timeout : 1000 * 60 * 5,
						catche : false,
						error : function() {
...
<body style="background: white ! important;">
	<section id="page">
		...
		<div id="outer" class="container-main" style="width: 100%;">
			...
			<%@include file="pharma_report_Cancel_indent_pop_up.jsp"%>
								...
								<div class="col-md-12-1">
									...
									<div id="companyReport" class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Cancel Indent Report</h4>
										</div>

										<div class="col-md-12-1" style="margin-top: 10px;">


											<div class="col-md-4-1" style="margin-top: 0px;"></div>
								...
								<div class="col-md-6-1"
										...
										<div class="box border purple">
											<div class="box-title" style="background-color: #a696ce">
												<h4>
													<i class="fa fa-bitbucket"></i>Cancel Indent Report
												</h4>
												<div class="tools">
