...
<script type="text/javascript">
	function loadPopUp(currentVal, id, type) {
		...
		$('#Product_With_Zero_Stock_Pop_Up').modal('show');
	...
	function resetValues() {
		$('#Product_With_Zero_Stock_Pop_Up').find('input:text').val('');
		$('#Product_With_Zero_Stock_Pop_Up').find('input:hidden').val('');
	}
	...
	function myfunction() {
		...
		if (ProductId == "0" || ProductId == "undefined" || ProductId == "") {
			...
			$("#Product_With_Zero_Stock_Pop_Up").modal('hide');
...
<div id="Product_With_Zero_Stock_Pop_Up" class="modal fade in">
