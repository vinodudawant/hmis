									...
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<div class="li pull-right" style="margin-left: 9px;">
												<a href="/EhatEnterprise/pharmacy/productMinLevel/view-frm"
							...
							<div id="SearchContent" class="col-md-12-1"
								...
								<div class='col-md-2-1'>
									<input type="text" id='txtPartyName1' name='txtPartyName1'
										...
										onblur="splitProductBelowMinLevel($('#txtPartyName1').val())" />
										...
										<tbody id="divProductOrderList">
											<c:forEach items="${ltPoMasters}" var="row" varStatus="count">
												<tr>
													...
													<td class="col-md-1 center">${row.poDeleteFlag} <input
												...
												<%-- 	<td class="col-md-2 center">
													...
													<td class="col-md-2 center">
													 <a id="btnPrint${row.poId}"
														class="btn btn-xs btn-success"
														onclick="productBelowMinLevelPrint(${row.poId});">
															<i class="fa fa-print"></i>
													</a>
													</td>
													<%-- <c:choose>
														<c:when test="${row.poStatus=='pending'}">
															...
															href="/EhatEnterprise/pharmacy/po/edit-view?poId=${row.poId}"><i
													...
													<td class="col-md-1 center">
														<button id="btnDelete2" class="btn btn-xs btn-success"
															onclick="deleteProductBelowMinLevel(${row.poId})" value="DELETE">
