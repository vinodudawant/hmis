...
<!-- /for Developers  -->
<script
	src="<c:url value="../.././pharma-resources/js/app_js/pharma_preparation.js"/>"></script>
...
function validateData() 
{
	...
	var txtPreparation  = $('#txtPreparation').val().toString().trim(); 
			
	if($('#txtPreparation').val()!=null && $('#txtPreparation').val()!="")
		{ 
		if(txtPreparation.length!=0 )
		{
		if($('#preparationId').val()!=null && $('#preparationId').val()!="")
		{ 
			//alert("Record Updated Successfully!");
		    $('#preparationMasterForm').submit();
		}
		  else
		   {
...
function validateSearch()
{
	...
	{ 
		searchPreparation($("#hiddenId").val());
	}
	else
	{	
		alert("Enter Preparation Name in Search Box");
	    $('#searchBox').focus();
	}
						...
						<div id="content" class="col-lg-12">
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>Preparation Master</li>
										<!-- 	<li><i class="fa fa-question"></i></li>
											<li><i class="fa fa-exclamation-circle"
												style="color: red;">12</i></li> -->
										<div class="li pull-right" style="margin-left: 9px;">
												<!-- <button class="btn btn-xs btn-success"
													onclick="validateData();">Save<i class="fa fa-save"></i></button> --> <!-- <button class="btn btn-xs btn-warning">Print</button>
							...
							<!-- /Common -->
							 ...
							 <div id="SearchContent" class="col-md-12-1">
								...
								<div class='col-md-1-1'>Preparation Name</div>
													...
													jQuery.ajax({
														...
														success : function(r) {
															...
															for(var i=0;i<r.length;i++){
																availableTags[i]=r[i].preparationName+"$"+r[i].preparationId;
															}
							...
							<div class="panel panel-default">
								<div class="panel-body">
									<div id="formMaster" class="col-md-4-1"
										...
										<form:form commandName="preparation" id="preparationMasterForm"
											action="../../pharmacy/preparation/save" method="post">

											<div class="col-md-12-1 center">
												<h4 id="title">Preparation Master</h4>
											</div>
											...
											<div class="col-md-12-1 "
												...
												<div class="col-md-7-1" style="margin-top: 9px;">
													...
													<form:input path="preparationName" type="text" autocomplete="off"
													 id="txtPreparation"
														name="txtPreparation" class="form-control input-SmallText"
														placeholder="Preparation Name" required="true"
														
														 />
                                                          <!--  	onblur="isAlphaWithSpace('txtFormName',0,25)" -->
													<form:hidden path="preparationId" id="preparationId" />

												</div>
												<div class="col-md-1-1"
													style="color: red; margin-top: 9px;">
													<b>*</b>
												</div>
											...
											<div class="col-md-12-1" style="margin-top: 9px;">
														...
														<div class="col-md-7-1" style="margin-top: 9px;">
															<form:radiobutton path="preparationQty" value="0"
																id="radioPreprationNo" name="radioPrepration" checked="true" />
															No
															<form:radiobutton path="preparationQty" value="1"
																id="radioPreprationYes" name="radioPrepration"
											...
											<table
												...
												<thead class="cf" style="background: white;">
													<tr>
														...
														<th style="height: 21.5px;" class="col-md-2"><div>Preparation
																Name</div></th>
														<th style="height: 21.5px;" class="col-md-2"><div>Preparation
																QTY</div></th>		
												...
												<tbody id="PreparationContent">
													<c:forEach items="${ltPreparationMaster}" var="row"
														varStatus="count">

														<tr>
															<td class="col-md-1">${(count.index)+1}<input
																type="hidden" id="preparationId${row.preparationId }"
																value="${row.preparationId}"></td>


															<td class="col-md-2">${row.preparationName }<input
																type="hidden" id="preparationName${row.preparationId }"
																value="${row.preparationName}"></td>
																
															<td class="col-md-2">${row.preparationQty }<input
																type="hidden" id="preparationQty${row.preparationId }"
																value="${row.preparationQty}"></td>	

															<td class="col-md-1">
																<button id="btnEdit${row.preparationId}"
																	class="btn btn-xs btn-success"
																	onclick="editPreparation(${row.preparationId})" value="EDIT">
																	<i class="fa fa-edit"></i>
																</button>
															</td>
															<td class="col-md-1">
																<button id="btnDelete4" class="btn btn-xs btn-success"
																	onclick="deletePreparation(${row.preparationId})" value="DELETE">
