...
<script>
	...
	function getCounterSaleData() {
		...
		if (from != '') {
			...
			jQuery.ajax({
				...
				url : "../report/getDailyUserWiseSaleData",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
	...
	function getTotalSaleData() { 
		...
		if (from != '') {
			...
			jQuery.ajax({
				...
				type : "GET",
				data : str + "&reqType=AJAX",
				url : "../report/getUserWiseDailyTotalSaleData",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
		...
		if(r.length>0)
		{
			for ( var i = 0; i < r.length; i++) {
				...
				divContent = divContent + "<tr><td>" + r[i].vouNo + "</td><td>"
						...
						+ r[i].vendorAddress + "</td><td>" + r[i].amount
						+ "</td></tr>";
	...
	function getDailySaleData() {
		...
		jQuery.ajax({
			...
			type : "GET",
			data : str + "&reqType=AJAX",
			url : "/EhatEnterprise/pharmacy/report/getUserDailySaleReport",
			timeout : 1000 * 60 * 5,
			catche : false,
			error : function() {
				...
				.ajax({
					...
					success : function(r) {
						...
						for ( var i = 0; i < result.ul.length; i++) {
							divContent = divContent
									+ "<option value='"+result.ul[i].ui+"'>"
									+ result.ul[i].fname + " "
									+ result.ul[i].mname + " "
									+ result.ul[i].lname + "</option>";
						}
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>UserWise Daily Sale Report</li>
										</ul>
								...
								<div class="col-md-12-1">
									...
									<div id="companyReport" class="col-md-6-1"
										...
										<div class="box border purple">
											<div class="box-title">
												<h4>
													<i class="fa fa-user"></i>UserWise Daily Sale Report
												</h4>
												<div class="tools">
									...
									<div class="col-md-5-1"
										...
										<div class="box border purple">
											<div class="box-title" style="background-color: #a696ce">
												<h4>
													<i class="fa fa-user"></i>UserWise Daily Sale
												</h4>
												<div class="tools">
															...
															<tbody>
																...
																<tr>
																	...
																	<td>
																		...
																		%> <a
																		href='/EhatEnterprise/ehat_Reports/Pharmacy/Sales/userwise/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
																	</td>
																	<td>
																		<%
