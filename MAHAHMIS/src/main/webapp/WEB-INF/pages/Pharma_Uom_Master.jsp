...
<!-- Application js -->
<script
	src="<c:url value="../.././pharma-resources/js/app_js/pharma_uom.js"/>"></script>
	<script
...
{
	var txtUomDescription= $('#txtUomDescription').val().toString().trim(); 
	
	if($('#txtUomDescription').val()!=null && $('#txtUomDescription').val()!="")
		{ 
		 if(txtUomDescription.length!=0)
		 {
		if($('#uomId').val()!=null && $('#uomId').val()!="")
		{	
			  //alert("Record Updated Successfully!");	 
			$('#uomMasterForm').submit();
		}
		else
...
function validateSearch()
{
	...
	{ 
		searchUom($("#hiddenId").val());
	}
	else
	{	
		alert("Enter Uom in Search Box");
	    $('#searchBox').focus();
	}
					...
					<div class="row">
						<div id="content" class="col-lg-12">
							...
							<div id="SearchContent" class="col-md-12-1">
								...
								<div class='col-md-1-1'>Unit of Measurement</div>
...
<!-- ,isAlphabet('searchBox',0,25) -->
													...
													jQuery.ajax({
														...
														success : function(r) {
															...
															for(var i=0;i<r.length;i++){
																availableTags[i]=r[i].uomName+"-"+r[i].uomId;
															}
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div id="uomMaster" class="col-md-4-1"
										style="height: 100%; margin-top: 1%; padding-left: 20px; border: 1px solid #b8b8b8;">
										<form:form commandName="uom" id="uomMasterForm"
											action="../../pharmacy/uom/save" method="post">
											<div class="col-md-12-1 center">
												<h4 id="title">Uom Master</h4>
											</div>
											...
											<div class="col-md-12-1 "
												...
												<div class="col-md-5-1" style="margin-top: 9px;">
													<form:input path="uomName" type="text" autocomplete="off"
													
														id="txtUomDescription" name="txtUomDescription"
														class="form-control input-SmallText" placeholder="unit of Measurement"
														></form:input>
													<form:hidden path="uomId" id="uomId" />
												</div>
												<!-- onblur="isName('txtUomDescription',0,500);"  -->
									...
									<div
										...
										<div
											...
											<table
												...
												<tr>
													<th style="height: 21.5px;" class="col-md-2"><div>Sr No
															</div></th>
													<th style="height: 21.5px;" class="col-md-2"><div>Unit of Measurement</div></th>
													...
													<tbody id="divUomList">
														<c:forEach items="${ltUomMasters}" var="row"
															varStatus="count">
															<tr>
																<td class="col-md-2">${(count.index)+1} <input
																	type="hidden" id="uomId${row.uomId }"
																	value="${row.uomId }"></td>
																<td class="col-md-2">${row.uomName } <input
																	type="hidden" id="uomName${row.uomId }"
																	value="${row.uomName }"></td>


																<td class="col-md-2">
																	<button id="btnEdit${row.uomId}"
																		class="btn btn-xs btn-success"
																		onclick="editUom(${row.uomId})" value="EDIT">
																		<i class='fa fa-edit' class='edit'></i>
																	</button>
																</td>
																<td class="col-md-1">
																	<button id="btnDelete2" class="btn btn-xs btn-success"
																		onclick="deleteUom(${row.uomId})" value="DELETE">
