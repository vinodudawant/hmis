	...
	function getDebitNoteData()
	{
		...
		if (from != '' && to != '') {
			...
			jQuery.ajax({
				...
				type : "GET",
				data : str + "&reqType=AJAX",
				url : "../report/getDebitNoteDataReport",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
	...
	function setPartyResult(result) {
		...
		for ( var i = 0; i < r.length; i++) {
			...
			divContent = divContent + "<tr><td>" + r[i].vouNo + "</td><td>"
					+ r[i].date + "</td><td>" + r[i].vendorName + "</td><td>"
					+ r[i].vendorAddress + "</td><td>"+r[i].amount
					+ "</td><td>" + r[i].productName
					+ "</td></tr>";
...
<body style="background: white ! important;">
	<section id="page">
		...
		<div id="outer" class="container-main" style="width: 100%;">
			...
			<%@include file="pharma_report_partywise_DBCR_pop_up.jsp"%>
								...
								<div class="col-md-12-1">
									...
									<div id="companyReport" class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Partywise DB Note</h4>
										</div>
															...
															<tbody>
																<%
																	File folder = new File(
																			request.getRealPath("/ehat_Reports/Pharmacy/Notes/debitnote/"));
																...
																<tr>
																	...
																	<td>
																		...
																		%> <a
																		href='/EhatEnterprise/ehat_Reports/Pharmacy/Notes/debitnote/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
																	</td>
																	<td>
																		<%
