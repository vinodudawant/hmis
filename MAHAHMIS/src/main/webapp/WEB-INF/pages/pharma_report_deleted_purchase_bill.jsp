...
<script>
	...
	function loadPopUp() {
		...
		if (from != '' && to != '') {
			...
			jQuery.ajax({
				...
				url : "../report/getDeletedPurchaseBillData",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
	...
	function setPartyResult(result) {
		...
		for ( var i = 0; i < r.length; i++) {
			...
			+ r[i].billDate + "</td><td>" + r[i].batchCode+"</td><td>" + r[i].vendorName+"</td><td>" + r[i].qty+"</td><td>" + r[i].rate+"</td><td>" + r[i].amount+"</td></tr>";
		...
		/* var indentId = indentId; */
			...
			jQuery
					.ajax({
						...
						type : "GET",
						data : str + "&reqType=AJAX",
						url : "/EhatEnterprise/pharmacy/report/getDeletedPurchaseBillReport",
						timeout : 1000 * 60 * 5,
						catche : false,
						error : function() {
...
<body style="background: white ! important;">
	<section id="page">
		...
		<div id="outer" class="container-main" style="width: 100%;">
			...
			<%@include file="pharma_report_deleted_purchase_bill_pop_up.jsp"%>
								...
								<div class="col-md-12-1">
									...
									<div id="companyReport" class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Deleted Purchase Bill Report</h4>
										</div>
									...
									<div class="col-md-6-1"
										...
										<div class="box border purple">
											<div class="box-title" style="background-color: #a696ce">
												<h4>
													<i class="fa fa-bitbucket"></i>Total Deleted Purchase Bill
												</h4>
												<div class="tools">
