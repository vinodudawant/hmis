...
<script>
	...
	function getDeletedCashList() {
		jQuery.ajax({
			type : "GET",
			url : "getDeletedCashReceiptList",
			timeout : 1000 * 60 * 5,
			catche : false,
			error : function() {
				alert("error");
			...
			success : function(r) {
				setDeletedCashListResult(r);
			}
		});

	}

	function getDeletedCashReport() {
				jQuery.ajax({
					async : true,
					type : "POST",
					url : "getDeletedCashReceiptListReport",
	...
	function setDeletedCashListResult(result) {
		var data = result;
		// prepare the data
		var source = {
			datatype : "json",
	...
	function setResult(result) {
		...
		$('#template')
				.html(
						"<button onclick='getDeletedCashReport()' class='btn btn-xs btn-success' type='button'>Get"
									...
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li id="template" class="pull-right">
												<button onclick="getDeletedCashReport();"
							...
							<div class="col-md-12-1">
								<div class="col-md-12"
									...
									<div class="col-md-12-1" style="margin-top: 2%;">
										<div class="col-md-12-1">
											<h4 id="title" class="center">Deleted Cash Receipt Report</h4>
										</div>
