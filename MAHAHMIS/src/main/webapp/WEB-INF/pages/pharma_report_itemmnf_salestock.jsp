						...
						<div id="content" class="col-lg-12">
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>ITEM WISE MFG WISE SALE STOCK REPORT</li>
							...
							<div class="col-md-12-1">
									...
									<div class="col-md-12-1">
										...
										<div style="margin-top: 0px; margin-bottom: 10px;"
											...
											<div style="margin-top: 9px;" class="col-md-4-1">
												<input type="text" onkeyup="searchcategory(this.id);"
													placeholder="Category" name="searchBox3" autocomplete="off"
										...
										<div style="margin-top: 0px; margin-bottom: 10px"
											...
											<div class="col-md-4-1" style="margin-top: 9px;">
												<button style="margin-left: 5%;"
													onclick="getsalestockReportitemwise()" id="getproductData22"
								...
								<div class="col-md-12-1 panel-body"
									style="border: 2px solid; margin-top: 2%;" id="salestockitemwsDiv">
									<div class="col-md-12-1 center" style="margin-bottom: 10px;">
										

										<table>
										<thead>
										<tr><th colspan="7" align="center"><h4 id="titlesalestock" align="center">ITEM WISE MFG WISE SALE STOCK REPORT</h4></th></tr>
												...
												<table
													...
													<thead style="background-color: lightgray;">
														<tr>
															...
															<th>CLOSING Qyt</th>
															<th>DIFFERENCE</th>
															<th>AS ON DATE CLOSING Qyt</th>
															<th>PURCHASE RATE For Supl1</th>
															<th>SUPPLIER NAME</th>
															<th>PURCHASE RATE For Supl2</th>
															<th>SUPPLIER NAME</th>
															
														</tr>
													</thead>
													<tbody id="itemwisemfgwisesalestock">
													</tbody>
												</table>
											</div>
										</div>
