...
<script>
	...
	function getReportDeletedCashPaid() {
		jQuery.ajax({
			type : "GET",
			url : "getDeletedCashPaidList",
			timeout : 1000 * 60 * 5,
			catche : false,
			error : function() {
				alert("error");
			...
			success : function(r) {
				setDeletedCashPaidListResult(r);
			}
		});

	}

	function getDeletedRecordCashPaidReport() {
				jQuery.ajax({
					async : true,
					type : "POST",
					url : "getDeletedCashPaidReport",
	...
	function setDeletedCashPaidListResult(result) {
		var data = result;
		// prepare the data
		var source = {
			datatype : "json",
	...
	function setResult(result) {
		...
		$('#template')
				.html(
						"<button onclick='getDeletedRecordCashPaidReport()' class='btn btn-xs btn-success' type='button'>Get"
									...
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li id="template" class="pull-right">
												<button onclick="getDeletedRecordCashPaidReport();"
							...
							<div class="col-md-12-1">
								<div class="col-md-12"
									...
									<div class="col-md-12-1" style="margin-top: 2%;">
										<div class="col-md-12-1">
											<h4 id="title" class="center">Deleted Cash Paid Report</h4>
										</div>
