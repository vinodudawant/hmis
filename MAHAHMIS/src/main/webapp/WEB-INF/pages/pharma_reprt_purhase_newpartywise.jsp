...
<script>
		...
		if (vendorId != '' && vendorId.length > 0) {
			...
			jQuery
					.ajax({
						...
						type : "POST",
						data : str + "&reqType=AJAX",
						url : "../../pharmacy/report/getPartyWisePurchaseByPartyId",
						timeout : 1000 * 60 * 5,
						catche : false,
						error : function() {
	...
	function getPurchaseDataByPartyIdReport() {
		...
		var vendorName = $("#txtProductName").val();
		var vendorId = $("#hiddenProductId").val();
		...
		if (vendorId != '' && vendorId.length > 0) {
			...
			var inputs = [];
			inputs.push('vendorId=' + vendorId);
			inputs.push('productName=' + "0");
			inputs.push('from=' + from);
			inputs.push('to=' + to);
			inputs.push('vendorName=' + vendorName);
			inputs.push('totalAmount=' + 0.0);
			inputs.push('productId=' + vendorId);
			...
			jQuery
					.ajax({
						...
						type : "GET",
						data : str + "&reqType=AJAX",
						url : "../../pharmacy/report/getPartyNewWisePurchaseReport",
						timeout : 1000 * 60 * 5,
						catche : false,
						error : function() {
	...
	function setResult(result) {
		...
		$('#setButtons1')
				.html(
						" <a title='' target='_blank' id='getPDFFile' name='getPDFFile' style='text-decoration: none;' href='/MAHAHMIS/ehat_Reports/"+splitResult[0]+"'> <input type='button' class='btn btn-xs btn-warning' value='View PDF' style=''></a>"
								...
								+ "<button style='margin-left: 12px;' type='button' class='btn btn-xs btn-danger' onclick='hidePopUp()' data-dismiss='modal'>Close</button>");
	}
												...
												<div class="col-md-12-1" style="margin-top: 5px;">
													<div class="col-md-5-1" style="margin-top: 0px;">
														<div class="form-group">
															<label for="product">Vendor Name</label> <input type="text"
										...
										<div class="col-md-12-1"
											...
											<div style="margin-top: 9px;" class="col-md-4-1">
												<button class="btn btn-xs btn-success" type="button"
													id="getIndentData" onclick="getPurchaseDataByPartyIdReport()"
												...
												<div class="col-md-12-1"
											style="margin-top: 0px; margin-bottom: 10px">
										<div id="setButtons1" style="margin-top: 11px;" class="col-md-6-1">
															...
															<tbody>
																...
																<tr>
																	...
																	<td>
																		...
																		%> <a
																		href='/MAHAHMIS/ehat_Reports/Pharmacy/purchase/partywise/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
																	</td>
																	<td>
																		<%
