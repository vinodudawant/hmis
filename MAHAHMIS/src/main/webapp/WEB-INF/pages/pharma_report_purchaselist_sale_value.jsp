...
<script
	...
	<script
	src="<c:url value="/pharmacy/resources/js/pharma_purchaseList_withsaleval_report.js"/>"></script>
						...
						<div id="content" class="col-lg-12">
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>Purchase list Report with sale value</li>
																...
																function(e) {
																	window
																			.open('data:application/vnd.ms-excel,'
																					+ encodeURIComponent($(
																							'div[id$=purchaselistwithsaleval]')
																							.html()));
																	e
																			.preventDefault();
																});
							...
							<div class="col-md-12-1">
									...
									<div class="col-md-12-1">
										...
										<div class="col-md-4-1 "
											...
											<div style="margin-top: 0px; margin-bottom: 10px"
												...
												<div class="col-md-4-1" style="margin-top: 9px;">
													<button style="margin-left: 5%;" onclick="getpurchaselistwithsaleval()"
								...
								<div class="col-md-12-1 panel-body"
									style="border: 2px solid; margin-top: 2%;" id="purchaselistwithsaleval">
									<div class="col-md-12-1 center" style="margin-bottom: 10px;">
										
										<table>
										<thead>
										<tr><th colspan="7" align="center"><h4 id="titlesaleval" align="center">Purchase list Report with sale value</h4></th></tr>
												...
												<table
													...
													<thead style="background-color: lightgray;">
														<tr>
															...
															<th>INVOICE DATE</th>
															<th>GRN AMT</th>
															<th>GRN AMT WITH GST</th>
															<th>SALE VALUE OF GRN</th>
															<th>PROFIT AMT</th>
															<th>PROFIT%</th>
															
														</tr>
													</thead>
													<tbody id="purchaselistwithsalevaltable">
													</tbody>
												</table>
											</div>
										</div>
