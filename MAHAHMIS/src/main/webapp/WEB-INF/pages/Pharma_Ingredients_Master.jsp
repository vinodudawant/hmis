...
<script type="text/javascript"
	src="<c:url value="/pharmacy/resources/js/app_js/pharma_ingredient.js"/>"></script>
					...
					<div class="row">
						<div id="content" class="col-lg-12">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li class="pull-right">
												<button class="btn btn-xs btn-success"
													onclick="$('#ingredientsMasterForm').submit()">Save</button>
							...
							<div id="SearchContent" class="col-md-12-1">
								...
								<div class='col-md-1-1'>Ingredient Name</div>
								...
								<div class='col-md-2-1'>
									<input id='' type='button' value='Search' class='edit'
										onclick='searchIngredient($("#hiddenId").val())' />
													...
													jQuery.ajax({
														...
														success : function(r) {
															...
															for(var i=0;i<r.length;i++){
																availableTags[i]=r[i].ingredientContent+"-"+r[i].ingredientId;
															}
							...
							<div class="panel panel-default">
								<div class="panel-body">
									<div id="ingredientsMaster" class="col-md-4-1"
										style="height: 100%; margin-top: 0%; padding-left: 20px; border: 1px solid #b8b8b8;">

										<form:form commandName="ingredients"
											id="ingredientsMasterForm" action="save"
											method="post">


											<div class="col-md-12-1 center">
												<h4 id="title">Ingredients Master</h4>
											</div>
											...
											<div class="col-md-12-1 "
												...
												<div class="col-md-7-1" style="margin-top: 9px;">
													<form:input path="ingredientContent" type="text"
														id="txtContentName" name="txtContentName"
														class="form-control input-SmallText"
														placeholder="Content Name" maxlength="25" required="true" />

													<form:hidden path="ingredientId" id="txtContentCode" />
												</div>
										...
										<table
											...
											<thead class="cf" style="background: white;">
												<tr>
													...
													<th style="height: 21.5px;" class="col-md-2 center"><div>Content
														</div></th>
										...
										<div class="col-md-12-1"
											...
											<div class="container-main col-md-7-1"
												...
												<table
													...
													<tbody id="divIngredientList">
														<c:forEach items="${ingredientsMaster}" var="row"
															varStatus="count">
															<tr>
																<td class="col-md-1 center">${(count.index)+1} <input
																	type="hidden" id="contentId${row.ingredientId }"
																	value="${row.ingredientId }">
																</td>
																<td class="col-md-2 center">${row.ingredientContent
																	}<input type="hidden"
																	id="contentName${row.ingredientId }"
																	value="${row.ingredientContent }">
																</td>

																<td class="col-md-1 center">
																	<button id="btnEdit${row.ingredientId}"
																		class="btn btn-xs btn-success"
																		onclick="editIngredients(${row.ingredientId})"
																		value="EDIT">
																...
																<td class="col-md-1 center">
																	<button id="btnDelete2" class="btn btn-xs btn-success"
																		onclick="deleteIngredient(${row.ingredientId})"
																		value="DELETE">
