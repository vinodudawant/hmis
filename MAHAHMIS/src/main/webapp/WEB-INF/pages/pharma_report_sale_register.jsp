...
<script
	src="<c:url value="/pharmacy/resources/js/pharma_sale_register.js"/>"></script>
									...
									<div class="col-md-12-1">
										...
										<div class="col-md-5-1 "
											...
											<b>IndentSale </b> <input type="radio" value="all"
												style="margin-left: 2%;" name="saleTye" id="allsaletype" checked="checked">
											<b>Total Sale </b>
										...
										<div style="margin-top: 0px; margin-bottom: 10px"
											...
											<div class="col-md-4-1" style="margin-top: 9px;">
												<button style="margin-left: 5%;"
													onclick="getsaleReportDatawithgst()" id="getproductData"
											...
											<thead>
												<tr>
													<th colspan="7" align="center"><h4
															id="titlesalewithgst" align="center">Sale Register Report
															</h4></th>
												</tr>
												<tr>
													<th align="center"></th>
