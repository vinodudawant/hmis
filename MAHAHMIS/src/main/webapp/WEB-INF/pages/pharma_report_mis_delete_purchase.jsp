...
<script>
	...
	function getDeletedPurchaseList() {
		jQuery.ajax({
			type : "GET",
			url : "getDeletedPurchase",
			timeout : 1000 * 60 * 5,
			catche : false,
			error : function() {
				alert("error");
			...
			success : function(r) {
				setDeletedPurchaseListResult(r);
			}
		});

	}

	function getDeletedPurchaseReport() {
				jQuery.ajax({
					async : true,
					type : "POST",
					url : "getDeletedPurchaseReport",
	...
	function setDeletedPurchaseListResult(result) {
		var data = result;
		// prepare the data
		var source = {
			datatype : "json",
									...
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li id="template" class="pull-right">
												<button onclick="getDeletedPurchaseReport();"
							...
							<div class="col-md-12-1">
								<div class="col-md-12"
									...
									<div class="col-md-12-1" style="margin-top: 2%;">
										<div class="col-md-12-1">
											<h4 id="title" class="center">Deleted Purchase Bills</h4>
										</div>
