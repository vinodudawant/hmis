...
<script>
	...
	function getStoreList() {
		...
		jQuery
				.ajax({
					...
					url : "../../pharmacy/report/fetchStockDetails",
					timeout : 1000 * 60 * 5,
					cache : false,
					error : function() {
						alert('error');
	...
	function getCurrentStockProductList() {
		...
		jQuery
				.ajax({
					...
					type : "POST",
					data : str + "&reqType=AJAX",
					url : "../../pharmacy/product/getAllProducts",
					timeout : 1000 * 60 * 5,
					cache : false,
					error : function() {
						alert('error');
	 ...
	 function getCategoryList() {
			...
			jQuery
					.ajax({
						...
						type : "POST",
						data : str + "&reqType=AJAX",
						url : "../../pharmacy/report/getCategoryWiseStock",
						timeout : 1000 * 60 * 5,
						cache : false,
						error : function() {
							alert('error');
	...
	function getData(){
		...
		jQuery.ajax({
			...
			type : "POST",
			data : str + "&reqType=AJAX",
			url : "../../pharmacy/report/geCurrentStockReport",
			timeout : 1000 * 60 * 5,
			catche : false,
			error : function() {
	...
	function calculateByPurRate(pageNumber)
	{
		...
		jQuery.ajax({
			...
			//data:{type:'purRate'},
			data : str + "&reqType=AJAX",
			url : "../../pharmacy/report/getProductWiseStockOnPurRate2",
			timeout : 1000 * 60 * 5,
			catche : false,
			error : function() {
				alert("error");
...
<body style="background: white ! important;">
 ...
 -->
								...
								<div class="col-md-12-1 panel-body"
									...
									<table>
										<thead>
										<tr><th colspan="7" align="center"><h4 id="titlesalewithgst" align="center">Current Stock Reports</h4></th></tr>
