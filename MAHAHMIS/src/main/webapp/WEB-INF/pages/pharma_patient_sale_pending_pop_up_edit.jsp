...
<script type="text/javascript">
	function loadForEdit(currentVal, id)
	{
		...
		$('#Patient_PopUp_Form_Edit').modal('show');
		else
			{
	...
	function displayResult(item) 
	{
		...
		$('#hiddenProductPrescription').val(content[7]);
...
if($("#hiddenSponserFlag").val()=='ACTIVE')
{
	...
	function editProForEdit(rCount) {
		...
		if($('#txtEditQty' + rCount).val()==0)
			$('#txtEditQty' + rCount).val()
			
			if($('#txtEditQty' + rCount).val()==0)
		$('#txtEditQty').val($('#txtQty' + rCount).val());
			else
				$('#txtEditQty').val($('#txtEditQty' + rCount).val());
		...
		$('#txtTotalStk').val($('#textClStk' + rCount).val());
	...
	/* 	$('#txtTotalStk').val($('#textTotalStk' + rCount).val()); */
		...
		if (($('#hiddenBatchId').val() == "")
			...
			/* alert("edit"+$('#textPerRatePerUnitFlag' + rowCount).val()); */
		/* 	
			alert("edit"+$('#textPerRatePerUnitFlag' + rowCount).val()); */
	...
	function myfunctionPurchase() {
		...
		if (parseFloat($('#txtQty').val()) > parseFloat($('#txtClStk').val())) {
			...
			$("#Patient_PopUp_Form_Edit").modal('hide');
...
<div id="Patient_PopUp_Form_Edit" class="modal fade in">
						...
						<div class="col-md-12-1" style="margin-top: 9px;">
							...
							<div class="col-md-12-1" style="margin-top: 2px;">
								...
								<div class="col-md-11-1" style="margin-top: 0px;">
									<div class="col-md-3-1" style="margin-top: 0px;">
										<div class="form-group">
											<label for="product">Edit Quantity</label> <input type="text"
												id="txtEditQty" name="txtEditQty" value='0'
												class="form-control input-SmallText" placeholder="Qty"
												required
												onblur="isFloatingPoint('txtQty'),calculatePatientDiscOnEditQty(),validationsOfEditQty();">
									...
									<div class="col-md-3-1" style="margin-top: 0px;">
										<div class="form-group">
											<label for="product">Rate</label> <input type="text"
												...
												required onchange="calculatePatientDiscOnEditQty()">
											<div class='col-md-1-1 center'
									...
									<div class="col-md-3-1" style="margin-top: 0px;">
										<div class="form-group">
											<label for="product">Discount%</label> <input type="text"
												...
												maxlength="25" required onblur="calculatePatientDiscOnEditQty();">
										</div>
									</div>
									...
									<div class="col-md-8-1" style="margin-top: 20px; float: right;">
										...
										<div class="col-md-4-1" style="margin-top: -1px;">
											<input type="text" id="txtDiscAmt" name="txtDiscAmt"
												...
												onkeyup="calculatePatientDiscOnEditQty();">
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-12-1" style="margin-top: 2px;">
								...
								<div class="col-md-11-1" style="margin-top: 0px;">
									...
									<div class="col-md-8-1" style="margin-top: 0px; float: right;">
