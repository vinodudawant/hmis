								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>Cash Paid Report</li>
											<!-- <li><i class="fa fa-question"></i></li>
											<li><i class="fa fa-exclamation-circle"
												style="color: red;">12</i></li> -->
											<li class="pull-right" id="template">
												<button type="submit" class="btn btn-xs btn-success"
													onclick="getReportForPharmacyCashPaidList();">Get
													Cash Paid Report</button> <!-- <button class="btn btn-xs btn-danger">Discard</button> -->
											</li>
										</ul>
								...
								<div class="col-md-12-1">
									<div id="companyReport" class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Cash Paid Report</h4>
										</div>
									...
									<div class="col-md-6-1 panel-body" style="border: 2px solid;margin-top: 2%;" id="reportList">
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Cash Paid Report List</h4>
												...
												<tbody>
													<%
														File folder = new File(
																request.getRealPath("/ehat_Reports/Pharmacy/CashPaid/"));
													...
													<tr>
														...
														<td>
															...
															%> <a
															href='/EhatEnterprise/ehat_Reports/Pharmacy/CashPaid/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
														</td>
														<td>
															<%
