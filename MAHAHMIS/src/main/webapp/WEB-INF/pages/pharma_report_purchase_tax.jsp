						...
						<div id="content" class="col-lg-12">
							...
							<div class="col-md-12-1">
									...
									<div class="col-md-12-1">
										...
										<div class="col-md-4-1 "
											...
											<div style="margin-top: 0px; margin-bottom: 10px"
												...
												<div class="col-md-4-1" style="margin-top: 9px;">
													<button style="margin-left: 5%;" onclick="getpurchasetaxdata()"
								...
								<div class="col-md-12-1 panel-body"
									style="border: 2px solid; margin-top: 2%;" id="reportpurchasetax">
									<div class="col-md-12-1 center" style="margin-bottom: 10px;">
										

                                      <table>
										<thead>
										<tr><th colspan="7" align="center"><h4 id="titlepurtax" align="center">Purchase Tax Report</h4></th></tr>
										...
										<div class="tab-content">
											...
											>
												<table
													...
													<thead style="background-color: lightgray;" id="purchaseHeader">
														
													</thead>
													<tbody id="purchasetaxtable" class="table-striped">
													</tbody>
												</table>
											</div>
										</div>
