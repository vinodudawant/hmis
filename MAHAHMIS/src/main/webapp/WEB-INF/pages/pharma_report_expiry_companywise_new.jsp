					...
					.ajax({
						...
						success : function(r) {
							...
							divContent = divContent
									+ "<select id='company' name='company' class='form-control form-control-sm text-center' style='width:100%;height:30px'>";
							...
							$("#companyData").show('show'); 
						}
					});

		}
	 function getExpiryDataByCompId()
		{
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>Near Expiry Company-wise Products</li>
							...
							<div class="col-md-12-1">
										...
										<div style="margin-top: 0px; margin-bottom: 10px"
											...
											<div class="col-md-4-1" style="margin-top: 9px;">
												<button style="margin-left: 5%;"
													onclick="getExpiryDataByCompId()" id="getproductData"
								...
								<div class="col-md-12-1 panel-body"
									...
									<div class="col-md-12-1 center" style="margin-bottom: 10px;">
										...
										<table>
										<thead>
										<tr><th colspan="7" align="center"><h4 id="titlesalewithgst" align="center">Near Expiry Company-Wise Products</h4></th></tr>
