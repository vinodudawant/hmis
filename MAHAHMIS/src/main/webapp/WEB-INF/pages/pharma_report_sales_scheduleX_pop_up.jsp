				...
				<div class="modal-header  col-md-12">
					<div class="box-title  col-md-12 center">
						<div class="col-md-8-1" style="margin-top: 11px;">
							<h4>
								<i class="fa fa-calendar"></i>Schedule X Sale Information
							</h4>
						</div>

						<div class="col-md-4-1" style="margin-top: 11px;" id='setButtons'>
							<button onclick="getDailySaleDataSchX()" class="btn btn-xs btn-success" type="button">Get Report</button>
				...
				<div class="modal-body col-md-12">
					<div class="col-md-12-1">
						...
						<div class='col-md-12-1' style='margin-top: 0px; margin-left: 1%;'>
							<strong>CounterSale</strong><input type="radio" name="saleType" value="counterSale" onclick="getCounterSaleDataSchX()" checked="checked">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<strong>IndentSale</strong><input type="radio" name="saleType" value="indentSale" onclick="getIndentSaleDataSchX()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<strong>hospitalSale</strong><input type="radio" name="saleType" value="hospitalSale" onclick="getHospitalSaleDataSchX()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<strong>patientSale</strong><input type="radio" name="saleType" value="patientSale" onclick="getPatientSaleDataSchX()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<strong>Total Sale</strong><input type="radio" name="saleType" value="totalSale" onclick="getTotalSaleDataSchX()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
