...
<script>
	...
	function setPartyResult(result) {
		...
		for ( var i = 0; i < r.length; i++) {
			...
			divContent = divContent + "<tr align='center'><td class='col-md-1'>" + r[i].productName + "</td><td class='col-md-1'>"
					...
					/* 
					<td class='col-md-1'>" + r[i].rate + "</td>
					<td class='col-md-1'>" + r[i].purRate + "</td> */
		}
		$("#stockData").html(divContent);
		
		//$("#totalAmount").val(total.toFixed(3));
		$("#totalAmount").html(total.toFixed(3));
	}
	...
	function calculateByPurRate()
	{
		jQuery.ajax({
			...
			type : "POST",
			data:{type:'purRate'},
			url : "../../pharmacy/report/getProductWiseStock",
			timeout : 1000 * 60 * 5,
			catche : false,
			error : function() {
				alert("error");
							...
							<div class="col-md-12-1">
									<div  class="col-md-11"
										...
										<div class="col-md-12-1" style="margin-top:2%;">
											...
											<div id="reportList" class="col-md-12" style="width: 100%; overflow-y: scroll;width:100% ;  height: 500px; max-height: auto;">
												<table
													...
													<!-- <tr><td colspan="13" style="float:right" id="totalAmount"><input type="text" id="totalAmount" readonly style="float:right"></td></tr>
											 -->    <tr>
														<td class="col-md-1" colspan="10" align="right">Total :</td>
