										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li class="pull-right" id="template">
												<button type="submit" class="btn btn-xs btn-success"
													onclick="getReportForPharmacyChequeReceiptList();">Get
								...
								<div class="col-md-12-1">
									<div id="companyReport" class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Cheque Receipt Report</h4>
										</div>
									...
									<div class="col-md-6-1 panel-body" style="border: 2px solid;margin-top: 2%;" id="reportList">
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Cheque Receipt Report List</h4>
												...
												<tbody>
													<%
														File folder = new File(
																request.getRealPath("/ehat_Reports/Pharmacy/ChequeReceipt/"));
													...
													<tr>
														...
														<td>
															...
															%> <a
															href='/EhatEnterprise/ehat_Reports/Pharmacy/ChequeReceipt/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
														</td>
														<td>
															<%
