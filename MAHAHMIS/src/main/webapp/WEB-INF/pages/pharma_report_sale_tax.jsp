...
<script
	src="<c:url value="/pharmacy/resources/js/pharma_saleTax.js"/>"></script>
						...
						<div id="content" class="col-lg-12">
							...
							<div class="col-md-12-1">
									...
									<div class="col-md-12-1">
										...
										<div class="col-md-4-1 "
											...
											<b>IndentSale </b> <input type="radio" value="all"
												style="margin-left: 2%;" name="saleTye" checked="checked" id="allsaletype">
											<b>Total Sale </b>
										...
										<div style="margin-top: 0px; margin-bottom: 10px"
											...
											<div class="col-md-4-1" style="margin-top: 9px;">
												<button style="margin-left: 5%;"
													onclick="getsaleRep()" id="getsaleTaxData"
								...
								<div class="col-md-12-1 panel-body"
									style="border: 2px solid; margin-top: 2%;" id="salereportListwithgst">
									<div class="col-md-12-1 center" style="margin-bottom: 10px;">
										

										<table>
										<thead>
										<tr><th colspan="7" align="center"><h4 id="titlesalewithgst" align="center">Sale Tax Report</h4></th></tr>
										...
										<div class="tab-content">
											...
											>
												<table
													...
													<thead style="background-color: lightgray;" id="saletaxheader">

													</thead>
													<tbody id="saletaxtablerep">
													</tbody>
												</table>
											</div>
										</div>
