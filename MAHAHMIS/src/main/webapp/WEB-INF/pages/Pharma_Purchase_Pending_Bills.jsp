		...
		<form action="">
			<div class="modal-content" class="col-md-12">
				<div class="modal-header">
					<div class="box-title">
						<h4 id="popUpHeading">
							<i class="fa fa-calendar"></i>Pending Purchase Bill
						</h4>
					</div>
				</div>
            ...
            <div style='float: left;'>
                <input type="button" value="Export to Excel" id='excelExport' />
                	<script type="text/javascript">
													$("[id$=excelExport]").click(function(e) {
													    window.open('data:application/vnd.ms-excel,' + encodeURIComponent( $('div[id$=jqxgrid]').html()));
													    e.preventDefault();
													});
