...
<title>Check Receipt Entry | Pharmacy</title>
<meta name="viewport"
...
<!-- Application js -->
<script
	src="<c:url value="../.././pharma-resources/js/app_js/pharma_patient.js"/>"></script>
<script
	src="<c:url value="../.././pharma-resources/js/app_js/Pharma_Cheque_Receipt_Entry.js"/>"></script>
<script
	src="<c:url value="../.././pharma-resources/js/app_js/pharma_pur.js"/>"></script>
<!-- CUSTOM SCRIPT -->
			...
			if (bankName != "" || requestCount == 0) {
				...
				jQuery
						.ajax({
							...
							url : "../../pharmacy/chequeReceiptEntry/autoSuggestionByBranch",
							timeout : 1000 * 60 * 15,
							cache : false,
							error : function() {
								alert('error');
							...
							success : function(r) {
								...
								/* alert("Hi1"); */
									...
									for ( var i = 0; i <r.length; i++) 
									{
										...
										{	 
											  */
											availableTags[i] = r[i].branchName
												+ '_'
												+ r[i].branchId ;
										 /*  } */ 	
									}
					...
					if($('#txtBranch').val()!=null && $('#txtBranch').val()!="")
					   { 
						...
						if($('#searchBox3').val()!=null && $('#searchBox3').val()!="")
								...
								if($('#txtAmount').val()!=null && $('#txtAmount').val()!="")
								   { 
									if($('#txtChequeNo').val()!=null && $('#txtChequeNo').val()!="")
									   { 
								if($('#chequeReceiptId').val()!=null && $('#chequeReceiptId').val()!="")
								   { 
									alert("Record Updated Successfully!");	
									$('#ChequeReceiptMasterForm').submit();
									window
									.open("../../pharmacy/chequeReceiptEntry/view"); 
								   }
								else
						  ...
						  {
							alert("Vendor branch is not available");
							$('#txtBranch').val('');
							 $('#txtBranch').focus();
						  }	
					   }
						  ...
						  {
							alert("Enter Vendor Branch");
							 $('#txtBranch').focus();
						  }	
					 }
					else
					  {
						alert("Vendor bank is not available");
						$('#searchBox2').val('');
						 $('#searchBox2').focus();
					  }	
					}
...
function validateSearch()
{
	...
	{ 
		searchCheque($("#vendorIdSearch").val());
	}
	else
	{	
							...
							<div class="row">
								...
								<div class="panel-body">
									<div id="chequeReceiptEntry" class="col-md-4-1"
										...
										<form:form commandName="chequeReceiptEntry"
											id="ChequeReceiptMasterForm"
											action="../../pharmacy/chequeReceiptEntry/save"
											method="post">

											<div class="col-md-12-1" style="margin-top: 9px">
												<h4>Cheque Receipt Entry</h4>
											</div>
											...
											<div class="col-md-4-1" style="margin-top: 9px;">
												<div class="col-md-12-1" style="margin-top: 0px;">
													...
													<div class="col-md-7-1" style="margin-top: 0px;">
														<input type="text" id='searchBox1' name='searchBox1'
															placeholder="Name" class="form-control input-SmallText"
															onblur="splitChequeReceiptEntryContent($('#searchBox1').val());" />
														<form:hidden id="vendorId" path="vendorMaster.vendorId" />
														<form:hidden path="chequeReceiptId" id="chequeReceiptId" />
												...
												<div class="col-md-12-1" style="margin-top: 0px;">
													...
													<div class="col-md-7-1" style="margin-top: 9px;">
														<form:textarea path="" readonly="true" id="txtAddress"
															style="width:97%;" class="col-md-11-1" placeholder="Address" name="txtAddress"
												...
												<div class="col-md-12-1" style="margin-top: 9px;">
													...
													<div class="col-md-7-1" style="margin-top: 9px;">
														<form:input path="" readonly="true" id="txtPhone"
															class="form-control input-SmallText" type="text"
															name="txtPhone" tabindex="-1" placeholder="Phone" />
														<br>
														<!-- <div class='col-md-1-1 center'
															style='margin-top: -12px; margin-left: 204px; color: red;'>
															<b> *</b>
																				...
																				source : function(
																					...
																					jQuery
																							.ajax({
																								...
																								data : str
																										+ "&reqType=AJAX",
																								url : "../../pharmacy/bank/autoSuggestionBankNames1",
																								timeout : 1000 * 60 * 5,
																								catche : false,
																								error : function() {
																									alert(error);
												...
												<div class="col-md-12-1"
													...
													<div class="col-md-7-1" style="margin-top: 9px;">
														<form:textarea path="chequeReceiptNarration"
															style="width:97%;" id="txtNaration" class="col-md-11-1"
															type="text" name="txtNaration" placeholder="Narration"
															 />
														<br>
												...
												<div class="col-md-12-1" style="margin-top: 9px;">
													...
													<div class="col-md-7-1" style="margin-top: 0px;">
														<form:input path="" id="txtCurrDate"
															class="form-control input-SmallText" type="text"
												...
												<div class="col-md-12-1" style="margin-top: 9px;">
													...
													<div class="col-md-7-1" style="margin-top: 9px;">
														...
														<form:hidden id="bankId1" path="bankMaster1.bankId" />
                                                                 <!-- ,isAlphaWithSpace('searchBox3',0,200); -->
														<script type="text/javascript">
															$("#searchBox3")
																	.autocomplete(
																			{
												...
												<div class="col-md-12-1"
													...
													<div class="col-md-7-1" style="margin-top: 9px;">
														<form:input path="chequeReceiptAmt" type="text"
															id="txtAmount" class="form-control input-SmallText" placeholder="Amount"
															name="txtAmount" onblur="isFloatingPoint('txtAmount',0,100);" />
														<div class='col-md-1-1 center' 
															style='margin-top: -12px; margin-left: 204px; color: red;'>
															<b> *</b>
														</div>
												...
												<div class="col-md-12-1" style="margin-top: 0px;">
													...
													<div class="col-md-7-1" style="margin-top: 9px;">
														<form:input path="chequeReceiptNo" type="text" placeholder="Cheque No"
												...
												<div class="col-md-12-1" style="margin-top: 9px;">
													...
													<div class="col-md-7-1" style="margin-top: 9px;">
														<form:input path="chequeReceiptDate" id="popup_container2"
															class="form-control input-SmallText" type="text"
												...
												<div class="col-md-12-1" style="margin-top: 9px;">
													...
													<div class="col-md-7-1" style="margin-top: 0px;">
														<form:input path="chequeReceiptMadeBy" id="txtEntryMadeBY"
															class="form-control input-SmallText" type="text"
											...
											<table
												...
												<thead class="cf" style="background: white;">
													<tr>
														...
														<th style="height: 21.5px;" class="col-md-1 center"><div>Vendor
																Name</div></th>
														...
														<tbody id="divChequeList">
															<c:forEach items="${ltChequeMasters}" var="row"
																varStatus="count">
																<tr>

																	<td class="col-md-1">${(count.index)+1}<input
																		type="hidden"
																		id="chequeReceiptId${row.chequeReceiptId}"
																		value="${row.chequeReceiptId}"></td>

																	<td class="col-md-1">${row.vendorMaster.vendorName}
																		<input type="hidden"
																		id="vendorName${row.chequeReceiptId}"
																		value="${row.vendorMaster.vendorName}">
																	</td>

																	<td style="display: none" id="txtDebit">${row.bankMaster1.bankName}
																		<input type="hidden"
																		id="bankName1${row.chequeReceiptId}"
																		value="${row.bankMaster1.bankName}">
																	</td>
																	<td style="display: none" id="txtDebit">${row.bankMaster.bankName}
																		<input type="hidden"
																		id="bankName${row.chequeReceiptId}"
																		value="${row.bankMaster.bankName}">
																	</td>
																	<td class="col-md-1">${row.chequeReceiptAmt} <input
																		type="hidden"
																		id="chequeReceiptAmt${row.chequeReceiptId}"
																		value="${row.chequeReceiptAmt}">
																	</td>


																	<td class="col-md-1">${row.chequeReceiptNo} <input
																		type="hidden"
																		id="chequeReceiptNo${row.chequeReceiptId}"
																		value="${row.chequeReceiptNo}">
																	</td>


																	<td class="col-md-1">${row.branchMaster.branchName}
																		<input type="hidden"
																		id="OurbranchName${row.chequeReceiptId}"
																		value="${row.branchMaster.branchName}">
																	</td>

																	<td style="display: none">${row.branchMaster1.branchName}
																		<input type="hidden"
																		id="branchName1${row.chequeReceiptId}"
																	...
																	<td style="display: none"><c:set var="now2"
																			value="${row.chequeReceiptDate}" /> <fmt:formatDate
																			value="${now2}" var="parsedDate" pattern="dd/MM/yyyy" />
																		<c:out value="${parsedDate}"></c:out> <input
																		type="hidden"
																		id="chequeReceiptDate${row.chequeReceiptId}"
																		value="<c:out value="${parsedDate}"></c:out>">

																	</td>

																	<td style="display: none">${row.vendorMaster.vendorAddress}
																		<input type="hidden"
																		id="vendorAddress${row.chequeReceiptId}"
																		value="${row.vendorMaster.vendorAddress}">
																	</td>

																	<td style="display: none">${row.vendorMaster.vendorId}
																		<input type="hidden"
																		id="vendorId${row.chequeReceiptId}"
																		value="${row.vendorMaster.vendorId}">
																	</td>


																	<td style="display: none">${row.bankMaster.bankId}
																		<input type="hidden" id="bankId${row.chequeReceiptId}"
																		value="${row.bankMaster.bankId}">
																	</td>

																	<td style="display: none">${row.bankMaster1.bankId}
																		<input type="hidden"
																		id="bankId1${row.chequeReceiptId}"
																		value="${row.bankMaster1.bankId}">
																	</td>

																	<td style="display: none">${row.branchMaster.branchId}
																		<input type="hidden"
																		id="branchId${row.chequeReceiptId}"
																		value="${row.branchMaster.branchId}">
																	</td>

																	<td style="display: none">${row.branchMaster1.branchId}
																		<input type="hidden"
																		id="branchId1${row.chequeReceiptId}"
																		value="${row.branchMaster1.branchId}">
																	</td>

																	<td style="display: none">${row.bankMaster.bankName}
																		<input type="hidden"
																		id="bankName${row.chequeReceiptId}"
																		value="${row.bankMaster.bankName}">
																	</td>

																	<td style="display: none">${row.vendorMaster.vendorMobileNumber}
																		<input type="hidden"
																		id="vendorMobileNum${row.chequeReceiptId}"
																		value="${row.vendorMaster.vendorMobileNumber}">
																	</td>

																	<td style="display: none">${row.chequeReceiptNarration}
																		<input type="hidden"
																		id="chequeReceiptNarration${row.chequeReceiptId}"
																		value="${row.chequeReceiptNarration}">
																	</td>


																	<td style="display: none">${row.chequeReceiptMadeBy}
																		<input type="hidden"
																		id="chequeReceiptMadeBy${row.chequeReceiptId}"
																		value="${row.chequeReceiptMadeBy}">
																	</td>
                                                                     
                                                                    <%--     <td class="col-md-2 center"><a
															id="btnPrint${row.chequeReceiptId}" class="btn btn-xs btn-success"
															href="/EhatEnterprise/pharmacy/chequeReceiptEntry/printView?chequeId=${row.chequeReceiptId}">
																<i class="fa fa-print"></i>
															</a></td> --%>
															<td class="col-md-2 center"><button
															id="btnPrint${row.chequeReceiptId}" class="btn btn-xs btn-success"
															onclick="chequeReceiptPrint(${row.chequeReceiptId});">
																<i class="fa fa-print"></i>
															</button></td>
															
                                                                     
																	<td class="col-md-1 center">
																		<button id="btnEdit${row.chequeReceiptId}"
																			class="btn btn-xs btn-success"
																			onclick="edit(${row.chequeReceiptId})" value="EDIT">
																	...
																	<td class="col-md-1 center">
																		<button id="btnDeleteENtry"
																			class="btn btn-xs btn-success"
																			onclick="deleteCheque(${row.chequeReceiptId})"
																			value="DELETE">
