...
<script>
	...
	function getPendingMrnReportDataList() {
		var inputs = [];
		var str = inputs.join('&');
		jQuery.ajax({
			async : true,
			...
			url : "../report/getPendingMRNReportData",
			timeout : 1000 * 60 * 5,
			catche : false,
			error : function() {
				alert('Network Issue!');
			...
			success : function(r) {
				...
				for ( var i = 0; i < r.lstMrnReportDetail.length; i++) {
					divContent = divContent + '<tr>'
							...
							+ '<td>'+r.lstMrnReportDetail[i].mrnDate + '</td>' 
				...
				$("#pendingMrnReportDataList").html(divContent); 
																...
																.click(
																		function(
																			...
																			$(document).on('click','#btnExport',function(e) {
				                                                                var result = 'data:application/vnd.ms-excel,' + encodeURIComponent($('div[id$=pendingMrnReportList]').html());
				                                                                var link = document.createElement("a");
				                                                                document.body.appendChild(link);
				                                                                link.download = "Pending MRN Report.xls"; //You need to change file_name here.
				                                                                link.href = result;
				                                                                link.click();
				                                                            });   //Add By Ajinkya
...
/* 																			window
							...
							<div style="margin-top: 0px; margin-bottom: 10px" class="col-md-12-1">
								<div class="col-md-4-1" style="font-size: 15px;">
									<b>Pending MRN Report</b>
								</div>
								<div class="col-md-3-1" style="">
									<button style="margin-left: 5%;" onclick="getPendingMrnReportDataList()"
										...
										<div class="tab-content">
											<div class="tab-pane fade in active">
												<table
													...
													<tbody id="pendingMrnReportDataList">
													</tbody>
												</table>
											</div>
										</div>
