...
<script>
	...
	function loadPopUp() {
		...
		if (from != '' && to != '') {
			...
			jQuery.ajax({
				...
				url : "../report/getCompanyWisePurchase",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
	...
	function getProductPurchaseDataByCompanyId(companyId1) {
		/*var indentId = $('#selectIndentId').val();*/
		
		var companyId = companyId1;
		var from = $("#popup_container2").val();
		var to = $("#popup_container3").val();

		/* var indentId = indentId; */
		if (companyId1 != '' && companyId1.length > 0) {
			var inputs = [];
			...
			jQuery
					.ajax({
						...
						type : "POST",
						data : str + "&reqType=AJAX",
						url : "/EhatEnterprise/pharmacy/report/getCompanyWisePurchaseByCompanyId",
						timeout : 1000 * 60 * 5,
						catche : false,
						error : function() {
						...
						success : function(r) {
							setCompanyWisePurchaseResult(r);
						}
					});
			return true;
		}
	...
	function setCompanyWisePurchaseResult(result) {
		var r = result;
		var divContent = "";
		total=0;
	...
	function getPurchaseDataByCompanyIdReport() {
		/*var indentId = $('#selectIndentId').val();*/
		...
		var companyName=datarow['productCompany'];
		...
		if (companyId != '' && companyId.length > 0) {
			...
			jQuery
					.ajax({
						...
						type : "GET",
						data : str + "&reqType=AJAX",
						url : "/EhatEnterprise/pharmacy/report/getCompanyWisePurchaseReport",
						timeout : 1000 * 60 * 5,
						catche : false,
						error : function() {
	...
	function setResult(result) {
		...
		$('#setButtons')
				.html(
						"<button onclick='getPurchaseDataByCompanyIdReport()' class='btn btn-xs btn-success' type='button'>Get"
	...
	function setCompanyGridData(result)
	{
		var data = result;
	    // prepare the data
	    var source =
	    {
	        ...
	        datafields: [
	            ...
	            { name: 'productCompany', type: 'string'},
	        ],
	        localdata: data
	    };
	    ...
	    $("#companyData").jqxGrid(
	    {
	        ...
	        enabletooltips: true,
	        columns: [
	            { text: 'Company Id', datafield: 'companyId', hidden: true},
	            { text: 'Company Name', datafield: 'productCompany',width: 346},
	    ...
	    $("#companyData").bind('rowselect', function (event) {
	        ...
	        getProductPurchaseDataByCompanyId(datarow['companyId']);
	    });
...
<body style="background: white ! important;">
	<section id="page">
		...
		<div id="outer" class="container-main" style="width: 100%;">
			...
			<%@include file="pharma_report_purchase_companywise_pop_up.jsp"%>
								...
								<div class="col-md-12-1">
									<div id="companyReport" class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Purchase CompanyWise Report</h4>
										</div>
									...
									<div class="col-md-6-1"
										...
										<div class="box border purple">
											<div class="box-title" style="background-color: #a696ce">
												<h4>
													<i class="fa fa-bitbucket"></i>Purchase CompanyWise Report
													List
												</h4>
												<div class="tools">
															...
															<tbody>
																<%
																	File folder = new File(
																			request.getRealPath("/ehat_Reports/Pharmacy/purchase/companywise/"));
																...
																<tr>
																	...
																	<td>
																		...
																		%> <a
																		href='/EhatEnterprise/ehat_Reports/Pharmacy/purchase/companywise/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
																	</td>
																	<td>
																		<%
