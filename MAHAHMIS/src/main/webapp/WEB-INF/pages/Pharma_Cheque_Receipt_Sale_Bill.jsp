...
<body>
	...
	<c:forEach items="${chequeReceiptDataSale}" var="row" varStatus="count">

        <c:set var="billId" value="${row.chequeReceiptSaleId }" />

		<c:set var="billNumber" value="${row.chequeReceiptSaleNo }" />

		<c:set var="saleDate" value="${row.chequeReceiptSaleDate }" />
   	...
   	<c:set var="vendorBank" value="${row.bankMaster.bankName }" />
   		...
   		<c:set var="vendorBranch" value="${row.branchMaster.branchName}" />
			...
			<c:set var="less" value="${row.chequeReceiptSaleAmt}" />
		  
		  <c:set var="entrymadeby" value="${row.chequeReceiptSaleMadeBy}" />
