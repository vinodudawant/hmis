...
<script>
	 ...
	 * *******/
	function getExpiredProductData()
		{
			//alert("Hello");
	...
	function setExpiredProductsResult(result){
		var r = result;
		var divContent = "";
		total=0;
		...
		$("#expiryproducts").html(divContent);
	...
	function downloadExcel(){
		jQuery.ajax({
			...
			type : "POST",
			data : "&reqType=AJAX",
			url : "../../pharmacy/report/downloadExcel",
			timeout : 1000 * 60 * 5,
			catche : false,
			error : function() {
	...
	function getExel2() {
		window.open('data:application/vnd.ms-excel,'
				+ encodeURIComponent($('div[id$=expiredProductsList]').html()));
		e.preventDefault();
	}
	function getPDF2() {
		window.open("data:application/pdf," + encodeURI($('div[id$=expiredProductsList]').html())); 
		/* window.open('data:application/vnd.ms-pdf,'
				+ encodeURIComponent($('div[id$=expiredProductsList]').html()));
		e.preventDefault(); */
	}
</script>
						...
						<div id="content" class="col-lg-12">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li class="pull-right">
												<button id="btnExport"
													...
													data-original-title="Excel" onclick="getExel2()">Export To Excel</button> <!-- <script
											...
											<!-- <button id="btnPdf"
													...
													title="" data-placement="left" data-toggle="tooltip"
													data-original-title="Pdf" onclick="getPDF2()">Export To PDF</button> --><!--  <script
													type="text/javascript">
												$("[id$=btnPdf]")
														.click(
																function(e) {
							...
							<div class="col-md-12-1">
										...
										<div style="margin-top: 0px; margin-bottom: 10px"
											...
											<div class="col-md-4-1" style="margin-top: 9px;">
												<button style="margin-left: 5%;"
													onclick="getExpiredProductData()" id="getproductData"
								...
								<div class="col-md-12-1 panel-body"
									style="border: 2px solid; margin-top: 2%;" id="expiredProductsList">
									<div class="col-md-12-1 center" style="margin-bottom: 10px;">
										

										<table>
										<thead>
										<tr><th colspan="7" align="center"><h4 id="titlesalewithgst" align="center">Expired Products</h4></th></tr>
