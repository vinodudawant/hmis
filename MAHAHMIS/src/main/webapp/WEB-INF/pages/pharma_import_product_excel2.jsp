...
<title>Import CathLab Product List | Pharmacy</title>
<meta name="viewport"
							...
							<div class="">
								<div class="col-md-12-1">
									...
									<div class="row panel panel-default">
										...
										<h4>
											The excel file must be in following format ...<a href="../.././pharma-resources/pharmaexcel/cathlaproduct.xlsx"><button
