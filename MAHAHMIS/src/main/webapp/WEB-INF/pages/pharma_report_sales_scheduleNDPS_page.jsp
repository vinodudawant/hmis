...
<script>
	...
	function getPatientSaleDataSchNDPS() {
		...
		if (from != '' && to != '') {
			...
			jQuery.ajax({
				...
				url : "../report/getTotalSchNDPSPatientSaleData",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
	...
	function getCounterSaleDataSchNDPS() {
		...
		if (from != '' && to != '') {
			...
			jQuery.ajax({
				...
				type : "GET",
				data : str + "&reqType=AJAX",
				url : "../report/getTotalSchNDPSCounterSaleData",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
	...
	function getTotalSaleDataSchNDPS()
	{
		var from = $("#popup_container2").val();
		...
		if (from != '' && to != '') {
			...
			jQuery.ajax({
				...
				type : "GET",
				data : str + "&reqType=AJAX",
				url : "../report/getTotalSchNDPSSaleData",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
	...
	function getHospitalSaleDataSchNDPS()
	{
		var from = $("#popup_container2").val();
		...
		if (from != '' && to != '') {
			...
			jQuery.ajax({
				...
				type : "GET",
				data : str + "&reqType=AJAX",
				url : "../report/getTotalSchNDPSHospitalSaleData",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
	...
	function getIndentSaleDataSchNDPS() {
		var from = $("#popup_container2").val();
		...
		if (from != '' && to != '') {
			...
			jQuery.ajax({
				...
				type : "GET",
				data : str + "&reqType=AJAX",
				url : "../report/getTotalSchNDPSIndentSaleData",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
	...
	function getDailySaleDataSchNDPS()
	{
		...
		/* var indentId = indentId; */
			...
			jQuery
					.ajax({
						...
						type : "GET",
						data : str + "&reqType=AJAX",
						url : "/EhatEnterprise/pharmacy/report/getTotalScheduleNDPSSaleReport",
						timeout : 1000 * 60 * 5,
						catche : false,
						error : function() {
...
<body style="background: white ! important;">
	<section id="page">
		...
		<div id="outer" class="container-main" style="width: 100%;">
			...
			<%@include file="pharma_report_sales_scheduleNDPS_pop_up.jsp"%>
								...
								<div class="col-md-12-1">
									...
									<div id="companyReport" class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Scheduled NDPS sales Report</h4>
										</div>
									...
									<div class="col-md-6-1"
										...
										<div class="box border purple">
											<div class="box-title" style="background-color: #a696ce">
												<h4>
													<i class="fa fa-bitbucket"></i>Scheduled NDPS sales Report
												</h4>
												<div class="tools">
