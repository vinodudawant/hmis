	...
	function getCounterSaleData() {
		...
		if (from != '') {
			...
			jQuery.ajax({
				...
				url : "../report/getDailyTotalSaleDataFifthCounter",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
	...
	function getDailySaleData() {
		...
		jQuery
				.ajax({
					...
					type : "GET",
					data : str + "&reqType=AJAX",
					url : "/EhatEnterprise/pharmacy/report/getFifthCounterDailySaleReport",
					timeout : 1000 * 60 * 5,
					catche : false,
					error : function() {
...
<body style="background: white ! important;">
	<section id="page">
		...
		<div id="outer" class="container-main" style="width: 100%;">
			...
			<%@include file="pharma_report_sales_fifth_counter_pop_up.jsp"%>
								...
								<div class="col-md-12-1">
									...
									<div id="companyReport" class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Daily Sale Report For SSR</h4>
										</div>
									...
									<div class="col-md-6-1"
										...
										<div class="box border purple">
											<div class="box-title" style="background-color: #a696ce">
												<h4>
													<i class="fa fa-bitbucket"></i>Daily Sale Report For SSR
												</h4>
												<div class="tools">
															...
															<tbody>
																<%
																	File folder = new File(
																			request.getRealPath("/ehat_Reports/Pharmacy/Sales/fifthCounterSale/"));
																...
																<tr>
																	...
																	<td>
																		...
																		%> <a
																		href='/EhatEnterprise/ehat_Reports/Pharmacy/Sales/fifthCounterSale/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
																	</td>
																	<td>
																		<%
