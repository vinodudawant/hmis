...
<div id="indent_cancel_report" class="modal fade in" style="height: 500px;">
				...
				<div class="modal-header  col-md-12">
					<div class="box-title  col-md-12 center">
						<div class="col-md-8-1" style="margin-top: 11px;">
							<h4>
								<i class="fa fa-calendar"></i>Cancel Indent Report
							</h4>
					...
					<div class="col-md-4-1" style="margin-top: 29px;" id='setButtons'>
							...
							<button onclick="getIndentSaleReport();" class="btn btn-xs btn-success" type="button">Get Report</button>
