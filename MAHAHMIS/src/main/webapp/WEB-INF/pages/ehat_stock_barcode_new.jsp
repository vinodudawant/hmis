...
<%@ page import="com.hms.pharmacy.service.PurchaseService"%>
<%@ page import="com.hms.pharmacy.pojo.PurchaseSlave"%>
...
<body>
	<%
		...
		int[] headerwidth11 = { 5 };
			...
			Integer purId= Integer.parseInt(masterId);
			
			PurchaseService hs = (ApplicationContextUtils.getApplicationContext()).getBean(PurchaseService.class);
			List<PurchaseSlave> purchaseDetails = hs.getBatchDetailsForPrint(purId);
			PurchaseSlave hospObj = purchaseDetails.get(0);
			
			String batchCode= hospObj.getBatchMaster().getBatchCode();
			String ProductName=hospObj.getProductMaster().getProductName();
			Integer batchId=hospObj.getBatchMaster().getBatchId();
			
			System.out.println("ProductName----"+ProductName+batchCode+batchId);

			Barcode128 code128 = new Barcode128();
			code128.setBaseline(-1);
			code128.setGenerateChecksum(true);
			code128.setCode(batchId.toString());
			int i = 0;
			//while (i < Integer.parseInt(count)) {
				...
				HeaderTable10.addCell(new Phrase("", tableheader));
