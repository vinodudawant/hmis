...
<!-- Application js -->
<script
	src="<c:url value="/pharmacy/resources/js/app_js/pharma_product_below_min_level.js"/>"></script>
<!-- CUSTOM SCRIPT -->
	...
	function fetchProductBelowMinLevel() {
		jQuery
				.ajax({
					async : true,
					type : "GET",
					url : "/EhatEnterprise/pharmacy/productMinLevel/getMinLevelProductListData",
					timeout : 1000 * 60 * 5,
					catche : false,
					error : function() {
						alert("error");
...
<body style="background: white ! important;">
	<section id="page">
		...
		<header class="navbar clearfix" id="header">
			...
			<%@include file="pharma_product_below_min_level_pop_up.jsp"%>
				...
				<div class="row">
					<div id="content" class="col-lg-12">
							...
							<div class="col-sm-12">
								<div class="page-header">
									...
									<ul class="breadcrumb col-md-12-1"
										...
										<li>Product Below Minimum Level</li>
										<div class="li pull-right" style="margin-left: 9px;">
											<a class="btn btn-xs btn-info"
												href="/EhatEnterprise/pharmacy/productMinLevel/view">Back
												to List</a>
											<button class="btn btn-xs btn-success" type="button"
												id="saveBtn" onclick="saveProductBelowLevel();">Save
						...
						<!-- 	<div class="col-md-12-1" style="margin-top: -2%">
							<b>Product Below Minimum Level</b>
						</div> -->
						<form:form commandName="po" id="productMinLevelForm"
							action="/EhatEnterprise/pharmacy/productMinLevel/save"
							method="post">
							<div id="tabs" class="col-md-12-1 panel panel-default panel-body">
								<div class="panel-body">
									<div id="purchaseOrder" class="col-md-4-1 center"
										style="height: 100%; width: 100%; padding-left: -10px; border: 1px solid #b8b8b8; background-color: #a3e4d7;">
										...
										<div class="col-md-6-1 " style="margin-top: 9px;">
											...
											<form:radiobutton path="poType" value="0"
												...
												name="radioPurchase" />
											Sale Based
											<form:radiobutton path="poType" value="1" id="radioSaleBased"
												name="radioPurchase" />
										</div> --%>
										</div>
									</div>
								...
								<div id="HSTDiv1"
									style="width: 97%; margin-left: 16px; height: 200Px; overflow-y: scroll; overflow-x: auto; border: 1px solid #436a9d;">
									<table id="ItemInfoTable" cellpadding="0" cellspacing="0"
										border="1"
										class="table table-bordered ta ble-striped table-condensed">
										<thead>
											<tr>
								...
								<div id="last" class="panel-body" style="margin-top: 8px;">
									<div class="panel-body col-md-11-1"
										style="height: 100%; width: 100%; padding-left: -10px; border: 1px solid #b8b8b8;">
