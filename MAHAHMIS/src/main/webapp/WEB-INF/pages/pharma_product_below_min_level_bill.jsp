	...
	<c:forEach items="${poData}" var="row" varStatus="count">
       ...
       <c:set var="billId" value="${row.poProductCount }" />
		...
		<%
					...
					PdfPCell text = new PdfPCell(new Phrase("Purchase Order(Product Below Min Level)",
					subheader));
		...
		<%
				...
				/* 	document.add(afterVentilation);
					...
					PdfPCell mrpCell0 = new PdfPCell(new Phrase("Total Vat", subheader));
					...
					PdfPCell mrpCell01 = new PdfPCell(new Phrase(totalVat, subheader));
					...
					HeaderTable7.addCell(new Phrase("                       "+total, subheader));
					/* PdfPCell mrpCell011 = new PdfPCell(new Phrase("TotalVat", subheader));
					mrpCell0.setHorizontalAlignment(Element.ALIGN_CENTER);
					mrpCell0.setBorder(Rectangle.NO_BORDER); 
					HeaderTable7.addCell(mrpCell011); */
					
					/* HeaderTable7.addCell(new Phrase("" , subheader)); */
					
					/*  PdfPCell mrpCell012 = new PdfPCell(new Phrase(, subheader));
					mrpCell01.setHorizontalAlignment(Element.ALIGN_CENTER);
					mrpCell01.setBorder(Rectangle.NO_BORDER);
					HeaderTable7.addCell(mrpCell012);   */
