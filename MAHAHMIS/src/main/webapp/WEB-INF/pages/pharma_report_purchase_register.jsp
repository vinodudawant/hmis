...
<script
	src="<c:url value="/pharmacy/resources/js/pharma_purchasetx_report.js"/>"></script>
</head>
<script>
						...
						<div id="content" class="col-lg-12">
							...
							<div class="col-md-12-1">
									...
									<div class="col-md-12-1">
										...
										<div class="col-md-4-1 "
											style="margin-top: 6px; margin-bottom: 10px;">
																...
																<input type="radio" value="0"    name="purTransTypess" id="rdoCashCredit">
																<b>Credit</b>
																<input type="radio" value="1" style="margin-left:2%;"  name="purTransTypess" id="rdoCash">
																<b>Cash</b>
																<input type="radio" value="2" style="margin-left:2%;"  name="purTransTypess" id="rdoCard">
																<b>Card </b>
																
																<input type="radio" value="3" checked="true" style="margin-left:2%;"  name="purTransTypess" id="rdoCard">
																<b>All </b>
										...
										<div class="col-md-4-1 "
											...
											<div style="margin-top: 0px; margin-bottom: 10px"
												...
												<div class="col-md-4-1" style="margin-top: 9px;">
													<button style="margin-left: 5%;" onclick="getpurchaseRegisterdata()"
								...
								<div class="col-md-12-1 panel-body"
									style="border: 2px solid; margin-top: 2%;" id="reportpurchasereg">
									<div class="col-md-12-1 center" style="margin-bottom: 10px;">
										

                                      <table>
										<thead>
										<tr><th colspan="7" align="center"><h4 id="titlepurregister" align="center">Purchase Register Report</h4></th></tr>
											...
											>
												<table
													class='table table-bordered table-condensed cf table-fixed'
														style='margin-bottom: 9px; max-width:1000%;  overflow-x: scroll; overflow-y: scroll; max-width: 1000%;'>
													<thead style="background-color: lightgray;" id="purchaseregisterh">
														<tr>
														<th>Sr No</th>
														<th>Bill Date </th>
														<th>Party Name</th>
														...
														<th>Bill No</th>
														<th>Gross Amount</th>
														<th>Gross Amt With GST</th>
														<th>Cash/Cridit</th>
														<th>Party Invice.No</th>
														<th>Remark</th>
														</tr>
													</thead>
													<tbody id="purchaseregistertable" class="table-striped">
													</tbody>
												</table>
											</div>
										</div>
