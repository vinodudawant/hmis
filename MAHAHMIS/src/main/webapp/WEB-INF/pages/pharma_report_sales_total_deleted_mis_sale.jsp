...
<script>
	...
	function getDeletedTotalSaleData() {
		jQuery.ajax({
			type : "GET",
			url : "getTotalSaleDeletedData",
			timeout : 1000 * 60 * 5,
			catche : false,
			error : function() {
				alert("error");
			...
			success : function(r) {
				setDeletedTotalSaleListResult(r);
			}
		});

	}

	function getDeletedTotalSaleReport() {
				jQuery.ajax({
					async : true,
					type : "POST",
					url : "getTotalSaleDeletedReport",
	...
	function setDeletedTotalSaleListResult(result) {
		var data = result;
		// prepare the data
		var source = {
			datatype : "json",
	...
	function setResult(result) {
		...
		$('#template')
				.html(
						"<button onclick='getDeletedTotalSaleReport()' class='btn btn-xs btn-success' type='button'>Get"
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>Deleted Total Sale Report</li>
											...
											<li id="template" class="pull-right">
												<button onclick="getDeletedTotalSaleReport();"
							...
							<div class="col-md-12-1">
								<div class="col-md-12"
									...
									<div class="col-md-12-1" style="margin-top: 2%;">
										<div class="col-md-12-1">
											<h4 id="title" class="center">Deleted Total Sale Report</h4>
										</div>
