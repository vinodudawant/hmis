...
<script>
	...
	function loadPopUp() {
		...
		if (from != '' && to != '') {
			...
			jQuery.ajax({
				...
				url : "../report/getDateWiseVatPurchase",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
	...
	function setVatDateWiseResult(r) {
		...
		$("#vatDateWisePurchaseResult").html(divContent);
	}
		...
		if (from != '' && to != '') {
			...
			jQuery
					.ajax({
						...
						type : "GET",
						data : str + "&reqType=AJAX",
						url : "/EhatEnterprise/pharmacy/report/getDateWiseVatPurchaseReport",
						timeout : 1000 * 60 * 5,
						catche : false,
						error : function() {
...
<body style="background: white ! important;">
	<section id="page">
		...
		<div id="outer" class="container-main" style="width: 100%;">
			...
			<%@include file="pharma_report_vat_datewise_purchase_pop_up.jsp"%>
								...
								<div class="col-md-12-1">
									<div class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">DateWise GST Purchase Report</h4>
										</div>
									...
									<div class="col-md-6-1"
										...
										<div class="box border purple">
											<div class="box-title" style="background-color: #a696ce">
												<h4>
													<i class="fa fa-bitbucket"></i>DateWise GST Purchase Report
												</h4>
												<div class="tools">
															...
															<tbody>
																<%
																	File folder = new File(
																			request.getRealPath("/ehat_Reports/Pharmacy/vat/datewise/"));
																...
																<tr>
																	...
																	<td>
																		...
																		%> <a
																		href='/EhatEnterprise/ehat_Reports/Pharmacy/vat/datewise/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
																	</td>
																	<td>
																		<%
