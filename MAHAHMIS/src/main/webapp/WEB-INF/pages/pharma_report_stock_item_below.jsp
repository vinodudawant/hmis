...
<script>
	...
	function getMinLevelProductList() {
		...
		jQuery.ajax({
			async : true,
			type : "GET",
			url : "../productMinLevel/getMinLevelProductList",
			timeout : 1000 * 60 * 5,
			catche : false,
			error : function() {
				alert("error");
	...
	function getCurrentStockCompanyWiseReport() {
				jQuery.ajax({
					async : true,
					type : "POST",
					url : "getProductBelowMinLevelReport",
		...
		if (productId != '') {
			...
			jQuery
					.ajax({
						...
						url : "/EhatEnterprise/pharmacy/report/getProductWiseStockByProductId",
						timeout : 1000 * 60 * 5,
						catche : false,
						error : function() {
	...
	function setProductByIdListResult(result) {
		...
		for ( var i = 0; i < result.length; i++) {
			...
			divContent = divContent + "<tr><td class='col-md-1'>"
					...
					+ result[i].batchCode + "</td><td class='col-md-1'>"
...
<body style="background: white ! important;">
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>Item Below Min Level Report</li>
							...
							<div class="col-md-12-1">
								<div class="col-md-12"
									...
									<div class="col-md-12-1" style="margin-top: 2%;">
										<div class="col-md-12-1">
											<h4 id="title" class="center">Item Below Min Level</h4>
										</div>
									...
									<div class="col-md-12"
										...
										<div id='jqxWidget'>
											<div class="col-md-12-1" id='jqxgrid' style="margin-top: 2%;"></div>
											<div id="jqxwindow">
												<div>Find Record</div>
	...
	<div style="display: none; overflow: hidden;" id="loadingImage"
		class="center">
		<img src="/EhatEnterprise/pharmacy/resources/images/ajax-loader.gif">
	</div>
