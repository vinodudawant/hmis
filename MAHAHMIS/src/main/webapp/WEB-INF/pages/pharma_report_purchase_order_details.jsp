								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li>Purchase Order Details Report</li>
							...
							<div class="col-md-12-1">
									...
									<div class="col-md-12-1">
										...
										<div class="col-md-4-1 "
											...
											<div style="margin-top: 0px; margin-bottom: 10px"
												...
												<div class="col-md-4-1" style="margin-top: 9px;">
													<button style="margin-left: 5%;" onclick="getpurchaseOrderData()"
								...
								<div class="col-md-12-1 panel-body"
									...
									<div class="col-md-12-1 center" style="margin-bottom: 10px;">
										...
										<table>
										<thead>
										<tr><th colspan="7" align="center"><h4 id="titlepurchaseorder" align="center">Purchase Order Details Report</h4></th></tr>
