...
<script>
	...
	function loadPopUp() {
		...
		if (productId != '' && from != '' && to != '') {
			...
			jQuery.ajax({
				...
				url : "../report/getCategoryWisePurchase",
				timeout : 1000 * 60 * 5,
				catche : false,
				error : function() {
					alert("error");
	...
	function getProductPurchaseDataByCategoryId(categoryId1) {
		/*var indentId = $('#selectIndentId').val();*/
		var productId = $("#hiddenProductId").val();
		var categoryId = categoryId1;
		var from = $("#popup_container2").val();
		var to = $("#popup_container3").val();
		...
		if (categoryId != '' && categoryId.length > 0) {
			...
			jQuery
					.ajax({
						...
						type : "POST",
						data : str + "&reqType=AJAX",
						url : "/EhatEnterprise/pharmacy/report/getCategoryWisePurchaseByCatId",
						timeout : 1000 * 60 * 5,
						catche : false,
						error : function() {
	...
	function getPurchaseDataByCategoryIdReport() {
		/*var indentId = $('#selectIndentId').val();*/
		...
		var categoryName=datarow['productCategory'];
		...
		if (categoryId != '' && categoryId.length > 0) {
			...
			jQuery
					.ajax({
						...
						type : "GET",
						data : str + "&reqType=AJAX",
						url : "/EhatEnterprise/pharmacy/report/getCategoryWisePurchaseReport",
						timeout : 1000 * 60 * 5,
						catche : false,
						error : function() {
	...
	function setResult(result) {
		...
		$('#setButtons')
				.html(
						"<button onclick='getPurchaseDataByCategoryIdReport()' class='btn btn-xs btn-success' type='button'>Get"
	...
	function setCategoryGridData(result)
	{
	  ...
	  /*   var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties, rowdata) {
	    ...
	    $("#categoryData").jqxGrid(
	    {
	        ...
	        enabletooltips: true,
	        columns: [
	            { text: 'Category Id', datafield: 'categoryId', hidden: true},
	            { text: 'category Name', datafield: 'productCategory',width: 346},
	    ...
	    $("#categoryData").bind('rowselect', function (event) {
	        ...
	        getProductPurchaseDataByCategoryId(datarow['categoryId']);
	    });
...
<body style="background: white ! important;">
	<section id="page">
		...
		<div id="outer" class="container-main" style="width: 100%;">
			...
			<%@include file="pharma_report_purchase_categorywise_pop_up.jsp"%>
								...
								<div class="col-md-12-1">
									<div id="companyReport" class="col-md-5-1"
										...
										<div class="col-md-12-1 center" style="margin-bottom: 10px;">
											<h4 id="title">Purchase CategoryWise Report</h4>
										</div>
									...
									<div class="col-md-6-1"
										...
										<div class="box border purple">
											<div class="box-title" style="background-color: #a696ce">
												<h4>
													<i class="fa fa-bitbucket"></i>Purchase CategoryWise Report
													List
												</h4>
												<div class="tools">
															...
															<tbody>
																<%
																	File folder = new File(
																			request.getRealPath("/ehat_Reports/Pharmacy/purchase/categorywise/"));
																...
																<tr>
																	...
																	<td>
																		...
																		%> <a
																		href='/EhatEnterprise/ehat_Reports/Pharmacy/purchase/categorywise/<%=listOfFiles[i].getName()%>'><%=listOfFiles[i].getName()%></a>
																	</td>
																	<td>
																		<%
