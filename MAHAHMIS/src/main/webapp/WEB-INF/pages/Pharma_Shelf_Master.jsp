...
<!-- Application js -->
	<script
	src="<c:url value="../.././pharma-resources/js/app_js/pharma_shelf.js"/>"></script>
	<script
...
{
	var txtName= $('#txtName').val().toString().trim(); 
								...
								<div class='col-md-2-1'>
									<input type="text"
									 id='searchBox' name='searchBox'
										...
										onblur="splitShelfContent($('#searchBox').val())" /> <input
							...
							<div class="panel panel-default">
								<div class="panel-body">
									<div id="shelfMaster" class="col-md-4-1"
										...
										<form:form commandName="shelf" id="shelfMasterForm"
											action="../../pharmacy/shelf/save" method="post">
											<div class="col-md-12-1 center">
												<h4 id="title">Shelf Master</h4>
											</div>
											...
											<div class="col-md-12-1 "
												...
												<div class="col-md-7-1" style="margin-top: 9px;">
													<form:input type="text" autocomplete="off"
													 path="shelfName" id="txtName"
														placeholder="shelf name" name="txtName"
														class="form-control input-SmallText" />
													<!-- 	onblur="isAlphaWithDigitSpace('txtName',0,25)"  -->
													<form:hidden path="shelfId" id="shelfId" />
												</div>
											...
											<table
												...
												<thead class="cf" style="background: white;">
													<tr>
														...
														<th style="height: 21.5px;" class="col-md-2"><div>Shelf
																Name</div></th>
														<th style="height: 21.5px;" class="col-md-2"><div>Edit</div></th>
														<th style="height: 21.5px;" class="col-md-2"><div>Delete</div></th>
													</tr>
												</thead>
												<tbody id="divShelfList">
													<c:forEach items="${ltShelfMasters}" var="row"
														varStatus="count">
														<tr>
															<td class="col-md-1">${(count.index)+1} <input
																type="hidden" id="shelfId${row.shelfId }"
																value="${row.shelfId }"></td>
															<td class="col-md-2">${row.shelfName } <input
																type="hidden" id="shelfName${row.shelfId }"
																value="${row.shelfName }"></td>


															<td class="col-md-2">
																<button id="btnEdit${row.shelfId}"
																	class="btn btn-xs btn-success"
																	onclick="edit(${row.shelfId})" value="EDIT">
																	<i class="fa fa-edit"></i>
																</button>
															</td>
															<td class="col-md-2">
																<button id="btnDelete2" class="btn btn-xs btn-success"
																	onclick="deleteShelf(${row.shelfId})" value="DELETE">
