...
<meta charset="utf-8">
<title>IVF Previous AutoSummary DashBoard</title>
<meta name="viewport"
...
<body>
	<c:if test="${ sessionScope.userType != null }">
		...
		<section id="page">
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a href="ivf_dAllocation.jsp">IVF Previous AutoSummary</a></li>
									...
									<div class="col-md-4">
										<div class="input-group" id="documentByName">
											<input class="form-control" 	title="Please enter State name" id="searchId"
												type="text" placeholder="Patient Name" onkeyup="autoSuggestionForPriviousAuttosummary(this.id)">
														...
														<div class="row" style="margin-top: 10px">
															<div class="col-md-12">
																...
																<div class="panel panel-primary"
																	...
																	<div class="panel-heading" id="divEhatContent">Previous Auto Summary</div>
																	<div class="panel-body"
																		...
																		<table id="ehatTable" cellpadding="0" cellspacing="0"
																			...
																			<tbody id="ivfPreviousAutosummaryDetails">
																			</tbody>
																		</table>
																	</div>
																</div>
			...
			<!--Cancel IVF Admission Bed pop up  -->
			<div id="cancelIVFAdmissionPopUp" class="popup modal fade in" tabindex="-1"
						...
						<div class="modal-content">
										...
										<div class="box-body">
											...
											<div class="col-xs-12 col-md-12">
												<div class="col-xs-4 col-md-12">
													...
													<label>Reason to cancel Admission For IVF Patient</label>
							...
							<div class="modal-footer">
								<input type="button" value="submit" class="btn btn-primary"
									onclick="cancelAdmissionOfIVFpatient()" />
	...
	<div id="ivfTreatId" style="display: none;"></div>
