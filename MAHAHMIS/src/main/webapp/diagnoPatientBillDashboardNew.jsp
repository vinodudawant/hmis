...
<meta charset="utf-8">
<title>Diagnosis Bill Dashboard</title>
<meta name="viewport"
						...
						<div id="content" class="col-lg-12">
									...
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><a href="diagnoPatBillDashboard.jsp">Diagnostics</a></li>
												<li><a href="diagnoAssignTestDashboardNew.jsp">Diagnostic Patient</a></li>
												<li><a href="diagnoPatientBillDashboardNew.jsp">Bill</a></li>
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="col-sm-2">
										<label for="inlineFold" class="control-label">Patient Name: 
										</label>
									</div>
									<div class="col-md-4">
										<div class="input-group" id="documentByName">
											<input class="form-control" id="searchName"
												type="text" onkeyup="dignoPatRecAutoSugg(this.id,'Bill')">
																		...
																		<table id="ehatTable" cellpadding="0" cellspacing="0"
																			...
																			<thead id="ehatTHead">
																				<tr>
																					...
																					<th class="col-md-1 center">View Bill</th>
																				</tr>
																			</thead>

																			<tbody id="diagnosticBillTestBody">
																			</tbody>
																		</table>
																	</div>
																</div>
