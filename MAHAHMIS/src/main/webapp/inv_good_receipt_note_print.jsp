...
<body>
	<%
		...
		/* 	String hospitalName = hospObj.getHospitalName();
			...
			String vendorId = request.getParameter("grnId");
		...
		PdfPTable HeaderTable45 = new PdfPTable(3);
			...
			HeaderTable45.addCell(new Phrase("Goods Receipt Note" ,header));
		...
		/*******************************************/	
			...
			GoodReceiptNoteService puservice=(ApplicationContextUtils.getApplicationContext()).getBean(GoodReceiptNoteService.class);
			GoodReceiptNoteDto lstpurchaseobj=puservice.editGoodReceiptNote(pId,"all",request);
		...
		HeaderTable01.getDefaultCell().setBorder(Rectangle.NO_BORDER);
			      ...
			      nestedTable1.addCell(new Paragraph("  GRN NO",subheader ));
		...
		HeaderTable012.getDefaultCell().setBorder(Rectangle.NO_BORDER);
			      ...
			      nestedTable3.addCell(new Paragraph("  GRN DATE",subheader));		      	
			      nestedTable3.addCell(new Paragraph(": "+ lstpurchaseobj.getGrnDate(),tabletext));
		...
		HeaderTable152.getDefaultCell().setBorder(Rectangle.NO_BORDER);
			      ...
			      nestedTable511.addCell(new Paragraph(": "+ lstpurchaseobj.getGrnDate(),tabletext));
		...
		HeaderTable182.getDefaultCell().setBorder(Rectangle.NO_BORDER);
			      ...
			      nestedTable412.addCell(new Paragraph(": "+lstpurchaseobj.getGrnDeliveryDate(),tabletext));
		...
		HeaderTable013.getDefaultCell().setBorder(Rectangle.NO_BORDER);
			      ...
			      nestedTable5.addCell(new Paragraph(": "+ lstpurchaseobj.getGrnSupplierName(),tabletext));
		  ...
		  if(lstpurchaseobj.getPartyMasterDto().getPartyMasterAddressInfoDto()!=null){
		 	 for(PartyMasterAddressInfoDto partyMasterAddressInfoDto :lstpurchaseobj.getPartyMasterDto().getPartyMasterAddressInfoDto()){
			    ...
			    //  nestedTable11.addCell(new Paragraph(": "+supplierStreet+",  "+supplierArea+",  "+supplierCity+" - "+supplierPin+",  "+lstpurchaseobj.getGrnSupplierState()+", "+ lstpurchaseobj.getGrnSupplierMobile()+", Vendor ID:"+lstpurchaseobj.getId(),tabletext));
			    	...
			    	nestedTable11.addCell(new Paragraph(": "+lstpurchaseobj.getGrnSupplierState()+","+lstpurchaseobj.getGrnSupplierAddress() ,tabletext));
	 ...
	 PdfPTable HeaderTableMain = new PdfPTable(14);
		...
		for(int i=0;i<=lstpurchaseobj.getLstGoodReceiptNoteItemDto().size()-1;i++)
			{
			String hsnCode=lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getHsnNameValue();
		...
		HeaderTableMain.addCell(new Phrase(""+lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemName(),	tabletext));
		PdfPCell cell13= null;
		if(lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemBatchNo().equalsIgnoreCase("0")){
			 cell13 = new PdfPCell(new Phrase(	"NA", tabletext));
		}else{
			 cell13 = new PdfPCell(new Phrase(	""+lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemBatchNo(), tabletext));
		}
		...
		String itemBatchExpDate = formatter22.format(lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemExpireDate());
		...
		PdfPCell cell132 = new PdfPCell(new Phrase(	""+lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemUnitName(), tabletext));
		cell132.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(cell132);

		PdfPCell batchCodeCells = new PdfPCell(new Phrase(""+lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemQuantity(), tabletext));
		batchCodeCells.setHorizontalAlignment(Element.ALIGN_CENTER);
		HeaderTableMain.addCell(batchCodeCells);


		PdfPCell cell222 = new PdfPCell(new Phrase("" +lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemUnitPrice() ,tabletext));
		cell222.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(cell222);

		

		PdfPCell prcell = new PdfPCell(new Phrase("" +df2.format(lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemDiscountAmt()) ,tabletext));
		prcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(prcell);

		PdfPCell cell42 = new PdfPCell(	new Phrase("" + df2.format(lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemBaseAmt()),	tabletext));
		...
		totalgst = totalgst + lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemGst();
		PdfPCell gst3 = new PdfPCell(new Phrase(""+df2.format(lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemGst()),	tabletext));
		gst3.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(gst3);
		totalgstAmt = totalgstAmt + lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemGstAmt();
		PdfPCell gst31 = new PdfPCell(new Phrase(""+df2.format(lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemGstAmt()),	tabletext));
		gst31.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(gst31);
		
		PdfPCell gst212 = new PdfPCell(new Phrase(""+df2.format(lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemIgst()),	tabletext));
		gst212.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(gst212);
		totaligst = totaligst + lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemIgst();
		PdfPCell gst2 = new PdfPCell(new Phrase(" "+df2.format(lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getIgstAmount()),tabletext));
		gst2.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(gst2);
		totaligstAmt = totaligstAmt+lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getIgstAmount();
		totalAmt = totalAmt +lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemBaseIgstGstAmt();
		PdfPCell gst21 = new PdfPCell(new Phrase(""+df2.format(lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemBaseIgstGstAmt()),	tabletext));
	...
	/* PdfPCell cellB1  = new PdfPCell(new Phrase("     "+lstpurchaseobj.getIgstTotalAmount() ,subheader));
	 */
	PdfPCell cellB111  = new PdfPCell(new Phrase("     "+df2.format(lstpurchaseobj.getGrossLessAmount()) ,subheader));
	...
	/* PdfPCell cellB1  = new PdfPCell(new Phrase("     "+lstpurchaseobj.getIgstTotalAmount() ,subheader));
	 */
	PdfPCell cellB111a  = new PdfPCell(new Phrase("     "+df2.format(lstpurchaseobj.getGrossAddAmount()) ,subheader));
	...
	/*-------------------------------------------------------Add End---------------------------------------  */
		  ...
		  PdfPTable HeaderTableC = new PdfPTable(12);
		    ...
		    PdfPCell cellC1  = new PdfPCell(new Phrase("  "+ df2.format(lstpurchaseobj.getGrossTaxes()),subheader));
	  ...
	  //r0w5
		  ...
		  PdfPTable HeaderTableD = new PdfPTable(12);
		    ...
		    //PdfPCell cellD1  = new PdfPCell(new Phrase("            "+ lstpurchaseobj.getGrossTotalAmount(),subheader));
		    	    ...
		    	    PdfPCell cellD1  = new PdfPCell(new Phrase("            "+ df2.format(lstpurchaseobj.getGrossNetAmount()),subheader));
