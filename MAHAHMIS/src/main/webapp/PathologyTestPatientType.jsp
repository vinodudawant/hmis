...
<script>
	jQuery(document).ready(function() {
		App.setPage("PathologyTestPatientType"); //Set current page
...
<script type="text/javascript">
	onload = function() {
		...
		getLabPatTypes("onload");
		autoSuggestionForLab("byName", "onload","pathologyTestPatType");
	}
</script>
						...
						<div class="row">
							<div id="content" class="col-lg-12">
									...
									<div class="col-sm-12">
										<div class="page-header">
											...
											<ul class="breadcrumb col-md-12-1"
												...
												<li><a href="PathologyTestPatientType.jsp">Lab Patient Type</a></li>
												<div class="li pull-right">
													<button class="btn btn-xs btn-success" 
													data-toggle="tooltip" data-placement="left" title="Save Patient"
													onclick="saveLabPatTypes()">
								...
								<div class="col-md-12-1">
									...
									<div class="col-md-2-1"><label class="TextFont" style="margin-left: 10%;margin-top:3%;">
									Lab Patient Type Name:</label></div>
								...
								<div class="panel panel-default">
									<div class="panel-body">
										...
										<div id="infoDiv" class="col-md-5-1"
											style="height: 460px; max-height: auto; border: 1px;"></div>

										<div id="userMangTemp" class="col-md-7-1"
											style="height: 460px; max-height: auto; overflow-y: scroll; padding-left: 3%;"></div>
										</div>
									</div>
								</div>
						</div>
