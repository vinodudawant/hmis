							...
							<div id="content" class="col-lg-12">
											...
											<ul class="breadcrumb col-md-12-1"
												...
												<div class="pull-right" id="savebtn">
													<button class="btn btn-xs btn-success"
														...
														title="Save HRA Type"
														onclick="InsertHRA('insert','admin')">
								...
								<div style="width: 100%; padding-top: 2.5%; padding-left: 10%">
									...
									<div class="form-group col-md-9-1">
										<div class="divide-10"></div>
											<label class="TextFont">HRA Type ID:</label> 
												<input type="text" class="form-control input-SmallText" disabled="disabled" value="" name="txthraID" id="txthraID">													
									</div>
									
									<div class="form-group col-md-9-1">
										<div class="divide-10"></div>
											<label class="TextFont">HRA Type:</label> 
												<input type="text" class="form-control input-SmallText" name="txthra" id="txthra">													
									</div>
								</div>
								</div>
							</div>
										...
										<div class="divide-10"></div>
										<div id="listhraTemp" class="col-md-7-1"
