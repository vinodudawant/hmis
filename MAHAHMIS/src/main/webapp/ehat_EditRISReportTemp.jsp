...
<script type="text/javascript" src="js/ehat_viewRis_modified.js"></script>
...
// 			fetchRisReportList();
		...
		getRISReportToEdit(<%=request.getParameter("testReportId")%>);
	}
</script>
</head>
...
<body style="background: white ! important;">
	<section id="page">
												...
												<div class="row">
													...
													<div class="col-md-11">
														...
														<div class="col-md-12" style="margin-top: 20px">
															...
															<div class="col-md-3">
																<div class="form-group">
																	<label id="ipdlabel" class="control-label lblBold">Ipd No :</label> <label
		...
		<input type="hidden"  id="createUpdateReportId" value="<%=request.getParameter("testReportId")%>"> <!-- CRUD of ris report template -->
