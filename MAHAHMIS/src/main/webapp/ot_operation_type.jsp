									...
									<div class="page-header" style="height: 92%;">
										...
										<ul class="breadcrumb col-md-12-1"
												...
												<button class="btn btn-xs btn-info pull-right editUserAccess" type="button"
													onclick="toggleForm()">
													<i class="fa fa-plus"></i> Add Procedure Type
												</button>
								...
								<div class="col-md-12">
									...
									<div class="col-sm-4 text-center">
											...
											<input class="form-control"
												 id="searchText"
												type="text" placeholder="Procedure Type"
												onkeyup="getProcedureTypeList()">
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="panel panel-primary">
										<div class="panel-heading">Procedure Type Master</div>
										<div class="panel-body">

											<div class="panel panel-default form-group"
												id="addProType" style="display: none;">

												<div class="panel-body">

													<form class="col-md-12 form-group" id="proTypeForm">
														<div class="form-row align-items-center">
															<div class="col-md-3">
																<label>Procedure Type:</label> <input type="hidden"
																	value="0" id="procedureTypeId"> <input type="text"
																	class="form-control form-control-sm mb-2"
																	id="procedureType" placeholder="procedure Type">
															</div>
														</div>
														...
														<div class="form-row align-items-center">
															<div class="col-md-2">
																...
																<button class="btn btn-xs btn-primary" type="button"
																	onclick="onSaveProcedureType()">save</button>
															</div>
														</div>
													</form>
												</div>
												...
												<table
													...
													<thead>
														<tr>
															...
															<th class="col-md-3 text-center">Procedure Type</th>

														</tr>
													</thead>
													<tbody id="procedureTypeist">
													</tbody>
												</table>
											</div>
