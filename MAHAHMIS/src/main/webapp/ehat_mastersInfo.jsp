...
<meta charset="utf-8">
<title>EhatEnterprise |Information </title>
...
<body>
	...
	<%-- 	<%@include file="left_menu_nobel.jsp"%> --%>
									...
									<div class="box-body">
										<div class="tabbable header-tabs">
											<ul class="nav nav-tabs">
												...
												<li class="ehatListinfo2" id="subchrgsinfo" onclick="setNewTempInfo(this.id);"><a ><i
														class="fa fa-bookmark"></i> <span
														class="hidden-inline-mobile">Charges Information</span>
														</a></li>
											
												<li class="ehatListinfo" id="subsinfo" onclick="setNewTempInfo(this.id);"><a ><i
														class="fa fa-bookmark"></i> <span
														class="hidden-inline-mobile">Service Information</span>
														</a></li>
											</ul>
											...
											<div class="row" style="margin-top: 10px">
												<div class="col-md-12">
													...
													<div class="box border green" id="div1">
														<div class="box-title">
															<h4>
																<i class="fa fa-table"></i>Masters Information
															</h4>
														...
														<div class="box-body" id="divEhatList" style="height: 300px;overflow: auto;" >
															...
															<table id="servicesDiv" cellpadding="0" cellspacing="0" border="0"
		...
		<input type="hidden" id="chargesinfo" value="chargesinfo">
