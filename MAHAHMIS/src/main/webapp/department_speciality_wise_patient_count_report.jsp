...
<title>Speciality wise department wise patient count</title>
...
<script type="text/javascript" src="js/business_report.js"></script>
...
<script type="text/javascript">
	onload = function() {
		...
		getSpecialityReport("Speciality Wise");
		updateDynamicDateLabel();
...
/* For example, you can add styles for the 'User Name' column */
...
<body>
									...
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><i class="fa fa-home"></i> <a
												href="">Finance</a></li>
											<li><a href="department_speciality_wise_patient_count_report.jsp">Speciality wise department wise patient count</a></li>
											<li class="pull-right">
										...
										var clonedContent = $('div[id$=diveMain]').clone();
										    ...
										    link.download = "Business_Report.xls";
										    link.href = result;
										    link.click();
										});
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" >
											<input type="button" onclick="getSpecialityReport(this); updateDynamicDateLabel();"
												class="btn btn-info" value="Speciality Wise">
										</div>
										
										<div class="col-md-1" style="margin-left: 100px">
											<input type="button" onclick="getSpecialityReport(this); updateDynamicDateLabel();"
												class="btn btn-info" value="Department Wise">
										</div>
												...
												<div id="diveMain" class="col-md-12" style="margin-top: 5px">
													...
													<div id="divLine2" class=" box border col-md-12" style="overflow: auto;">
														<form class="form-horizontal col-md-12"
															...
															<div class="col-md-12">
														    <label id="businessSheetLabel">
														        <i class="fa fa-arrow-down"></i> Department Speciality Wise Patient Count Report from
    ...
    <table class="table">    
      <tbody id="SpecialityWiseReport">      </tbody>
    </table>
  </div>
