...
<body>
	<%
		try {
			...
			response.setHeader("Content-Disposition", "inline; filename = Diagnostic Receipt");
 ...
 */		
			...
			String docName = "";
			int count = 0;
			String refDoc  	=ltRegMasterDto.get(0).getRefDoctorName();
		...
		/* 	p.add(new Chunk(" \nCIN: "+cinNo+", GST : "+gstNo , tabletext));	
			...
			HeaderTable2.addCell(new Phrase("     DIAGNOSTICS RECEIPT ", header));
			HeaderTable2.addCell(new Phrase("", subheader));
			HeaderTable2.addCell(new Phrase("", subheader));
