...
<meta charset="utf-8">
<title>Bill Quotation RunTime</title>
<meta name="viewport"
				...
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<!-- SAMPLE -->
						 ...
						 <div class="alert alert-block alert-info fade in" style="display: none;">
												...
												<!--  <li><a href="#box_tab7" data-toggle="tab"><i
													...
													<li	 class="form-group col-md-2" style="padding-left: 0px;padding-top: 5px;">
																	<input type="button"
																		...
																		id="printTbl1" onclick="PrintBillQutRunime()" name="FetchServices" style="padding: 0px; margin-top: 2px;"
																		>
																</li>
																...
																<!-- <script type="text/javascript">
																	$("[id$=printTbl1]").click(function(e) {
																	    window.open('data:application/vnd.ms-excel,' + encodeURIComponent( $('div[id$=divOne]').html()));
																	    e.preventDefault();
																	});													
																</script> -->
															...
															<!-- 	<script type="text/javascript">
													$("[id$=printTbl1]").click(function(e) {
													    window.open('data:application/pdf,' + encodeURIComponent( $('div[id$=divOne]').html()));
													    e.preventDefault();
													});													
												</script> -->
													 ...
													 --%>
														...
														<li	 class="form-group col-md-2" style="padding-left: 0px;padding-top: 5px;">
																	<input type="button"
																		...
																		id="Clear" name="Clear" style="padding: 0px; margin-top: 2px; margin-bottom: 5px;"
																		onclick="clearTable()">
																</li>
																
														<li class="active"><a href="#box_tab4" id="generalShowForIpd" 
														data-toggle="tab"><i class="fa fa-home"></i> <span id="ipdGeneral" style="padding: 0px; margin-top: 2px; margin-bottom: 5px;"
													...
													<div class="tab-pane fade in active" id="box_tab4">
															...
															<form>
																...
																<div class="form-group col-md-3" style="padding-right: 4px;">
																	<label for="email">Particular:</label> <input
																		type="text" class="form-control" id="perticular"
																		placeholder="Enter Perticular" name="perticular"
																		onkeyup="setallservautocompleteOnBillingForQuotation(this.id);">
																</div>
																<!-- <div class="form-group col-md-2" style="padding-right: 4px;">
																	<label for="email">Particular:</label> <input
																		type="text" class="form-control" id="perticular"
																...
																<!-- <div class="form-group col-md-2" style="padding-left: 28px;padding-top: 19px;">
																	<input type="button"
																		class="form-control btn btn-primary" value="Add"
																		id="Add" name="addBill" style="padding: 0px"
																		onclick="addBillQuotationsRunTime()">
																</div> -->
																
																<div class="form-group col-md-1" style="padding-left: 5px;padding-top: 19px;">
																	<input type="button"
																		class="form-control btn btn-primary" value="Add"
																		id="Add" name="addBill" style="padding: 0px"
																		onclick="addBillQuotationsRunTime()">
																...
																<div class="form-group col-md-1" style="padding-left: 0px;padding-top: 19px;">
																	<input type="button"
																		...
																		onclick="saveQuotations('runtime');">
																</div>
																<input type="hidden" id="SpecialDisc" /> <input
																	type="hidden" id="queryType" value="insert" />
															</form>
													 ...
													 <%--	<div>
															...
															<div class="panel-body">
																...
																<div id="divOne">
																	...
																	<table class='table table-hover' id="tableOne">
																		...
																		<thead>
																			<tr>
																			<th class='only-checkbox'style="display: none;"></th>
																			<th class='only-checkbox'style="display: none;"></th>
																			<th class='only-checkbox'style="display: none;"></th>
																				<th class='only-checkbox'>#</th>
																				<th>Item</th>
														...
														<div
															...
															<label
																style="cursor: pointer; padding-top: 0px; margin-right: 20px; margin-bottom: 0px;"
																id="totalQtyRunT"> <i class="fa fa-at-o"></i>
																0
															</label> <label
																style="padding-top: 0px; margin-right: 5px; margin-bottom: 0px;"
																> <i class="fa fa-inr edit_currency_symbol"></i>&nbsp;&nbsp;Total
											...
											<div class="tabbable header-tabs">
												...
												<!-- <li	 class="form-group col-md-2" style="padding-left: 0px;padding-top: 5px;">
																	<input type="button"
																		...
																		id="printTbl2" onclick="PrintBillQutRunime('compare')" name="FetchServices" style="padding: 0px;"
																		>
																</li> -->
																...
																<li	 class="form-group col-md-2" style="padding-left: 0px;padding-top: 5px;">
																	<input type="button"
																		class="form-control btn btn-primary" value="Print"
																		id="printTbl2"  name="FetchServices" style="padding: 0px;  margin-top: 2px;margin-bottom: 2px;"
																		>
																</li>
													
													<li class="active"><a href="#box_tab4" id="generalHideForIpd"
														data-toggle="tab"><i class="fa fa-home"></i> <span id="ipdGeneral"
															class="hidden-inline-mobile" onclick="getIpdComparisonPatientsRunTime()">Compare Services</span> <!-- <span
														class="badge badge-blue font-11">3</span> --></a></li>
																														
																<script type="text/javascript">
																	$("[id$=printTbl2]").click(function(e) {
																	    window.open('data:application/vnd.ms-excel,' + encodeURIComponent( $('div[id$=divTwo]').html()));
																	    e.preventDefault();
																	});													
																</script>
												...
												<div class="tab-content">
													...
													<!-- Dynamic Tem added -->
														...
														<div
															...
															<label
																...
																Amount:</label><label
																style="padding-top: 0px; margin-right: 20px; margin-bottom: 0px;"
																id="totalAmtsComp"> <i class="fa fa-inr edit_currency_symbol"></i>
															</label>
														</div>
														<!-- /ORDER DETAILS -->
													</div>
													...
													<div class="tab-pane fade in active" id="box_tab4">
														...
														<div
															...
															<label
																style="cursor: pointer; padding-top: 0px; margin-right: 20px; margin-bottom: 0px;"
																id="totalQtyComparison">0 <i class="fa fa-at-o"></i>
...
<!-- --------------------------------------------------------------------------- -->
										...
										<div style="height: auto;">
											...
											<div style="width: 100%;; font-weight: bold; height: 100Px;">
												...
												<form class="form-inline">
                                                        <div class="form-group">
                                                        <label for="inputPassword4">Quotation Name:</label>
                                                        <textarea id="quotationName" name="addressText" cols="46" rows="2"></textarea>
											...
											<div style="width: 100%;; font-weight: bold; height: 100Px;">
												...
												<form class="form-inline">
                                                	<div class="form-group">
                                                        ...
                                                        <textarea id="patientNamePrint" name="addressText" cols="46" rows="2"></textarea>                                                
 													</div>
											     </form>
												...
												<form class="form-inline">
                                                	<div class="form-group">
                                                        ...
                                                        <textarea id="doctorNamePrint" name="addressText" cols="46" rows="2"></textarea>
 													</div>
											     </form>
				...
				<div class="modal-footer" style="text-align: left;">
					...
					<form class="form-inline col-md-12">
						...
						<div class="form-group col-md-2">
							<label for="pwd"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label>
							<button type="button" class="form-control btn btn-primary md-close"
								id="idForBill"	onclick="setNarrationPrintPopup1()" >Submit</button>							
						</div>
						
						<div class="form-group col-md-2">
							<label for="pwd"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label>
							
							<button id="idCloseBill" type="button" class="form-control btn btn-primary md-close"
								onclick="closePrintPopup()" data-dismiss="modal">Cancel</button>
						</div>
 ...
 <!-- Modal For Narration after Bill edit end -->
   ...
   <input id="ehathallTypeId" type="hidden" value="0"
	...
	<input id="narrationRunTime" type="hidden" value='narrationRunTime' />	
	<input id="narrationPrint" type="hidden" value='narrationPrint' />	
	<input id="comparePFlag" type="hidden" value='N' />	
