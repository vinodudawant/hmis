...
<meta charset="utf-8">
<title>Processed Complaints Reports</title>
<meta name="viewport"
...
<body>
	<c:if test="${ sessionScope.userType != null }">
									...
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a
												href="processed_complaints_reports.jsp">Processed Complaints Reports</a></li>
												...
												$("[id$=btnExportReport]")
														.click(
																function(e) {
															        ...
															        var table_div = document.getElementById('assetComplaintTableIdReport');
															        var table_html = table_div.outerHTML.replace(/ /g, '%20');
															        a.href = data_type + ', ' + table_html;
															        //setting the file name
															        a.download = 'Processed_Complaints_Reports_' + postfix + '.xls';
														...
														<div class="col-md-12">
															...
															<div class="col-md-12">
																...
																<div class="panel panel-primary"
																	...
																	<div class="panel-heading" id="divEhatContent">Processed Complaints</div>
																	<div class="panel-body"
																		style="overflow: auto; height: 300px" id="assetComplaintTableIdReport">
																		<table id="assetComplaintTableId" cellpadding="0" cellspacing="0"
																			...
																			<thead id="ehatTHead">
																				<tr>
																					...
																					<th class="col-md-1 center">Last Updated Date Time </th>
																					<th class="col-md-1 center">Last Updated By</th>
																					
																				</tr>
																			</thead>
																			<tbody id="assetTicketManagementTableBodyIdReport">
																			</tbody>
																		</table>
																	</div>
																</div>
		...
		jQuery(document).ready(function() {		
			...
			getAllAssetCategory();
			getAllProcessedComplaintsDataReport();
