...
<script type="text/javascript" src="js/opd_indivisual_instruction.js"></script> <!-- Akshata Desai /10/MARCH/22 -->
<script type="text/javascript" src="js/dd_group_inst.js"></script> <!-- Akshata Desai/11/MARCH/22 -->
...
<script type="text/javascript" src="js/dd_instruction_new.js"></script>
...
<%
	...
	String ShradhhaFlag = resourceBundleEha.getObject("ShradhhaFlag").toString();
				...
				<div id="main-content">
					<div class="container">
									...
									<div class="col-sm-12">
										<div class="page-header">
											<ul class="breadcrumb col-md-12-1"
												...
												<input type="button"  id="viewBMI" class="btn btn-xs btn-success li pull-right" data-placement="left" data-toggle="modal" data-target="#ViewBMIDetailsPopup" style="margin-left: 2px" value="BMI & BSA" onclick="viewBMIDetailsOfDoctorDesk();">
						...
						<div class="alert alert-block alert-info fade in col-md-12-1"style="padding-block-end:5%; padding-top:3%;margin-top:-29px;">
							...
							<div class="row">
								<!-- <div class="col-md-1">
									<img id="patImg" style="width: 100%;height: 45px" src="pharmacy/pharmacy/readImage?url=Koala.jpg"
								...
								<div class="col-md-3" >
                                    	...
                                    	<div id="TARGET_HEIGHTdiv" class="col-md-3">
                                              <div class="form-group">
                                                    <!-- <label class="control-label lblBold">Hall(HType):</label> <label id="hallName" class="control-label"></label> -->
                                                       <label class="control-label lblBold">Target Height :</label> <label id="TARGET_HEIGHT" class="control-label"></label> 
                                              </div>
                                    	</div>
															...
															<thead>
																<tr>
																	<th class='col-sm-1-1 center'
																		style='height: 21.5px; width: 25px; font-size: "103";'><label
																		class='TextFont'>#</label></th>
																	<th class='col-sm-4-1 center'
																		style='height: 21.5px; width: 102px; font-size: "3";'><label
                                                  ...
                                                  <div class="col-md-12-1"
                                                     ...
                                                     <div class="col-md-12-1"
														...
														<div class="col-md-6-1">
															<label class="TextFont">Local Examination:</label>
														...
														<div class="col-md-6-1" style="padding-left: 0.8%;">
															...
															<textarea style='margin-left: 1%;' id='invsRep' '3'
																cols='40' class=""></textarea>
														</div>
													</div>
													<div class="col-md-12-1"
															...
															<div
																...
																<div
																	...
																	<div class='btn btn-xs btn-primary' data-toggle="modal"
																		data-target="#AddUpdateAdminInstructionPopup" onclick="getAllGrpInstDataForModal(),getAllTemplatesForIPD(),createPCAdminInstructionIPD();"
																...
																<div class="col-md-12-1"
																	...
																	<div class="col-md-12-1" style="margin-top: 0px;">
																		...
																		<div class="col-md-1-2 pull-right">
																			...
																			<button class="btn btn-xs btn-info editUserAccess" title="Send Prescription" onclick="sendPrescptionToEcogreen()" data-toggle="tooltip" disabled="disabled">
																		...
																		<div class="col-md-5-1 pull-right"
																			...
																			<div class="col-md-6-1" style="margin-top: -3px;">
																				...
																				<div class="form-group Remove-Padding col-sm-11-1">
																					...
																					<div id="divTagname">
																						...
																						<!-- changed, aniket kanse 22 DEC 21 -->
																							...
																							name="name" autocomplete="off"
																							class="typeahead form-control input-SmallText"
																							onkeyup="getGenMedicineData(this.id, 'prescription');" />
																					</div>
																					<input type="hidden" id="medicineID" value="0" />
																			...
																			<table class="table table-bordered table-condensed">
																				<thead>
																					<tr>
																						...
																						<th class="col-md-2-1" style="height: 21.5px;"><div
																								class="TextFont">Drug Name</div></th>		
...
<%-- 			<input type="hidden" style="display: none" value="<%=request.getParameter("callFrom")%>" id="callFrom" />
 --%>			<div id="patobject" style="display: none;"></div>
			...
			<div id="InstructionListMarathi" style="display: none;">
				<option value="">----</option>
				<option value="1">à¤œà¥‡à¤µà¤£à¤¾à¤¨à¤‚à¤¤à¤°/After Dinner</option>
				<option value="2">à¤¬à¤¾à¤¹à¥‡à¤°à¥‚à¤¨ à¤²à¤¾à¤µà¤£à¥‡/Topical Application</option>
				<option value="3">à¤¨à¤¾à¤¶à¥à¤¤à¥à¤¯à¤¾ à¤…à¤—à¥‹à¤¦à¤°-à¤œà¥‡à¤µà¤£à¤¾à¤…à¤—à¥‹à¤¦à¤°/Before
					Breakfast-Before Dinner</option>
				<option value="4">à¤¨à¤¾à¤¶à¥à¤¤à¥à¤¯à¤¾ à¤¨à¤‚à¤¤à¤°-à¤œà¥‡à¤µà¤£à¤¾à¤¨à¤‚à¤¤à¤°/After Food</option>
			</div>
					...
					<div class="box-title">
						...
						<div class="form-group col-md-6-1" style="float: right;">
							...
							<button class="btn btn-xs btn-warning"
								...
								<button class="btn btn-xs btn-warning"
								onclick="printPrescription('OPD');" type="button">
								<i class="fa fa-print"></i>Prescrption Print
							</button>
			...
			<div class="modal-header" style="padding-bottom: 0px;">
				<div class="box-title"
					...
					<div class="form-group col-md-2-1"
						...
						<button class="btn btn-xs btn-success editUserAccess"
							name="btnSave" id="btnSave" value="Save Now"
							onclick="saveOPDPrescriptionSequence()" disabled="disabled">Save</button>
...
<!-- End prescription editSequence pop-up -->
...
<input type="hidden" id="dietValueId" value="0" />
<!-------------------------For LIS Start---------------------  -->
...
<input type="hidden" id="sponsorTestCharges" value="0">
	...
	<input type="hidden" id="ShradhhaFlag" value="<%=ShradhhaFlag%>">
<!-------------------------For LIS END---------------------  -->
			...
			<div class="modal-body">
				...
				<div class="modal-footer">
					...
					<input type='hidden' id="commonAd_patId" value='0' /> <input
						...
						<input type="hidden" id="preprationQty" value="0">
				</div>
			</div>
		</div>
	</div>
