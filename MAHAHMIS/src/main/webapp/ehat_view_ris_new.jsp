...
<!-- 																		class="control-label" id="ipdNo"></label> -->
															...
															<label id = "" class="control-label lblBold">Diagnostics No :</label> <label
																		class="control-label" id="ipdNo"></label>
									...
									<div class="col-md-12">
										...
										<div class="col-md-12"> <!-- 2nd row start -->
											...
											<div class="col-sm-3" id="divIdProcess" >
															<div class="form-group" align="center">
																 <label class="control-label" style="margin-right: 150px;"></label> 
																		<button class="btn btn-xs btn-primary" id="btnCreReport" 
											...
											<div class="col-sm-3" id="divIdProcess" >
															<div class="form-group" align="center">
																 <label class="control-label" style="margin-right: 150px;"></label> 
																		<button class="btn btn-xs btn-primary" id="saveRisRecordss" 
													...
													class="datatable table  table-bordered">
														<thead id="risRecTableHead" class="fixedheaderdemo">
															<tr>
																...
																<th class="col-md-1 center">View / Print Report</th>
													...
													<div class="col-sm-3">
														<div class="form-group" align="center">
															 <label class="control-label" style="margin-right: 90px;">  </label> 
																...
																<!-- <input style="width: 120%;" type="file"  id="fileUp" multiple name="uploadRISDocs" /> -->
																
																<input type="file" style="margin-top: 0px; cursor: pointer;" id="fileUp" multiple name="uploadRISDocs">
																
																<!-- <input type="file" style="margin-top: 0px; cursor: pointer;" id="ifile" multiple name="uploadOpdDocs"> -->
														</div>
													</div>
	...
	<input type="hidden"  id="idRadiologyTestReport" value="0"> <!-- CRUD of ris upload doc, aniket JAN 22 -->
...
<input type="hidden"  id="idTestRadiology" value="<%=request.getParameter("Idradiology")%>"> <!-- radiology test ID , aniket 31 JAN 22-->
