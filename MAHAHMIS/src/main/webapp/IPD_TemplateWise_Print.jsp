...
<%@page import="com.hms.ipd.dto.IpdPatientDischargeSummaryDTO"%>
...
<body>
	<%
		...
		//	int recId=Integer.parseInt(request.getParameter("recId"));
			...
			int pid=Integer.parseInt(request.getParameter("patID"));
		...
		/* 	p.add(new Chunk(" \nCIN: "+cinNo+", GST : "+gstNo , tabletext));	
			...
			HeaderTable2.addCell(new Phrase("    IPD Template Wise ", header));
			HeaderTable2.addCell(new Phrase("", subheader));
			HeaderTable2.addCell(new Phrase("", subheader));
...
// strat History Data
			...
			IPD_DischargeController uss1=(ApplicationContextUtils.getApplicationContext()).getBean(IPD_DischargeController.class);
			IPDDischargeService uss2=(ApplicationContextUtils.getApplicationContext()).getBean(IPDDischargeService.class);			
			IpdPatientDischargeSummaryDTO lstmaster1 = uss2.fetchIPDDischargeSummaryTemplate(treatmentId,pid);
						...
						HeaderTable31.getDefaultCell().setBorder(Rectangle.BOTTOM);
							...
							if(lstmaster1 != null){
					           ...
					           java.util.List<Element> ie1 = HTMLWorker.parseToList(new StringReader(lstmaster1.getTempData()), styleSheet);
					           if(lstmaster1.getTempData().equals("") || lstmaster1.getTempData().equals("NULL")){
					        	   ...
					        	   java.util.List<Element> ie3 = HTMLWorker.parseToList(new StringReader(lstmaster1.getTempData()), styleSheet);
