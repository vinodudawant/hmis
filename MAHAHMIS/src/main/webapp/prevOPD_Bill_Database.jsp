...
<title>Previous OPD Patient Bill</title>
...
<script>
	jQuery(document).ready(function() {
		...
		$("#byName").val("");
		$("#byName").val("");
		getAllPatientRecordsForPrevOPD(0,'-',1);
					...
					<div class="row">
						<div id="content" class="col-lg-12">
							...
							<div class="col-md-12-1">
								...
								<div class="col-md-4 TextFont" id="divbyName">
									<input name="byName" type="text" id="byName" class="form-control input-SmallText" autocomplete="off"
										onkeyup="getPatientAutoDetails(this.id,'prevOpdDD',event)" placeholder="Patient Id,Name,Mobileno"/>																		
								</div>
