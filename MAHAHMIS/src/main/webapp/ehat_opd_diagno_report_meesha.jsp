...
<title>Opd Diagnostic Report</title>
								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="ehat_opd_diagno_report.jsp">Opd Diagnostic Report</a></li>
											<li class="pull-right">
												...
												<button id="btnPrint" class="btn btn-xs btn-warning"
													...
													To Excel</button> <script type="text/javascript">
														...
														//	window.open('data:application/vnd.ms-excel,'+ encodeURIComponent($('div[id$=diveMain]').html()));
													        ...
													        a.download = 'OPD_Diagno_Report_' + postfix + '.xls';
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getOpdDiagnoPatientData();"
										...
										<div class="panel panel-default"
											...
											<div class="panel-body">
												...
												<div id="diveMain" class="col-md-12" style="margin-top: 5px">
													...
													<div id="divLine2" class=" box border col-md-12" style="overflow: auto;height: 350px">
																...
																<table class="datatable table table-bordered table-striped table-condensed cf" id="hisabTbl"
																	...
																	<thead class="cf">
																		<tr>
																			...
																			<th style="height: 21.5px;width: 7%" >Source Name</th>		
																			<th style="height: 21.5px;width: 7%" >Service Group</th>	
