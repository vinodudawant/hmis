...
<title>Schedular Consulting Room</title>
<meta name="viewport"
...
<script src="js/ehat_hr_make_salary.js"></script>
<script>
	jQuery(document).ready(function() {
		App.setPage("Scheduler"); //Set current page
...
<script type="text/javascript">
function getNextId1() {
	var tableName = "ehat_scheduler_room_master";
													...
													<table class='table table-bordered table-condensed cf'
														...
														<thead class='cf'>
															<tr>
																...
																<th class='col-md-1-1 center' style='height: 21.5px;'><div
																		class='TextFont'>Room ID</div></th>
																<th class='col-md-1-1 center' style='height: 21.5px;'><div
																		class='TextFont'>Room Name</div></th>
