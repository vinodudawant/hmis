/*******************************************************************************
 * JS Calendar Copyright (C) September 2006 DTHMLGoodies.com, Alf Magne
 * Kalleland
 * 
...
/*
 * Update log: (C) www.dhtmlgoodies.com, September 2005
 * 
 * Version 1.2, November 8th - 2005 - Added <iframe> background in IE Version
 * 1.3, November 12th - 2005 - Fixed top bar position in Opera 7 Version 1.4,
 * December 28th - 2005 - Support for Spanish and Portuguese Version 1.5,
 * January 18th - 2006 - Fixed problem with next-previous buttons after a month
 * has been selected from dropdown Version 1.6, February 22nd - 2006 - Added
 * variable which holds the path to images. Format todays date at the bottom by
 * use of the todayStringFormat variable Pick todays date by clicking on todays
 * date at the bottom of the calendar Version 2.0 May, 25th - 2006 - Added
 * support for time(hour and minutes) and changing year and hour when holding
 * mouse over + and - options. (i.e. instead of click) Version 2.1 July, 2nd -
 * 2006 - Added support for more date formats(example: d.m.yyyy, i.e. one letter
 * day and month). // Modifications by Gregg Buntin Version 2.1.1 8/9/2007 gfb -
 * Add switch to turn off Year Span Selection This allows me to only have this
 * year & next year in the drop down
 * 
 * Version 2.1.2 8/30/2007 gfb - Add switch to start week on Sunday Add switch
 * to turn off week number display Fix bug when using on an HTTPS page
 * 
 */
...
var showWeekNumber = true; // true = show week number, false = do not show week
// number
...
// [UCFdayString] = day of week (examle: Mon, Tue, Wed...) ( First letter in
// uppercase)
// [day] = Day of month, 1..31
// [monthString] = Name of current month
// [year] = Current year
var todayStringFormat = '[todayString] [UCFdayString]. [day]. [monthString] [year]';
var pathToImages = 'images/dhtmlgoodies_calendar/'; // Relative to your HTML
// file
...
case "en": /* English */
	...
	break;
case "ge": /* German */
	var monthArray = [ 'Januar', 'Februar', 'M�rz', 'April', 'Mai', 'Juni',
			'Juli', 'August', 'September', 'Oktober', 'November', 'Dezember' ];
	var monthArrayShort = [ 'Jan', 'Feb', 'Mar', 'Apr', 'Mai', 'Jun', 'Jul',
			'Aug', 'Sep', 'Okt', 'Nov', 'Dez' ];
	...
	break;
case "no": /* Norwegian */
	var monthArray = [ 'Januar', 'Februar', 'Mars', 'April', 'Mai', 'Juni',
			'Juli', 'August', 'September', 'Oktober', 'November', 'Desember' ];
	var monthArrayShort = [ 'Jan', 'Feb', 'Mar', 'Apr', 'Mai', 'Jun', 'Jul',
			'Aug', 'Sep', 'Okt', 'Nov', 'Des' ];
	var dayArray = [ 'Man', 'Tir', 'Ons', 'Tor', 'Fre', 'L&oslash;r',
			'S&oslash;n' ];
	var weekString = 'Uke';
	var todayString = 'Dagen i dag er';
	break;
case "nl": /* Dutch */
	var monthArray = [ 'Januari', 'Februari', 'Maart', 'April', 'Mei', 'Juni',
			'Juli', 'Augustus', 'September', 'Oktober', 'November', 'December' ];
	var monthArrayShort = [ 'Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun', 'Jul',
			'Aug', 'Sep', 'Okt', 'Nov', 'Dec' ];
	...
	break;
case "es": /* Spanish */
	var monthArray = [ 'Enero', 'Febrero', 'Marzo', 'April', 'Mayo', 'Junio',
			'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre',
			'Diciembre' ];
	var monthArrayShort = [ 'Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul',
			'Ago', 'Sep', 'Oct', 'Nov', 'Dic' ];
...
case "pt-br": /* Brazilian portuguese (pt-br) */
	var monthArray = [ 'Janeiro', 'Fevereiro', 'Mar&ccedil;o', 'Abril', 'Maio',
			'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro',
			'Dezembro' ];
	var monthArrayShort = [ 'Jan', 'Fev', 'Mar', 'Abr', 'Mai', 'Jun', 'Jul',
			'Ago', 'Set', 'Out', 'Nov', 'Dez' ];
	...
	break;
case "fr": /* French */
	var monthArray = [ 'Janvier', 'F�vrier', 'Mars', 'Avril', 'Mai', 'Juin',
			'Juillet', 'Ao�t', 'Septembre', 'Octobre', 'Novembre',
			'D�cembre' ];
	var monthArrayShort = [ 'Jan', 'Fev', 'Mar', 'Avr', 'Mai', 'Jun', 'Jul',
			'Aou', 'Sep', 'Oct', 'Nov', 'Dec' ];
...
case "da": /* Danish */
	...
	var monthArrayShort = [ 'jan', 'feb', 'mar', 'apr', 'maj', 'jun', 'jul',
			'aug', 'sep', 'okt', 'nov', 'dec' ];
	var dayArray = [ 'man', 'tirs', 'ons', 'tors', 'fre', 'l&oslash;r',
			's&oslash;n' ];
	var weekString = 'Uge';
	var todayString = 'I dag er den';
	break;
case "hu": /* Hungarian - Remember to use UTF-8 encoding, i.e. the <meta> tag */
	var monthArray = [ 'Január', 'Február', 'Március', '�?prilis',
			'Május', 'Június', 'Július', 'Augusztus', 'Szeptember',
			'Október', 'November', 'December' ];
	var monthArrayShort = [ 'Jan', 'Feb', 'Márc', '�?pr', 'Máj', 'Jún',
...
case "it": /* Italian */
	var monthArray = [ 'Gennaio', 'Febbraio', 'Marzo', 'Aprile', 'Maggio',
			...
			'Dicembre' ];
	var monthArrayShort = [ 'Gen', 'Feb', 'Mar', 'Apr', 'Mag', 'Giu', 'Lugl',
			'Ago', 'Set', 'Ott', 'Nov', 'Dic' ];
	...
	break;
case "sv": /* Swedish */
	var monthArray = [ 'Januari', 'Februari', 'Mars', 'April', 'Maj', 'Juni',
			'Juli', 'Augusti', 'September', 'Oktober', 'November', 'December' ];
	var monthArrayShort = [ 'Jan', 'Feb', 'Mar', 'Apr', 'Maj', 'Jun', 'Jul',
			'Aug', 'Sep', 'Okt', 'Nov', 'Dec' ];
	var dayArray = [ 'M&aring;n', 'Tis', 'Ons', 'Tor', 'Fre', 'L&ouml;r',
			'S&ouml;n' ];
	var weekString = 'Vecka';
	var todayString = 'Idag &auml;r det den';
	break;
case "cz": /* Czech */
	var monthArray = [ 'leden', '&#250;nor', 'b&#345;ezen', 'duben',
			'kv&#283;ten', '&#269;erven', '&#269;ervenec', 'srpen',
			'z&#225;&#345;&#237;', '&#345;&#237;jen', 'listopad', 'prosinec' ];
	var monthArrayShort = [ 'led', '&#250;n', 'b&#345;', 'dub', 'kv&#283;',
			'&#269;er', '&#269;er-ec', 'srp', 'z&#225;&#345;', '&#345;&#237;j',
			'list', 'pros' ];
...
function writeCalendarContent() {
	...
	calTable.style.cssText = 'float:left';
...
function writeTimeBar() {
	...
	// hourPicker.style.top = monthDiv.offsetTop + monthDiv.offsetHeight + 1 +
	// 'px';
...
//jitendra
function displayCalendarJitendra(inputField, format, buttonObj, displayTime, timeInput) {
