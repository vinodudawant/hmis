...
<meta charset="utf-8">
<title> IPD Deleted Receipt Report </title>
<meta name="viewport"
					...
					<div class="row">
						<div id="content" class="col-lg-12">
								...
								<div class="col-sm-12">
									<div class="page-header" style="height: 92%;">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a
												href="report_ipd_deleted_collection.jsp">IPD Deleted Receipt Report  </a></li>
											<li class="pull-right">
											...
											data-toggle="tooltip" >Export Excel</button>
												<script type="text/javascript">
													$("[id$=btnExportipddel]").click(function(e) {
																		...
																		var table_div = $('#ipddeletedtable').clone();
																		...
																		a.download = 'IPD Deleted Collection Report' + postfix + '.xls';
							...
							<div class="col-md-12">
									...
									<div class="col-md-6">
										<select id="payMode" class="form-control input-SmallText" style="width:100%">
									...
									<div class="divide-20"></div>
										...
										onclick="getIpdCollectionReport('deletedreport')">Search&nbsp;
										<i class="fa fa-search" aria-hidden="true"></i>
										</button> -->
										<button class="btn btn-primary btn-xs" 
										onclick="getIpdRecData('deleted')">Search&nbsp;
										<i class="fa fa-search" aria-hidden="true"></i>
										</button>
									</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="panel panel-primary">
										<div class="panel-heading">IPD Deleted Receipt Report  </div>
										<div class="panel-body">

											<div class="dynamicstructurescroll" >
												<table id="ipddeletedtable"
