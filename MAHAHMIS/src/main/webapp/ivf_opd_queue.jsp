...
<script type="text/javascript" src="js/ivf_opd_queue.js"></script>
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a href="ivf_opd_queue.jsp">IVF Bill Queue</a></li>
										</ul>
										<!-- /BREADCRUMBS -->
																	...
																	<div class="row" style="margin-top: 2px">
																		<div class="col-sm-12">
																			...
																			<div class="col-md-2">
																				<div class="input-group date col-md-12">
																					<div>
																						<select id="doctorName" name="doctorName" class="col-md-12" style="width: 98%;">	</select>
																					</div>
																				</div>
																			</div> -->
																			...
																			<div class="form-group col-md-3">
																				<select class="input-group form-control" onchange="setPatientSearchType()"
																					...
																					<option value="4">Patient Addhar</option>
																				</select>
																			</div>
																			<div class="form-group col-md-3" id="divpatientopd">
																				<input class="form-control input-SmallText"
																					...
																					name="patientopd" onkeyup="setAutoPatientName(this.id,'ivf',event);"
