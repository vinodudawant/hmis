...
<body>
	<%
		...
		//									HeaderTable12.addCell(cellNabh);
			...
			int[] HeaderWidth1 =  {10,12,13,26,16,19,23,20,20,20,25,20};
		...
		/*  if(!(dailycollection.getLstOpdReceipt().get(z).getPayMode().trim()).equalsIgnoreCase("CAdvance")){
		 ...
		 HeaderTable1.addCell(new Phrase(""+dailycollection.getLstOpdReceipt().get(z).getRemark(),tabletext));
		      ...
		      if(dailycollection.getLstOpdReceipt().get(z).getPayMode().trim().equalsIgnoreCase("Cash")){
		      ...
		      if(dailycollection.getLstOpdReceipt().get(z).getPayMode().trim().equalsIgnoreCase("Cheque")){
		      ...
		      if(dailycollection.getLstOpdReceipt().get(z).getPayMode().trim().equalsIgnoreCase("Phone Pay")){
		      ...
		      if(dailycollection.getLstOpdReceipt().get(z).getPayMode().trim().equalsIgnoreCase("Paytm")){
		      ...
		      if(dailycollection.getLstOpdReceipt().get(z).getPayMode().trim().equalsIgnoreCase("RTGS/NEFT")){
		       ...
		       if(dailycollection.getLstOpdReceipt().get(z).getPayMode().trim().equalsIgnoreCase("UPI")){
		...
		//////////////////////////////////////////OPD Total Refund///////////////////////////////////////////////////////		 
		 ...
		 for (int z = 0; z < dailycollection.getLstOpdRefund().size(); z++) {
			 ...
			 if(dailycollection.getLstOpdRefund().get(z).getPayMode().trim().equalsIgnoreCase("Cash")){
		      ...
		      if(dailycollection.getLstOpdRefund().get(z).getPayMode().trim().equalsIgnoreCase("Cheque")){
		      ...
		      if(dailycollection.getLstOpdRefund().get(z).getPayMode().trim().equalsIgnoreCase("Phone Pay")){
		      ...
		      if(dailycollection.getLstOpdRefund().get(z).getPayMode().trim().equalsIgnoreCase("Paytm")){
		      ...
		      if(dailycollection.getLstOpdRefund().get(z).getPayMode().trim().equalsIgnoreCase("UPI")){
		 ...
		 for (int z = 0; z < dailycollection.getLstIpdReceipt().size(); z++) {
			...
			/*  if(!(dailycollection.getLstIpdReceipt().get(z).getPayMode().trim()).equalsIgnoreCase("CAdvance")){
			 ...
			 HeaderTable1.addCell(new Phrase(""+dailycollection.getLstIpdReceipt().get(z).getRemark(),tabletext));
			  ...
			  if(dailycollection.getLstIpdReceipt().get(z).getPayMode().trim().equalsIgnoreCase("Cash")){
		      ...
		      if(dailycollection.getLstIpdReceipt().get(z).getPayMode().trim().equalsIgnoreCase("Cheque")){
		      ...
		      if(dailycollection.getLstIpdReceipt().get(z).getPayMode().trim().equalsIgnoreCase("Phone Pay")){
		      ...
		      if(dailycollection.getLstIpdReceipt().get(z).getPayMode().trim().equalsIgnoreCase("Paytm")){
		      ...
		      if(dailycollection.getLstIpdReceipt().get(z).getPayMode().trim().equalsIgnoreCase("UPI")){
		...
		//////////////////////////////////////////IPD Total Refund///////////////////////////////////////////////////////		
		 ...
		 for (int z = 0; z < dailycollection.getLstIpdRefund().size(); z++) {
			 ...
			 if(dailycollection.getLstIpdRefund().get(z).getPayMode().trim().equalsIgnoreCase("Cash")){
		      ...
		      if(dailycollection.getLstIpdRefund().get(z).getPayMode().trim().equalsIgnoreCase("Cheque")){
		      ...
		      if(dailycollection.getLstIpdRefund().get(z).getPayMode().trim().equalsIgnoreCase("Phone Pay")){
		      ...
		      if(dailycollection.getLstIpdRefund().get(z).getPayMode().trim().equalsIgnoreCase("Paytm")){
		      ...
		      if(dailycollection.getLstIpdRefund().get(z).getPayMode().trim().equalsIgnoreCase("UPI")){
		...
		//////////////////////////////////////////Diagnosis Total Collection///////////////////////////////////////////////////////		 
		 ...
		 for (int z = 0; z < dailycollection.getLstDiagReceipt().size(); z++) {
			...
			/*  if(!(dailycollection.getLstDiagReceipt().get(z).getPayMode().trim()).equalsIgnoreCase("CAdvance")){
			 ...
			 if(dailycollection.getLstDiagReceipt().get(z).getPayMode().trim().equalsIgnoreCase("Cash")){
		      ...
		      if(dailycollection.getLstDiagReceipt().get(z).getPayMode().trim().equalsIgnoreCase("Cheque")){
		      ...
		      if(dailycollection.getLstDiagReceipt().get(z).getPayMode().trim().equalsIgnoreCase("Phone Pay")){
		      ...
		      if(dailycollection.getLstDiagReceipt().get(z).getPayMode().trim().equalsIgnoreCase("Paytm")){
		      ...
		      if(dailycollection.getLstDiagReceipt().get(z).getPayMode().trim().equalsIgnoreCase("UPI")){
		...
		//////////////////////////////////////////Diagnosis Total Refund///////////////////////////////////////////////////////		
		 ...
		 for (int z = 0; z < dailycollection.getLstDiagRefund().size(); z++) {
			 ...
			 if(dailycollection.getLstDiagRefund().get(z).getPayMode().trim().equalsIgnoreCase("Cash")){
		      ...
		      if(dailycollection.getLstDiagRefund().get(z).getPayMode().trim().equalsIgnoreCase("Cheque")){
		      ...
		      if(dailycollection.getLstDiagRefund().get(z).getPayMode().trim().equalsIgnoreCase("Phone Pay")){
		      ...
		      if(dailycollection.getLstDiagRefund().get(z).getPayMode().trim().equalsIgnoreCase("Paytm")){
		      ...
		      if(dailycollection.getLstDiagRefund().get(z).getPayMode().trim().equalsIgnoreCase("UPI")){
	...
	HeaderTable2.addCell(new Phrase("Total Refund Collection:    " + df2.format(TotalRefundCollection), subheader));
