	...
	<c:if test="${ sessionScope.userType != null }">
		...
		<c:if test="${sessionScope.userType != null }">
			...
			<%
		    	...
		    	String CovidReportProfileId = "0";//resourceBundleEha.getObject("CovidReportProfileId").toString();
		    	String SARSCOV2ANTIGEN = "0";//resourceBundleEha.getObject("SARSCOV2ANTIGEN").toString();
		    	String COVID19RNAAMPLIFICATION = "0";//resourceBundleEha.getObject("COVID19RNAAMPLIFICATION").toString();
		    	String REALTIMEHEPATITISCVIRUSHCV = "0";//resourceBundleEha.getObject("REALTIMEHEPATITISCVIRUSHCV").toString();
		    	String REALTIMETRUENAT = "0";//resourceBundleEha.getObject("REALTIMETRUENAT").toString();
		    	
		    	String SARSCoV2RTPCR = "0";//resourceBundleEha.getObject("SARSCoV2RTPCR").toString();		 
		    	String CTVALUEFORCONFIRMATORYGENE = "0";//resourceBundleEha.getObject("CTVALUEFORCONFIRMATORYGENE").toString();
		    	String SARSCOV2 = resourceBundleEha.getObject("SARSCOV2").toString();
		    	String SARSCOV2ANTIGENTest = "0";//resourceBundleEha.getObject("SARSCOV2ANTIGENTest").toString();
		    	String REALTIMEHEPATITISCVIRUSHCVTestId = "0";//resourceBundleEha.getObject("REALTIMEHEPATITISCVIRUSHCVTestId").toString();
		    	String REALTIMETRUENATTestId = "0";//resourceBundleEha.getObject("REALTIMETRUENATTestId").toString();
										...
										<div class="row">
											...
											<div class="col-md-11">
												...
												<div class="col-md-12" style="margin-top: 1%;">
													...
													<div class="col-md-2">
														<div class="form-group">
															<label class="control-label lblBold">Ref.BNo: </label>
															<label class="control-label" id="billNo"></label>
													...
													<div class="col-md-4">
														<div class="form-group">
															<label class="control-label lblBold">Diagonstic No :</label>
														    <label class="control-label" id="digNo"></label>
													...
													<div class="col-md-2">
														<div class="form-group">
															<label class="control-label lblBold">Gender :</label> 
													...
													<div class="col-md-2">
														<div class="form-group">
															<label class="control-label lblBold">Bill No: </label>
															<label class="control-label" id="consultingDoctor"> Vinod-D</label>
													...
													<div class="col-md-2">
														<div class="form-group">
															<label class="control-label lblBold">DOA:</label> 
															<label class="control-label" id="doa"></label>
													...
													<div class="col-md-4">
														<div class="form-group">
															<label class="control-label lblBold">Patient Address :</label>
														    <label class="control-label" id="addressNew">
															</label>
													...
													<div class="col-md-2">
														<div class="form-group">
															<label class="control-label lblBold">Collection Date :</label> 
															<label class="control-label" id="collectionDate"></label>
													...
													<div class="col-md-2">
														<div class="form-group">
															<label class="control-label lblBold">Collection Time :</label> 
															<label class="control-label" id="collectiontime"></label>
													...
													<div class="col-md-2">
														<div class="form-group">
															<label class="control-label lblBold">Accepted Date :</label> 
															<label class="control-label" id="accepteddate"></label>
													...
													<div class="col-md-2">
														<div class="form-group">
															<label class="control-label lblBold">Accepted Time :</label>
															<label class="control-label" id="acceptedtime"></label>
														</div>
													</div>
										...
										<div class="panel-body">
											...
											<div class="form-row">
												...
												<select id="kitSpecId" name="select" style="width:70%;">
													...
													<option value="Truenat HCV Chip Based Real Time PCR Test for Hepatitis C Virus">Truenat HCV Chip Based Real Time PCR Test for Hepatitis C Virus</option>
													<!-- <option value="Malaria Test Kit">Malaria Test Truenat HCV Chip Based Real Time PCR Test for Hepatitis C VirusKit</option>												
												...
												<div class="col-md-4"
													...
													<div class="panel panel-primary">
														<div id="routinevaluedivId" class="panel-body"
															...
															<table
																...
																<thead id="ehatTHead">
																	<tr style="background-color: lightblue">
																		...
																		<th class="col-md-1 center" style="display: none;">Parameter/Micro-organism</th>
																		<th class="col-md-2 center">Test Result</th>
																		<th class="col-md-1 center">Previous Result</th>
																		<th class="col-md-1 center">Normal Values</th>
																		<th class="col-md-1 center">Units</th>
																		<th class="col-md-1 center">Flag</th>
																		<th class="col-md-1 center">Method</th>
															...
															<input type="hidden" value="<%=SARSCoV2RTPCR%>"  id="SARSCoV2RTPCR" />
															<input type="hidden" value="<%=CTVALUEFORCONFIRMATORYGENE%>"  id="CTVALUEFORCONFIRMATORYGENE" />
															...
															<input type="hidden" value="<%=SARSCOV2%>"  id="SARSCOV2" />
															<input type="hidden" value="<%=SARSCOV2ANTIGENTest%>"  id="SARSCOV2ANTIGENTest" />
															
															<input type="hidden" value="<%=REALTIMEHEPATITISCVIRUSHCV%>"  id="REALTIMEHEPATITISCVIRUSHCV" />
															<input type="hidden" value="<%=REALTIMEHEPATITISCVIRUSHCVTestId%>"  id="REALTIMEHEPATITISCVIRUSHCVTestId" />
															
															<input type="hidden" value="<%=REALTIMETRUENAT%>"  id="REALTIMETRUENAT" />
															<input type="hidden" value="<%=REALTIMETRUENATTestId%>"  id="REALTIMETRUENATTestId" />
