...
<meta charset="utf-8">
<title>Maintenance-Contract Master</title>
<meta name="viewport"
...
<body>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="page-header">
										...
										<li><i class="fa fa-home"></i><a href="inv_maintenance_contract_master.jsp"> Maintenance Contract Master</a>
										</ul>
										<!-- /BREADCRUMBS -->
									</div>
								</div>
								...
								<div class="col-md-12">
											...
											<div class="col-md-4">											
												<div class="input-group" >												
													<input type="search" placeholder="search by type" class="form-control" id="searchMaintenanceContractId"> <span
										...
										<button class="btn btn-xs btn-info pull-left editUserAccess" type="button" onclick="toggleEntryDiv('divForEntry')">
											<i class="fa fa-plus"></i> Add New Maintenance-Contract Type
										</button>
									</div>
								</div>
							</div>
											...
											<div class="col-md-12" id="divForEntry" style="display: none;">
												<div class="container">
													<div class="panel panel-primary" style="margin-top: 20px">
														<div class="panel-heading" id="divEhatContent">Maintenance-Contract Form</div>
														<div class="panel-body">
															<form id="financialFormId" onsubmit="return false">
																<div class="form-row">
																	<div class="form-group col-md-3">
																		<label for="inputEmail4"> Type</label> <input
																			type="text" class="form-control" id="maintenanceTypeId"
																			placeholder="Enter Type">
																	</div>
																
																</div>
																<button type="button" class="btn btn-success editUserAccess" onclick="saveMaintenanceContractMaster()" style="margin-top: 15px;">Save</button>
																<button type="button" class="btn btn-warning deleteUserAccess" onclick="refreshMaintenanceContractMaster()" style="margin-top: 15px;">Clear</button>
															</form>
														</div>
												...
												<div class="tabbable header-tabs">
													<div class="row" style="margin-top: 10px">
														<div class="col-md-12">
															...
															<div class="panel panel-primary" style="margin-top: 20px">
																<div class="panel-heading" id="divEhatContent">Maintenance-Contract Data</div>
																<div class="panel-body" style="overflow: auto;height: 300px">
																	<table id="ehatTable" class="datatable table table-striped table-bordered" >
																		...
																		<tbody id="maintenanceContractMasterDetails">
																		</tbody>
																	</table>
																</div>
															</div>
	...
	<script src="ehat-design/js/script.js"></script>
		...
		<input type="hidden" id="maintenanceContractId" value="0">
