...
<meta charset="utf-8">
<title>All Sub Inventory Stock Reports</title>
<meta name="viewport"
									...
									<div class="page-header" style="height: 94%;">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a
												href="inv_all_sub_inventory_reports.jsp">All Sub Inventroy Stock Reports</a></li>
											<li class="pull-right">
												...
												$("[id$=subInventoryExportReport]")
														.click(
																function(e) {
															        ...
															        a.download = 'All_Sub_Inventroy_Stock_Reports_' + postfix + '.xls';
																	...
																	<div class="row">
																		<div class="col-md-12">
																			<div class="panel panel-primary" style="overflow: auto;">
																				<div class="panel-heading" id="divEhatContent">All Sub Store Stock Reports List</div>
																				<div class="panel-body">
