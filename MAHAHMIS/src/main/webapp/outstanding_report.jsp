...
<title>Patient Outstanding Report</title>
						...
						<div class="row">
							<div id="content" class="col-lg-12">
									...
									<div class="col-sm-12">
										<div class="page-header">
											...
											<ul class="breadcrumb col-md-12-1"
												...
												<li><a href="outstanding_report.jsp">Patient Outstanding Report</a></li>
												<li class="pull-right">
													...
													<script type="text/javascript">
														 ...
														 $(document).on('click','#btnExport',function(e) {
														        ...
														        link.download = "Patient Outstanding Report.xls"; //You need to change file_name here.
														        link.href = result;
														        link.click();
														    });
								...
								<div class="panel panel-default" style="margin-top:-16px;">
									...
									<div class="col-md-3" id="fromDateDiv">
														<div class="row">
															<label class="TextFont" style=" margin-left: 18px;">Search By</label> 
									</div>
									
										<select id="search_department" class="form-control input-SmallText" style="width:100%">
											...
											<option value="3">Diagnostic</option>
													...
													<div class="col-md-3">
														...
														title="Show" onclick="fetchOutStandingReport()" type="button">
														<b> Show </b>
														</button>
											...
											<div id="divTestDashVoucherList" class=" box border col-md-12"
												...
												<form class="form-horizontal col-md-12">
													...
													<table border="1"  id="printTable" style="margin-top:20px; width: 100%;" bordercolor="#ddd">
															<%-- <colgroup>
