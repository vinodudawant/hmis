								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a href="">B 2 B Collected</a></li>
								...
								<div class="col-md-12">
									...
									<div class="col-md-2">
										<div class="input-group" id="divbyName"
											...
											<label for="inlineFold" class="control-label"></label> <input
												...
												onkeyup="b2BPatientAutoSuggestion(this.id, 'collected');">
										</div>
									</div>
									...
									<div class=" col-md-1">
										<input type="button" value="Search"
											...
											onclick="searchB2BRecords('collected');"
									...
									<div class="panel">
										<div class="panel-body" style="overflow: auto; height: 460px">
											<div class="col-md-1"
												...
												<input type="button" value="Bulk Submit"
													class="btn btn-xs btn-success " data-toggle="tooltip"
													data-placement="bottom" title="Bulk Submit"
													onclick="bulkSubmit()" />
											</div>
											<table id="ehatTable" class="datatable table  table-bordered" style="margin-top:1%">
												<thead id="ehatTHead">
													<tr style="background-color: lightblue">
														...
														<th class="col-md-1 center">Submit</th>
												...
												<tbody id="collectedRecordTableBody">
												</tbody>
											</table>
										</div>
									</div>
								...
								<div style="margin-top: -1%">
									<div class="" align="right">
										<ul class="pagination pagination-blue margin-bottom-10"
											id="collectedJumpToPage">
										</ul>
										<ul class="pagination pagination-blue margin-bottom-10"
											id="collectedPagination">
										</ul>
										<ul class="pagination pagination-blue margin-bottom-10"
											id="collectedNumberOfPages">
										</ul>
									</div>
								</div>
								<!--   Ending  pagination -->
																...
																<div class="col-md-12" style="font-weight: bold;">
																	...
																	<div id="reCollectionDiv" class="form-group col-md-2"
																		...
																		<input type="button" value="Reject"
																			...
																			id="rejectid"
																			onclick="rejectSample('collected')" />
																	</div>
																	...
																	<div id="closeDiv" class="form-group col-md-2"
																		...
																		<input type="button" value="close"
																			...
																			id="closeId"
																			onclick="closeRejectPopup('collected')" />
																	</div>
																</div>
