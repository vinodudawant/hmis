(function(X, Q) {
    "object" === typeof module && module.exports ? (Q["default"] = Q, module.exports = X.document ? Q(X) : Q) : "function" === typeof define && define.amd ? define("highcharts/highcharts", function() {
        return Q(X)
    }) : (X.Highcharts && X.Highcharts.error(16, !0), X.Highcharts = Q(X))
    ...
    Q(A, "parts/Utilities.js", [A["parts/Globals.js"]], function(d) {
        ...
        function K(a, c) {
            ...
            for (a = k.pop();
                "undefined" !==
                typeof a && "undefined" !== typeof c && null !== c;) c = c[a], a = k.pop();
            return c
        }
        d.timers = [];
        var J = d.charts,
            ...
            H = function() {
                ...
                a.prototype.update = function() {
                    ...
                    else a.attr ? a.element && a.attr(c, k, null, !0) : a.style[c] = k + this.unit;
                    r && r.call(a, k, this)
                };
                a.prototype.run = function(a, c, k) {
                    ...
                    a !== c || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date, this.start = a, this.end = c, this.unit = k, this.now =
                ...
                a.prototype.step = function(a) {
                    var c = +new Date,
                        ...
                        z = k.duration,
                        b = k.curAnim;
                    if (r.attr && !r.element) a = !1;
                    else if (a || c >= z + this.startTime) {
                        this.now = this.end;
                        this.pos = 1;
                        this.update();
                        var l = b[this.prop] = !0;
                        ...
                        l && e && e.call(r);
                        a = !1
                    } else this.pos = k.easing((c -
                        this.startTime) / z), this.now = this.start + (this.end - this.start) * this.pos, this.update(), a = !0;
                    return a
                };
        ...
        var n = d.isDOMElement = function(a) {
            ...
            t = d.isClass = function(a) {
                ...
                return !(!E(a, !0) || n(a) || !c || !c.name || "Object" ===
                    c.name)
            },
        ...
        var p = d.css = function(a, c) {
            ...
            S = d.format = function(a, c, k) {
                ...
                for (k = k && k.numberFormatter || T; a;) {
                    ...
                    if (e) {
                        p = p.split(":");
                        r = K(p.shift() || "", c);
                        if (p.length && "number" === typeof r)
                            if (p = p.join(":"), b.test(p)) {
            ...
            B = d.normalizeTickInterval = function(a, c, k, r, e) {
                ...
                var b = a / k;
                c || (c = e ? [1,
                    1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10
                ] : [1, 2, 2.5, 5, 10], !1 === r && (1 === k ? c = c.filter(function(a) {
                    return 0 === a % 1
                }) : .1 >= k && (c = [1 / k])));
            ...
            c = d.stableSort = function(a, c) {
                var k = a.length,
                    r, e;
                for (e = 0; e < k; e++) a[e].safeI = e;
                a.sort(function(a, k) {
                    r = c(a, k);
                    return 0 === r ? a.safeI - k.safeI : r
                });
                for (e = 0; e < k; e++) delete a[e].safeI
            },
            ...
            T = d.numberFormat = function(a, c, k, r) {
                ...
                if (-1 === c) c = Math.min(z, 20);
                else if (!N(c)) c = 2;
                else if (c && b[1] && 0 > b[1]) {
                    var l = c + +b[1];
                    0 <= l ? (b[0] = (+b[0]).toExponential(l).split("e")[0], c = l) : (b[0] = b[0].split(".")[0] || 0, a = 20 > c ? (b[0] * Math.pow(10, b[1])).toFixed(c) :
                        0, b[1] = 0)
                }
        ...
        var ca = d.getStyle = function(a, c, k) {
                if ("width" === c) return c = Math.min(a.offsetWidth, a.scrollWidth), k = a.getBoundingClientRect &&
                    a.getBoundingClientRect().width, k < c && k >= c - 1 && (c = Math.floor(k)), Math.max(0, c - d.getStyle(a, "padding-left") - d.getStyle(a, "padding-right"));
            ...
            ea = d.removeEvent = function(a, c, k) {
                ...
                function e(k) {
                    ...
                    if (a.nodeName) {
                        ...
                        Z(z, function(a, c) {
                            if (k[c])
                                for (e = k[c].length; e--;) r(c, k[c][e].fn)
                        })
                    }
                }
                var z;
                ["protoEvents", "hcEvents"].forEach(function(b,
                    l) {
                ...
                if (L.createEvent && (a.dispatchEvent || a.fireEvent)) {
                    ...
                    function(c, r) {
                        ...
                        var e = 0,
                            b = 0,
                            l = c.length + r.length;
                        for (z = 0; z < l; z++) !1 === (c[e] ? r[b] ? c[e].order <= r[b].order ? c[e++] : r[b++] : c[e++] : r[b++]).fn.call(a, k) && k.preventDefault()
        ...
        f = function() {
            ...
            d.prototype.brighten = function(d) {
                ...
                if (this.stops) this.stops.forEach(function(f) {
                    ...
                    for (f = 0; 3 > f; f++) x[f] += M(255 * d), 0 > x[f] && (x[f] = 0), 255 < x[f] &&
                        (x[f] = 255);
                return this
            };
    ...
    Q(A, "parts/SVGElement.js",
        [A["parts/Color.js"], A["parts/Globals.js"], A["parts/Utilities.js"]],
        function(d, f, E) {
            var q = f.deg2rad,
                M = f.doc,
                K = f.hasTouch,
            ...
            E = function() {
                ...
                B.prototype.applyTextOutline = function(c) {
                    var a = this.element,
                        k; - 1 !== c.indexOf("contrast") && (c = c.replace(/contrast/g, this.renderer.getContrast(a.style.fill)));
                    c = c.split(" ");
                    var r = c[c.length - 1];
                ...
                B.prototype.attr = function(c, a, k, r) {
                    var e = this.element,
                        b, l = this,
                        g, h, p = this.symbolCustomAttribs;
                ...
                B.prototype.complexColor = function(c, a, k) {
                    ...
                    g(this.renderer, "complexColor", {
                        ...
                        if (b) {
                            ...
                            "radialGradient" === b && O &&
                                !N(l.gradientUnits) && (p = l, l = I(l, r.getRadialAttr(O, p), {
                                    gradientUnits: "userSpaceOnUse"
                                }));
                            u(l, function(a, c) {
                                "id" !== c && t.push(c, a)
                ...
                B.prototype.css = function(c) {
                    ...
                    if (l) {
                        ...
                        if (c)
                            ...
                            else if ("text" === r.nodeName.toLowerCase() && c.width) var h = this.textWidth = G(c.width);
                        this.styles = c;
                ...
                B.prototype.dashstyleSetter = function(c) {
                    ...
                    if (c = c && c.toLowerCase()) {
                        ...
                        for (c = k.length; c--;) k[c] = "" + G(k[c]) * y(a, NaN);
                ...
                B.prototype.destroy = function() {
                    var c = this,
                        ...
                        e = a.ownerSVGElement;
                    a.onclick = a.onmouseout = a.onmouseover = a.onmousemove = a.point =
                        null;
                    S(c);
                    if (c.clipPath && e) {
                        var b = c.clipPath;
                    ...
                    if (c.stops) {
                        for (e = 0; e < c.stops.length; e++) c.stops[e].destroy();
                        c.stops.length = 0;
                        c.stops = void 0
                    }
                    c.safeRemoveChild(a);
                    for (k.styledMode || c.destroyShadows(); r && r.div && 0 === r.div.childNodes.length;) a = r.parentGroup, c.safeRemoveChild(r.div), delete r.div, r = a;
                    c.alignTo && m(k.alignedObjects,
                        c);
                    u(c, function(a, k) {
                ...
                B.prototype.getBBox = function(c, a) {
                    ...
                    if (!k) {
                        ...
                        r.isSVG &&
                            (c = k.width, r = k.height, u && (k.height = r = {
                                "11px,17": 14,
                                "13px,20": 16
                        ...
                        if (v && 0 < k.height) {
                            for (; 250 < p.length;) delete h[p.shift()];
                            h[v] || p.push(v);
                            h[v] = k
                        }
                    }
                ...
                B.prototype.setTextPath = function(c, a) {
                    ...
                    if (c && a && a.enabled) {
                        ...
                        var h = b.element;
                        (a = c.element.getAttribute("id")) || c.element.setAttribute("id",
                            a = R());
                        if (l)
                            for (c = k.getElementsByTagName("tspan"); c.length;) c[0].setAttribute("y", 0), p(g.dx) && c[0].setAttribute("x", -g.dx), h.appendChild(c[0]);
                        e && b && b.add({
                ...
                B.prototype.strokeSetter = function(c, a, k) {
                    this[a] = c;
                    this.stroke && this["stroke-width"] ? (B.prototype.fillSetter.call(this, this.stroke, "stroke", k), k.setAttribute("stroke-width",
                ...
                B.prototype.strokeWidth = function() {
                    ...
                    var c = this.getStyle("stroke-width"),
                        a = 0;
                    if (c.indexOf("px") === c.length - 2) a = G(c);
                    else if ("" !== c) {
                ...
                B.prototype.updateShadows = function(c, a, k) {
                    var r = this.shadows;
                    if (r)
                        for (var e = r.length; e--;) k.call(r[e], "height" === c ? Math.max(a - (r[e].cutHeight || 0), 0) : "d" === c ? this.d : a, c, r[e])
                };
                B.prototype.updateTransform = function() {
                    ...
                    e ? c.push("rotate(90) scale(-1,1)") : b && c.push("rotate(" + b + " " + y(this.rotationOriginX, g.getAttribute("x"), 0) + " " +
                        y(this.rotationOriginY, g.getAttribute("y") || 0) + ")");
                ...
                B.prototype.zIndexSetter = function(c, a) {
                    ...
                    if (g) {
                        ...
                        for (h = a.length - 1; 0 <= h && !l; h--) {
                            ...
                            var p = !N(g);
                            if (r !== b)
                                if (0 > c && p && !k && !h) e.insertBefore(b, a[h]), l = !0;
                                else if (G(g) <= c || p && (!N(c) || 0 <= c)) e.insertBefore(b, a[h + 1] || null), l = !0
                        }
    ...
    Q(A, "parts/SvgRenderer.js", [A["parts/Color.js"], A["parts/Globals.js"],
        A["parts/SVGElement.js"], A["parts/Utilities.js"]
    ], function(d, f, E, q) {
        var M = d.parse,
            K = q.addEvent,
            J = q.attr,
        ...
        C(d.prototype, {
            ...
            init: function(a, k, r, e, b, l, g) {
                ...
                e = z.element;
                a.appendChild(e);
                J(a, "dir", "ltr"); - 1 === a.innerHTML.indexOf("xmlns") && J(e, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = e;
                this.boxWrapper = z;
                this.alignedObjects = [];
                ...
                this.setSize(k, r, !1);
                var h;
                u && a.getBoundingClientRect && (k = function() {
                    x(a, {
                        left: 0,
                        top: 0
                    });
            ...
            truncate: function(a, c, r, e, b, l, g) {
                var k = this,
                    z = a.rotation,
                    h, p = e ? 1 : 0,
                    u = (r || e).length,
                ...
                if (n = b + U > l) {
                    for (; p <= u;) P = Math.ceil((p + u) / 2), e && (h = g(e, P)), U = y(P, h && h.length - 1), p === u ? p = u + 1 : U > l ? u = P - 1 : p = P;
            ...
            buildText: function(a) {
                ...
                var f = function(a) {
                        var k;
                        r.styledMode || (k = /(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize :
                            d || r.style.fontSize || 12);
                                ...
                                if (" " !== k) {
                                    ...
                                    if (n) {
                                        ...
                                        if (t) u = r.truncate(a, p, k, void 0, 0, Math.max(0, n - parseInt(d || 12, 10)), function(a, c) {
                                            ...
                                            for (; O.length;) O.length && !G && 0 < P && (p = I.createElementNS(R, "tspan"), J(p, {
                                                    dy: y,
                                                    x: v
                                                }), m && J(p, "style", m), p.appendChild(I.createTextNode(O.join(" ").replace(/- /g, "-"))), c.appendChild(p)),
                                                r.truncate(a, p, null, O, 0 === P ? g : 0, n, function(a, c) {
            ...
            button: function(a, c, r, e, b, l, g, h, p, u) {
                ...
                if (m) {
                    ...
                    ["width", "height"].forEach(function(a) {
                        P[a + "Setter"] = function(a, c) {
                            ...
                            this[c] = a;
                            F(r) && (g && "within" === g.backgroundSize && this.width && this.height && (r = Math.round(r * Math.min(this.width / this.imgwidth, this.height / this.imgheight))), this.element && this.element.setAttribute(c,
            ...
            symbols: {
                ...
                "triangle-down": function(a, c, r, e) {
                    return [
                        ["M", a, c],
                        ["L", a + r, c],
                        ["L", a + r / 2, c + e],
                ...
                callout: function(a, c, r, e, b) {
                    ...
                    var h = [
                        ["M", a + k, c],
                        ["L", a + r - k, c],
                        ["C", a + r, c, a + r, c, a + r, c + k],
                        ["L", a + r, c + e - k],
                        ["C", a + r, c + e, a + r, c + e, a + r - k, c + e],
                        ["L", a + k, c + e],
                        ["C", a, c + e, a, c + e, a, c + e - k],
                        ["L", a, c + k],
                        ["C", a, c, a, c, a + k, c]
                    ];
                    g && g > r ? b > c + l && b < c + e - l ? h.splice(3, 1, ["L", a + r, b - 6], ["L", a + r + 6, b], ["L", a + r, b + 6], ["L", a + r, c + e - k]) : h.splice(3, 1, ["L", a + r, e / 2], ["L", g, b], ["L", a + r, e / 2], ["L", a + r, c + e - k]) : g && 0 > g ? b > c + l && b < c + e - l ? h.splice(7, 1, ["L", a, b + 6], ["L", a - 6, b], ["L", a, b - 6], ["L", a, c + k]) : h.splice(7, 1, ["L", a, e / 2], ["L", g, b], ["L", a, e / 2],
                        ["L", a, c + k]) : b && b > e && g > a + l && g < a + r - l ? h.splice(5, 1, ["L", g + 6, c + e], ["L", g, c + e + 6], ["L", g - 6, c + e], ["L", a + k, c + e]) : b && 0 > b && g > a + l && g < a + r - l && h.splice(1, 1, ["L", g - 6, c], ["L", g, c - 6], ["L", g + 6, c], ["L", r - k, c]);
                    return h
                }
            },
            clipRect: function(a, c, r, b) {
                var k = e() + "-",
            ...
            pathToSegments: function(a) {
                for (var c = [], e = [], b = {
                        ...
                        T: 3,
                        V: 2
                    }, l = 0; l < a.length; l++) t(e[0]) && w(a[l]) && e.length === b[e[0].toUpperCase()] && a.splice(l, 0, e[0].replace("M", "L").replace("m", "l")), "string" === typeof a[l] && (e.length && c.push(e.slice(0)), e.length = 0), e.push(a[l]);
                c.push(e.slice(0));
                return c
            },
            label: function(a, c, e, b, l, g, h, p, u) {
                var k = this,
                    r = k.styledMode,
                ...
                z.on = function(a, c) {
                    ...
                    if (k) {
                        var e = function(e) {
                            ("mouseenter" === a || "mouseleave" === a) && e.relatedTarget instanceof Element && (z.element.contains(e.relatedTarget) || k.element.contains(e.relatedTarget)) || c.call(z.element, e)
                        };
                        k.on(a, e)
                    }
    ...
    Q(A, "parts/Html.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        J(D.prototype, {
            ...
            htmlUpdateTransform: function() {
                if (this.added) {
                    ...
                    if ("SPAN" === t.tagName) {
                        ...
                        I !== this.cTT &&
                            (p = n.fontMetrics(t.style.fontSize, t).b, !K(e) || e === (this.oldRotation || 0) && v === this.oldAlign || this.setSpanRotation(e, h, p), this.getSpanCorrection(!K(e) && this.textPxLength || t.offsetWidth, p, h, e, v));
                        M(t, {
            ...
            getSpanCorrection: function(n, t, d) {
                this.xCorr = -n * d;
                this.yCorr = -t
            }
        });
            ...
            html: function(n, t, d) {
                ...
                v && (m.add = function(e) {
                    ...
                    if (this.parentGroup = e) {
                        var v = e.div;
                        if (!v) {
                            for (; e;) l.push(e), e = e.parentGroup;
    ...
    Q(A, "parts/Tick.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        f = function() {
            ...
            d.prototype.addLabel = function() {
                ...
                d = t.labelFormatter.call(n.formatCtx,
                    this.formatCtx);
            ...
            d.prototype.getLabelPosition = function(n, t, d, m, b, g, v, h) {
                var e = this.axis,
                    ...
                    f = {};
                M(y) || (y = 0 === e.side ? d.rotation ? -8 : -d.getBBox().height : 2 === e.side ?
                    u.y + 8 : Math.cos(d.rotation * D) * (u.y - d.getBBox(!1, 0).height / 2));
            ...
            d.prototype.handleOverflow = function(n) {
                ...
                var h = this.label,
                    ...
                    y = 1,
                    G, w = {};
                if (e || "justify" !== C(f.overflow, "justify")) 0 > e && m - p * l < v ? G = Math.round(m / Math.cos(e * D) - v) : 0 < e && m + p * l > g && (G = Math.round((b - m) / Math.cos(e *
                    D)));
                else if (b = m + (1 - p) * l, m - p * l < v ? u = n.x + u * (1 - p) - v : b > g && (u = g - n.x + u * p, y = -1), u = Math.min(I, u), u < I && "center" === d.labelAlign && (n.x += y * (I - u - p * (I - Math.min(l, u)))), l > u || d.autoRotation && (h.styles || {}).width) G = u;
            ...
            d.prototype.moveLabel = function(n, d) {
                var t = this,
                    ...
                    v = g.reversed,
                    h = g.chart.inverted;
                m && m.textStr === n ? (t.movedLabel = m, b = !0, delete t.label) : H(g.ticks,
                    function(e) {
            ...
            d.prototype.renderGridLine = function(n, d, f) {
                var m = this.axis,
                    ...
                    y = b[I + "LineColor"];
                b = b[I + "LineDashStyle"];
                g || (m.chart.styledMode || (v.stroke = y, v["stroke-width"] = u, b && (v.dashstyle = b)), e || (v.zIndex =
                    1), n && (d = 0), this.gridLine = g = l.path().attr(v).addClass("highcharts-" + (e ? e + "-" : "") + "grid-line").add(m.gridGroup));
            ...
            d.prototype.renderMark = function(n, d, f) {
                ...
                b = b[h + "Color"];
                e && (m.opposite && (e[0] = -e[0]), l &&
                    (this.mark = p = g.path().addClass("highcharts-" + (v ? v + "-" : "") + "tick").add(m.axisGroup), m.chart.styledMode || p.attr({
                        stroke: b,
                        "stroke-width": u
                    })), p[l ? "attr" : "animate"]({
            ...
            d.prototype.renderLabel = function(n, d, f, m) {
                ...
                var l = !0,
                    I = n.x;
                n = n.y;
                h && x(I) && (h.xy = n = this.getLabelPosition(I, n, h, g, e, b, m, p), this.isFirst && !this.isLast && !C(v.showFirstLabel,
    ...
    Q(A, "parts/Time.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        f = function() {
            ...
            f.prototype.dateFormat = function(n, f, w) {
                ...
                L(m, function(e, l) {
                    for (; - 1 !== n.indexOf("%" + l);) n = n.replace("%" + l, "function" === typeof e ? e.call(b, f) : e)
                });
            ...
            f.prototype.getTimeTicks = function(d, f, w, m) {
                ...
                if (E(f)) {
                    ...
                    e >= C.day && b.set("Date", h, e >= C.month ? 1 : Math.max(1,
                        p * Math.floor(b.get("Date", h) / p)));
                    if (e >= C.month) {
                    ...
                    f = h.getTime();
                    for (h = 1; f < w;) g.push(f), f = e === C.year ? b.makeTime(n + h * p,
                        0) : e === C.month ? b.makeTime(n, m + h * p) : !l || e !== C.day && e !== C.week ? l && e === C.hour && 1 < p ? b.makeTime(n, m, u, y + h * p) : f + e * p : b.makeTime(n, m, u + h * p * (e === C.day ? 1 : 7)), h++;
                    g.push(f);
    ...
    Q(A, "parts/Options.js", [A["parts/Globals.js"],
        A["parts/Time.js"], A["parts/Color.js"], A["parts/Utilities.js"]
    ], function(d, f, E, q) {
        E = E.parse;
        var M = q.merge;
        d.defaultOptions = {
    ...
    Q(A, "parts/Axis.js", [A["parts/Color.js"], A["parts/Globals.js"], A["parts/Tick.js"], A["parts/Utilities.js"]], function(d, f, E, q) {
        ...
        q = function() {
            ...
            B.prototype.init = function(c, a) {
                ...
                a = e.options.events; - 1 === c.axes.indexOf(e) && (k ? c.axes.splice(c.xAxis.length, 0, e) : c.axes.push(e),
                    c[e.coll].push(e));
                e.series = e.series || [];
            ...
            B.prototype.defaultLabelFormatter = function() {
                ...
                var m = this.chart,
                    u = m.numberFormatter;
                if (p) var v = t(p, this, m);
                else if (e) v = a;
                else if (b) v = k.dateFormat(b, a);
                else if (h && 1E3 <= c)
                    for (; h-- && "undefined" === typeof v;) k = Math.pow(l, h + 1), c >= k && 0 === 10 * a % k && null !== g[h] && 0 !== a && (v = u(a / k, -1) +
                        g[h]);
            ...
            B.prototype.getPlotLinePath = function(c) {
                ...
                var k = this,
                    ...
                    v = c.lineWidth,
                    d = c.force,
                    y, O, f, I, G = p && e.oldChartHeight || e.chartHeight,
                ...
                n(this, "getPlotLinePath", c, function(c) {
                    ...
                    c.path = B && !d ? null : e.renderer.crispLine([
                        ["M", y, O],
                        ["L", f, I]
                    ], v || 1)
                });
            ...
            B.prototype.getMinorTickPositions = function() {
                ...
                if (g && g / k < this.len / 3) {
                    ...
                    else if (this.dateTime && "auto" === this.getMinorTickInterval()) e = e.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(k), l, b, c.startOfWeek));
                    else
                        for (c = l + (a[0] - l) % k; c <= b && c !== e[0]; c += k) e.push(c)
                }
            ...
            B.prototype.setAxisTranslation = function(c) {
                ...
                if (d || m || b) {
                    ...
                    p ? (g = p.minPointOffset, h = p.pointRangePadding) : a.series.forEach(function(c) {
                        ...
                        b = Math.max(b, e);
                        if (!a.single || m) c = c.is("xrange") ? !d : d, g = Math.max(g, c && v(k) ? 0 : e / 2), h = Math.max(h,
                            c && "on" === k ? 0 : e)
                    });
            ...
            B.prototype.setTickInterval = function(c) {
                ...
                a.adjustForMinRange();
                !(f || a.axisPointRange || a.stacking && a.stacking.usePercentage || m) && H(a.min) && H(a.max) && (k = a.max - a.min) && (!H(G) && v && (a.min -= k * v), !H(t) && u && (a.max +=
                    k * u));
                ...
                a.tickInterval = a.min === a.max || "undefined" === typeof a.min || "undefined" ===
                    typeof a.max ? 1 : m && !d && y === a.linkedParent.options.tickPixelInterval ? d = a.linkedParent.tickInterval : l(d, this.tickAmount ? (a.max - a.min) / Math.max(this.tickAmount - 1, 1) : void 0, f ? 1 : (a.max - a.min) * y / Math.max(a.len, y));
                ...
                a.pointRange && !d && (a.tickInterval = Math.max(a.pointRange,
                    a.tickInterval));
            ...
            B.prototype.setTickPositions = function() {
                ...
                !e && (this.ordinal && this.ordinal.positions || !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len,
                    ...
                    [this.min, this.max]))) && (this.tickPositions = e = b);
            ...
            B.prototype.trimTicks = function(c, a, e) {
                ...
                if (!this.isLinked) {
                    if (a && -Infinity !==
                        ...
                        for (; this.min - l > c[0];) c.shift();
                    if (e) this.max = b;
                    else
                        for (; this.max + l < c[c.length - 1];) c.pop();
            ...
            B.prototype.adjustTickAmount = function() {
                var c = this.options,
                    ...
                    g = this.finalTickAmt,
                    h = e && e.length,
                    p = l(this.threshold, this.softThreshold ?
                        0 : null),
                    m;
                if (this.hasData()) {
                    if (h < b) {
                        for (m = this.min; e.length < b;) e.length % 2 || m === p ? e.push(F(e[e.length - 1] + a)) : e.unshift(F(e[0] - a));
                        this.transA *= (h - 1) / (b - 1);
                    ...
                    if (H(g)) {
                        for (a = c = e.length; a--;)(3 === g && 1 === a % 2 || 2 >= g && 0 < a && a < c - 1) && e.splice(a, 1);
            ...
            B.prototype.setScale = function() {
                ...
                (c = this.len !== this.oldAxisLength) || a || e || this.isLinked || this.forceRedraw || this.userMin !== this.oldUserMin || this.userMax !== this.oldUserMax || this.alignToOthers() ? (this.stacking && this.stacking.resetStacks(), this.forceRedraw = !1, this.getSeriesExtremes(), this.setTickInterval(), this.oldUserMin = this.userMin, this.oldUserMax = this.userMax,
                    this.isDirty || (this.isDirty = c || this.min !== this.oldMin || this.max !== this.oldMax)) : this.stacking && this.stacking.cleanStacks();
            ...
            B.prototype.setAxisSize = function() {
                var c = this.chart,
                    ...
                    e = a.offsets || [0, 0, 0, 0],
                    b = this.horiz,
                    g = this.width = Math.round(I(l(a.width,
                        c.plotWidth - e[3] + e[1]), c.plotWidth)),
            ...
            B.prototype.getSlotWidth = function(c) {
                ...
                if (!b) {
                    c = null === (a = null === l || void 0 === l ? void 0 :
                        l.style) || void 0 === a ? void 0 : a.width;
            ...
            B.prototype.renderUnsquish = function() {
                ...
                if (this.autoRotation) f > m && f > d.h ? u.rotation = this.labelRotation : this.labelRotation = 0;
                else if (p) {
                    var n = m;
                    if (!y) {
                        var I = "clip";
                ...
                u.rotation && (n = f > .5 * c.chartHeight ? .33 * c.chartHeight :
                    f, y || (I = "ellipsis"));
            ...
            B.prototype.addTitle = function(c) {
                ...
                this.axisTitle || ((g = l.textAlign) || (g = (e ? {
                    ...
                    middle: "center",
                    high: b ? "left" : "right"
                })[l.align]), this.axisTitle = a.text(l.text,
                    0, 0, l.useHTML).attr({
                    zIndex: 7,
            ...
            B.prototype.getOffset = function() {
                ...
                c.axisGroup || (c.gridGroup = e.g("grid").attr({
                    ...
                    " " + (w || "")).add(S), c.labelGroup = e.g("axis-labels").attr({
                    zIndex: I.zIndex || 7
                ...
                }), c.staggerLines && (G *= c.staggerLines), c.labelOffset = G * (c.opposite ?
                    -1 : 1)) : p(h, function(a, c) {
                    a.destroy();
                    delete h[c]
                });
            ...
            B.prototype.getLinePath = function(c) {
                ...
                return a.renderer.crispLine([
                    ["M", l ? this.left : g, l ? b : this.top],
                    ["L", l ? a.chartWidth -
                        this.right : g, l ? b : a.chartHeight - this.bottom
                    ]
                ], c)
            };
            ...
            B.prototype.destroy = function(c) {
                ...
                for (b in a.plotLinesAndBandsGroups) a.plotLinesAndBandsGroups[b] = a.plotLinesAndBandsGroups[b].destroy();
                p(a, function(c, e) {
        ...
        var E = f.addEvent,
            ...
            J = function() {
                ...
                d.prototype.getLogTickPositions = function(d, f, H, C) {
                    ...
                    if (.5 <= d) d = Math.round(d), t = x.getLinearTickPositions(d, f, H);
                    else if (.08 <= d) {
                        n =
                            Math.floor(f);
                        var N, m;
        ...
        f = function() {
            ...
            d.compose = function(d) {
                ...
                E(d, "init", function(d) {
                    ...
                    "logarithmic" !== d.userOptions.type ? this.logarithmic = void 0 : (f || (f = this.logarithmic = new J(this)), this.log2lin !==
    ...
    Q(A, "parts/PlotLineOrBand.js", [A["parts/Globals.js"], A["parts/Axis.js"], A["parts/Utilities.js"]], function(d, f, E) {
            ...
            D = function() {
                ...
                f.prototype.render = function() {
                    ...
                    var c = {},
                        a = t.chart.renderer,
                        k = l ? "bands" : "lines";
                    m && (e = m.log2lin(e), h = m.log2lin(h), p =
                        m.log2lin(p));
                    ...
                    else if (l) G = t.getPlotBandPath(e,
                        h, b);
                    else return;
        ...
        x(f.prototype, {
            ...
            removePlotBandOrLine: function(d) {
                for (var f = this.plotLinesAndBands, t = this.options, w = this.userOptions, m = f.length; m--;) f[m].id === d && f[m].destroy();
                [t.plotLines || [], w.plotLines || [], t.plotBands || [], w.plotBands || []].forEach(function(b) {
                    for (m = b.length; m--;)(b[m] || {}).id === d && L(b, b[m])
                })
            },
            ...
            m = function() {
                ...
                b.prototype.getAnchor = function(b, d) {
                    var g = this.chart,
                        ...
                        v, n;
                    b = w(b);
                    this.followPointer && d ? ("undefined" === typeof d.chartX && (d = e.normalize(d)),
                        b = [d.chartX - m, d.chartY - l]) : b[0].tooltipPos ? b = b[0].tooltipPos : (b.forEach(function(e) {
                        v = e.series.yAxis;
                        n = e.series.xAxis;
                ...
                b.prototype.getLabel = function() {
                    ...
                    if (!this.label) {
                        ...
                        this.split ?
                            this.label = e.g(f) : (this.label = e.label("", 0, 0, l.shape || "callout", null, null, l.useHTML, null, f).attr({
                                padding: l.padding,
                                r: l.borderRadius
                            }), p || this.label.attr({
                ...
                b.prototype.getPosition = function(b, d, h) {
                    var e = this.chart,
                        ...
                        k = function(k) {
                            var l = "x" === k;
                            return [k, l ? v : n, l ? b : d].concat(f ? [l ? c(b) : a(d), l ? t.left - g + c(h.plotX + e.plotLeft) : t.top - g + a(h.plotY + e.plotTop), 0, l ? v : n] : [l ? b : d, l ? h.plotX + e.plotLeft : h.plotY + e.plotTop, l ? e.plotLeft : e.plotTop, l ? e.plotLeft + e.plotWidth : e.plotTop + e.plotHeight])
                        },
                        r = k("y"),
                        z = k("x"),
                        w = !this.followPointer && D(h.ttBelow, !e.inverted === !!h.negative),
                        x = function(e, b, k, h, p, r, d) {
                            var u =
                                "y" === e ? a(g) : c(g),
                                f = (k - h) / 2,
                                v = h < p - g,
                            ...
                            else if (v) l[e] = Math.min(d - h, 0 > z - m ? z : z - m);
                            else if (y) l[e] = Math.max(r, p + m + k > b ? p : p + m);
                            else return !1
                        },
                        C = function(a, c, e, b, k) {
                            var h;
                ...
                b.prototype.move = function(b, d, h, e) {
                    ...
                    g.getLabel().attr(l);
                    g.drawTracker();
                    m && (f.clearTimeout(this.tooltipTimeout),
                    ...
                    if (this.followPointer ||
                        ...
                        if (d && h) {
                            ...
                            this.tracker ? this.tracker.attr(e) :
                                (this.tracker = d.renderer.rect(e).addClass("highcharts-tracker").add(d), b.styledMode || this.tracker.attr({
                                    fill: "rgba(0,0,0,0)"
                                }))
                        }
                    }
                ...
                b.prototype.updatePosition =
                    function(b) {
                        ...
                        this.move(Math.round(b.x), Math.round(b.y || 0),
                            d, l)
                    };
                return b
            }();
    ...
    Q(A, "parts/Pointer.js", [A["parts/Globals.js"], A["parts/Utilities.js"], A["parts/Tooltip.js"], A["parts/Color.js"]], function(d, f, E, q) {
        ...
        f = function() {
            ...
            f.prototype.drag = function(b) {
                ...
                if (!c || !c.touch)
                    if (l < v ? l = v : l > v + t && (l = v + t), g < n ? g = n : g > n + B && (g = n + B), this.hasDragged = Math.sqrt(Math.pow(a - l, 2) + Math.pow(k - g, 2)), 10 < this.hasDragged) {
            ...
            f.prototype.findNearestKDPoint = function(b, e, g) {
                ...
                b.forEach(function(b) {
                    ...
                    if ((l = D(b, !0)) && !(l = !D(d, !0))) {
                        ...
                        var h = d.dist - b.dist,
                            p = (b.series.group &&
                                b.series.group.zIndex) - (d.series.group && d.series.group.zIndex);
            ...
            f.prototype.getPointFromEvent = function(b) {
                b = b.target;
                for (var e; b && !e;) e = b.point, b = b.parentNode;
                return e
            };
            ...
            f.prototype.scaleGroups = function(b, e) {
                ...
                g.series.forEach(function(d) {
                    l = b || d.getPlotBox();
                    d.xAxis && d.xAxis.zoomEnabled && d.group && (d.group.attr(l), d.markerGroup && (d.markerGroup.attr(l), d.markerGroup.clip(e ? g.clipRect : null)), d.dataLabelsGroup &&
            ...
            f.prototype.touch = function(b, e) {
                ...
                if (1 === b.touches.length)
                    if (b =
                        this.normalize(b), (l = g.isInsidePlot(b.chartX - g.plotLeft, b.chartY - g.plotTop)) && !g.openMenu) {
    ...
    Q(A, "parts/MSPointer.js", [A["parts/Globals.js"], A["parts/Pointer.js"], A["parts/Utilities.js"]], function(d, f, E) {
        ...
        function M(f, n, m, b) {
            "touch" !== f.pointerType && f.pointerType !== f.MSPOINTER_TYPE_TOUCH || !H[d.hoverChartIndex] || (b(f),
                b = H[d.hoverChartIndex].pointer, b[n]({
                    type: m,
        ...
        var K = this && this.__extends || function() {
                var d = function(f, m) {
                    ...
                    instanceof Array && function(b, g) {
                        ...
                        for (var d in g) g.hasOwnProperty(d) && (b[d] = g[d])
                    };
                    return d(f, m)
                };
                return function(f, m) {
            ...
            v = function() {
                ...
                g.prototype.renderTitle = function() {
                    ...
                    l.text && (this.title || (this.title = this.chart.renderer.label(l.text, g - 3, g - 4, null, null, null, b.useHTML, null, "legend-title").attr({
                            zIndex: 1
                        }), this.chart.styledMode || this.title.css(l.style), this.title.add(this.group)),
                        l.width || this.title.css({
                ...
                g.prototype.renderItem = function(b) {
                    ...
                    c || (b.legendGroup = g.g("legend-item").addClass("highcharts-" + k.type + "-series highcharts-color-" + b.colorIndex + (t ? " " + t : "") + (a ? " highcharts-series-" + b.index : "")).attr({
                        zIndex: 1
                    }).add(this.scrollGroup), b.legendItem = c = g.text("", w ? h + m : -m, this.baseline || 0, z), e.styledMode || c.css(C(b.visible ?
                        f : v)), c.attr({
                        align: w ? "left" : "right",
                        zIndex: 2
                ...
                g.prototype.render = function() {
                    ...
                    var f = b.spacingBox.width - 2 * m - h.x; - 1 < ["rm", "lm"].indexOf(this.getAlignment().substring(0, 2)) && (f /= 2);
                ...
                g.prototype.align = function(b) {
                    ...
                    var e = this.chart,
                        g = this.options,
                        d = b.y;
                    /(lth|ct|rth)/.test(this.getAlignment()) && 0 < e.titleOffset[0] ? d += e.titleOffset[0] :
                        /(lbh|cb|rbh)/.test(this.getAlignment()) && 0 < e.titleOffset[2] && (d -= e.titleOffset[2]);
                    d !== b.y && (b = C(b, {
                        y: d
                    }));
                ...
                g.prototype.handleOverflow = function(b) {
                    ...
                    v && (m = Math.min(m, v));
                    z.length = 0;
                    b > m && !1 !== c.enabled ? (this.clipHeight =
                        n = Math.max(m - 20 - this.titleHeight - f, 0), this.currentPage = D(this.currentPage, 1), this.fullHeight = b, x.forEach(function(a, c) {
                            ...
                            0, 0, k, k).add(r), C("upTracker").on("click", function() {
                            e.scroll(-1, a)
        ...
        N(aa.prototype, {
            ...
            init: function(a, c) {
                ...
                b(this, "init", {
                    ...
                    f.xAxis = [];
                    f.yAxis = [];
                    f.pointCount = f.colorCounter = f.symbolCounter =
                        0;
                    b(f, "afterInit");
                    f.firstRender()
                })
            ...
            get: function(a) {
                ...
                for (e = 0; !k && e < b.length; e++) k = m(b[e].points || [], c);
                return k
            },
            getAxes: function() {
                var c = this,
            ...
            layOutTitles: function(a) {
                ...
                ["title", "subtitle", "caption"].forEach(function(a) {
                    ...
                    if (b) {
                        ...
                        g.floating || ("top" === d ? c[0] = Math.ceil(c[0] + h) : "bottom" === d && (c[2] = Math.ceil(c[2] +
                            h)))
                    }
                }, this);
            ...
            temporaryDisplay: function(a) {
                var c = this.renderTo;
                if (a)
                    for (; c && c.style;) c.hcOrigStyle && (C(c, c.hcOrigStyle), delete c.hcOrigStyle), c.hcOrigDetached && (z.body.removeChild(c), c.hcOrigDetached = !1), c = c.parentNode;
                else
                    for (; c && c.style;) {
                        z.body.contains(c) ||
                            c.parentNode || (c.hcOrigDetached = !0, z.body.appendChild(c));
            ...
            getAxisMargins: function() {
                ...
                a.hasCartesianSeries ? k(a.axes) : b &&
                    b.length && k(b);
            ...
            drawChartBox: function() {
                ...
                h || (d.attr({
                    ...
                    u && (m ? (u !== m.attr("href") && m.attr("href", u), m.animate(w)) : this.plotBGImage = c.image(u, v, z, n, y).add()));
                t ? t.animate({
                    width: B.width,
                    height: B.height
            ...
            linkSeries: function() {
                ...
                c.forEach(function(c) {
                    ...
                    l(b) && (b = ":previous" === b ? a.series[c.index - 1] : a.get(b)) && b.linkedParent !== c && (b.linkedSeries.push(c), c.linkedParent = b, b.enabledDataSorting &&
    ...
    Q(A, "parts/ScrollablePlotArea.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        E(f, "afterSetChartSize", function(f) {
            ...
            if (!this.renderer.forExport) {
                ...
                } else q && (this.scrollablePixelsY = x = Math.max(0, q - this.chartHeight)) && (this.plotHeight += x, this.inverted ? (this.clipBox.width += x, this.plotBox.width += x) : (this.clipBox.height += x, this.plotBox.height +=
                    x), F = {
                    2: {
                        name: "bottom",
                        value: x
        ...
        f.prototype.applyFixed = function() {
            ...
            x ? (this.fixedDiv = q("div", {
                ...
                zIndex: -1
            }).addClass("highcharts-scrollable-mask").add(), this.moveFixedElements(), E(this, "afterShowResetZoom",
                this.moveFixedElements), E(this, "afterLayOutTitles", this.moveFixedElements)) : this.fixedRenderer.setSize(this.chartWidth, this.chartHeight);
            ...
            x &&
                (F.scrollPositionX && (this.scrollingContainer.scrollLeft = this.scrollablePixelsX * F.scrollPositionX), F.scrollPositionY && (this.scrollingContainer.scrollTop = this.scrollablePixelsY * F.scrollPositionY));
            L = this.axisOffset;
            ...
            J = function() {
                ...
                d.prototype.buildStacks = function() {
                    ...
                    if (!d.isXAxis) {
                        ...
                        for (D = 0; D < C; D++) f[D].modifyStacks();
    ...
    Q(A, "parts/Point.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        f = function() {
            ...
            d.prototype.applyOptions = function(f, b) {
                ...
                m && (this.y =
                    d.prototype.getNestedProperty.call(this, m));
            ...
            d.prototype.firePointEvent = function(d, b, g) {
                ...
                "click" === d && h.allowPointSelect && (g = function(b) {
            ...
            d.prototype.getZone = function() {
                ...
                var g = 0,
                    f;
                for (f = b[g]; this[d] >= f.value;) f = b[++g];
            ...
            d.prototype.optionsToObject =
                function(f) {
                    var b = {},
                        ...
                        p = 0,
                        l = 0;
                    if (H(f) || null === f) b[h[0]] = f;
                    else if (F(f))
                        for (!m && f.length > e && (g = typeof f[0], "string" === g ? b.name = f[0] : "number" === g && (b.x = f[0]), p++); l < e;) m && "undefined" === typeof f[p] || (0 < h[l].indexOf(".") ? d.prototype.setNestedProperty(b, f[p], h[l]) : b[h[l]] = f[p]), p++, l++;
    ...
    Q(A,
        "parts/Series.js", [A["mixins/legend-symbol.js"], A["parts/Globals.js"], A["parts/Point.js"], A["parts/Utilities.js"]],
        function(d, f, A, q) {
            "";
            var E = q.addEvent,
                K = q.animObject,
            ...
            f.Series = I("line", null, {
                ...
                bindAxes: function() {
                    ...
                    t(this, "bindAxes", null, function() {
                        (a.axisTypes || []).forEach(function(d) {
                            b[d].forEach(function(b) {
                                e = b.options;
                                if (c[d] === e.index || "undefined" !== typeof c[d] && c[d] === e.id || "undefined" === typeof c[d] && 0 === e.index) a.insert(b.series),
                                    a[d] = b, b.isDirty = !0
                            });
                ...
                setOptions: function(a) {
                    ...
                    this.tooltipOptions = h(G.tooltip, G.plotOptions.series && G.plotOptions.series.tooltip, G.plotOptions[this.type].tooltip, b.tooltip.userOptions, e.series && e.series.tooltip, e[this.type].tooltip,
                        a.tooltip);
                ...
                findPointIndex: function(a, c) {
                    ...
                    if (b) var f = this.chart.get(b);
                    else if (this.linkedParent || this.enabledDataSorting) {
                        var h =
                            l && l.matchByName ? "name" : "index";
                        f = n(d, function(c) {
                    ...
                    "undefined" === typeof m && g(e) && (m = this.xData.indexOf(e, c)); - 1 !== m && "undefined" !== typeof m && this.cropped && (m = m >= this.cropStart ? m - this.cropStart : m);
                ...
                updateData: function(a, c) {
                    ...
                    if (l)
                        for (a = d.length; a--;)(f = d[a]) && !f.touched && f.remove && f.remove(!1, c);
                    else !u || e && e.enabled ? p = !1 : (a.forEach(function(a,
                        c) {
                ...
                setData: function(a, c, b, e) {
                    ...
                    if (!x) {
                        ...
                        if (n && f > n)
                            if (n = d.getFirstValidPoint(a), g(n))
                                for (b = 0; b < f; b++) y[b] = this.autoIncrement(), w[b] = a[b];
                            else if (m(n))
                            if (t)
                                for (b = 0; b < f; b++) e = a[b], y[b] = e[0], w[b] = e.slice(1, t + 1);
                            else
                                for (B && (G = B.indexOf("x"), q = B.indexOf("y"),
                                        G = 0 <= G ? G : 0, q = 0 <= q ? q : 1), b = 0; b < f; b++) e = a[b], y[b] = e[G], w[b] = e[q];
                        else D(12, !1, r);
                        else
                            for (b = 0; b < f; b++) "undefined" !== typeof a[b] && (e = {
                                series: d
                            }, d.pointClass.prototype.applyOptions.apply(e, [a[b]]), d.updateParallelArrays(e, b));
                        w && v(w[0]) && D(14, !0, r);
                        d.data = [];
                        d.options.data = d.userOptions.data = a;
                        for (b = l; b--;) k[b] && k[b].destroy && k[b].destroy();
                ...
                getProcessedData: function(a) {
                    ...
                    if (m && this.sorted && !h && (!l || e > l || this.forceCrop))
                        if (c[e - 1] < p || c[0] > n) c = [], b = [];
                        else if (this.yData && (c[0] < p || c[e - 1] > n)) {
                    ...
                    for (l = c.length || 1; --l;)
                        if (e = f ? a(c[l]) - a(c[l - 1]) : c[l] - c[l - 1], 0 < e && ("undefined" === typeof y || e < y)) var y = e;
                        else 0 > e && u && (D(15, !1, this.chart), u = !1);
                    return {
                        xData: c,
                        yData: b,
                        cropped: v,
                ...
                generatePoints: function() {
                    ...
                    var p = [],
                        n;
                    b ||
                        m || (b = [], b.length = c.length, b = this.data = b);
                    ...
                    this.options.keys = a;
                    if (b && (l !== (e = b.length) || m))
                        for (n = 0; n < e; n++) n !== h || m || (n += l), b[n] && (b[n].destroyElements(), b[n].plotX =
                            void 0);
                    this.data = b;
                    this.points = p;
                ...
                getExtremes: function(a, c) {
                    ...
                    for (p = 0; p < e; p++) {
                        ...
                        v = c || this.getExtremesFromAll ||
                            this.options.getExtremesFromAll || this.cropped || !b || (d[p + u] || v) >= f && (d[p - u] || v) <= h;
                        if (w && v)
                            if (w = y.length)
                                for (; w--;) g(y[w]) && (k[l++] = y[w]);
                            else k[l++] = y
                ...
                getFirstValidPoint: function(a) {
                    for (var c = null, b = a.length, e = 0; null === c && e < b;) c = a[e], e++;
                    return c
                },
                translate: function() {
                    ...
                    var a = this.options,
                        ...
                        h = f.length,
                        u = !!this.modifyValue,
                        n, v = this.pointPlacementToXValue(),
                        y = !!v,
                        w = a.threshold,
                    ...
                    for (n = 0; n < h; n++) {
                        ...
                        C.plotX = G = F(x(b.translate(D, 0, 0, 0, 1, v, "flags" ===
                            this.type), -1E5, 1E5));
                        ...
                        C.plotY = "number" === typeof R &&
                            Infinity !== R ? x(l.translate(R, 0, 1, 0, 1), -1E5, 1E5) : void 0;
                ...
                destroy: function(a) {
                    ...
                    for (l = h.length; l--;)(m = h[l]) && m.destroy && m.destroy();
                    b.points = null;
                ...
                getGraphPath: function(a, c, b) {
                    ...
                    a.forEach(function(k, m) {
                        ...
                        k.isNull && !H(c) && 0 < m ? h = !d.connectNulls : k.isNull && !c ? h = !0 : (0 === m || h ? m = [
                                ["M", k.plotX, k.plotY]
                            ] : e.getPointSpline ?
                            m = [e.getPointSpline(a, k, m)] : g ? (m = 1 === g ? [
                                ["L", n.plotX, r]
                            ] : 2 === g ? [
                                ["L", (n.plotX + u) / 2, n.plotY],
                                ["L", (n.plotX + u) / 2, r]
                            ] : [
                                ["L", u, n.plotY]
                            ], m.push(["L", u, r])) : m = [
                                ["L", u, r]
                            ], l.push(k.x), g && (l.push(k.x), 2 === g && l.push(k.x)), f.push.apply(f, m), h = !1)
                    });
                    f.xMap = l;
                    ...
                    function c() {
                        ["group", "markerGroup"].forEach(function(c) {
                            b[c] && (e.renderer.isVML && b[c].attr({
                                width: b.yAxis.len,
                                height: b.xAxis.len
                            }), b[c].width = b.yAxis.len, b[c].height = b.xAxis.len, b[c].invert(b.isRadialSeries ?
                                !1 : a))
                        })
                    }
                    var b = this,
    ...
    Q(A, "parts/Stacking.js", [A["parts/Axis.js"], A["parts/Globals.js"], A["parts/StackingAxis.js"], A["parts/Utilities.js"]], function(d, f, A, q) {
            ...
            H = function() {
                ...
                d.prototype.render = function(d) {
                    ...
                    this.label ? this.label.attr({
                        text: t,
                        visibility: "hidden"
                    }) : (this.label = f.renderer.label(t,
                        null, null, n.shape, null, null, n.useHTML, !1, "stack-labels"), t = {
                        r: n.borderRadius || 0,
                        text: t,
                        rotation: n.rotation,
                ...
                d.prototype.setOffset = function(d, f, n, t, q) {
                    ...
                    f && m && (q = f.getBBox(), t = f.padding, g = "left" === g ? b.inverted ? -t : t : "right" === g ? q.width : b.inverted && "center" === g ? q.width / 2 : b.inverted ? n ? q.width + t : -t : q.width / 2, n = b.inverted ? q.height / 2 : n ? -t : q.height, this.alignOptions.x = x(this.options.x, 0), this.alignOptions.y = x(this.options.y, 0), m.x -= g, m.y -= n, f.align(this.alignOptions,
                        null, m), b.isInsidePlot(f.alignAttr.x + g - this.alignOptions.x, f.alignAttr.y + n - this.alignOptions.y) ? f.show() : (f.alignAttr.y = -9999, d = !1), d && F.prototype.justifyDataLabel.call(this.axis, f, this.alignOptions, f.alignAttr, q, m), f.attr({
                        x: f.alignAttr.x,
                        y: f.alignAttr.y
        ...
        q.prototype.getStacks = function() {
            ...
            d.series.forEach(function(w) {
                ...
                !w.options.stacking || !0 !== w.visible && !1 !== d.options.chart.ignoreHiddenSeries || (w.stackKey = [w.type,
                    x(w.options.stack, ""), f ? n.top : n.left, f ? n.height : n.width
                ].join())
            })
        };
        A.compose(d);
    ...
    Q(A, "parts/Dynamics.js", [A["parts/Globals.js"],
        A["parts/Point.js"], A["parts/Time.js"], A["parts/Utilities.js"]
    ], function(d, f, A, q) {
        var E = q.addEvent,
            K = q.animate,
            J = q.createElement,
        ...
        d.cleanRecursively = function(e, g) {
            ...
            b(e, function(b, l) {
                if (t(e[l], !0) && !e.nodeType && g[l]) b = d.cleanRecursively(e[l], g[l]), Object.keys(b).length &&
                    (f[l] = b);
                else if (t(e[l]) || e[l] !== g[l]) f[l] = e[l]
            });
            return f
        };
        C(q.prototype, {
            addSeries: function(b, e, d) {
                var f, l = this;
            ...
            update: function(f, l, h, p) {
                ...
                if (c = f.chart) {
                    ...
                    "alignTicks" in c && (w = !0);
                    b(c, function(c, b) {
                        -1 !== u.propsRequireUpdateSeries.indexOf("chart." + b) && (a = !0); - 1 !== u.propsRequireDirtyBox.indexOf(b) && (u.isDirtyBox = !0);
                ...
                f.plotOptions && m(!0, this.options.plotOptions,
                    f.plotOptions);
                f.time && this.time === d.time && (this.time = new A(f.time));
                b(f, function(c, b) {
                    if (u[b] && "function" === typeof u[b].update) u[b].update(c, !1);
                    else if ("function" === typeof u[y[b]]) u[y[b]](c);
            ...
            setSubtitle: function(b, e) {
                this.applyDescription("subtitle", b);
                this.layOutTitles(e)
            },
            setCaption: function(b, e) {
        ...
        C(f.prototype, {
            update: function(b,
                ...
                function l() {
                    ...
                    !c.fixedBox && c.hasCartesianSeries &&
                        (m.isDirtyBox = !0);
        ...
        C(l.prototype, {
            addPoint: function(b, e, d, f, l) {
                ...
                var v = p.x;
                var y = u.length;
                if (this.requireSorting && v < u[y - 1])
                    for (n = !0; y && u[y - 1] > v;) y--;
            ...
            update: function(b, e) {
                ...
                var f = this,
                    ...
                    k = I[n].prototype,
                    p, u = ["group", "markerGroup", "dataLabelsGroup", "transformGroup"],
        ...
        C(p.prototype, {
            update: function(e, d) {
                ...
                f.options[this.coll].indexOf &&
                    (f.options[this.coll][f.options[this.coll].indexOf(this.userOptions)] = e);
            ...
            remove: function(b) {
                for (var e = this.chart, d = this.coll, f = this.series, l = f.length; l--;) f[l] && f[l].remove(!1);
                F(e.axes, this);
                F(e[d], this);
            ...
            setTitle: function(b, e) {
                this.update({
                    title: b
                }, e)
            },
            setCategories: function(b, e) {
                this.update({
                    categories: b
                }, e)
            }
        ...
        f("area", "line", {
            ...
            getStackPoints: function(d) {
                ...
                if (this.options.stacking) {
                    for (g = 0; g < d.length; g++) d[g].leftNull = d[g].rightNull = void 0, n[d[g].x] = d[g];
                    K(w, function(b, e) {
                    ...
                    q.forEach(function(d, e) {
                        ...
                        if (n[d] && !n[d].isNull) f.push(n[d]), [-1, 1].forEach(function(f) {
                            var h = 1 === f ? "rightNull" : "leftNull",
                                ...
                                u = w[q[e + f]];
                            if (u)
                                for (g = t; 0 <= g && g < m;) l = u.points[g], l || (g === t ? n[d][h] = !0 : v[g] && (I = w[d].points[g]) && (p -= I[1] - I[0])), g += b;
        ...
        f("column", "line", {
            ...
            translate: function() {
                ...
                d.points.forEach(function(e) {
                    ...
                    L(e.options.pointWidth) && (q = k = Math.ceil(e.options.pointWidth), a -= Math.round((q -
                        p) / 2));
                    e.barX = a;
                    e.pointWidth = q;
            ...
            pointAttribs: function(d, f) {
                ...
                f && d && (d = H(n.states[f], d.options.states && d.options.states[f] || {}), f = d.brightness, g = d.color || "undefined" !== typeof f && E(g).brighten(d.brightness).get() ||
                    g, v = d[m] || v, h = d[b] || h, q = d.dashStyle || q, e = C(d.opacity, e));
                m = {
                    fill: g,
                    stroke: v,
                    "stroke-width": h,
            ...
            drawPoints: function() {
                ...
                d.points.forEach(function(g) {
                    ...
                    if (F(g.plotY) && null !== g.y) {
                        ...
                        n || (g.graphic = n = x[g.shapeType](b).add(g.group ||
                            d.group)) && d.enabledDataSorting && f.hasRendered && f.pointCount < m && (n.attr({
                            x: g.startXPos
                        }), h = !0, e = "animate");
                        if (n && h) n[e](H(b));
            ...
            animate: function(d) {
                ...
                if (d) b.scaleY = .001, d = J(q.toPixels(w.threshold),
                    q.pos, q.pos + q.len), m ? b.translateX = d - q.len : b.translateY = d, f.clipBox && f.setClip(), f.group.attr(b);
                else {
    ...
    Q(A, "mixins/centered-series.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        d.CenteredSeriesMixin = {
            getCenter: function() {
                ...
                f.angular && (d[3] = 0);
                for (C = 0; 4 > C; ++C) w = d[C], f = 2 > C || 2 === C && /%$/.test(w), d[C] = M(w, [A, E, D, d[2]][C]) + (f ? x : 0);
                d[3] > d[2] && (d[3] = d[2]);
                return d
            },
    ...
    Q(A, "parts/PieSeries.js", [A["parts/Globals.js"], A["mixins/legend-symbol.js"], A["parts/Point.js"], A["parts/Utilities.js"]], function(d, f, A, q) {
        ...
        D("pie", "line", {
            ...
            updateTotals: function() {
                ...
                this.total = b;
                for (d = 0; d < n; d++) e = f[d], e.percentage = 0 < b && (e.visible || !h) ? e.y / b * 100 : 0, e.total = b
            },
            generatePoints: function() {
            ...
            translate: function(d) {
                ...
                for (u = 0; u < y; u++) {
                    ...
                    x = (x + w) / 2;
                    x > 1.5 * Math.PI ?
                        x -= 2 * Math.PI : x < -Math.PI / 2 && (x += 2 * Math.PI);
                    t.slicedTranslation = {
            ...
            redrawPoints: function() {
                ...
                d.points.forEach(function(g) {
                    ...
                    if (!g.isNull && h) {
                        ...
                        g.delayedRendering ? (h.setRadialReference(d.center).attr(p).attr(n),
                            b.styledMode || h.attr(e).attr({
                                "stroke-linejoin": "round"
            ...
            drawPoints: function() {
                ...
                this.points.forEach(function(b) {
                    ...
                    b.graphic || (b.graphic = d[b.shapeType](b.shapeArgs).add(b.series.group),
                        b.delayedRendering = !0)
                })
            },
            searchPoint: t,
            sortByAngle: function(d, b) {
                d.sort(function(d, f) {
            ...
            connectorShapes: {
                fixedOffset: function(d, b, f) {
                    ...
                    b = b.touchingSliceAt;
                    return [
                        ["M", d.x, d.y], f.softConnector ? ["C", d.x + ("left" === d.alignment ? -5 : 5), d.y, 2 * g.x - b.x, 2 * g.y - b.y, g.x, g.y] : ["L", g.x, g.y],
                        ["L", b.x, b.y]
                    ]
                },
                straight: function(d, b) {
                    b = b.touchingSliceAt;
                    return [
                        ["M", d.x, d.y],
                        ["L", b.x, b.y]
    ...
    Q(A, "parts/DataLabels.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        d.distribute = function(b, f, m) {
            ...
            for (e = b.length; e--;) u += b[e].size;
            if (u > q) {
                t(b, function(b, e) {
                    return (e.rank || 0) - (b.rank || 0)
                });
                for (u = e = 0; u <= q;) u += b[e].size, e++;
            ...
            for (b = b.map(function(b) {
                ...
                for (e =
                    b.length; e--;) n = b[e], u = (Math.min.apply(0, n.targets) + Math.max.apply(0, n.targets)) / 2, n.pos = M(u - n.size * n.align, 0, f - n.size);
                e = b.length;
                for (n = !1; e--;) 0 < e && b[e - 1].pos + b[e - 1].size > b[e].pos && (b[e - 1].size += b[e].size, b[e - 1].targets = b[e - 1].targets.concat(b[e].targets), b[e - 1].align = .5, b[e - 1].pos + b[e - 1].size > f && (b[e - 1].pos = f - b[e - 1].size), b.splice(e, 1), n = !0)
            }
            l.push.apply(l, v);
            e = 0;
            b.some(function(b) {
                ...
                if (b.targets.some(function() {
                        l[e].pos = b.pos + g;
                        if ("undefined" !== typeof m && Math.abs(l[e].pos - l[e].target) > m) return l.slice(0,
        ...
        N.prototype.drawDataLabels = function() {
            ...
            function d(c, a) {
                ...
                if (F(c) && !F(a)) b = c.map(function(c) {
                    ...
                    for (e = Math.max(c.length, a.length); e--;) b[e] = H(c[e], a[e]);
                else b = H(c, a);
                return b
            }
            var f = this,
        ...
        N.prototype.alignDataLabel = function(b, d, f, h, e) {
            var g = this,
                ...
                k = this.visible && !1 !== b.visible && (b.series.forceDL ||
                    n && !a || c || f.inside && h && l.isInsidePlot(q, m ? h.x + 1 : h.y + h.height - 1, m));
            var r = function(f) {
        ...
        N.prototype.justifyDataLabel = function(b,
            d, f, h, e, m) {
            var g = this.chart,
                n = d.align,
                p = d.verticalAlign,
        ...
        m.pie && (m.pie.prototype.dataLabelPositioners = {
            ...
            radialDistributionX: function(b, d, f, h) {
                return b.getX(f < d.top + 2 || f > d.bottom - 2 ? h : f, d.half, d)
            },
            justify: function(b, d, f) {
                return f[0] + (b.half ? -1 : 1) * (d + b.labelDistance)
            },
            alignToPlotEdges: function(b, d, f, h) {
                b = b.getBBox().width;
                return d ? b + h : f - b - h
            },
            alignToConnectors: function(b, d, f, h) {
                var e = 0,
                    g;
                b.forEach(function(b) {
            ...
            b.visible && (e.enabled || b._hasPointLabels) && (f.forEach(function(a) {
                ...
                a.dataLabel &&
                    (a.visible ? (A[a.half].push(a), a.dataLabel._pos = null, !K(e.style.width) && !K(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > w && (a.dataLabel.css({
                ...
                if (l) {
                    ...
                    for (J = 0; J < l; J++) {
                        ...
                        F = v = r.natural.y;
                        p && K(m.distributeBox) && ("undefined" ===
                            typeof m.distributeBox.pos ? L = "hidden" : (z = m.distributeBox.size, F = Q.radialDistributionY(m)));
                        delete m.positionIndex;
                        if (e.justify) E = Q.justify(m, B, C);
            ...
            this.points.forEach(function(b) {
                var d = b.dataLabel,
                    f;
                d && b.visible && ((f = d._pos) ?
                    (d.sideOverflow && (d._attr.width = Math.max(d.getBBox().width - d.sideOverflow, 0), d.css({
            ...
            if (!m) {
                if (null !== h[0]) var l =
                    Math.max(d[2] - Math.max(b[1], b[3]), e);
                else l = Math.max(d[2] - b[1] - b[3], e), d[0] += (b[3] - b[1]) / 2;
        ...
        m.column && (m.column.prototype.alignDataLabel = function(b, d, f, h, e) {
            var g = this.chart.inverted,
                ...
                q =
                D(f.inside, !!this.options.stacking);
    ...
    Q(A, "modules/overlapping-datalabels.src.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        d.prototype.hideOverlappingLabels = function(d) {
            ...
            d.forEach(function(b) {
                if (b) {
                    var d = b.newOpacity;
                    b.oldOpacity !== d && (b.alignAttr && b.placed ? (b[d ? "removeClass" : "addClass"]("highcharts-data-label-hidden"), n = !0, b.alignAttr.opacity =
                        d, b[b.isOld ? "animate" : "attr"](b.alignAttr, null, function() {
                            f.styledMode || b.css({
    ...
    Q(A, "parts/Interaction.js", [A["parts/Globals.js"], A["parts/Legend.js"], A["parts/Point.js"], A["parts/Utilities.js"]], function(d, f, A, q) {
        ...
        x(q.prototype, {
            ...
            zoom: function(b) {
                ...
                g && !h ?
                    d.showResetZoom() : !g && w(h) && (d.resetZoomButton = h.destroy());
                ...
                F(this, "pan", {
                    ...
                    c.forEach(function(a) {
                        ...
                        if (!e.ordinal) {
                            ...
                            e = v - q;
                            0 < e && (v = q, p -= e);
                            if (c.series.length && p !== t.min && v !== t.max && a || x && p >= u && v <= q) c.setExtremes(p,
                                v, !1, !1, {
                                    trigger: "pan"
            ...
            setState: function(b, d) {
                ...
                if (e.state !== b && ([e.group, e.markerGroup, e.dataLabelsGroup].forEach(function(a) {
                    ...
                    if (g && !g.dashstyle)
                        for (h = {
                                "stroke-width": m
                            }, g.animate(h, a); e["zone-graph-" + f];) e["zone-graph-" + f].attr(h), f += 1;
    ...
    Q(A, "parts/Responsive.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        d.prototype.setResponsive = function(d, f) {
            ...
            w = w.toString() || void 0;
            w !== (n && n.ruleIds) && (n && this.update(n.undoOptions,
                d, !0), w ? (n = this.currentOptions(f), n.isResponsiveOptions = !0, this.currentResponsive = {
                ruleIds: w,
                mergedOptions: f,
                undoOptions: n
        ...
        d.prototype.currentOptions = function(d) {
            function f(d,
                ...
                var b;
                J(d, function(d, n) {
                    if (!m && -1 < A.collectionsWithUpdate.indexOf(n))
                        for (d = x(d), w[n] = [], b = 0; b < d.length; b++) t[n][b] && (w[n][b] = {}, f(d[b], t[n][b], w[n][b], m + 1));
