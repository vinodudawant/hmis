! function(e) {
    var t = function(t, n, r) {
        ...
        var o = '<div class="daterangepicker dropdown-menu">' + '<div class="calendar left"></div>' + '<div class="calendar right"></div>' + '<div class="ranges">' + '<div class="range_inputs">' + '<div class="daterangepicker_start_input" style="float: left">' + '<label for="daterangepicker_start">' + this.locale.fromLabel + "</label>" + '<input class="input-mini" id="fromDate" type="text" name="daterangepicker_start" value="" disabled="disabled" />' + "</div>" + '<div class="daterangepicker_end_input" style="float: left; padding-left: 11px">' + '<label for="daterangepicker_end">' + this.locale.toLabel + "</label>" + '<input class="input-mini" type="text" id="toDate" name="daterangepicker_end" value="" disabled="disabled" />' + "</div>" + '<button class="' + this.applyClass + ' applyBtn" onclick=getGraphData("range"); disabled="disabled">' + this.locale.applyLabel + "</button> " + '<button class="' + this.cancelClass + ' cancelBtn">' + this.locale.cancelLabel + "</button>" + "</div>" + "</div>" + "</div>";
        ...
        if (i) {
            ...
            if (typeof n.startDate == "string") this.startDate = moment(n.startDate, this.format);
            if (typeof n.endDate == "string") this.endDate = moment(n.endDate, this.format);
            if (typeof n.minDate == "string") this.minDate = moment(n.minDate, this.format);
            if (typeof n.maxDate == "string") this.maxDate = moment(n.maxDate, this.format);
            if (typeof n.startDate == "object") this.startDate = moment(n.startDate);
            if (typeof n.endDate == "object") this.endDate = moment(n.endDate);
            if (typeof n.minDate == "object") this.minDate = moment(n.minDate);
            if (typeof n.maxDate == "object") this.maxDate = moment(n.maxDate);
            if (typeof n.ranges == "object") {
                for (var u in n.ranges) {
                    var a = moment(n.ranges[u][0]);
                    var f = moment(n.ranges[u][1]);
                    if (this.minDate && a.isBefore(this.minDate)) a = moment(this.minDate);
                    if (this.maxDate && f.isAfter(this.maxDate)) f = moment(this.maxDate);
                ...
                for (var u in this.ranges) {
                    l += "<li onclick=getGraphData('range');>" + u + "</li>"
                }
                l += "<li>" + this.locale.customRangeLabel + "</li>";
                l += "</ul>";
                this.container.find(".ranges").prepend(l)
            }
            //alert(JSON.stringify(n.dateLimit));
            if (typeof n.dateLimit == "object") this.dateLimit = 365;
            if (typeof n.locale == "object") {
    ...
    t.prototype = {
        ...
        move: function() {
            ...
            if (this.opens == "left") {
                this.container.css({
                    ...
                    right: e(window).width() - this.element.offset().left - this.element.outerWidth() - t.left,
                    left: "auto"
                });
        ...
        updateMonthYear: function(t) {
            ...
            if (!n) r = this.container.find(".calendar.right");
        ...
        buildCalendar: function(e, t, n, r, i) {
            ...
            if (h > a) h -= 7;
            if (f == this.locale.firstDay) h = a - 6;
        ...
        renderCalendar: function(t, n, r, i) {
            ...
            for (var u = 0; u < 6; u++) {
                s += "<tr>";
                if (this.showWeekNumbers) s += '<td class="week">' + t[u][0].week() + "</td>";
                for (var a = 0; a < 7; a++) {
                    var f = "available ";
