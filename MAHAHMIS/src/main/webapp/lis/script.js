var App = function () {
	...
	var handleXcharts = function () {
		...
		function chart3() {
			...
			var opts = {
			  ...
			  "mouseover": function (d, i) {
				var pos = $(this).offset();
				$(tt).text(d3.time.format('%Y-%m-%d')(d.x) + ': (Patient Count : ' + d.y +' )')
				  .css({top: topOffset + pos.top, left: pos.left + leftOffset})
				  .show();
			  },
			  "mouseout": function (x) {
		...
		function chart7() {
			...
			var opts = {
			  ...
			  "mouseover": function (d, i) {
				var pos = $(this).offset();
				$(tt).text(d3.time.format('%Y-%m-%d')(d.x) + ': (Amount : ' + d.y + ' )')
				  .css({top: topOffset + pos.top, left: pos.left + leftOffset})
				  .show();
			  },
			  "mouseout": function (x) {
	...
	var handleDashFlotCharts = function () {
		...
		function chart_revenue() {
			var likes = [[0, Math.random()*100], [1, Math.random()*100], [3, Math.random()*100], [4, Math.random()*100],[5,Math.random()*100],[6, Math.random()*100],[7, Math.random()*100],[8, Math.random()*100],[9, Math.random()*100],[10, Math.random()*100],[11, Math.random()*100],[12, Math.random()*100]];
