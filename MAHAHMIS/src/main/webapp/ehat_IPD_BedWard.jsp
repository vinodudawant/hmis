								...
								<div class="col-md-12">
									<div class="panel panel-default">
										<div class="panel-body">
												...
												<div class="col-md-12">
													<div class="form-group col-md-3">
														...
														<label for="">Select Ward Type:</label> <select
															...
															style='width: 100%' onchange="fetchWordTypeList();">
													...
													<div class="form-group col-md-3">
														...
														<!-- style='width: 100%' onchange="fetchNoOfBeds();"> -->
													</div>
													...
													<div class="form-group col-md-3">
														<label for="" style="color: red">Available Beds:</label> <label
															for="" style="color: red" id="AvailableBeds">0</label>
													</div>

													<div class="form-group col-md-3">
														<label for="" style="color: red">Bed Cleaning:</label> <label
															for="" style="color: red" id="cleaningBeds">0</label>
													</div>
											...
											<!--Billable bed popup -->
											<div id="bedAllocationPopUp" class="popup modal fade in"
																...
																<form class="form-horizontal col-md-12-1"
																	...
																	<div class="form-group col-md-6-1" style="margin: 0px;">
																		<label class="checkbox-inline input-SmallText"
																			...
																			onclick="allocateBedToPatient()" name="radBillableBed"
