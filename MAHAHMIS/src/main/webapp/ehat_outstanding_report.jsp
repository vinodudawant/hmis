...
<title>OPD/Diag Bill Outstanding Report</title>
								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="ehat_outstanding_report.jsp">OPD/Diag Bill Outstanding Report</a></li>
											<li class="pull-right">
													...
													To Excel</button>
													 <script type="text/javascript">
														 ...
														 $(document).on('click', '#btnPrint', function (e) {
															    ...
															    link.download = "OPD/Diag Bill Outstanding Report.xls";
															    link.href = result;
															    link.click();
															});
