...
<body style="background: white ! important;">
	<section id="page">
		...
		<div id="outer" class="container-main" style="width: 100%;">
			...
			%>
			<%
				if (sessionOBJ == "inventory") {
					/* value="inventory";
					sessionPageValue.setAttribute("inventorymodule", value);
					System.out.println("session value is======"+value); */
			%>
			...
			%>
			<%
				if (sessionOBJ == "DoctorDesk") {
					/* value="DoctorDesk";
					sessionPageValue.setAttribute("doctordeskmodule", value);
					System.out.println("session value is======"+value); */
			%>
			...
			<%
				if (sessionOBJ == "ipd") {
					/* value="ipd";
					sessionPageValue.setAttribute("ipdmodule", value);
					System.out.println("session value is======"+value); */
			%>
			...
			%>
			<%
				if (sessionOBJ == "OTSchedule") {
					/* value="OTSchedule";
					sessionPageValue.setAttribute("otschedulemodule", value);
					System.out.println("session value is======"+value); */
			%>
			...
			<%
				if (sessionOBJ == "Lab") {
					/* value="Lab";
					sessionPageValue.setAttribute("labmodule", value);
					System.out.println("session value is======"+value); */
			%>
			...
			<%
				if (sessionOBJ == "Pharmacy") {
					/* value="Lab";
					sessionPageValue.setAttribute("labmodule", value);
					System.out.println("session value is======"+value); */
			%>
			<%@include file="WEB-INF/pages/Pharma_left_menu_masters.jsp"%>
			<%
				}
			%>
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li><a href="inventory_Materail_Request_Note.jsp">Material
													Request Note</a></li>
											<!-- <li>View Database</li> -->
										</ul>
									...
									<div class="col-sm-5">
										<input type="date" class="form-group"
										 onkeypress="return checkDate(event)"
											...
											placeholder="Dispensed Date" value="<%=todays_date%>" autocomplete="off"  readonly />
									</div>
								</div>
								...
								<div class="modal-body">
									<div class="col-md-12">
										<form class="form-horizontal  col-md-12-1" method="get">
											...
											<div style="margin-top: 46px; margin-left: 2px;"
												class="col-md-12-1">
												<!-- BOX -->
