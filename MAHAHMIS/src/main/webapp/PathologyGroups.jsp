...
<script>
	jQuery(document).ready(function() {
		App.setPage("PathologyGroups"); //Set current page
...
<script type="text/javascript">
	onload = function() {
		...
		getGroups("onload");
		autoSuggestionForLab("byName", "onload","pathologyGroup");
	}
</script>
</head>
						...
						<div class="row">
							<div id="content" class="col-lg-12">
									...
									<div class="col-sm-12">
										<div class="page-header">
											...
											<ul class="breadcrumb col-md-12-1"
												...
												<li><a href="PathologyGroups.jsp">Lab Headings</a></li>
												<div class="li pull-right">
													<button class="btn btn-xs btn-success" 
													data-toggle="tooltip" data-placement="left" title="Save Pathology Group"
													onclick="saveGroups()">
								...
								<div class="col-md-12-1">
									...
									<div class="col-md-1-1"><label class="TextFont" style="margin-left: 10%;margin-top:3%;">Heading Name:</label></div>
								...
								<div class="panel-body" class="col-md-12-1">
											<div id="infoDiv" class="col-md-4-1"
												style="height: 450px; margin-top: 0%"></div>
												<div class="divide-10"></div>
											<div class="col-md-8-1"  id="userMangTemp"
