								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li><a href="ipdRequestLnl.jsp">LNL</a></li>
											<!-- <li>View Database</li> -->
										</ul>
											...
											<!-- 			<li><a data-toggle="tab" href="#Recieved"
													...
													<!-- 		<li><a data-toggle="tab" href="#MrnReturn"
														...
														<li><a data-toggle="tab"
															href="#LnlReturn" id="lnlRet" onclick="LnlReturn(),getlistforReturnItems('IPD');"><span
...
<!-- User Name and password for Approve Incharge  Date 18 jan 2016   Author:sudhir -->
	...
	<input type="hidden" id="callfrom" value="DoctorDesk">
</body>
</html>