...
<title>ProFees Doctors Report</title>
									...
									<div class="col-sm-12">
										<div class="page-header">
											...
											<ul class="breadcrumb col-md-12-1"
												...
												<li><a href="profees_doctors_payable_report.jsp">Doctor's Payable Report </a></li>
												<li class="pull-right">
											...
											<div id="divLine1" class=" box border col-md-12">
												...
												<form class="form-horizontal col-md-12">
													...
													<div class="col-md-3">
														...
														title="Show" onclick="proFeesDoctorsReport('doctor')" type="button">
														<b> Show </b>
														</button>
														</div>
