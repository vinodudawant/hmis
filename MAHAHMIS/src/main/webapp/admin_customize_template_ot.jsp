...
<meta charset="utf-8">
<title>Customize OT Template</title>
<meta name="viewport"
...
<body>
	<c:if test="${ sessionScope.userType != null }">
									...
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a
												href="customize_template.jsp">Customize Template</a></li>
								...
								<div class="col-md-12">
									...
									<div class='form-group col-md-3 pull-right'>
										<button type="button" class="btn btn-success"
											onclick="saveCustomizeTemplateForOT()" style="margin-top: 15px;">Save</button>
										<button type="button" class="btn btn-warning"
											onclick="resetCustomizeTemplateForOT()" style="margin-top: 15px;">Clear</button>
												...
												<div class="col-md-12" id="divForEntry"
													...
													<div class="container">
														<div class="panel panel-primary">
															<div class="panel-heading" id="divEhatContent">Customize
																Template</div>
															<div class="panel-body">
																<div class="form-row">
																	...
																	<div class="form-group col-md-3">
																		...
																		<select	name="tempname" id="selCustomizeTemp" style="width: 100%;">
												...
												<div class="tabbable header-tabs">
													<div class="row" style="margin-top: 5px">
														<div class="col-md-12">
															...
															<div class="panel panel-primary">
																<div class="panel-heading" id="divEhatContent">Customize Template
																	Details</div>
																<div class="panel-body">
		...
		<input type="hidden" id="idCustomizeTemplate" value="0">
