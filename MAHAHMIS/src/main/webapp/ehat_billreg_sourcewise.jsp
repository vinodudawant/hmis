...
<title>Bill Register Source wise Report</title>
								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="ehat_billreg_sourcewise.jsp">Sourcewise Bill Register Report</a></li>
											<li class="pull-right">
												...
												<button id="btnPrint" class="btn btn-xs btn-warning"
													...
													To Excel</button>
													 ...
													 $(document).on('click', '#btnPrint', function (e) {
														    ...
														    link.download = "Sourcewise Bill Register Report.xls";
														    link.href = result;
														    link.click();
														});
												...
												<div id="diveMain" class="col-md-12" style="margin-top: 5px">
													...
													<div id="divLine2" class=" box border col-md-12" style="overflow: auto;">
														<form class="form-horizontal col-md-12"
															...
															<div
																style="margin-top: -21px; height: 350px;width: 1700px"
																...
																style="background: Scrollbar; border-bottom: 1px solid black; border-top: 1px solid black;">
																	...
																	<thead class="cf">
																		<tr>
																			...
																			<th style="height: 21.5px;width: 7%">Total Amt</th>		
																			<th style="height: 21.5px;width: 5%">Discount Amt</th>	
																			<th style="height: 21.5px;width: 5%">Paid Amt</th>	
