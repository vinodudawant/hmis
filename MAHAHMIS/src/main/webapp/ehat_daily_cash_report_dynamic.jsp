													...
													To Excel</button>
													 <script type="text/javascript">
														 ...
														 $(document).on('click','#btnPrint',function(e) {
														        ...
														        link.download = "Daily Collection Report.xls"; //You need to change file_name here.
														        link.href = result;
														        link.click();
														    });
							...
							%>
										...
										<div style="height: 100px;overflow: auto;">
												...
												<!-- 	<tr>
												  <th colspan=8 style="color: blue;">Opd Total Collection</th>						
														...
														<tr>
													<th>#</th>
													<th id="thCenterPatientId1">UHID</th>
													<th>Bill No</th>
													<th >Opd No</th>
													<th>Rec Id</th>
													<th>Patient Name</th>
								...
								<div style="margin-top: 12px;">
										...
										<table class="table table-bordered responsive "
											...
											<thead>
												<tr>
													<th style="color: blue;">Ipd Total Collection</th>
												</tr>
											</thead>
										</table>
								 	...
								 	<div id="ipdDiv">
										<div class="col-md-12" >
									 		<div style="margin-top: 20px;height: 180px; overflow: auto;">
												<table  class="datatable table table-bordered table-striped table-condensed cf">
													<thead class="cf">										
														...
														<tr>									
															...
															<th style="height: 21.5px;width: 45px" >Bill No</th>	
															<th style="height: 21.5px;width: 90px" >Ipd No</th>		
															<th style="height: 21.5px;width: 50px" >Rec Id</th>													
															<th style="height: 21.5px;width: 150px" >Patient Name</th>
															<th style="height: 21.5px;width: 150px" >Consulting Doctor</th>						
															<th style="height: 21.5px;width: 90px" >Rec Date</th>												
															<th style="height: 21.5px;width: 65px" >Pay Mode</th>														
															<th style="height: 21.5px;width: 65px" >Total Paid</th>
															<th style="height: 21.5px;width: 65px" >Total Bill</th>	
															<th style="height: 21.5px;width: 65px" >Total Remain</th>													
															<th style="height: 21.5px;width: 100px" >User</th>		
															<th style="height: 21.5px;width: 100px" >Remark</th>										
									...
									<div style="margin-top: 12px;">
										...
										<table class="table table-bordered responsive "
											...
											<thead>
												<tr>
													<th style="color: blue;">Ipd Total Refund</th>
												</tr>
											</thead>
										</table>
									</div>
												...
												<table class="datatable table table-bordered table-striped table-condensed cf">
													<thead class="cf">																				
														<tr>									
															...
															<th style="width: 45px" class="col-md-1 center hidden">Patient Id</th>
															<th style="width: 45px" id="thCenterPatientId3">Patient Id</th>				
															<th style="width: 45px" >Bill No</th>	
															<th style="width: 90px" >Ipd No</th>		
															<th style="width: 50px" >Rec Id</th>													
															<th style="width: 150px" >Patient Name</th>
															<th style="width: 150px" >Consulting Doctor</th>						
															<th style="width: 90px" >Rec Date</th>												
															<th style="width: 65px" >Pay Mode</th>														
															<th style="width: 65px" >Total Refund</th>	
															<th style="width: 65px" >Total Bill</th>	
															<th style="width: 65px" >Total Remain</th>												
