...
<body>
									...
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><a href="UserManagement.jsp">Administrator</a></li>
												<li><a href="admin_bedward_mangement.jsp">Ward/Bed Management</a></li>
											<li class="pull-right">
											<button class="btn btn-xs btn-info pull-right" type="button" onclick="addNewHall();">
												...
												<div class="col-md-12" id="divForEntry" style="display: none;">
													<div class="container">
														<div class="panel panel-primary">
															<div class="panel-heading" id="divEhatContent">Ward/Bed
																Master</div>
															<div class="panel-body">
																<div class="form-row" id="displayhiadandshow">
																		...
																		<table id="fixed_header" class="table table-striped table-bordered">
																			<thead id="ehatTHead" class="fixedheaderdemo">
																				<tr>
																					...
																					<th class="col-md-2 center">Bed</th>
																					<th class="col-md-1 center">Edit</th>	
																					<th class="col-md-1 center">Delete Ward</th>	
	...
	<input type="hidden" value="" id="hall_id">
		<!-- /JAVASCRIPTS -->
	</c:if>
	<c:if test="${sessionScope.userType == null}">
