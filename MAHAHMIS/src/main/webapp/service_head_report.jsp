...
<meta charset="utf-8">
<title> Head Wise Service Report </title>
									...
									<div class="col-sm-12">
										<div class="page-header">
											...
											<ul class="breadcrumb col-md-12">
												...
												<li><i class="fa fa-home"></i> <a href="ehat_finance_dashboard.jsp">Home</a>
												</li>
												<li><a href="finance_dashboard.jsp">Siddhivinayak Report</a></li>
												<li><a href="service_head_report.jsp"> Head Wise Service Report </a></li>
												<li class="pull-right">
				...
				<div id="diveMain" class="col-md-12-1 ">
					...
					<form class="form-horizontal col-md-12 ">
								...
								<form class="form-horizontal col-md-12 ">
										...
										<div class="col-sm-3" id="mutlischeme" style="margin-bottom: 20px;">
										...
										<div class="col-md-1">
											...
											<button class="btn btn-xs btn-primary" type="button"
												...
												onclick="fetchServiceWiseHeadReport()" type="button">
												<b>Show</b>
											</button>
										</div>
													...
													<table  border="1"  id="printTable" style="margin-top:20px;width: 2000px; bordercolor=#ddd">
														...
														<thead  id="headServiceWiseReport">
															<tr class="sticky-header">
																...
																<th class='col-md-3 center'>Head Name</th>
																<th class='col-md-1 center'>Count</th>
																<th class='col-md-2 center'>Amount</th>
																<th class='col-md-1 center'>Concession</th>
																<th class='col-md-1 center'>Discount</th>
																<th class='col-md-2 center'>Net Amount</th>
