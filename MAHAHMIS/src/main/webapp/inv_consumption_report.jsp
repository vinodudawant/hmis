									...
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a
												href="inv_consumption_report.jsp">Consumption Report</a></li>
										</ul>
										<!-- /BREADCRUMBS -->
								...
								<div class="col-md-12">
									...
									<div class="col-md-4">
										<div class="input-group" id="searchSubInventoryDivId">
											<input class="form-control"
												title="Please enter sub inventory name name" id="subInvName"
												type="text" placeholder="Sub Inventory  Name"
												onkeyup="setAutoSubInventoryNameForConsumtion(this.id)">
											<span class="input-group-btn">
												<button class="btn btn-primary" onclick="getConsumptionListForConsumtionReport()"
									...
									<div class="col-md-4">
										...
										<div class="input-group">
											<select class="form-control" id="searchByType" onchange="getConsumptionTypeListForConsumtionReport()">
																...
																function(e) {
																	/* window
																			.open('data:application/vnd.ms-excel,'
																					+ encodeURIComponent($(
																							'div[id$=itemconsumptionDetailMasterInfo]')
																							.html()));
																	e
																			.preventDefault(); */
															        ...
															        var table_div = document.getElementById('itemconsumptionDetailMasterInfo');
															        var table_html = table_div.outerHTML.replace(/ /g, '%20');
															        a.href = data_type + ', ' + table_html;
															        //setting the file name
															        a.download = 'Item_Consumption_Report_' + postfix + '.xls';
																...
																<div class="panel panel-primary" style="overflow: auto; ">
																	...
																	<div class="panel-body"
																		...
																		<table
																			...
																			<tbody id="itemConsumptionDetailList">
																			</tbody>
																		</table>
