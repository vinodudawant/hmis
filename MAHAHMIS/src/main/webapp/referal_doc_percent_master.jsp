...
<title>Referal doc Percentage Master</title>
<meta name="viewport"
...
<script type="text/javascript" src="js/validate.js"></script>
 ...
 <script type="text/javascript" src="js/profeesAdvance.js"></script>
  <script type="text/javascript" src="js/ReferalDocPercentMaster.js"></script>
									...
									<div class="col-sm-12">
										<div class="page-header" style="margin-bottom: 15px">
											<ul class="breadcrumb col-md-12-1"
												...
												<li><a href="referal_doc_percent_master.jsp">Referal doc Percentage Master</a></li>
												...
												<div class="pull-right">
													<button class="btn btn-xs btn-success editUserAccess"
														...
														onclick="savePerMasterForRefDoc()">
													...
													<input type="button" class="btn btn-xs btn-success"
														...
														onclick="getDrForRefDocDeptList('onclick')">
												</div>
											</ul>
									...
									<div class="panel-body" >
										...
										<form class="form-horizontal col-md-12" >
											...
											<label><b>Doctor Name<span style="color: red;">*</span></b></label>
												...
												onkeyup="setAutoSugForRefDoctorList(this.id,'profees')"
											...
											<div class="form-group col-md-12" id="chargesSlaveDiv">
													<div class="form-group">
														<div class="col-md-12">
															...
															<select class="col-md-8" name="listmstr"
																id="listmstr_select_chargesinfo" style="width: 180px;margin-top: 13px;margin-left: -33px"
																onchange="setDyanamicDivForChargesinfoReferal('dynamicItemsinfo',this.id)">
																<option id="firstElmts2">--- Select Charges
																	Info ---</option>
															</select>
															<div
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title">Referal doc Percentage Master</h4>
							</div>
											...
											<div class="panel-body">
												<div class="tabbable">
													<ul class="nav nav-tabs">
														<!-- <li class="active" id="confgDrDeptsList"><a
															onclick="getDrForRefDocDeptList('onclick');"
														...
														<!-- <li id="confgDrPersonalList"><a
															...
															data-toggle="tab" style="cursor: pointer"><i
																class="fa fa-user-md"></i> Doctor Pers.Percent</a></li>
														<li><a onclick="fetchConfgDrPersonalList('groupPersonal','onclick');"
															data-toggle="tab" style="cursor: pointer"><i
																class="fa fa-user-md"></i> Group Pers.Percent</a></li> -->
														
														<li id="confgDrPersonalList"><a
															onclick="getRefDrPersonalList('doctorPersonal','onclick');"
															data-toggle="tab" style="cursor: pointer"><i
																class="fa fa-user-md"></i> Doctor Pers.Percent</a></li>
																
														<li id="confgDrPersonalList"><a
															onclick="getRefDrPersonalList('doctorRupees','onclick');"
															data-toggle="tab" style="cursor: pointer"><i
																class="fa fa-user-md"></i> Doctor Rupees</a></li>
																
														<!-- <li><a onclick="getRefDrPersonalList('groupPersonal','onclick');"
															data-toggle="tab" style="cursor: pointer"><i
																class="fa fa-user-md"></i> Group Pers.Percent</a></li> -->
