...
<body>
	<%
		try {
			...
			Document document = new Document(PageSize.LEGAL.rotate());///*new Rectangle(500,864),0,0,0,0);	//*/new Rectangle(0, 0,648, 864));/* width,height*/
		...
		//	int numOfPrint = adminModel.generalAccessNumOfPrint(printId);// to get number of prints
			...
			int[] headerwidth5 = { 4,8,10,10,14,6,6,7,8,7,10,10};
			...
			HeaderTable5.addCell(new Phrase("Rec No", subheader));	
			HeaderTable5.addCell(new Phrase("Rec Date", subheader));
			HeaderTable5.addCell(new Phrase("Patient Name.", subheader));
			HeaderTable5.addCell(new Phrase("Doctor Name", subheader));
			HeaderTable5.addCell(new Phrase("Service Name", subheader));
			HeaderTable5.addCell(new Phrase("GST Amt", subheader));
			HeaderTable5.addCell(new Phrase("Total Amt", subheader));
			HeaderTable5.addCell(new Phrase("Discount Amt", subheader));
			HeaderTable5.addCell(new Phrase("Paid Amt", subheader));
			HeaderTable5.addCell(new Phrase("Balance Amt", subheader));
			HeaderTable5.addCell(new Phrase("Ref. Dr.", subheader));			
			HeaderTable5.addCell(new Phrase("Source", subheader));		
			...
			for (int i = 0; i < lstPojo1.size(); i++) {
		        ...
		        if(!recdate.equals("-") || recdate.equals(null)){
						 String space[]=lstPojo1.get(i).getRecDate().split(" ");
						 String a1=space[0];
						 String a[]=a1.split("-");
				...
				HeaderTable5.addCell(new Phrase("" + drName,tabletext));
				
				HeaderTable5.addCell(new Phrase(""+serviceName, tabletext));
				HeaderTable5.addCell(new Phrase(""+gstAmt ,tabletext));				
				...
				HeaderTable5.addCell(new Phrase(""+refDr, tabletext));
				HeaderTable5.addCell(new Phrase(""+source1 ,tabletext));	
