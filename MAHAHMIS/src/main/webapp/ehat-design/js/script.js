var App = function () {
	...
	/*-----------------------------------------------------------------------------------*/
	/*	Sidebar & Main Content size matchearth
	 */
	/*-----------------------------------------------------------------------------------*/
	...
	var handleDataTables = function () {
		...
		$('#datatable2').dataTable({
                ...
                oTableTools: {
                    ...
                    sSwfPath: "ehat-design/js/datatables/extras/TableTools/media/swf/copy_csv_xls_pdf.swf"
                }
			});
	...
	var handleSelect2 = function () {
		...
		$("#lstMasterHall").select2();
		$("#listmstr_select_combination").select2();
		$("#listmstr_select_otcharges").select2();
		$("#listmstr_select_otcharges2").select2();
		$("#listmstr_select_otdrugs").select2();
		$("#listmstr_select_otinv").select2();
		$("#listmstr_select_otcath").select2();
		$("#listmstr_select_otcpoe").select2();
		...
		$("#selOTtypeOT").select2();
		//Added by kishor
		$("#doctorNameIpdSponsor").select2();
		$("#doctorNameOpdSponsor").select2();
	...
	var handleBackstretch = function () {
		 $.backstretch([
		"ehat-design/img/login/1.jpg"
		, "ehat-design/img/login/2.jpg"
		, "ehat-design/img/login/3.jpg"
		, "ehat-design/img/login/4.jpg"
	...
	var handleChat = function (elem) {
		var append = function() {
			...
			var msg = '';
				...
				msg +=	'<img class="media-object" alt="Generic placeholder image" src="ehat-design/img/chat/headshot2.jpg">';
				msg +=  '</a>';
	...
	var handleSliderNav = function () {
		...
		$('#address-book .slider-content ul li ul li a').click(function(e){
			...
			//Set the image
			$('#contact-card .headshot img').attr('src', 'ehat-design/img/addressbook/'+img_id+'.jpg');
	...
	var handleThemeSkins = function () {
        ...
        var setSkin = function (color) {
            $('#skin-switcher').attr("href", "ehat-design/css/themes/" + color + ".css");
		...
		if ($.cookie('gritter_show')) {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    image: 'ehat-design/img/gritter/cloud.png',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    // (string | optional) the image to display on the left
                    image: 'ehat-design/img/gritter/settings.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    ...
                    // (string | optional) the image to display on the left
                    image: 'ehat-design/img/gritter/buy.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
	...
	return {
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="./ehat-design/img/loaders/12.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
