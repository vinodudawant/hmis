...
<script type="text/javascript" src="js/ExtraJs/prevDiagnostic_Bill_Database.js"></script>
...
<script>
	jQuery(document).ready(function() {
		...
		$("#byName").val("");
		$("#byName").val("");
		getAllPatientRecordsForPrevDiagnostic(0,'-',1);		
		setAvaStatus();
...
<script type="text/javascript">
	...
	/* 	setPatientSearchType();
		...
		$("#byName").val("");
		$("#byName").val("");
		getAllPatientRecordsForPrevDiagnostic();		
		setAvaStatus();
		$("#preOpdBill").addClass("anchorActive");
					...
					<div class="row">
						<div id="content" class="col-lg-12">
							...
							<div class="col-md-12-1">
								...
								<div class="col-md-4 TextFont" id="divbyName">
									<input name="byName" type="text" autocomplete="off" id="byName" class="form-control input-SmallText"
										onkeyup="setAutoPatientName(this.id,'prevDiagnosticDD',event)" placeholder="Patient Id,Name,Mobileno"/>																		
								</div>
							...
							<div class="col-md-12" style="margin-top: 7px; padding-left: 3%; width: 102.3%; margin-bottom: 16px;">
								<div class="col-md-12-1" style="overflow-y: scroll; height:430px; maxheight: auto; border: 1px solid #b8b8b8;">
