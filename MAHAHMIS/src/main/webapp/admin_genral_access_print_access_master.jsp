...
<meta charset="utf-8">
<title>admin_genral_access_print_access_master</title>
<meta name="viewport"
										...
										<div class="page-header">
											...
											<ul class="breadcrumb">
												...
												<li><i class="fa fa-home"></i> <a
													href="UserManagement.jsp">Administrator</a></li>
												<li><i class="fa fa-home"></i> <a
													href="admin_genral_access_print_access_master.jsp">Admin
														Genral Access Print Master</a></li>
												...
												<div class="row" style="margin-top: 5px">
													<div class="col-md-12">
														<div class="panel panel-primary">
															<div class="panel-heading" id="divEhatContent">Admin
																Genral Access Print Master</div>
															<div class="panel-body"
																style="overflow: auto; height: 300px;">
																<div class="pull-right">
																<button type="button" class="btn btn-success"
																	 onclick="savePrintAccess()">Save</button>
																	 </div>
