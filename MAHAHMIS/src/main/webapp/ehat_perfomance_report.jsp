									...
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><i class="fa fa-home"></i> <a
												href="">Finance</a></li>
											<li><a href="ehat_perfomance_report.jsp">Performance Report</a></li>
											<li class="pull-right">
													...
													To Excel</button>
													 <script type="text/javascript">
														 ...
														 $(document).on('click', '#btnPrint', function (e) {
														    ...
														    link.download = "Performance Report.xls";
														    link.href = result;
														    link.click();
														});
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getPerformanceReport();"
														...
														<form class="form-horizontal col-md-12"
															...
															<div style="width: 1000px;">													
																<table class="datatable table table-bordered table-striped table-condensed cf" id="hisabTbl"
																	...
																	<thead class="cf">
																		<tr>																																																						
																			<th style="height: 21.5px;width: 25%" >Performance Report</th>	
																			<th style="height: 21.5px;width: 10%" >Date : </th>	
																			<th id='frDate' style="height: 21.5px;width: 10%" ></th>	
																			<th id='frDate' style="height: 21.5px;width: 10%" >To</th>																		
																			<th id='tdDate' style="height: 21.5px;width: 10%" ></th>																																																													
																		</tr>
																	</thead>
																...
																<table class="datatable table table-bordered table-striped table-condensed cf" id="hisabTbl"
																	...
																	<thead class="cf">
																		<tr>
																			...
																			<th style="height: 21.5px;width: 10%" >Dept.</th>	
																			<th style="height: 21.5px;width: 10%" >R.No.</th>																																					
																			<th style="height: 21.5px;width: 25%" >Patient Name</th>	
																			<th style="height: 21.5px;width: 10%" >Bill Amt</th>	
																			<th style="height: 21.5px;width: 10%" >Paid Amt</th>																		
																			<th style="height: 21.5px;width: 10%" >Balance Amt</th>																																																													
																		</tr>
																	</thead>
															...
															<div
																style="overflow: auto; margin-top: -21px; height: 350px;width: 1000px"
