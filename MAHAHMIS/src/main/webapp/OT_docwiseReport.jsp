									...
									<div class="col-sm-12">
										<div class="page-header">
											<ul class="breadcrumb col-md-8-1"
												...
												<li><a href="OT_Reports.jsp">
														Doctor Wise Surgery 	</a></li>
											</ul>
											<div style="margin-top:2px" class="pull-right">
													<button data-original-title="Export" class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="left" title="" onclick="showEXPORTot()" id="btnPrint">
														EXPORT
													</button>
													<script type="text/javascript">

														$(document).on('click', '#btnPrint', function (e) {
															var clonedContent = $('div[id$=containerot]').clone();
														    ...
														    link.download = " OTDoctorwiseSurgeryReport.xls";
														    link.href = result;
														    link.click();
														});																												
													</script> 
...
<div style="font-weight: bold;" class="col-md-1-1">Search
									By:</div>
										<div class="form-group col-md-2-1"style="">
										
											<input type="text"
												onclick="displayCalendar(document.getElementById('popup_container2'),'yyyy-mm-dd',this)"
												id="popup_container2"
											...
											<div class="form-group col-md-2-1" style="padding-left:10px;">
											<input type="text"
							...
							<!-- 	<div style="font-weight: bold;" class="col-md-1-1">Patient
								...
								<div class="divide-40"></div>
										...
										<div id="containerot" class="col-md-12-1"
											...
											<div style="margin-left:389px;display: none;" class=""><label style="width:200px;font-size:16px" class="center">SIDDHIVINAYAK NURSING HOME</label><br>
									<label style="width:320px;margin-left:-41px" class="center">1166, E Ward, Takala, Chowk, Sykes Extension, Kolhapur, Maharashtra 416008 Kolhapur Pin - 416008</label>
								
								<div style="margin-left:-36px" class=""><label style="width:300px;font-size:16px;display: none;" class="center">Doctor Wise Surgery Breakup	</label><br>
