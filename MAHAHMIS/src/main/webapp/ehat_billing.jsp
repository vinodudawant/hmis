...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		//setallservautocompleteOnBilling("tk"); 
		//setallchargesConfigOnBillingForIPD("tk");
		//hallwiseRateIPDauto("tk");
										...
										<div class="li pull-right">
											...
											<form action="UploadDoctordeskServlet" id="fileUploadfrm"
												...
												<div class="centered">
													...
													</label> <label class="checkbox-inline">Emergency Charge <input
															...
															<tr>
																<th class="col-md-3 center"><div class="TextFont">
																		<button id="btnRefund" class="btn btn-xs btn-primary"
																			onclick="saveRefundBillDetails('refund')"
