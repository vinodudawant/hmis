...
<script type="text/javascript"
	src="js/organ_collection.js"></script>
...
<body>
	<c:if test="${ sessionScope.userType != null }">
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><a href="odt_organ_barcode_generate.jsp">Barcode
													Generation</a></li>
										</ul>
														...
														<div class="row" style="padding: 20px 0 15px;">
															<div class="col-md-12">
																<label style="color: #2874A6; font-size: 12px">
																	Barcode Generate From Existing Organ Container </label>
															</div>
														</div>
														...
														<div class="row" style="padding: 5px 0;">
															<div class="col-md-3">
																<div class="form-group">
																	<label> Organ Container Number</label>

																	<div class="form-group" id="divtext_search_container_number">
																		<input type="text" class="form-control"
																			name="search_donor" id="search_container_number"
																			placeholder="Search Container Number"
																			onkeyup="serachOrganContainerNumberById(this.value)">
																	</div>
																</div>
															</div>
															<div class="col-md-3">
															...
															<div class="col-md-12">
																<button type="submit" class="btn btn-primary"
																	onclick="organDetailsBarcodePrint('barcodeGeneration')">Generate</button>
															</div>
														</div>
		...
		<input type="hidden" id="organDetailsNo" value="0" />
