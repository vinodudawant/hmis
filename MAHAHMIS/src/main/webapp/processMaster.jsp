									...
									<div class="box-body">
										<div class="tabbable header-tabs">
											<ul class="nav nav-tabs">
												...
												<li id ="processMaster" onclick="setNewTempProcess(this.id);" class="active ehatList "><a ><i
														class="fa fa-bookmark"></i> <span
														class="hidden-inline-mobile">Process Master</span>
...
<!-- JAVASCRIPTS -->
	...
	<script>
		jQuery(document).ready(function() {		
			...
			setNewTempProcess("processMaster"); 
			getAllProcess();
