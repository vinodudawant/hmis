...
<title>Opd/Diag Deleted Receipt Report</title>
								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="ehat_deleted_receipt_report.jsp">Opd/Diag Deleted Receipt Report</a></li>
											<li class="pull-right">
													 ...
													 <script type="text/javascript">
														 ...
														 $(document).on('click', '#btnPrint', function (e) {
															var clonedContent = $('div[id$=diveMain]').clone();
															    ...
															    link.download = "Opd/Diag Deleted Receipt Report.xls";
															    link.href = result;
															    link.click();
															});
																...
																style="background: Scrollbar; border-bottom: 1px solid black; border-top: 1px solid black;">
																	...
																	<thead class="cf">
																		<tr>
																			...
																			<th style="height: 21.5px;width: 6%" >Rec Date</th>																		
																			...
																			<th style="height: 21.5px;width: 6%" >Bill Date</th>		
																			<th style="height: 21.5px;width: 5%" >Source</th>	
																			<th style="height: 21.5px;width: 6%" >User</th>																			
																			<th style="height: 21.5px;width: 7%" >Deleted Date</th>		
																			<th style="height: 21.5px;width: 5%" >Deleted By</th>		
																			<th style="height: 21.5px;width: 7%" >Deleted Remark</th> 
																			<th style="height: 21.5px;width: 4%" >Unit</th>																																																				
																		</tr>
																	</thead>
