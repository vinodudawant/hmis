...
<body>
	<c:if test="${ sessionScope.userType != null }">
								...
								<div class="col-md-12">
									...
									<div>
										<ul class="nav nav-tabs">
											<li class="activeLink active"><a data-toggle="tab" href="#General" id="ipdbillpat" onclick="getIpdBillPatients11('onload',0,'1');"
												id="generalTab">General Patients</a></li>
											<li class="activeLink1 "><a data-toggle="tab" href="#physalDischarge" id="ipdbillphydispat" onclick="getIpdBillPhyDisPatients('onload',0,'1');">
														...
														<div class="col-md-12">
															...
															<!-- <div style="" class="col-md-2 TextFont" id="divbyName">
																<input name="byName" type="text" id="byName" class="typeahead form-control input-SmallText"
																	onkeyup="getHitOnEnter11(this.id,event)" autocomplete="off"/>
															</div> -->
															
															<div style="" class="col-md-2 TextFont" id="divbyName">
																<input name="byName" type="text" id="byName" class="typeahead form-control input-SmallText"
																	onkeyup="getIpdGeneralBillAutoDetails(this.id,event)" autocomplete="off"/>
															</div>
															...
															<div class="form-group col-md-3">
																 ...
																 <select name='listmstr' class="input-group" id="wardName"
																	style='width: 100%' onchange="getIpdBillPatients11('onload',0,'1')">
														...
														<div class="row">
															...
															<div class="col-md-12" id="listBedInfo">
																<div class="panel panel-primary">
																	<div class="panel-heading" id="divEhatContent">General Ipd Queue
																		</div>
																	<div class="panel-body"
														...
														<div class="col-md-12">
															...
															<div style="" class="col-md-2 TextFont" id="divbyName">
																<input name="byName" type="text" id="byName1" class="typeahead form-control input-SmallText"
																	onkeyup="GenBillPhydisPat(this.id,event)" />
															</div>
															...
															<div class="form-group col-md-3">
																 ...
																 <select name='listmstr' class="input-group" id="wardName1"
																	style='width: 100%' onchange="getIpdBillPhyDisPatients('onload',0,'1')">
																	<option value="0">-- Ward Name --</option>
																</select>
					...
					<div class="modal-content col-md-8"
						...
						<div class="modal-header">
							...
							<button class="btn btn-xs btn-danger" aria-label="Close"
								...
								style="margin-top: -37px;; margin-left: 330px"
		...
		jQuery(document).ready(function() {
			...
			getIpdBillPatients11("onload",0,'1');
		...
		<input type="hidden" id="selfsponsoralertflag">
		...
		<%
			...
			ResourceBundle resourceBundleEha12 = ResourceBundle.getBundle("EhatEnterpriseConfigurationFile");
			String selfsponsoralertflag = "";/*resourceBundleEha12.getObject("selfsponsoralertflag").toString(); */
		%>
		<input type="hidden" id="adminServId" value=<%=servId%>>	
		<input type="hidden" id="adminSubServId" value=<%=subServId%>>
		<input id="hallDetailDiv" type="hidden" /> <input id="allBedObj" type="hidden" />
		<input id="treatIdForPopUp" type="hidden" value="0" /> 
		<input type="hidden" id="selfsponsoralertflag" value="<%=selfsponsoralertflag %>">
		<!-- /JAVASCRIPTS -->
	</c:if>
	<c:if test="${sessionScope.userType == null}">
