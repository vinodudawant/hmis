							...
							<div class="row form-group">
								...
								<div class="col-md-12">
									...
									<div class="col-sm-4 text-center">
										...
										<input class="form-control" id="searchTextGrp" type="text"
											placeholder="Procedure Group" onkeyup="getProcedureGrpList()">
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="panel panel-primary">
										<div class="panel-heading">Procedure Group Master</div>
										<div class="panel-body">

											<div class="panel panel-default form-group" id="addProGrp"
												style="display: none;">

												<div class="panel-body">

													<form class="col-md-12 form-group" id="proGrpForm">
														<div class="form-row align-items-center">
															<div class="col-md-3">
																<label>Procedure Group:</label> <input type="hidden"
																	value="0" id="procedureGrpId"> <input
																	type="text" class="form-control form-control-sm mb-2"
																	id="procedureGrpName" placeholder="procedure Group">
															</div>
															<div class="col-md-3">
																<label>Group Type:</label> <select
																	class="form-control form-control-sm" id="grpType">
																	<option value="0">--select group--</option>
																	<option value="minor OT">Minor OT</option>
																	<option value="speciality">Speciality</option>
																	<option value="super speciality">Super
																		Speciality</option>
																</select>
															</div>
														</div>
														...
														<div class="form-row align-items-center">
															<div class="col-md-2">
																...
																<button class="btn btn-xs btn-primary" type="button"
																	onclick="onSaveProcedureGrp()">save</button>
															</div>
														</div>
													</form>
												</div>
												...
												<table
													...
													<thead>
														<tr>
															...
															<th class="col-md-3 text-center">Procedure Group</th>
															<th class="col-md-3 text-center">Group Type</th>
														</tr>
													</thead>
													<tbody id="procedureGrpist">
													</tbody>
												</table>
											</div>
