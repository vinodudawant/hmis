...
<!-- include js for development -->
<script type="text/javascript" src="js/inv_stock_audit.js"></script>
									...
									<div class="page-header" style="height: 94%;">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a
												href="inv_stock_audit.jsp">Stock Audit</a></li>
											<!-- <li class="pull-right">
												<button onclick="expoertexcel()" title=""
												...
												<div class="container">
													<ul class="nav nav-tabs">
														<li class="active"><a data-toggle="tab" href="#home" onclick="onClearText('clearSubInv')">Inventory
																Stock</a></li>
														<li id="invSubstock"><a data-toggle="tab"
															href="#menu1" onclick="onClearText('clearInv')">SubInVentory Stock</a></li>
													...
													<div class="tab-content">
															...
															<div class="col-md-3" style="margin: 1%;">
																<div class="input-group" id="itemByName">
																	<input type="search" id="stockItemName"
																		...
																		onkeyup="StockItemSuggestion(this.id,'stockAudit')">
																					...
																					<div style="overflow: auto;" id="sTable">
																						<table id="fixed_header"
																							...
																							<thead id="ehatTHead" class="fixedheaderdemo">
																								<tr>
																									<th class="col-md-1 center">SNo</th>
																									<th class="col-md-1 center">Item Id</th>
																									<th class="col-md-1 center">Item Name</th>
																									<th class="col-md-1 center">Batch No</th>
																									<th class="col-md-1 center" style="display: none;">ReOrder Stock</th>
																							...
																							<tbody id="stockAuditItem" style="height: 94px;">
																							</tbody>
																						</table>
																					</div>
																				</div>
														...
														<div id="menu1" class="tab-pane fade">
															<div class="col-md-3" style="margin: 1%;">&nbsp;</div>
															<div class="col-md-3" style="margin: 1%;">
																<div class="input-group" id="subInvByName">
																	<input type="search"
																		placeholder="enter subinventory name"
																		class="typeahead form-control col-md-4 input-SmallText"
																		id="subInvSearchText"
																		onkeyup="getSubInvAutoSuggestion(this.id,'subInvName')">
																	<span class="input-group-btn">
																		<button class="btn btn-primary btn-xs"
																			style="height: 25px; margin-bottom: 10px"
																			type="button">
															...
															<div class="col-md-3" style="margin: 1%;">
																<input type="button" value="View Suvbintorylist"
																	onclick="getAllSubInvList()" data-toggle="modal"
																	data-target="#Item_subinvlist"
																...
																<div class="tabbable header-tabs">
																	<div class="row">
																		<div class="col-md-12">
																			<div class="panel panel-primary"
																				style="margin-top: 5px">
																				<div class="panel-heading" id="divEhatContent">SubStore Stock List</div>
																				<div class="panel-body">
																					<div style="overflow: auto;" id="tTable">
																						<table id="fixed_header"
																							class="table table-striped table-bordered">
																							<thead id="ehatTHead" class="fixedheaderdemo">
																								<tr>
																	...
																	<div style="margin-top: -2%;">
																		<div class="pull-right">
																			<ul class="pagination pagination-blue margin-bottom-10"
																				id="stockAuditItemRecordPagination">
																			</ul>
																		</div>
																		<div class="pull-left">
																			<ul
																				class="pagination pagination-blue margin-bottom-10"
																				id="totalNumberOfPagesStockAuditItem">
																			</ul>
																			<input type='hidden' id='subInvId'>
																		</div>
															...
															<div id="Item_subinvlist" class="modal fade in"
																tabindex="-1">
																		...
																		<div class="modal-header">
																				...
																				<div class="pull-right" style="margin-right: 15px;">
																					<button data-dismiss="modal"
																						class="btn btn-primary btn-danger" type="button">Close</button>
																			...
																			<div style="overflow: auto;">
																				<table
																					...
																					<thead>
																						<tr>
																							<th>Sr.No</th>
																							<th>SubInventoryID</th>
																							<th>SubInventoryName</th>
																							<th>View</th>
																						</tr>
																					</thead>
																					<tbody id="subInvList">
