...
<title>Opd/Diag Discount Report</title>
								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="opd_discount_report.jsp">Opd/Diag Discount Report</a></li>
											<li class="pull-right">
													 ...
													 <script type="text/javascript">
													 	...
													 	$(document).on('click', '#btnPrint', function (e) {
															var clonedContent = $('div[id$=diveMain]').clone();
															    ...
															    link.download = "Opd/Diag Discount Report.xls";
															    link.href = result;
															    link.click();
															});
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getOpdDiscountReport();"
																...
																<table class="datatable table table-bordered table-striped table-condensed cf" id="hisabTbl"
																	...
																	<thead class="cf">
																		<tr>
																			...
																			<th style="height: 21.5px;width: 5%" >Receipt Date</th>																		
																			<th style="height: 21.5px;width: 6%" >Receipt Amount</th>
																			<th style="height: 21.5px;width: 6%" >Discount Amount</th>
																			<th style="height: 21.5px;width: 5%" >Paid Amount</th>
																			<th style="height: 21.5px;width: 6%" >Remain Amount</th>
																			<th style="height: 21.5px;width: 10%" >Reffered By</th>	
																			<th style="height: 21.5px;width: 10%" >Discount Remark</th>
																			<th style="height: 21.5px;width: 10%" >Discount Given By</th>
																			<th style="height: 21.5px;width: 10%" >User</th>
																			<th style="height: 21.5px;width: 7%" >Unit</th>																																																			
																		</tr>
																	</thead>
