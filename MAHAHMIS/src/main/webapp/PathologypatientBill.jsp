	...
	<div style="width: 100%;" id="printContent">
		...
		<div style='width: 100%; padding-top: 2%;'>
			...
			<div
				...
				<samp>
					Bill Date : <span id="repDate"></span>
				</samp>
			</div>
		</div>
		<b>__________________________________________________________________________________________________________________________________________________________________________________</b>
		...
		<div style="width: 100%; padding-left: 7%;" id="reportTest">
			...
			<div
				...
				<table border="" width="100%" height="30";>
					<tr>
						<td style="width: 20%;"><center>#No.</center></td>



						<td style="width: 40%;"><center>Test Name</center></td>


						<td style="width: 40%;"><center>Amount</center></td>
				...
				<table width="100%" height="30" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td
							style="width: 20%; border: 1px solid; border-color: gray; text-align: center;">{count++}.</td>



						<td
							style="width: 40%; border: 1px solid; border-color: gray; text-align: center;">{$T.liTstSlave.objTst.tName}</td>


						<td
							style="width: 40%; border: 1px solid; border-color: gray; text-align: center;">{$T.liTstSlave.objTst.patAmt}</td>
				...
				<table width="100%" height="30" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td
							style="width: 20%; border: 1px solid; border-color: gray; text-align: center; display: none;"></td>



						<td
							style="width: 40%; border: 1px solid; border-color: gray; text-align: center;">Total</td>


						<td id="totalAmount"
							style="width: 40%; border: 1px solid; border-color: gray; text-align: center;"><%=request.getParameter("totalAmount")%></td>
