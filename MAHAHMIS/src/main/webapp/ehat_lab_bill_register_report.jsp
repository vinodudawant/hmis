...
<title>Lab Bill Register Report</title>
...
<script type="text/javascript" src="js/ehat_lab_bill_register.js"></script>
									...
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><i class="fa fa-home"></i> <a
												href="">Finance</a></li>
											<li><a href="ehat_lab_bill_register_report.jsp">Lab Bill register  Report</a></li>
											<li class="pull-right">
												...
												<button id="btnPrint" class="btn btn-xs btn-warning"
													...
													<!--  <script type="text/javascript">
														 ...
														 $(document).on('click','#btnPrint',function(e) {
														        ...
														        link.download = "IPD Updation Report.xls"; //You need to change file_name here.
														        link.href = result;
														        link.click();
														    });
													...
													<script type="text/javascript">
														...
														var clonedContent = $('div[id$=diveMain]').clone();
														    ...
														    var link = document.createElement("a");
														    document.body.appendChild(link);
														    link.download = "Lab Bill Regsiter Report.xls";
														    link.href = result;
														    link.click();
													});
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<select class="form-control input-SmallText" id="searchType">
											 <option value="0">All </option>
											 <option value="1" style="background-color: yellow;">OPD </option>
											 <option value="2" style="background-color: orange;">IPD </option>
											 <option value="3" style="background-color: violet;">Diagnostic </option>
											</select>
										</div>
																	

										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getBillRegisterReport();"
												...
												<div id="diveMain" class="col-md-12" style="margin-top: 5px">
													...
													<div id="divLine2" class=" box border col-md-12" style="overflow: auto;">
														<form class="form-horizontal col-md-12"
															...
															<div
																style=" margin-top: -21px; height: 350px;width: 2200px"
																...
																<table class="table table-bordered table-striped table-condensed cf"
																 style="background: Scrollbar; border-bottom: 1px solid black; border-top: 1px solid black;width: 2200px;">
																	...
																	<thead class="cf">
																		<tr>
																			<th style="height: 21.5px;" >Sr.No.</th>
																			<th style="height: 21.5px;" >Bill Date</th>
																			<th style="height: 21.5px;" >Bill No</th>
																			<th style="height: 21.5px;" >MRN</th>
																			<th style="height: 21.5px;" >UHID</th>
																			<th style="height: 21.5px;" >Patient Name</th>
																			<th style="height: 21.5px;" >Patient Type</th>
																			<th style="height: 21.5px;" >Sponsor Name </th>
																			<th style="height: 21.5px;" >Consultant Name </th>
																			<th style="height: 21.5px;" >Specility </th>
																			<th style="height: 21.5px;" >Ref. Doctor</th>	
																			<th style="height: 21.5px;" >Cash/Credit </th>
																			<th style="height: 21.5px;" > Bill Amt</th>	
																			<th style="height: 21.5px;" >Discount Amt</th>
																			<th style="height: 21.5px;" >Discount Approve By</th>
																			<th style="height: 21.5px;" >Discount Remark</th>		
																			<th style="height: 21.5px;" >Concession Amt </th>
																			<!-- <th style="height: 21.5px;" >Concession Approve By </th> -->
																			<th style="height: 21.5px;" >Net Bill</th>
																			<th style="height: 21.5px;" >Amount Paid</th>
																			<th style="height: 21.5px;" >Deposit </th>
																			<th style="height: 21.5px;" >Refund amount</th>			
																			<th style="height: 21.5px;" >Dues</th>
																			<th id="visitType" style="height: 21.5px;" >Visit Type</th>
																			<th style="height: 21.5px;" >Patho Bill Amount</th>
																			<th style="height: 21.5px;" >Patho Discount</th>
																			<th style="height: 21.5px;" >Patho Concession</th>
																			<th style="height: 21.5px;" >Patho Net Amount</th>
																			<th style="height: 21.5px;" >Patho Paid Amount</th>
																			<th style="height: 21.5px;" >Patho Refund</th>
																			<th style="height: 21.5px;" >Patho Dues Amount</th>
																			<th style="height: 21.5px;" >Hospital Bill Amount</th>
																			<th style="height: 21.5px;" >Hospital Discount</th>
																			<th style="height: 21.5px;" >Hospital Concession</th>
																			<th style="height: 21.5px;" >Hospital Net Amount</th>
																			<th style="height: 21.5px;" >Hospital Paid Amount</th>
																			<th style="height: 21.5px;" >Hospital Refund</th>
																			<th style="height: 21.5px;" >Hospital Dues Amount</th>
