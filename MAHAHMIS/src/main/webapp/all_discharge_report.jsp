...
<meta charset="utf-8">
<title>All Discharge Report</title>
							...
							<div class="col-sm-12">
								<div class="page-header">
									...
									<ul class="breadcrumb">
										...
										<li>Ipd Reports</li>
										<li><a href="all_discharge_report.jsp">All Discharge Reports</a></li>
										...
										<div class="li pull-right">
											<div class="form-group"> 
												<div class="col-md-12"> 													
													...
													value="" onclick="printAllDischarge()" title="" 
													...
													To Excel</button> </div> 	
													 <script type="text/javascript">
														...
														$(document).on('click', '#btnPrint1', function (e) {
														    ...
														    link.download = "Discharge Report.xls";
														    link.href = result;
														    link.click();
														});
													</script> 
								...
								<div class="box border">
									<div class="box-title">
										...
										<div id="divbyName" class="col-md-12 TextFont"style="top: -6px;width: 211px;">
											<input type="text"
												onkeyup="getDischargePatientsDetails()"
																					...
																					<div class="form-group"> 
																						<div class="col-md-12">  
																							...
																							<div class="col-md-12 select2-container select2-container-multi " 
																								style="margin-top: 2%; width: 160px"> 
																				...
																				<div class="col-md-2">
																					...
																					<div class="col-md-12" style="margin-top: 11px"><label> </label></div>
																					 ...
																					 <input type="button" class="btn btn-xs btn-warning"
																						value="show" onclick="getDischargePatientsDetails();" />
																				</div> 
												...
												<div id="printDiv1" class="col-md-12" style="margin-top: 5px">
													...
													<div id="divLine2" class=" box border col-md-12" style="overflow: auto;">
														<form class="form-horizontal col-md-12"
															...
															<div
																style="overflow: auto; margin-top: -7px; height: 350px; border-bottom: 1px solid black; border-top: 1px solid black;"
																...
																<table class="table table-bordered table-striped table-condensed cf">
																	...
																	<thead class="cf">
																		<tr>																			
																						...
																						<th class='center TextFont' style="width: 6%;">UHID</th>
																						<th class='center TextFont' style="width: 8%;">IPD No</th>
																						<th class='center TextFont' style="width: 5%;">Reg No.</th>	
																						<th class='center TextFont' style="width: 7%;">Date of Admission</th>
																						...
																						<th class='center TextFont' style="width: 12%;">Ward</th>
																						<th class='center TextFont' style="width: 7%;">Admitted Under</th>																						
																						<th class='center TextFont' style="width: 6%;">Discharge Type</th>
