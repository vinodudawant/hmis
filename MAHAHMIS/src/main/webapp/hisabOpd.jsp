								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="hisabOpd.jsp">Opd Finance</a></li>
											<li class="pull-right">
												...
												<!-- <button class="btn btn-xs btn-warning editUserAccess"
													...
													title="XML Report" onclick="getXML()">
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getFinaceDetails('hisab',1)"
																...
																<thead class="cf">
																	<tr>
																		...
																		<th style="height: 21.5px;" class="numeric col-md-1"><div
																				class="TextFont"><input type="checkbox" id="opdRecChk" onclick="checkUncheck(this.id,'recChk')"></div></th>								
																	</tr>
																</thead>
															</table>
