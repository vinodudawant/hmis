...
<meta charset="utf-8">
<title>Sub Inventory Stock Reports</title>
<meta name="viewport"
									...
									<div class="page-header" style="height: 94%;">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a
												href="inv_sub_inventory_reports.jsp">Sub Inventroy Stock Reports</a></li>
											<li class="pull-right">
												<button id="subInventoryExportReport" title=""
													data-placement="left" class="btn btn-xs btn-warning">
													Export To Excel</button>
												<script type="text/javascript">
												$("[id$=subInventoryExportReport]")
														.click(
																function(e) {
															        ...
															        var table_div = document.getElementById('tTable');
															        var table_html = table_div.outerHTML.replace(/ /g, '%20');
															        a.href = data_type + ', ' + table_html;
															        //setting the file name
															        a.download = 'Sub_Inventroy_Stock_Reports_' + postfix + '.xls';
											...
											<div class="row">
												<div class="container">
													<ul class="nav nav-tabs">
														<li class="active" id="invSubstock"><a data-toggle="tab"
															href="#menu1" onclick="onClearText('clearInv')">Sub Inventory Stock Reports</a></li>
																	...
																	<div class="row">
																		<div class="col-md-12">
																			<div class="panel panel-primary" style="overflow: auto;">
																				<div class="panel-heading" id="divEhatContent">Sub Store Stock Reports List</div>
																				<div class="panel-body">
																					<div style="height: 300px;" id="tTable">
