...
<script src="js/ehat_canteen_master.js"></script>
										...
										<!-- <li class="li pull-right">
											<div style="" class="col-sm-1 ">
												<button onclick="hideCanteenDiv();"
													class="btn btn-xs btn-danger">View List(Ctrl + v)</button>
											</div>
										</li> -->
									</ul>
									<!-- /BREADCRUMBS -->
...
<div id="canteendetails" class="col-md-12-1"
							...
							<div style="margin-top: -30px"
								...
								<div id="canteendiv" class="box-body big ">
									...
									<div style="width: 18%; "
										...
										<label class="control-label">Code Name</label><input type="text"
											placeholder="Code Name" id="codename">
									</div>
	...
	<div id="canteenList" class="col-md-12-1 panel body "
						...
						<thead class="cf" style="background: white;">
							<tr>
								<th style="height: 21.5px;" class="col-md-1"><div>Sr
										No</div></th>
								<th style="height: 21.5px;" class="col-md-2"><div>Item Id
										</div></th>
								<th style="height: 21.5px;" class="col-md-2"><div>Item Name
										</div></th>
										
								<th style="height: 21.5px;" class="col-md-2"><div>Item Price
										</div></th>
								<th style="height: 21.5px;" class="col-md-2"><div>Code Name
										</div></th>
		...
		<input type="hidden" id="serviceid" value="<%=canteenids%>">
