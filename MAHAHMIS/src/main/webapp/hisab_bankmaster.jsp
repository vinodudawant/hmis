...
<title>Bank Master Finance</title>
					...
					<div class="row">
						<div id="content" class="col-lg-12">
								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="hisab_bankmaster.jsp">Bank Master Finance</a></li>
											
										</ul>
										<!-- /BREADCRUMBS -->
										<div class="clearfix">
											<h3 class="content-title pull-left">Fixed Header And Sidebar</h3>
										</div>
							...
							<div class="col-md-12" style="margin: 1%;">
								...
								<div class="col-md-2">
									<label class="TextFont"
										style="margin-left: 10%; margin-top: 3%;">Bank
										Name:</label>
								</div>

								<div style="margin-top: 0px;" class="col-md-2 TextFont"
									id="byNamee">
									<input class="col-md-12" name="userName" type="text"
										onkeyup="setAutoCompleteForNarrationMaster(this.id,'search')"
														...
														<div class="row" id="input-type"> 
															...
															<div class="col-sm-4"> 
																<label class="radio-inline"> 
																	<button onclick="saveFinaceBankDetails('save')" title="" data-placement="left" data-toggle="tooltip" class="pull-right btn btn-xs btn-success btn-table-add-row" id="savebuton" type="button" data-original-title="Save &amp; Print"><i class="fa fa-save"></i></button>
												  				</label>
															</div> 											 
														</div> 
													</div> 
							...
							<div class="panel panel-default">
								<div class="panel-body">
									<div class="col-md-12">
										<div class="col-md-4" style="height: 250px; margin-top: 0%;padding: 25px;border: 1px solid;border-radius:3px;;border-color:#cdd2d2">
											...
											<form class="form-horizontal">
												...
												<div class="col-sm-8">
													<input type="text" placeholder="Account No" id="accNo" title="" class="form-control tip-focus" data-original-title="Please enter account no" maxlength="12"></div>
												</div>
											</form>
										...
										<div class="col-md-7" style="height: 250px; padding-left: 15px;border: 1px solid;border-radius:3px;margin-left: 5px;border-color:#cdd2d2 ">

											<div class="col-sm-12">
												<table style="width: 100%; margin-top: 10px;" class="table table-bordered table-condensed cf">
													<thead class="cf">
														<tr>
															<th style="height: 21.5px;" class="col-md-1 center"><div class="TextFont">#</div></th>
															<th style="height: 21.5px;" class="col-md-1 center"><div class="TextFont">Bank Name</div></th>
															<th style="height: 21.5px;" class="col-md-1 center"><div class="TextFont">Account No.</div></th>
															<th style="height: 21.5px;" class="numeric col-md-1 center"><div class="TextFont">Edit</div></th>
															<th style="height: 21.5px;" class="numeric col-md-1 center"><div class="TextFont">Delete</div></th>														
														</tr>
													</thead>
