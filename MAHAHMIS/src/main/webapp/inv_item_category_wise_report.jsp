...
<meta charset="utf-8">
<title>Item Category Wise Report</title>
<meta name="viewport"
									...
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a
												href="inv_expiray_report.jsp">Item Category Wise Report</a></li>
										</ul>
										<!-- /BREADCRUMBS -->
														...
														function(e) {
															/* window
																	.open('data:application/vnd.ms-excel,'
																			+ encodeURIComponent($(
																					'div[id$=itemcategoryDetailMasterInfo]')
																					.html()));
															e.preventDefault(); */
													        ...
													        var table_div = document.getElementById('itemcategoryDetailMasterInfo');
													        var table_html = table_div.outerHTML.replace(/ /g, '%20');
													        a.href = data_type + ', ' + table_html;
													        //setting the file name
													        a.download = 'Item_Category_Wise_Report_' + postfix + '.xls';
														...
														<div class="row" style="margin-top: 5px">
															...
															<div class="col-md-12">
																...
																<div class="panel panel-primary" style="overflow: auto; ">
																	<div class="panel-heading" id="divEhatContent">Item	Category Wise Report Table</div>
																	<div class="panel-body"
																		style="height: 300px"
																		id="itemcategoryDetailMasterInfo">
																		<table
																			...
																			<tbody id="itemCategoryWiseDetailList">
																			</tbody>
																		</table>
