...
<title>Bill Register Report</title>
...
<script type="text/javascript" src="js/ehat_bill_register.js"></script>
									...
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><i class="fa fa-home"></i> <a
												href="">Finance</a></li>
											<li><a href="ehat_bill_register_report.jsp">Bill register  Report</a></li>
											<li class="pull-right">
												...
												<button id="btnPrint" class="btn btn-xs btn-warning"
													...
													<script type="text/javascript">
														...
														var clonedContent = $('div[id$=diveMain]').clone();
														    ...
														    var link = document.createElement("a");
														    document.body.appendChild(link);
														    link.download = "Bill Regsiter Report.xls";
														    link.href = result;
														    link.click();
													});
