...
<title>Cancel Bill Report</title> 
	...
	<section id="page">
		...
		<!-- /SIDEBAR -->
			<div id="main-content">
						...
						<div id="content" class="col-lg-12">
								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="ehat_deleted_bill_report.jsp">Cancel Bill Report</a></li>
											<li class="pull-right">
													...
													<script type="text/javascript">
														$(document).on('click', '#btnPrint', function (e) {
															var clonedContent = $('div[id$=diveMain]').clone();
															    ...
															    link.download = "Cancle Bill Report.xls";
															    link.href = result;
															    link.click();
															});
													</script> 
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="col-sm-1">
																<label for="inlineFold" class="control-label">Department:</label>
															</div>
															<div class="col-sm-2">
																<select name="Search_dept" class="form-control" id="search_department" >
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getOpdDeletedServiceBills();"
																...
																<table class="datatable table table-bordered table-striped table-condensed cf" id="hisabTbl"
																	...
																	<thead class="cf">
																		<tr>
																			...
																			<th style="height: 21.5px;width: 3%" >UHID</th>
																			...
																			<th style="height: 21.5px;width: 7%" >Reffered Dr.</th>	
																			<th style="height: 21.5px;width: 3%" >Bill Amount</th>	
																			<th style="height: 21.5px;width: 7%" >Service Name</th>	
																			<th style="height: 21.5px;width: 7%" >Doctor Name</th>		
																			...
																			<th style="height: 21.5px;width: 7%" >User Name</th>			
																			<th style="height: 21.5px;width: 5%" >Cancelled By</th>		
																			<th style="height: 21.5px;width: 5%" >Cancel Date</th>
																			<th style="height: 21.5px;width: 5%" >Remark</th>
																			<th style="height: 21.5px;width: 6%" >Source Name</th>		
																			<th style="height: 21.5px;width: 5%" >Unit</th>	
																			<th style="height: 21.5px;width: 5%" >Department </th>																																
																		</tr>
																	</thead>
				...
				<input type="hidden" id="search_department" value='0'>
