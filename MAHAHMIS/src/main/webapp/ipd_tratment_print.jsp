...
<body>
	<%
		...
		/* 	p.add(new Chunk(" \nCIN: "+cinNo+", GST : "+gstNo , tabletext));	
			...
			HeaderTable2.addCell(new Phrase("  Auto Discharge History Print   ", header));
			HeaderTable2.addCell(new Phrase("", subheader));
			HeaderTable2.addCell(new Phrase("", subheader));
...
//start prescription 
			  ...
			  HeaderTable5.addCell(new Phrase("", tabletext));
	      	PrescriptionService uss3  =(ApplicationContextUtils.getApplicationContext()).getBean(PrescriptionService.class);
	      	List<OPDPrescriptionDtoSP> listPrescriptionsSP = new ArrayList<>();	
	      	listPrescriptionsSP =  uss3.getAllPrescriptionsByTreatmentId(treatmentId, unitId);  // data by stored procedure
	      	 ...
	      	 PdfPTable HeaderTableSpace1 = new PdfPTable(1);
	      		...
	      		PdfPTable HeaderTableH1 = new PdfPTable(4);
	      				...
	      				HeaderTableCh1.addCell(new Phrase("Medicine Name", subheader));
