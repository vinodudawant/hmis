...
<%
	try {
			...
			response.setHeader("Content-Disposition", "inline; filename = Diagnostic Refund Receipt");
		...
		/* 	p.add(new Chunk(" \nCIN: "+cinNo+", GST : "+gstNo , tabletext));	
			...
			HeaderTable2.addCell(new Phrase("     DIAGNOSTICS REFUND ", header));
			HeaderTable2.addCell(new Phrase("", subheader));
			HeaderTable2.addCell(new Phrase("", subheader));
            ...
            HeaderTable3.addCell(new Phrase("Diag. No. ",subheader));
...
//------------------------------------------------added by vishant---------------------------------------------------------------
			...
			// Table5 : For service details head start
						double totConAmt = 0;
						double paidAmt = lstPojo.get(0).getTotalPaid();
						double totRemain = lstPojo.get(0).getTotalRemain();
						PdfPTable HeaderTableService5 = new PdfPTable(9);
						int[] headerwidthService5 = { 25, 40, 30, 10, 15, 40, 25, 15,15 };
						HeaderTableService5.setWidths(headerwidthService5);
						HeaderTableService5.setWidthPercentage(95f);
						HeaderTableService5.getDefaultCell().setBorder(Rectangle.BOTTOM);

						HeaderTableService5.addCell(new Phrase("", tabletext));
						HeaderTableService5.addCell(new Phrase("", tabletext));
						HeaderTableService5.addCell(new Phrase("", tabletext));
						HeaderTableService5.addCell(new Phrase("", tabletext));
						HeaderTableService5.addCell(new Phrase("", tabletext));
						...
						int labId = 0;
						for (int i = 0; i < lstPojo.get(0).getListBillRefundSlave()
								.size(); i++) {

							double servId = lstPojo.get(0).getListBillRefundSlave()
									.get(i).getServiceId();
							if (servId == 11) {
						...
						if (labId == 1) {
							...
							HeaderTableService5.addCell(new Phrase("Department", subheader));
							HeaderTableService5.addCell(new Phrase("BillHead", subheader));
							HeaderTableService5.addCell(new Phrase("Doctor Name", subheader));
							HeaderTableService5.addCell(new Phrase("Qty.", subheader));
							HeaderTableService5.getDefaultCell().setHorizontalAlignment(
									Element.ALIGN_RIGHT);
							HeaderTableService5.addCell(new Phrase("Rate", subheader));
							
							if(concessionFlow.equalsIgnoreCase("on")){
								HeaderTableService5.addCell(new Phrase("Concession", subheader));
							}else{
								HeaderTableService5.addCell(new Phrase("", subheader));
							}
							HeaderTableService5.addCell(new Phrase("Discount", subheader));
							HeaderTableService5.addCell(new Phrase("Refund", subheader));
							HeaderTableService5.addCell(new Phrase("Paid", subheader));
						} else {
						...
						document.add(HeaderTableService5);
						HeaderTableService5.flushContent();

						HeaderTableService5.getDefaultCell().setBorder(Rectangle.NO_BORDER);
						...
						if (labId == 1) {
							...
							for (int i = 0; i < lstPojo.get(0)
									.getListBillRefundSlave().size(); i++) {
								
								int serId = lstPojo.get(0).getListBillRefundSlave()
										.get(i).getServiceId();
								...
								String compName = "";
								if (lstPojo.get(0).getListBillRefundSlave().get(i).getAgainstId() > 0) {
									
									againstId = lstPojo.get(0).getListBillRefundSlave().get(i).getAgainstId();
									compName = "Receipt Against : " + againstNo;
								} else {

									compName = lstPojo.get(0).getListBillRefundSlave()
											.get(i).getCompName();
								}
								double rate = lstPojo.get(0).getListBillRefundSlave()
										.get(i).getRate();
								double qty = lstPojo.get(0).getListBillRefundSlave()
										.get(i).getQuantity();
								double amt = lstPojo.get(0).getListBillRefundSlave()
										.get(i).getAmount();
								double discountedAmount = lstPojo.get(0).getListBillRefundSlave().get(i).getDiscount();
								double refundedAmount = lstPojo.get(0).getListBillRefundSlave().get(i).getPaid();
								double consn = lstPojo.get(0).getListBillRefundSlave()
										.get(i).getConcession();
								int servDocId = lstPojo.get(0)
										.getListBillRefundSlave().get(i).getDoctorId();
								...
								HeaderTableService5.addCell(new Phrase("" + compName,
										tabletext));
								HeaderTableService5.addCell(new Phrase("" + servDocName, tabletext));
								HeaderTableService5.addCell(new Phrase("" + Math.round(qty), tabletext));

								PdfPCell cell2 = new PdfPCell(new Phrase("" + df2.format(rate), tabletext));
								cell2.setHorizontalAlignment(Element.ALIGN_RIGHT);
								cell2.setBorder(Rectangle.NO_BORDER);
								HeaderTableService5.addCell(cell2);
								...
								if(concessionFlow.equalsIgnoreCase("on")){
									HeaderTableService5.getDefaultCell().setHorizontalAlignment(
											Element.ALIGN_RIGHT);
									HeaderTableService5.addCell(new Phrase("" + df2.format(consn), tabletext));
								}else{
									HeaderTableService5.getDefaultCell().setHorizontalAlignment(
											Element.ALIGN_RIGHT);
									HeaderTableService5.addCell(new Phrase("", tabletext));
								...
								PdfPCell cellService52 = new PdfPCell(new Phrase(""
										+ df2.format(discountedAmount), tabletext));
								cellService52.setHorizontalAlignment(Element.ALIGN_RIGHT);
								cellService52.setBorder(Rectangle.NO_BORDER);
								HeaderTableService5.addCell(cellService52);
								
								
								
								PdfPCell cellService51 = new PdfPCell(new Phrase(""
										+ df2.format(refundedAmount), tabletext));
								cellService51.setHorizontalAlignment(Element.ALIGN_RIGHT);
								cellService51.setBorder(Rectangle.NO_BORDER);
								HeaderTableService5.addCell(cellService51);
								
								//netAmt
								PdfPCell cellService5 = new PdfPCell(new Phrase(""
										+ df2.format(refundedAmount), tabletext));
								cellService5.setHorizontalAlignment(Element.ALIGN_RIGHT);
								cellService5.setBorder(Rectangle.NO_BORDER);
								HeaderTableService5.addCell(cellService5);
							}
							...
							for (int i = 0; i < lstPojo.get(0)
								...
								if (lstPojo.get(0).getAgainstId() > 0) {
									...
									againstNo = lstPojo.get(0).getListBillRefundSlave().get(i).getCompName();
									compName = "Receipt Against : " + againstNo;
								} else {
								...
								HeaderTableService5.getDefaultCell().setHorizontalAlignment(
										Element.ALIGN_LEFT);
								HeaderTableService5.addCell(new Phrase("" + serviceName,
										tabletext));
								HeaderTableService5.addCell(new Phrase("" + compName,
										tabletext));
								HeaderTableService5.addCell(new Phrase("" + servDocName,
										tabletext));
								HeaderTableService5.addCell(new Phrase("" + Math.round(qty),
										tabletext));
								...
								if(concessionFlow.equalsIgnoreCase("on")){
									HeaderTableService5.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
									HeaderTableService5.addCell(new Phrase("" + df2.format(consn),tabletext));
								}else{
									HeaderTableService5.getDefaultCell().setHorizontalAlignment(Element.ALIGN_RIGHT);
									HeaderTableService5.addCell(new Phrase("", tabletext));
						...
						HeaderTableService5.addCell(new Phrase("Amount In Words:", subheader));
						...
						HeaderTableService5.addCell(new Phrase("Rs. " + oustandingAmt + " Only", tabletext));
						...
						HeaderTableService5.addCell(new Phrase("", tabletext));
						HeaderTableService5.addCell(new Phrase("", tabletext));
						HeaderTableService5.addCell(new Phrase("Paid Amount ("+currencyName+".) :",
								tabletext));
						//******************************************************
						PdfPCell cellService5 = new PdfPCell(new Phrase(""
						...
						if (totConAmt > 0) {
							...
							HeaderTableService5.addCell(new Phrase("Discount ("+currencyName+".) :",
									tabletext));
							...
							HeaderTableService5.addCell(cell7);
						...
						HeaderTableService5.addCell(new Phrase("", tabletext));
						HeaderTableService5.addCell(new Phrase("", tabletext));
						HeaderTableService5.addCell(new Phrase("Refunded Amount ("+currencyName+".) :",
								tabletext));
						...
						HeaderTableService5.addCell(cell6);
						...
						HeaderTableService5.addCell(new Phrase("", tabletext));
						HeaderTableService5.addCell(new Phrase("", tabletext));
						HeaderTableService5.addCell(new Phrase("Balance Amount("+currencyName+"):",tabletext));
		...
		//----------------------------------------------------------------------------------------------------------------------				
			...
			//for (int i = 0; i < lstPojo.get(0).getListBillReceiptSlave().size(); i++) {
				...
				HeaderTable5.addCell(new Phrase(""+ againstId,tabletext));
			...
			finalam1 = (long) lstPojo.get(0).getTotalPaid();
