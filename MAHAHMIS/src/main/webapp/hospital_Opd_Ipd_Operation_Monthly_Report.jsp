...
<title>Hospital OPD/IPD Operation Monthly Report</title>
									...
									<div class="col-sm-12">
										<div class="page-header">
											...
											<ul class="breadcrumb col-md-12-1"
												...
												<li><i class="fa fa-home"></i> <a href="Hospital_OPD_IPD_Opreation monthly_Report .jsp">Hospital OPD/IPD Operation Monthly Report</a>
											</li>
													...
													<div class="col-md-3">
														<div class="row">
															...
															<button class="btn btn-xs btn-primary"
																...
																onclick="getOPDIPDOperationSpecilitywiseReport()"
																type="button">
																<b> Show </b>
															</button>
														</div>
