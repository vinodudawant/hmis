...
<body>
	<%
		...
		String  printTitle= "IPD PRESCRIPTION "; //request.getParameter("printTitle");
		...
		String printType="IPDPrintPrescription";
				...
				listPrescriptionsSP =  uss2.getAllPrescriptionsByTreatmentId(treatmentId, unitId);  // data by stored procedure
				 ...
				 PdfPTable HeaderTableSpace = new PdfPTable(1);
					...
					PdfPTable HeaderTableH = new PdfPTable(4);
							...
							int[] headerwidthCh = {5,7,5,5,5,5,5 };
							...
							HeaderTableCh.addCell(new Phrase("RX", subheader));
							...
							HeaderTableCh.addCell(new Phrase("Prep. Drug", subheader));
							HeaderTableCh.addCell(new Phrase("Dose", subheader));
							HeaderTableCh.addCell(new Phrase("Advice", subheader));
							HeaderTableCh.addCell(new Phrase("Frequency", subheader));
							...
							for(int i=0;i<listPrescriptionsSP.size();i++ ){
								...
								HeaderTableCh.addCell(new Phrase(""+listPrescriptionsSP.get(i).getPrepName() + ". "+listPrescriptionsSP.get(i).getMedicineName(), tabletext));
								...
								if(languageOF.equalsIgnoreCase("ENGLISH")){
									...
									//HeaderTableCh.addCell(new Phrase(""+marathiInstr, FontFactory.getFont("Shivaji05", 10)));
