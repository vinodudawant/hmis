...
<title>Doctor Round Charges</title>
<meta name="viewport"
									...
									<div class="col-sm-12">
										<div class="page-header">
											<ul class="breadcrumb col-md-12-1"
												...
												<li><a href="DoctorRound.jsp">Doctor Round Charges </a></li>
											...
											<div id="divLine1" class=" col-md-12"
												...
												<form class="form-horizontal col-md-12">
													...
													<div class="col-md-3">
														...
														<div class="col-md-4" id="divsp" style="display: none">
														<div class="row">
															<!-- ---------Touheed Plugin Multi select Plugin-------------- -->
															<label class="TextFont" style="margin-bottom: -1px;">Select
																Sponsor</label>
															<div id="" class="form-group Remove-Padding col-md-12-1"
																...
																<div class="form-group">
																	<div class="col-md-8">
																		...
																		<select name="listmstr" id="listmstr_select_service"
																			style="width: 200px"
																			onchange="fetchSuperCatogoiresSlave(this.id)">
																			<option id="firstElmts" value="0">--- Select Sponsor
																				---</option>
																		</select>
																	</div>
...
<!-- 																<div
	...
	<div class="col-md-3"  style="margin-left:30px">
														<div class="row">
																	<label for="numeric">Rate:</label> <input type="text"  onkeypress="return validatePrice(event)"  onkeyup="applytoall()" name="rate" id="rate" value="0" class="form-control" style="text-align: right;width:60%">
													...
													<div class="col-md-2">
														<div class="row">
															...
															<input  id="btnsp" type="button" onclick="savedrroundchargesp()"  name="saveBill" id="saveBill" value="save" class="form-control btn btn-primary" style="width:40%;margin-top:20px;margin-left:-41px;display: none;" >
													...
													<div id="mulDynamicItemDiv" style=" width: 48%;margin-left:-303px;margin-top:21px;display: none;" class="col-md-12 select2-container select2-container-multi ">
																											<ul
																												style="overflow-y: scroll; min-height: 56px;margin-left:-9px;width: 65%;"
											...
											<!-- <div id="divLine4" class=" box col-md-12"
												style="margin-left: 0%; margin-top: -2%;">
												<form class="form-horizontal col-md-12"
													style="margin-top: -1%;" id="myform">
													<div class="divide-20"></div>
													...
													<div class="col-md-3" style="margin-left: -1%;">
														<div class="row">
															<label class="TextFont" style="margin-left: 10px;">Department
																Name<b
																style='color: red; padding-left: 3px;'>*</b></label> <select id="deptIdForConfig" class="form-control"
																style="width: 100%; margin-top: -5px; margin-left: 6px;">
													...
													<div class="col-md-4" style="margin-left: -1%;">
														<div class="row">
															...
															<label class="TextFont" style="margin-left: 10px;">Select
																Services </label>
															<div id="" class="form-group Remove-Padding col-md-12-1"
																style="margin-left: 7%; height: 46px; width: 3%;">
																...
																<div class="form-group">
																	...
																	<div class="col-md-8">
																		<select name="listmstr" id="listmstr_select"
																			style="width: 200px"
																			onchange="setDyanamicDiv('dynamicItem',this.id)">
																			<option id="firstElmt" value="0">--- Select Services
																				---</option>
