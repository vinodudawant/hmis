...
<!-- include js for development -->
<script type="text/javascript" src="js/ot_procedure_.js"></script>
<script type="text/javascript" src="js/ot_pro_type.js"></script>
<script type="text/javascript" src="js/ot_pro_grp_.js"></script>
...
<body>
	...
	<c:if test="${ sessionScope.userType != null }">
							...
							<div class="row form-group">
								...
								<div class="col-md-12">
									...
									<div class="col-sm-4 text-center">
										...
										<input class="form-control" id="searchTextProcedure"
											type="text" placeholder="Procedure Name"
											onkeyup="getProcedure()">
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="panel panel-primary">
										<div class="panel-heading">Procedure Name</div>
										<div class="panel-body">

											<div class="panel panel-default form-group" id="addProName"
												style="display: none;">

												<div class="panel-body">

													<form class="col-md-12 form-group" id="proNameForm">

														<div class="col-md-4">
															<label>Procedure Name:</label> <input type="hidden"
																class="form-control form-control-sm" value="0"
																id="proMasterid"> <input type="text"
																class="form-control form-control-sm" id="procName">
														</div>

														<div class="col-md-4">
															<label>Procedure Category:</label> <select
																class="form-control form-control-sm"
																id="procCatListFornewOt">
																<option value="0">--select procedure Category--</option>
															</select>
														</div>

														<div class="col-md-4 form-group">
															<label>Type:</label> <select
																class="form-control form-control-sm" id="type">
															...
															<div class="col-md-4">
																<label>Procedure Type:</label> <select
																	style="width: 100%;"  id="procTypeList">
														...
														<div class="col-md-4">
															<label>Procedure Group:</label> <select
																style="width: 100%;" 
																id="procGrpList">
																<option value="0">--select procedure Group--</option>
															</select>
														</div>
														...
														<div class="col-md-1">
															...
															<label class="checkbox-inline"> <input
																type="checkbox" id="cathflag" value="">Cathlab
															</label>
														</div>
		...
		jQuery(document).ready(function() {
			...
			getProcedureTypeList('dropdownlist');
			getProcedureGrpList('dropdownlist');
			fetchprocedureCatsedrv('dropdownlist');
			getProcedure();
