...
<title>Ipd Breakup Report</title>
								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="ehat_ipdbreakup_report.jsp">Ipd Breakup Report</a></li>
											<li class="pull-right">
													...
													To Excel</button>
													 <script type="text/javascript">
														 ...
														 $(document).on('click', '#btnPrint', function (e) {
														    ...
														    link.download = "IPD Breakup Report.xls";
														    link.href = result;
														    link.click();
														});
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getIpdBreakupReport();"
												...
												<div id="diveMain" class="col-md-12" style="margin-top: 5px">
													...
													<div id="divLine2" class=" box border col-md-12" style="overflow: auto;">
														<form class="form-horizontal col-md-12"
															...
															<div style="width: 7000px;height: 380px" >													
