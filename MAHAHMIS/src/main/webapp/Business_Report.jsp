...
<body>
									...
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><i class="fa fa-home"></i> <a
												href="">Finance</a></li>
											<li><a href="Business_Report.jsp">Business Report</a></li>
											<li class="pull-right">
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getTotalBusinessAmtWithPatho(); updateDynamicDateLabel();"
													...
													<div id="divLine2" class=" box border col-md-12" style="overflow: auto;">
														<form class="form-horizontal col-md-12"
														    ...
														    <label id="businessSheetLabel">
														        <i class="fa fa-arrow-down"></i> Business sheet from
    ...
    <table class="table">
      <thead>
        <tr style="background-color: lightyellow; font-size: 16px; border: 2px solid darkgray; font-weight: bold;">
          <th>Department</th>
          <th>Bill Amount</th>
          <th>Discount</th>
          <th>Concession</th>         
