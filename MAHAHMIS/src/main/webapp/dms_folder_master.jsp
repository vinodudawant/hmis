...
<!-- include js for development -->
<script type="text/javascript" src="js/folder_master.js"></script>
</head>
<body>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<li><i class="fa fa-home"></i> <a href="folder_master.jsp">Folder Master</a>
										</li>	
                                                ...
                                                <div class="box-body big" id="divEhatContent">
													...
													<form class="form-horizontal col-md-4" role="form">
														<div class="form-group">
															...
															<div class="col-sm-8">
																<input class="form-control tip-focus" title="Please enter folder name" id="folderName" type="text" placeholder="folder Name">
															</div>
														</div>
													</form>
													...
													<form class="form-horizontal col-md-3" role="form">													
														<div class="form-group">
															...
															<div class="col-sm-4">
																<input type="button" class="btn btn-success editUserAccess" disabled onclick="saveFolderDoc()" value="Submit"></div>
															<div class="col-sm-4">
																<input type="button"  class="btn btn-info" onclick="refreshFolderDoc()" value="Refresh">
															</div> 
														</div>
													</form>
                                                </div>                                                
											...
											<div class="row" style="margin-top: 10px">
												<div class="col-md-12">
													...
													<div class="box border green" id="div1">
														<div class="box-title">
															<h4>
																<i class="fa fa-table"></i>Folder Details
															</h4>
															...
															<table id="ehatTable" cellpadding="0" cellspacing="0" border="0"
																...
																<thead id="ehatTHead">																	
																	<tr>
																		...
																		<th class="col-md-1 center">Folder ID</th>
																		<th class="col-md-1 center">Folder Name</th>
