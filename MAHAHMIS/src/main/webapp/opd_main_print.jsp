			      			...
			      			*/
                              ...
                              try {
                                      for (int i = 0; i < reportInstructionDTOList.size();  i++) {
                                        ...
                                        //  Table3.addCell(new Phrase(""   + (reportInstructionDTOList.get(i) .getReportInstruction()), tabletext));

                                         // Table3.addCell(new Phrase("", tabletext));

                                         /*  if (reportInstructionDTOList.get(i + 1).getReportInstruction() != null || reportInstructionDTOList.get(i + 1)
