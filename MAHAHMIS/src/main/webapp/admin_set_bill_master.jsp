								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="Business_Report.jsp">Set Ipd Bill</a></li>											
										</ul>
									...
									<div class="col-md-12">
										...
										<div class="col-md-2">
											<label class="TextFont">Select Department</label> <select
												id="departmentId" class="form-control input-SmallText">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="setIpdBillAmt();"
												class="btn btn-primary" value="Distribute">
										</div>
										...
										<div class="panel panel-default"
											...
											<div class="panel-body">
												...
												<div id="diveMain" class="col-md-12" style="margin-top: 5px">
														...
														<h1 id="resultHead" align="center">Start Distribute by click on above button</h1>			
