...
<title>Previous Template Wise Summary</title>
<meta name="viewport"
...
<script type="text/javascript">
	onload = function() {
		...
		//fetchIPDPatientsForManualDischargeSummary("onload");
		//setAutoPatientName("byName","onload","Previous_ManualSummary");
 		<%-- getAllPatientRecordsForPreviousAutosummary("null",<%=request.getParameter("type")%>); --%>
 		getAllPatientRecordsForPreviousAutosummary("null",'temp');
...
<body style="background: white ! important;">
	...
	<section id="page">
		...
		<c:if test="${ sessionScope.userType != null }">
								...
								<div class="col-md-12-1">
									...
									<div style="" class="col-md-2-1 TextFont" id="divbyName">
										<input name="byName" type="text" id="byName" class="typeahead form-control input-SmallText"
											onkeypress="getAllPatientRecordsForPreviousAutosummary(this.id,'temp')" />
									</div>
									<div class="col-md-1-1" style="margin-left: 0%;">
										<label class="TextFont" style="margin-left: 30%;margin-top:3%;">Patient UHID:</label></div>
									...
									<div class="col-md-1-1" style="text-align: center;">
										<input type="button" value="search" class="btn btn-xs btn-primary" class="btn btn-xs btn-primary"
											onclick="getAllPatientRecordsForPreviousAutosummary(this.id,'temp')" />
									</div>
								</div>
																	...
																	<thead class='cf'>
																		<tr>
																			...
																			<th class='col-sm-3-1 center' >Patient
																				Name</th>
																				<th class='col-sm-1-1 center' >UHID
																				</th>
																					<th class='col-sm-1-1 center' >Mobile
																				No</th>
																			 
																			<th class='col-sm-2-1 center' >Admition
																				No</th>
			...
			<input type="hidden" id="pageName"  value="Manual" />
		</c:if>
	</section>
</body>
</html>