...
<script type="text/javascript" src="js/checklistMaster.js"></script>
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><a href="ChecklistMaster.jsp">Checklist</a></li>
										</ul>
									...
									<div class="panel panel-default">
										<div class="panel-body">										
											...
											<div class="panel panel-primary">
												<div class="panel-heading">Checklist Master
													:</div>
												<div class="panel-body">
														...
														<div class="row" >
															...
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" name="checklist_id" id="checklistId"
																		placeholder="Checklist Id" class="form-control">
																</div>
															</div>    -->
															...
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" name="checklist_type" id="checklistType"
																		placeholder="checklist Type" class="form-control">
																</div>
															</div>
															...
															<div class="function-buttons" style="float: center;">
																<div class="buttons">
																	...
																	<button type="button" class="btn btn-warning"
																		onclick="clearChecklistMasterDetails()">Clear</button>
																</div>
															</div>																					
														</div>
													</form>
													...
													<div class="row" style="margin-top: 10px">
														<div class="col-md-12">
															...
															<div class="panel panel-primary"
																...
																<div class="panel-heading" id="divEhatContent">Checklist</div>
																<div class="panel-body"
																...
																<table class="datatable table table-striped table-bordered">
																	<thead id="">
																		<tr>
																			<th class="col-md-1 center">Checklist ID</th>
																			<th class="col-md-1 center">Checklist Type</th>
																			<th class="col-md-1 center">edit</th>
																			<th class="col-md-1 center">Delete</th>
																		</tr>
																	</thead>
																	<tbody id="checklistMaster">
