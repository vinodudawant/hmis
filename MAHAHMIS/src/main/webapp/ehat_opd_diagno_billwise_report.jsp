...
<title>Opd/Diag Report Billwise</title>
...
<script type="text/javascript">
	onload = function() {
		...
		getOpdDiagnoPatientDataBillWISE();
	}
								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="ehat_opd_diagno_billwise_report.jsp">Opd/Diag Report Billwise</a></li>
											<li class="pull-right">
													...
													To Excel</button> 
														<script type="text/javascript">
														 	...
														 	$(document).on('click', '#btnPrint', function (e) {
															    ...
															    link.download = "Opd/Diag Report Billwise.xls";
															    link.href = result;
															    link.click();
															});
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getOpdDiagnoPatientDataBillWISE();"
												...
												<div id="diveMain" class="col-md-12" style="margin-top: 5px">
													...
													<div id="divLine2" class=" box border col-md-12" style="overflow: auto;">
														<form class="form-horizontal col-md-12"
															...
															<div
																style="margin-top: -21px; height: 350px;width: 2500px"
																class="col-md-12-1 box border">
																<table class="table table-bordered table-striped table-condensed cf" id="hisabTbl"
																	...
																	<thead class="cf">
																		<tr>
																			...
																			<th style="height: 21.5px;width: 5%">Patient Name</th>
																			<th style="height: 21.5px;width: 3%" >Bill No</th>
																			<th style="height: 21.5px;width: 5%" >Bill Date</th>
																			<th style="height: 21.5px;width: 5%" >Referred Dr.</th>
																			...
																			<th style="height: 21.5px;width: 5%" >Bill Amount</th>
																			<th style="height: 21.5px;width: 5%" >Discount</th>	
																			<th style="height: 21.5px;width: 5%" >Paid Amount</th>	
																			<th style="height: 21.5px;width: 5%" >Balance</th>	
																		</tr>
																	</thead>
