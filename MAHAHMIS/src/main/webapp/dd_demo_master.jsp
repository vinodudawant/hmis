...
<!-- <script src="ehat-design/bootstrap-dist/js/bootstrap.min.js"></script>
<script src="js/bootstrap-switch/bootstrap.timepicker.min.js"></script>
<script src="js/bootstrap-switch/bootstrap.timepicker.js"></script>
<link type="text/css" href="js/bootstrap-switch/bootstrap.min.css" />
<link type="text/css"
	href="js/bootstrap-switch/bootstrap-timepicker.min.css" />
TIMEPEACKER
<link rel="stylesheet" type="text/css"
			...
			<div id="main-content">
				<div class="container">
					<div id="content" class="row" style="background: #fff;">
						...
						<div class="">
							<div class="">
								<div class="aa pageheaderfordd" style="background: #ccc; height:10%;">
		...
		@Author:Arpit 
		   -->
								...
								<div class="box-body col-md-9">
										...
										<div class="row">
											...
											<div class="col-sm-1" id="seropositiveDiv"
												...
												<div class=" text-center">
													<img src="ehat-design/img/icon8.png" height="33">
											...
											<div class="col-sm-1" id="emrhighriskdiv"
												...
												<div class=" text-center">
													<i class="fa fa-exclamation-triangle"
														style="font-size: 33px; color: #ff00009c;"></i>
												</div>
											</div>
										</div>
										<div class="clearfix"></div>
									...
									<div class="row">
										<div class="col-md-10 center_wrapper" id="divhome">
											<div class="col-md-12">
												<div class="box-body">
													<div class="row ">
														<div class="col-sm-12 ">
																	...
																	<table class="table home_table">
																		<thead>
																			<tr>
																				...
																				<th class="text-center">Date</th>
																				<th class="text-center">Since(Days)</th>
		               ...
		               -->
																		...
																		<table class="table home_table">
																			<thead>
																				<tr>
																					...
																					<th class="text-center">Recomanded By</th>
																					<th class="text-center">Date</th>
																				</tr>
																			</thead>
										...
										<div class="col-md-10  hiddenDiv" id="divHide"
											...
											<div class="panel panel-default" id="upperheadrbody"
												...
												<div class="panel-body">
													<div class="col-md-12">
														...
														<label class="col-md-4 patHeader">Appointment with
															<b><label class="patHeader" id="previousapp"></label></b>
														</label> <label class="col-md-4 patHeader" style="margin-left:-30px;">Treatment No:&nbsp;<b><label class="patHeader" id="previousTreamentId"></label></b></label> <b><label
															class="col-md-3 patHeader text-warning" style="margin-left:-10px;">Follow
														...
														<a style="cursor:pointer" id="copyicon" data-toggle="modal" data-target="#mdfortreatment"><i class="fa fa-copy" style="font-size: 15px;"
															aria-hidden="true"></i></a>&nbsp; <i
															class="fa fa-print" style="font-size: 15px;"
															aria-hidden="true"></i>&nbsp; <i
															class="fa fa-share" style="font-size: 15px;"
															aria-hidden="true" onClick="emailReportingTestPatient()"></i>&nbsp;&nbsp; <i class="fa fa-file"
													...
													<div class="col-md-12">
														...
														<label class="col-md-4 patHeader" id="previousAppTime"></label> <label
															class="col-md-4 patHeader" style="margin-left:-30px;">DOA:&nbsp;<b><label class="patHeader" id="previousDOA"></label></b> </label><b>&nbsp;&nbsp;<label
															class="col-md-3 patHeader  text-warning" id="followupDayTime" style="margin-left:-10px;">
															</label></b>
											...
											<div class="panel panel-default">
												...
												<div id="collapseHistory">
													<div class="panel-body">
														...
														<div class="form-row  tabledynamicscroll" id="formHistory"
															style="display: none">
															<div class="col-md-3" id="perosnalDiHide" style="display:none">&nbsp;</div>
																<div class="col-md-4 mb-3" id="formPersonalHistory">
																	<label class="patHeader" style="font-size: 10px !important;">Personal History</label>
															 ...
															 <div class="col-md-3" id="FamilyDiHide" style="display:none">&nbsp;</div> 
															<div class="col-md-4 mb-3" id="formFamilyhistory">
																<label class="patHeader" style="font-size: 10px !important;">Family History</label>
												...
												<div id="collapseComplaints">
													<div class="panel-body">
														...
														<div class="form-row " id="formComplaints"
															style="display: none">
															<div class="col-md-12 tabledynamicscroll" id="divForEntry"
																>
												...
												<div id="collapseCilinic">
													<div class="panel-body">
														...
														<div class="form-row" id="formClinical"
															style="display: none">
															<div class="col-md-12 tabledynamicscroll" id="divForEntry1"
																>
																<label for="inputPassword"
																	class="col-sm-3 col-form-label"> </label>
																<div class="col-sm-5 "
															...
															<div class="form-row">
																...
																<div class="col-md-3 mb-3">
																	<label>Quantity (Duration*Days)</label> <input
																		type="text" disabled placeholder="Qunatity" id="qty"
															...
															<table
																...
																<thead>
																	<tr>
																		<th class="text-center">#</th>
																		<th class="text-center">DRUG</th>
																		<th class="text-center">Dosage &amp; Frequency</th>
												...
												<div class="tab-content">
													<div class="tab-pane fade in active" id="tab_1_8">
														...
														<button type="button" style="font-size: 10px;"
															class="btn btn-default btn-block">Access
															Template</button>
														<div class="clearfix"></div>
														<div class="space"></div>
														...
														<button type="button" class="btn btn-default  ">Charts</button>
														<div class="clearfix"></div>
														<div class="space"></div>
