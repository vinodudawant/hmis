...
<script type="text/javascript" src="js/dd_previoustreatment.js"></script>
...
function toCreateDiv(RowCount) {
	...
	document.getElementById(divId).innerHTML = '<td	style="height: 21.5px; width: 52px; text-align: center;">'
			...
			+ rowCount
			+ '" ><option></option></select></td><td style="height: 21.5px; width: 114px;"><input type="checkbox" id="checkbox'
			+ rowCount + '"   name="checkboxDR" value= "0" /><input type="hidden" value="0" id="salveId'+ rowCount + '"/></div>';
									...
									<div class="col-md-5-1" style="margin-left: 10px;">
										...
										<div class="col-md-6-1"  style="margin-top: 10px;">
											<select id="selRisTempList" name="selRisTempList"
												style="margin-top: 0px;"
												class="col-md-11-1 form-control input-SmallText " onchange="getDocTemplate(this.value,0);">
			...
			<div class="modal-body">
				...
				<div class="modal-footer">
					...
					<input type='hidden' id="commonAd_patId" value='0' /> <input
						...
						<input type="hidden" id="treatId" value=<%=request.getParameter("tid")%> /> 
				</div>
			</div>
		</div>
	</div>
...
<!-- vitals Nurshing Pop Up start -->
     <div id="iPopupNursing" class="modal fade in" tabindex="-1">
			...
			<div class="modal-content col-md-12-1" style="width:114%; margin-top: 7%; margin-left: -4%;">
				...
				<div id="times"  class="table-multi-columns2" class="col-sm-12-1"
					style="height: 400px; overflow-x: auto">
					<table
						class="table table-bordered table-striped table-condensed cf table-fixed"
						style="width: 300%; max-width: 850%;">
						<thead>
							<tr>
								<th class="TextFont center" style="width: 50px;">Sr</th>
								...
								<div class="modal-body" id="tempModalGraph" style="margin-bottom: -5%;"> 			
									<div style="margin-top: 0px; margin-left: 10px;" class="tabbable tabs-left col-md-12-1"> 
										<ul style="height: 150px;" class="nav nav-tabs" id="ipdMonitoringSheetVerticalTab"> 
											<li><a onclick="setVitalRecordGraph('Temp');" href="#Monitoring_Graph" data-toggle="tab">Temp Graph </a></li> 
											<li><a onclick="setVitalRecordGraph('Pulse');" href="#Monitoring_Graph" data-toggle="tab">Pulse Graph </a></li> 
											<li><a onclick="setVitalRecordGraph('Bp');" href="#Monitoring_Graph" data-toggle="tab">Bp Graph </a></li> 
											<li><a onclick="setVitalRecordGraph('Spo');" href="#Monitoring_Graph" data-toggle="tab">Spo Graph </a></li> 
										</ul> 
