								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><a href="pathology_machine_utilization_report.jsp">Analytics</a></li>
											<li><i class="fa fa-home"></i> <a href="pathology_machine_utilization_report.jsp">Machine Utilization Report</a></li>
								...
								<div class="col-md-12">
									...
									<div class="col-md-2">
										<div class="input-group">
											<label for="inlineFold" class="control-label">Machine Name:</label> 
											<select id="machineId" class="form-control input-SmallText"
													onchange="getMachineSerialNumbers()">
									...
									<div class="col-md-2">
										<div class="input-group">
											<label for="inlineFold" class="control-label">Serial No. :</label> 
											<select id="serialNo"
									...
									<div class=" col-md-3">
										<input type="button" value="Search"
											...
											onclick="getMachineUtilizationReport();"
											style="margin-top: 20px;"/>
											
											<input type="button" value="Export To Excel"
											class="btn btn-warning btn-xs" id="exportToExcelId"
											style="margin-top: 20px;" />
									</div>
													...
													<table id="ehatTable"
														...
														<thead id="ehatTHead">
															<tr style="background-color: lightblue">
																...
																<th class="col-md-2 center">Machine Name</th>
																<th class="col-md-1 center">Serial No</th>
																<th class="col-md-1 center">Barcode</th>
																<th class="col-md-1 center">Location</th>
																<th class="col-md-2 center">Department</th>
																<th class="col-md-2 center">Actual Capacity</th>
																<th class="col-md-2 center">No of Test Done</th>
																<th class="col-md-1 center">Utilization(%)</th>
															</tr>
														</thead>
														<tbody id="reportList">
														</tbody>
