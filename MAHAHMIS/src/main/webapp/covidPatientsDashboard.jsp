						...
						<div id="content" class="col-lg-12">
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
												...
												<!-- <li><i class="fa fa-home"></i> <a href="covidPatientsDashboard.jsp"></a></li>
												 -->
										</ul>
										<!-- /BREADCRUMBS -->
									</div>
								...
								<div class="col-md-12">
									...
									<div class=" col-md-1 ">
										<input type="button" value="Search"
											...
											onclick="getTotalPatientCounts('search')"
							...
							<!-- 		<div class=" col-md-1 ">
										<input type="button" value="Print"
											...
											onclick="getTotalPatientCountsPrint('search')"
											style="margin-top: 20px;" />
									</div>
							 -->		
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="panel-heading">IPD Admission and Discharge Count</div>
															...
															<div class="col-md-12">
																...
																<div class="panel panel-default"
																	...
																	<div class="panel-body"
																		...
																		<table id="covidPatientCountTable" cellpadding="0" cellspacing="0"
																			border="0"
																			class="datatable table table-striped  table-bordered">
																	<thead>
																		<tr>
																			<th class="col-md-2 center" colspan="2" style="background:#7fb99399">Total IPD
																				Admissions</th>
																			<th class="col-md-2 center" style="background:#b97f843b" colspan="2">Total
																				Discharges</th>
																			<th class="col-md-2 center" style="background:#796e601a" colspan="2">Total
																				Transfer outs</th>
																				<th class="col-md-2 center" style="background:#e8414194" colspan="2">Total
																				Death</th>
																		</tr>
																		<tr>
																	...
																	<tbody id="covidPatientCountTableBody">	</tbody>
																			</tbody>
																		</table>
																	</div>
																</div>
