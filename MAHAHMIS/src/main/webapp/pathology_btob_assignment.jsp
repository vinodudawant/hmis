...
<meta charset="utf-8">
<title>B2B Sample Assignment</title>
<meta name="viewport"
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a href="">B 2 B Sample Assignment</a></li>
								...
								<div class="col-md-12">
									...
									<div class="col-md-2">
										<div class="input-group" id="divbyName"
											...
											<label for="inlineFold" class="control-label"></label> <input
												...
												onkeyup="b2BAssignAndTransferAutoSuggestion(this.id, 'assign');">
										</div>
									</div>
									...
									<div class=" col-md-1">
										<input type="button" value="Search"
											...
											onclick="searchB2BAssignAndTransferRecords('assign');"
									...
									<div class="panel panel-default">
										...
										<div class="panel panel-default">
											<div class="panel-heading">
												...
												<li  class="active"  id="assignSample" >
												<a id="assign"  data-toggle="tab" href="#sampleAssignTab"  onclick="getB2BAsssignAndTransferRecords(this.id)"><i class="fa fa-bookmark"></i> 
												<span class="hidden-inline-mobile">Assign Samples</span>
												<span class="badge badge-blue font-11" id="subChrgCount"></span>
												</a></li>

												<li id="assignedSample" >
												<a id="assigned"  data-toggle="tab" href="#sampleAssignedTab" onclick="getB2BAsssignAndTransferRecords(this.id)"><i class="fa fa-bookmark"></i> 
												<span class="hidden-inline-mobile">Assigned Samples</span>
												...
												<div class="panel-body">
													<div class="tab-content">
														...
														<div id="sampleAssignTab" class="tab-pane fade in active">
																	...
																	<div class="col-md-2">
																		<div class="input-group" id="patchNames">
																			...
																			<select id="patchId" style="width: 150px"
																				onchange="getRunnerBoysByPatch('assign');">
																				<option value="0">Select Patch</option>
																			</select>
																		</div>
																	</div>
																	<div class="col-md-2">
																		<div class="input-group" id="runnerBoys">
																			<label for="inlineFold" class="control-label">Runner
																				Boys</label> <b style="color: red;">*</b>
																			<select id="runnerBoyId" style="width: 150px">
																				<option value="0">Select Runner Boy</option>
																			</select>
																		</div>
																	</div>
																	<div class="col-md-2 pull-right">
																		<button class="btn btn-info btn-xs" style="margin-top: 13%; margin-left: 40%;"
																			value="Assign" onclick="assignSamples()">Assign Samples</button>
																	</div>
																</div>
																<div class="panel">
																	<div class="panel-body"
																		...
																		<table id="ehatTable"
																			...
																			<tbody id="sampleAssignTableBody">
																			</tbody>
																		</table>
																	</div>
																</div>
															...
															<div style="margin-top: -1%">
																<div class="pull-right">
																	<ul class="pagination pagination-blue margin-bottom-10"
																		id="sampleAssignJumpToPage">
																	</ul>
																	<ul class="pagination pagination-blue margin-bottom-10"
																		id="sampleAssignPagination">
																	</ul>
																	<ul class="pagination pagination-blue margin-bottom-10"
																		id="sampleAssignNumberOfPages">
																	</ul>
																</div>
															</div>
															<!--   Ending  pagination -->
														...
														<div id="sampleAssignedTab" class="tab-pane fade in">
																		...
																		<table id="ehatTable"
																			...
																			<thead id="ehatTHead">
																				<tr style="background-color: lightblue">
																					...
																					<th class="col-md-1 center">Assigned Date Time</th>
																				...
																				<tr style="background-color: lightcyan">
																					...
																					<th class="col-md-1 center">
																						<select onchange="getAssignedSamplesByRunnerBoy();"
																								style="width: 100%; height: 50%;" id="runnerBoyFilter">
																						</select>
																					</th>
																					<th class="col-md-1 center"></th>
																					<th class="col-md-1 center"></th>
																			...
																			<tbody id="sampleAssignedTableBody">
																			</tbody>
																		</table>
																	</div>
																</div>
															...
															<div style="margin-top: -1%">
																<div class="pull-right">
																	<ul class="pagination pagination-blue margin-bottom-10"
																		id="sampleAssignedJumpToPage">
																	</ul>
																	<ul class="pagination pagination-blue margin-bottom-10"
																		id="sampleAssignedPagination">
																	</ul>
																	<ul class="pagination pagination-blue margin-bottom-10"
																		id="sampleAssignedNumberOfPages">
																	</ul>
																</div>
															</div>
															<!--   Ending  pagination -->
