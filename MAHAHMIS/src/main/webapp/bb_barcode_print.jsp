...
<body>
	<%
		...
		HeaderTable12.getDefaultCell().setBorder(Rectangle.NO_BORDER);
		 ...
		 String patientName = request.getParameter("ptName");
		 int masterId = Integer.parseInt(request.getParameter("requestId"));
		 String bagDetailsId=request.getParameter("requestId");
		 System.out.print("masterIdmasterIdmasterId"+masterId);
		
		String barcode=	masterId+patientName;
			
			
			if(barcode != null && !barcode.isEmpty() )
			{
				
				HeaderTable11.addCell(new Phrase(" "+barcode, subheader));
			}
