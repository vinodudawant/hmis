...
<title>Opd/Diag Refund Report</title>
								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="opd_refund_report.jsp">Opd/Diagnostics Refund Report</a></li>
											<li class="pull-right">
														...
														<script type="text/javascript">
															...
															$(document).on('click', '#btnPrint', function (e) {
																var clonedContent = $('div[id$=diveMain]').clone();
																    ...
																    link.download = "Opd/Diagnostics Refund Report.xls";
																    link.href = result;
																    link.click();
																});
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<!-- <div class="col-md-3" style="margin-top: 2px">
											...
											<div class="col-md-10">
												<select onchange="BankOnSelect();" style="width: 100%" id="payMode" class="form-control">
										...
										<div class="col-md-1" style="margin-top: 18px">
											<input type="button" onclick="getOpdRefundReport();"
													...
													<div id="divLine2" class=" box border col-md-12" style="overflow: auto;height: 450px;">
														<form class="form-horizontal col-md-12"
															...
															<div style="width:1700px;">													
																<table class="table table-bordered table-striped" id="hisabTbl"
																style="background: Scrollbar; border-bottom: 1px solid black; border-top: 1px solid black;">
																	<thead>
																		<tr>
																			...
																			<th style="height: 21.5px;width: 9%" >Patient Name</th>																		
																			<th style="height: 21.5px;width: 5%" >Receipt No</th>
																			<th style="height: 21.5px;width: 8%" >Refund Date</th>
																			<th style="height: 21.5px;width: 7%" >Department</th>		
																			<th style="height: 21.5px;width: 7%" >Against Receipt Id</th>																		
																			<th style="height: 21.5px;width: 6%" >Receipt Amount</th>
																			<th style="height: 21.5px;width: 6%" >Refund Amount</th>
																			<th style="height: 21.5px;width: 6%" >Remain Amount</th>
																			<th style="height: 21.5px;width: 8%" >Refund Given By</th>	
																			<th style="height: 21.5px;width: 8%" >Refund Remark</th>
																			<th style="height: 21.5px;width: 7%" >Referred By</th>
																			<th style="height: 21.5px;width: 7%" >User</th>
																			<th style="height: 21.5px;width: 8%" >Unit</th>																																																			
																		</tr>
																	</thead>
