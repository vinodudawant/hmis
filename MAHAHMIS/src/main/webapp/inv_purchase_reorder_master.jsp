...
<!-- prime loader starts here -->
	<div class="col-md-12 container-fluid" id="primeLoader" style="display:none;z-index:9999;height:100vh;background-color:rgba(13,13,13,0.3);position:absolute;">
          <div  class="col-md-offset-5 col-md-1" style="overflow: hidden;border-radius:25%;top:30%;background-color:#eee;padding:0;">
              ...
              <img src="images/3.gif" style="top:0;left:0" height="100" width="125" />          
          </div>
	</div>
<!-- prime loader ends here -->
	<c:if test="${ sessionScope.userType != null }">
						...
						<div id="content" class="col-lg-12">
									...
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a
												href="inv_purchase_order_master.jsp">Purchase Re-Order</a></li>
										</ul>
										<!-- /BREADCRUMBS -->
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="col-md-4">
										<div class="input-group" id="searchPurchaseOrderDivId">
											<input type="search"
												...
												id="searchPurchaseOrderId" onkeyup="fetchPurchaseReOrderDetails(this.id)" />
											<span class="input-group-btn">
												<button class="btn btn-primary"
													style="height: 25px; margin-bottom: 10px" type="button" onclick="getPurchaseReOrderDetailsById();">
									...
									<div class="col-md-4">
										<button class="btn btn-xs btn-info pull-left" type='button' onclick="getAllItemStockBelowMinimumLevel()"
											data-toggle="modal" data-target="#purchaseReOrderModuleModal">
											<i class="fa fa-plus"></i> Add Re-Order Purchase
										</button>
									</div>
								</div>
							</div>
							<!--Re-Order Purchase modal starts here -->
							<div class="modal fade" id="purchaseReOrderModuleModal" tabindex="-1" data-backdrop="static" data-keyboard="false"
								role="dialog" aria-labelledby="purchaseReOrderModuleModal"
								aria-hidden="true">
								<div class="modal-dialog modal-dialog-centered" role="document"
									style="width: 90%;">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel">Re-Order Purchase
									         <div class="pull-right" style="margin-right: 15px;">
										         <button type="button" id='savePurchaseReOrder' class="btn btn-primary" onclick="savePurchaseReOrder()">Save</button>
										         <button type="button" class="btn btn-primary btn-danger" data-dismiss="modal" onclick="closePROPopUp();">Close</button>
											</div>
										</h5>
										</div>
												...
												<div class="col-md-12">
													<div class="container">
														<div class="panel panel-primary">
															<div class="panel-heading" id="divEhatContent">Purchase Re-Order 
																</div>
															<div class="panel-body">
																<form id="financialFormId" onsubmit="return false">
																	<div class="form-row">
																		<div class="form-group col-md-2">
																		<label for="partyId">ReOrder No</label>
																		 <input type="text"	placeholder="Re Order No" readonly="readonly"
																	...
																	<div class="form-group col-md-2">
																		...
																		<div class="form-group col-md-2">
																			<label for="QuatationDate">Re-Order Date<b
																				style="color: red;">*</b></label> 
																		...
																		<div class="form-group col-md-2">
																			<label for="status">Re Order Series<b style="color: red;">*</b></label>
																			<input type="text"	class="form-control tip-focus"	id="orderSeriesId" 
																				name="supplier" value="PO2RMH" readonly="readonly"/> 
																		</div>
																		<div class="form-group col-md-2">
																			<label for="priority">Re Order status<b
																				style="color: red;">*</b></label>
																		...
																		<div class="form-group col-md-2">
																			...
																			<select style="width:100%;" id="supplierStateId" onchange="getVenderStateOnPurchaseOrder();">
																				<option value="0">--Select Status--</option>
																			</select>
																		</div>
																	</div>
														...
														<div class="container" style="margin-top: 2%;">
															<ul class="nav nav-tabs">
																<li class="active"><a data-toggle="tab" href="#reOrderGeneralInfo">Item Info</a></li>
																<li><a data-toggle="tab" href="#reOrderContactInfo">Contact Info</a></li>
																<li><a data-toggle="tab" href="#reOrderAddressInfo">Address Info</a></li>
																<li><a data-toggle="tab" href="#reOrderTermsAndConditionInfo" onclick="getMasterTermsAndConditionOnPO()">Term Conditions</a></li>
																<li><a data-toggle="tab" href="#reOrderUploadInfo">Upload Document</a></li>
															</ul>
															<div class="tab-content">
																<!-- general tab starts here -->
																<div id="reOrderGeneralInfo" class="tab-pane fade in active">
																				...
																				<div class="row">
																							...
																							<div style="height: 100px; margin-left: 2%;" >
																								...
																								height:190px;overflow-y: scroll; border: 1px solid #436a9d;' >
																									...
																									<th class='col-md-2 center' id="reOrderedColumn"><div>ReOrdered</div></th>
																...
																<div id="reOrderContactInfo" class="tab-pane fade">
																	<div class="panel panel-primary"
																...
																<div id="reOrderAddressInfo" class="tab-pane fade">
																	<div class="panel panel-primary"
																		style="margin-top: 20px">
																		<div class="panel-body">
																			<div class="container">
																...
																<div id="reOrderTermsAndConditionInfo" class="tab-pane fade">
																	<div class='panel panel-primary'>
																		<div class="panel-body">
																			<div class="container">
																				<div class="row">
																...
																<div id="reOrderUploadInfo" class="tab-pane fade">
																	<div class="panel panel-primary"
																		style="margin-top: 20px">
																		<div class="panel-body">
																			<div class="container">
																						...
																						<div style="font-weight: bold; overflow: auto;">
																							<table border="1"
																								...
																								<tbody style="overflow-x: scroll; border: 1px solid #436a9d;"
																									id="uploadedDocumentProBody"></tbody>
																							</table>
																						</div>
																					</div>
																				</div>
																					...
																					<div class="modal-dialog modal-dialog modal-lg">
																						<div class="modal-content">
																							<div class="modal-header">
																								...
																								<div class="modal-body">
																									<iframe id="viewDocumentPro" width="100%" height="300px"></iframe>
																								</div>
																							</div>
																						</div>
																					</div>
													...
													<div class="row">
													  <div class="form-group">
													    <label for="name" class="col-lg-4">GST</label>
													      <div class="col-lg-8">
													          <input class="form-control" name="name"  readonly="readonly" id="taxVatId" type="text" value="0">
													      </div>
													  </div>
													</div>
													<div class="row">
													  <div class="form-group">
													    <label for="name" class="col-lg-4">IGST</label>
													      <div class="col-lg-8">
													          <input class="form-control" name="name"  readonly="readonly" id="taxIgstId" type="text" value="0">
													      </div>
													  </div>
													</div>
													<div class="row" style="display: none;">
							...
							<!-- Re-Order Purchase modal ends here -->
							<!-- new modal starts here -->
													...
													<div class="tabbable header-tabs">
														<div class="row" style="margin-top: 10px">
															<div class="col-md-12">
																...
																<div class="panel panel-primary"
																	style="margin-top: 20px">
																	<div class="panel-heading" id="divEhatContent">Purchase Re-Order Details</div>
																	<div class="panel-body"
																		...
																		<table id="purchaseOrderTableId" cellpadding="0" cellspacing="0"
																			...
																			<thead id="ehatTHead">
																				<tr>
																					...
																					<th class="col-md-1 center">Purchase Re-Order ID</th>
																			...
																			<tbody id="purchaseReOrderTableBodyId">
																			</tbody>
																		</table>
																	</div>
																</div>
		...
		<input type="hidden" id="hiddenVenderStatePRO" value="0">
	...
	<!-- include js for development -->
      ...
      <script type="text/javascript" src="js/ehat_inv_purchase_reorder.js"></script>
</body>
</html>
