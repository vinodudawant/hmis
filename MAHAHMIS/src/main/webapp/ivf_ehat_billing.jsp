...
<meta charset="utf-8">
<title>Billing | EhatEnterprise</title>
...
<script type="text/javascript" src="js/ivf_bill.js"></script>
<script type="text/javascript" src="js/ivf_ehat_bill.js"></script>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		getAllPayments();
		getAllNarrations();
		getIvfTreatIdByNormalTreatmentId();// added by dayanand for getting ivf treatment id
					...
					<div id="content" class="col-lg-12">
											...
											<form action="UploadDoctordeskServlet" id="fileUploadfrm"
												...
												<div class="centered">
													...
													<%-- <button id="btnConvertIpd"
														class="btn btn-xs btn-warning editUserAccess"
							...
							<div class="row">
								...
								<div class="col-md-11">
									...
									<div class="col-md-12">
										...
										<%-- <%
										if(session.getAttribute("userFor").equals("airport")){
										%>
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label lblBold">Collected At:</label> <label
													class="control-label" id="collectedAtName"></label>
											</div>
										</div>
										<%
										}
											...
											<div class="form-group">
												<input type="hidden" id="uId"
													value="<%=session.getAttribute("uId")%>" /> 
													 ...
													 <input
													type="hidden" id="prePostPaid" value="0" />
													
													 <input
													type="hidden" id="customerType" value="0" /> <input
													type="hidden" id="customerId" value="0" /><input
													type="hidden" id="businessType" value="2" /><input
													type="hidden" id="registeredAt" value="other" /><input
													...
													type="hidden" id="editPerticularId" value="0" /> 
													<input	type="hidden" id="treatId" 	value=<%=request.getParameter("treatmentId")%> /> <input
													...
													<input type="hidden" id="ivfTreatId" value="0" />
						...
						<div class="row">
																...
																<form>
																	...
																	<div class="form-group col-md-2"
																		...
																		<label for="email">Particular:</label> <input
																			...
																			onkeyup="autosuggetionForDefaultIVF(this.id);">
																	</div>
															...
															<div>
																...
																<div
																	...
																	<label
																	  ...
																	  <label data-target=""
																		data-toggle="modal"
																		style="cursor: pointer; margin-bottom: 0px; margin-left: 20px;"  onclick="deallocateBedToIvfPatient(<%=request.getParameter("treatmentId")%>)">
																		<i class="fa fa-arrow-circle-right"></i> Bed Deallocation
																	</label>
																...
																<form>
																	...
																	<div class="form-group col-md-2"
																		...
																		<label for="email">Particular:</label> <input
																			...
																			onkeyup="setallchargesConfigOnBillingOPDIVF(this.id);">
																	</div>
													...
													<div class="tabbable">
														<ul class="nav nav-tabs" id="receiptUl">
															<li class="active" id="allReceipt"><a
																onclick="getIvfBillReceiptDetails('all')" data-toggle="tab"><i
																	class="fa fa-user-md"></i> All Receipts</a></li>
															<li><a onclick="getIvfBillReceiptDetails('cash')"
																data-toggle="tab"><i class="fa fa-user-md"></i> Cash
																	Receipts</a></li>
															<li><a onclick="getIvfBillReceiptDetails('credit')"
																data-toggle="tab"><i class="fa fa-credit-card"></i>
																	Credit Receipts</a></li>
															<li><a onclick="getIvfBillReceiptDetails('refundable')"
																data-toggle="tab"><i class="fa fa-credit-card"></i>
																	Refundable</a></li>
															<li><a onclick="getIvfBillRefundDetails('refund')"
																data-toggle="tab"><i class="fa fa-credit-card"></i>
																	Refunded</a></li>
															<li id="deletedReceipt"><a
																onclick="getIvfBillReceiptDetails('deleted')"
																data-toggle="tab"><i class="fa fa-credit-card"></i>
																	Deleted</a></li>
							...
							%>
									...
									<div class="col-md-3" id="payDiv" style="display: none;">
											...
											<div class="box border">
												...
												<div class="box-body" style="min-height: 430px">
															...
															<tr>
																<th class="col-md-3 center"><div class="TextFont">
																		<button id="btnRefund" class="btn btn-xs btn-primary"
																			onclick="saveIvfRefundBillDetails('refund')"
													...
													<table class="table table-condensed  bottomLine">
														...
														<tr>
															<!-- <td><div id="hideshowiPharmacyBtn" class="TextFont"
																	style="padding-top: 0px; display: block;">
																	<button id="iPharmacyBtn"
																		class="btn btn-xs btn-success"
																		data-target="#Indent_Sales_pending_data"
																		data-toggle="modal"
																		onclick="patientPaymentData();getSubServiceDetailsForSponsor11(21);getDiscOfSponser(1);getPharmacyInBillOrNot();"
																		style="background: red none repeat scroll 0% 0%;">Pharmacy
																		Payment</button>
																</div></td> -->
															<td></td>
															<td align="right"><input id="btnPayNow"
																type="button" onclick="saveIvfBillDetails('cash')"
																class="btn btn-xs btn-primary" value="Pay Now"></td>
												...
												if (treatmentId != '0') {
													...
													jQuery
															.ajax({
																...
																type : "GET",
																data : str + "&reqType=AJAX",
																url : "/EhatEnterprise/pharmacy/patientSale/getPendingAmountByTreatmentId",
																timeout : 1000 * 60 * 5,
																catche : false,
																error : function() {
