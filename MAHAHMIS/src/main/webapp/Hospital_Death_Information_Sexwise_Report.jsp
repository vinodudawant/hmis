...
<title>Hospital Death Information Sexwise   Report</title>
									...
									<div class="col-sm-12">
										<div class="page-header">
											...
											<ul class="breadcrumb col-md-12-1"
												...
												<li><i class="fa fa-home"></i> <a href="Hospital_Death_Information_Sexwise_Report.jsp">Hospital Death Information Sexwise Report</a>
											</li>
													...
													<div class="col-md-3">
														<div class="row">
															...
															<button class="btn btn-xs btn-primary"
																...
																onclick="getDeathInformationSexwiseReport()"
																type="button">
																<b> Show </b>
															</button>
														</div>
