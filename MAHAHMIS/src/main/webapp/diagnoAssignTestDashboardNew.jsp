...
<meta charset="utf-8">
<title>Diagnosis Assign Test Dashboard</title>
<meta name="viewport"
									...
									<div class="col-md-4">
										<div class="input-group" id="documentByName">
											<input class="form-control" id="searchName"
												type="text" onkeyup="dignoPatRecAutoSugg(this.id,'Digno')">
																		...
																		<table id="ehatTable" cellpadding="0" cellspacing="0"
																			...
																			<thead id="ehatTHead">
																				<tr>
																					...
																					<th class="col-md-1 center">Add Test</th>
																				</tr>
																			</thead>

																			<tbody id="diagnosticAssignTestBody">
																			</tbody>
																		</table>
																	</div>
																</div>
