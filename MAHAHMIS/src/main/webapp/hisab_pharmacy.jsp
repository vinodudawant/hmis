								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="hisab_pharmacy.jsp">Pharmacy Finance</a></li>
											<li class="pull-right">
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-3" style="margin-top: 2px">
											...
											<div class="col-md-10">
												<input type="text" id="fromDate" name="txtBillDate"
													class="form-control input-SmallText" readonly
													placeholder="From Date" required value="<%=todays_date%>"
													onfocus="displayCalendar(document.getElementById('fromDate'),'dd/mm/yyyy',this)">
											</div>
										</div>
										...
										<div class="col-md-3" style="margin-top: 2px">
											...
											<div class="col-md-10">
												...
												<input type="text" class="form-control input-SmallText"
													...
													name="popup_container3" id="toDate" value="<%=todays_date%>">
										...
										<div id="divLine2" class=" box border col-md-12">
											<form class="form-horizontal col-md-12" style="margin-top:10px">
												...
												<table class="datatable table table-bordered table-striped table-condensed cf"
													...
													<thead class="cf">
														<tr>
															<th class='col-md-1 center' style='height: 21.5px;'><div class='TextFont'>GRN No.</div></th>
															<th class='col-md-1 center' style='height: 21.5px;'><div class='TextFont'>GRN Date</div></th>
															<th class='col-md-3' style='height: 21.5px;'><div class='TextFont'>Party Name</div></th>
															<th class='col-md-1 center' style='height: 21.5px;'><div class='TextFont'>Bill No</div></th>
															<th class='col-md-2 center' style='height: 21.5px;text-align:right'><div class='TextFont'>Gross Amount</div></th>
															<th class='col-md-1 center' style='height: 21.5px;text-align:right'><div class='TextFont'>Disc</div></th>
															<th class='col-md-1 center' style='height: 21.5px;text-align:right'><div class='TextFont'>GST</div></th>
															<th class='col-md-1 center' style='height: 21.5px;text-align:right'><div class='TextFont'>Total Amt</div></th>
