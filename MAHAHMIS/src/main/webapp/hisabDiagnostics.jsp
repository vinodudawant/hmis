												...
												<script type="text/javascript">
													$(document).on('click', '#btnPrint', function (e) {
														var clonedContent = $('div[id$=diveMain]').clone();
														    ...
														    link.download = "Diagnosis Finance.xls";
														    link.href = result;
														    link.click();
														});
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getFinaceDetails('hisab',3)"
									...
									<div id="diveMain" class="col-md-12" style="margin-top: 5px">
										...
										<div id="divLine3" class=" box border col-md-12">
											<form class="form-horizontal col-md-12" style="margin-top:10px">
												...
												<div id="divTestDashVoucharList" class="box border col-md-12" style="overflow: auto; margin-top: -21px; height: 160px;">
