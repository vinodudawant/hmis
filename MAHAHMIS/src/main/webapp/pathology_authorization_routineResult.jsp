										...
										<div class="page-header">
											...
											<ul class="breadcrumb col-md-12">
												...
												<div class="li pull-right">													
												    ...
												    <button  class="btn btn-warning btn-xs" id="PrintHBtn" value="PH"  onclick="printRoutineValueResultW()">Print(W-H)</button>	
												    <button  class="btn btn-warning btn-xs" id="printBtn" value="PF"  onclick="printRoutineValueResult()">Print(H)</button>
												    <button class="btn btn-success btn-xs" id="postBtn" value="AAP" onclick="saveLabTestRoutineValueResult(this.id)"> Authorization And Post</button>
								...
								<div class="panel panel-default">
									<div class="panel-body">
											...
											<div class="form-group col-md-3">
												<label><strong>Samples</strong></label> <select
													id="patientWiseSamples" name="select" style="width: 70%;"
                                       ...
                                       <div id="anitId" style="display:none">
											<div class="col-md-1" id="history"
												style="margin-top: 0%; margin-left: 84%">
												...
												<div class="col-md-4" style="width: 100%;margin-top:2%;overflow: auto;">																					
													<div class="panel panel-primary">													
														 <div class="panel-body"
														    ...
														    <input type="hidden" value="1" id="authotabId" />
