...
<script src="js/chargesinfo.js"></script>
								...
								<div class="col-sm-12">
									<div class="page-header" style="">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li><a href="sponsor_hall_reports.jsp">Charges report</a></li>
											<li class="pull-right">
												<button id="btnExport"
												...
												<script type="text/javascript">
												 $(document).on('click', '#btnExport', function (e) {
												    ...
												    link.download = "Charges Report.xls";
												    link.href = result;
												    link.click();
												});
											</script>
															...
															<div class="form-group">
																...
																<div class="col-md-12">
																	<select name="listmstr"
																		id="listmstr_select_chargesinfo" style="width: 200px"
																		onclick="setDyanamicDivForChargesinfo('dynamicItemsinfo',this.id)">
																		<option id="firstElmts2" value="0">---
																			Select Sponsors ---</option>
												...
												<div class="col-md-1-1"
													...
													<div style="margin-top: 0px;" class="col-md-0-1">
														<button class="btn btn-xs btn-success" type="button"
															id="getproductData" onclick="getChargesDetailsData()"
