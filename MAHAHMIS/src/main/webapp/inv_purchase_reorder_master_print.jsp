<%@page import="com.hms.inventory.service.PurchaseReOrderService"%>
...
<%@ page import="com.hms.inventory.service.PurchaseReOrderService"%>
<%@ page import="com.hms.inventory.dto.PurchaseReOrderItemSlaveDto"%>
<%@ page import="com.hms.inventory.dto.PurchaseReOrderDto"%>
...
<body>
	<%
		...
		HeaderTable45.addCell(new Phrase("Purchase Re-Order" ,header));
		...
		PurchaseReOrderService puservice=(ApplicationContextUtils.getApplicationContext()).getBean(PurchaseReOrderService.class);
		PurchaseReOrderDto lstpurchaseobj=puservice.editPurchaseReOrder(pId);
		...
		/* **** **  item Party Master GeneralDetails Date:18 feb 2016 ** *******/
			...
			HeaderTable01.getDefaultCell().setBorder(Rectangle.NO_BORDER);
		      ...
		      nestedTable1.addCell(new Paragraph("  PRO NO",subheader ));
			...
			HeaderTable012.getDefaultCell().setBorder(Rectangle.NO_BORDER);
		      ...
		      nestedTable3.addCell(new Paragraph("  PRO DATE",subheader));
 ...
 PdfPTable HeaderTableMain = new PdfPTable(14);
	...
	for(int i=0;i<=lstpurchaseobj.getPurchaseReOrderItemSlaveDto().size()-1;i++)
		{
		String hsnCode=lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getHsnNameValue();
		...
		if(hsnCode.equalsIgnoreCase(null) ||hsnCode.equalsIgnoreCase("null")){
			...
			HeaderTableMain.addCell(new Phrase(""+lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getItemName(),	tabletext));

			PdfPCell cell13 = new PdfPCell(new Phrase(	""+lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getItemTradeDiscount(), tabletext));
			cell13.setHorizontalAlignment(Element.ALIGN_RIGHT);
			HeaderTableMain.addCell(cell13);
			
			PdfPCell cell131 = new PdfPCell(new Phrase(	""+lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getItemTradeDiscountRupees(), tabletext));
			cell131.setHorizontalAlignment(Element.ALIGN_RIGHT);
			HeaderTableMain.addCell(cell131);
			
			PdfPCell cell132 = new PdfPCell(new Phrase(	""+lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getUomUnitLatestFactorName(), tabletext));
			cell132.setHorizontalAlignment(Element.ALIGN_RIGHT);
			HeaderTableMain.addCell(cell132);

			PdfPCell batchCodeCells = new PdfPCell(new Phrase(""+lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getItemQuantity(), tabletext));
			batchCodeCells.setHorizontalAlignment(Element.ALIGN_CENTER);
			HeaderTableMain.addCell(batchCodeCells);


			PdfPCell cell222 = new PdfPCell(new Phrase("" +lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getItemUnitPrice() ,tabletext));
			cell222.setHorizontalAlignment(Element.ALIGN_RIGHT);
			HeaderTableMain.addCell(cell222);

			

			PdfPCell prcell = new PdfPCell(new Phrase("" +lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getItemTradeDiscountAmount() ,tabletext));
			prcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
			HeaderTableMain.addCell(prcell);

			PdfPCell cell42 = new PdfPCell(	new Phrase("" + lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getItemTradeBaseAmount(),	tabletext));
		...
		/* 	PdfPCell cell56 = new PdfPCell(new Phrase(""+lstpurchaseobj.getLstGoodReceiptNoteItemDto().get(i).getItemBaseAmt(), tabletext));
			...
			PdfPCell gst3 = new PdfPCell(new Phrase(""+lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getGst(),	tabletext));
			gst3.setHorizontalAlignment(Element.ALIGN_RIGHT);
			HeaderTableMain.addCell(gst3);

			PdfPCell gst31 = new PdfPCell(new Phrase(""+lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getGstAmountValue(),	tabletext));
			gst31.setHorizontalAlignment(Element.ALIGN_RIGHT);
			HeaderTableMain.addCell(gst31);
			
			PdfPCell gst212 = new PdfPCell(new Phrase(""+lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getIgst(),	tabletext));
			gst212.setHorizontalAlignment(Element.ALIGN_RIGHT);
			HeaderTableMain.addCell(gst212);
			
			PdfPCell gst2 = new PdfPCell(new Phrase(""+lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getIgstAmountValue(),tabletext));
			gst2.setHorizontalAlignment(Element.ALIGN_RIGHT);
			HeaderTableMain.addCell(gst2);

			totalAmt = totalAmt +lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getTotalAmount();
			
			
			PdfPCell gst21 = new PdfPCell(new Phrase(""+lstpurchaseobj.getPurchaseReOrderItemSlaveDto().get(i).getTotalAmount(),	tabletext));
