...
onload = function() {
	...
	getlistforRequestedItemsDashboardCsd();
	getlistforProcessingItemsDashboardCsd();
	getlistforCompletedItemsDashboardCsd();
	getlistforDispachedItemsDashboardCsd();
