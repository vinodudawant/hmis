...
<title>Deleted Opd Bill Report</title>
								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="ehat_deleted_bill_report.jsp">Opd Deleted Bill Report</a></li>
											<li class="pull-right">
												...
												<button id="btnPrint" class="btn btn-xs btn-warning"
													...
													To Excel</button> <script type="text/javascript">
														$("[id$=btnPrint]").click(function(e) {
													        ...
													        a.download = 'Cancel_Bill_Report_' + postfix + '.xls';
																...
																<table class="datatable table table-bordered table-striped table-condensed cf" id="hisabTbl"
																	...
																	<thead class="cf">
																		<tr>
																			...
																			<th style="height: 21.5px;width: 6%" >Deleted By</th>		
																			<th style="height: 21.5px;width: 5%" >Deleted Date</th>
																			<th style="height: 21.5px;width: 5%" >Deleted Remark</th>
