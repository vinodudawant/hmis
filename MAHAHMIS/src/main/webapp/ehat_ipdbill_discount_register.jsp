...
<title>Consolidated Discount Register</title>
									...
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><i class="fa fa-home"></i> <a
												href="">Finance</a></li>
											<li><a href="ehat_ipdbill_discount_register.jsp">Consolidated Discount Register</a></li>
											<li class="pull-right">
													...
													To Excel</button>
													 <script type="text/javascript">
														 ...
														 $(document).on('click', '#btnPrint', function (e) {
															    ...
															    link.download = "Consolidated Discount Register.xls";
															    link.href = result;
															    link.click();
															});
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getIpdBillDiscountRegister();"
																...
																<table class="table table-bordered table-striped table-condensed cf">
																	...
																	<thead class="cf">
																		<tr>
																			...
																			<th style="height: 21.5px;width: 7%">Bill Amount</th>	
																			<th style="height: 21.5px;width: 7%">Concession</th>		
																			<th style="height: 21.5px;width: 9%">Authorized By</th>	
																			<th style="height: 21.5px;width: 9%">Reason</th>	
																			<th style="height: 21.5px;width: 9%">Requested by</th>
																			<th style="height: 21.5px;width: 7%">Request Comment</th>	
																			<th style="height: 21.5px;width: 9%">Approved by</th>
																			<th style="height: 21.5px;width: 7%">Approved Remark</th>	
																			<!-- <th style="height: 21.5px;width: 9%">User Name</th>	 -->																																																																	
																		</tr>
																	</thead>
