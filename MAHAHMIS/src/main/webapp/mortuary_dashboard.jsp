...
<script type="text/javascript">
	onload = function() {
		$("#mortuary").addClass("menuActive");//Annapurna
/* 		$("#mortuary").addClass("anchorActive"); */
						...
						<div class="modal-content">
							...
							<div class="modal-header">
								<button type="button" class="btn btn-default  li pull-right"
									id="closeDispecedpopup" onclick="RegisterMortuarypopup(),getCustomizeTemplatesIDDischarge(this.value);"
									style="">Close</button>
								<div class="box-title">
									<h4>
															...
															<div class="form-group"style="margin-top: 6%;">
																...
																<div class="form-group">
																	...
																	<div class="">
																		<input type="text"
																			class="typeahead form-control input-SmallText"
																			onchange='return validateAlphabets(this.id)' 
																			style="width: 70%;" name="DeceasedName"
																...
																<div>
																	<div class="form-group">
																		...
																		<div class="">
																			<input type="text"
																				class="typeahead form-control input-SmallText"
																				onkeypress='return validateAlphabets(this.id)' 
