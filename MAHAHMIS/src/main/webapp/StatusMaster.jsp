...
<script type="text/javascript" src="js/StatusMaster.js"></script>
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><a href="StatusMaster.jsp">Status</a></li>
										</ul>
									...
									<div class="panel panel-default">
										<div class="panel-body">										
											...
											<div class="panel panel-primary">
												<div class="panel-heading">Status Master
													:</div>
												<div class="panel-body">
												 		...
												 		<!-- 	<div class="col-md-2" style =display:none>
															...
															<div class="col-md-2" style =display:none>
																<div class="form-group">
																	<input type="text" name="status_id" id="statusId"
																		placeholder="Status Id" class="form-control">
																</div>
															</div> -->
															<div class="col-md-2" >
															Status Type
															...
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" name="status_type" id="statusType"
																		placeholder="Status Type" class="form-control" autocomplete=off>
																</div>
															</div>
														...
														<div class="function-buttons" style="float: center;">
															<div class="buttons">
																...
																<button type="button" class="btn btn-warning"
																	onclick="clearStatusMasterDetails()">Clear</button>
															</div>
														</div>																					
													</div>
													</form>
																	...
																	<div class="row" style="margin-top: 10px">
																		<div class="col-md-12">
																			...
																			<div class="panel panel-primary"
																				...
																				<div class="panel-heading" id="divEhatContent">Status</div>
																				<div class="panel-body"
																				...
																				<thead id="">
																					<tr>
																						<th class="col-md-1 center">Status ID</th>
																						<th class="col-md-1 center">Status Type</th>
																						<th class="col-md-1 center">edit</th>
																						<th class="col-md-1 center">Delete</th>
																						
																					</tr>
																				</thead>
																				<tbody id="statusMasterList">
