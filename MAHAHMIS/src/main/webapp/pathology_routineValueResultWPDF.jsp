...
<body>
	<%
		try {
			...
			Integer covidReportId=Integer.parseInt(COVID19RNAAMPLIFICATION);		
			...
			document.setMargins(40, 20, 80, 20);
			...
			System.out.println(collecteddate+"collecteddate"+barcodenumber+"barcodenumber");
		...
		postId = 0;
			...
			footerNew.setBorder(Rectangle.NO_BORDER);
			footerNew.setBottom(50);
