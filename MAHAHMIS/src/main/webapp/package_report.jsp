								...
								<div class="col-sm-12">
									<div class="page-header" style="">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li><a href="package_report.jsp">Package report</a></li>
											<li class="pull-right">
												<button id="btnExport"
									...
									<div class="col-md-12-1">
															...
															<div class="form-group">
																...
																<div class="col-md-12">
																	<select name="listmstrcom"
																		id="listmstr_select_combination" style="width: 200px"
												...
												<div class="col-md-1-1"
													...
													<div style="margin-top: 9px;" class="col-md-4-1">
														<button class="btn btn-xs btn-success" type="button"
															id="getproductData" onclick="getppackageData()"
										...
										<div id="reportListpackage"
											...
											<div style="margin-bottom: 10px;" class="col-md-12-1 center">
												<h4 id="packageName">Package Report</h4>
