...
<meta charset="utf-8">
<title>OutSource Reason Master</title>
<meta name="viewport"
...
<!-- include js for development -->
	...
	<!-- include js for development -->
<script type="text/javascript" src="js/pathology_outsource_reason.js"></script>
</head>
<body>
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><a href="pathology_outSource_ReasonMaster.jsp">OutSource Reason Master</a></li>
										</ul>
										<!-- /BREADCRUMBS -->
								...
								<div class="col-md-12">
									 ...
									 <div class="col-md-4">
										<div class="input-group" id="documentByName">
											<input class="form-control"
												title="Please enter Reason name" id="searchId" type="text"
												placeholder="Reason Name" onkeyup="searchOutSourceReasonByName(this.value)">
									...
									<div class="col-md-4">
										<button class="btn btn-xs btn-info pull-right" type="button" onclick="toggleEntryDiv('divForAddForm')">
											<i class="fa fa-plus"></i> Add OutSource Reason
										</button>
									</div>
								</div>
							</div>
														...
														<div class="panel panel-primary">
															<div class="panel-heading" id="divEhatContent"></div>
																...
																<div class="form-group col-md-4">
																	<label>OutSource Reason Name</label> <input type="text"
																		class="form-control" id="outReasonName" 
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-4">
																				<input type="button" class="btn btn-success"
																					onclick="saveOutSourceReason();" value="Save">
																			</div>
																			<div class="col-sm-4">
																				<input type="button" class="btn btn-info"
																					onclick="resetOutSorceReasonForm();" value="Reset">
																			</div>
																		</div>
																</form>
														...
														<div class="row">
															<div class="col-md-12">																
																<div class="panel panel-primary" style="margin-top: 5px">
																	<div class="panel-heading" id="divEhatContent">OutSource Reason
																		Table</div>
																	<div class="panel-body">
																		<table id="fixed_header" class="table table-bordered">
																			<thead id="ehatTHead" class="fixedheaderdemo">
																				<tr>
																					...
																					<th class="col-md-2 center">OutSource Reason Name</th>
																					<th class="col-md-2 center">Edit</th>
																					<th class="col-md-2 center">Delete</th>
																				</tr>
																			</thead>
																			<tbody id="outSourceReasonTableBody">
																			</tbody>
																		</table>																		
																	</div>
																</div>
	...
	<input type="hidden" id=outReasonId value="0">
