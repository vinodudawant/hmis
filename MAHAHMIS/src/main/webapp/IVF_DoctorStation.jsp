...
<title>IVF Doctor Station</title>
<meta name="viewport"
...
<script type="text/javascript"
	src="js/ExtraJs/jqx-widgets/jqxchart.core.js"></script>
<!-- /chart -->
<!-- for Developers  -->
<!-- Surgery advice -->
...
<script type="text/javascript" src="js/highslide.config.js"
...
<script type="text/javascript" src="js/shelf_sponsor_pay_alert.js"></script>
<script type="text/javascript" src="js/ivf_calender.js"></script>
<script type="text/javascript" src="js/ehat_OPDDoctorsDesk_ForIvf_IPD.js"></script>
<script type="text/javascript" src="js/ehat_OPDDoctorsDesk_ForIvf.js"></script>
<script type="text/javascript" src="js/previousfertilitytreatment.js"></script>
<script type="text/javascript" src="js/previousfertilitytreatprint.js"></script>
<script type="text/javascript" src="js/PreviousReportsList.js"></script>
<script type="text/javascript" src="js/PreviousReportsList.js"></script>
<script type="text/javascript" src="js/gynoexam.js"></script>
<script type="text/javascript" src="js/surgicalHistory.js"></script>
<script type="text/javascript" src="js/ivf_doctor_round.js"></script>

<script type="text/javascript" src="js/ivf__sx_advice.js"></script>
<script type="text/javascript" src="js/gynHistory.js"></script>
<script type="text/javascript" src="js/gynHistory_Print.js"></script>
<script type="text/javascript" src="js/ivf_doctor_desk.js"></script>
<script type="text/javascript" src="js/ivf_dignosis.js"></script>
<script type="text/javascript" src="js/ivf_diet.js"></script>
<script type="text/javascript" src="js/ivf_fm.js"></script>
<script type="text/javascript" src="js/ivf_service_adviced.js"></script>
...
<%
	...
	String subobjWithComplaintAndFinding = resourceBundleEha.getString("subobjWithComplaintAndFinding");
	//String covid = resourceBundleEha.getObject("covid").toString();
	//String amba = resourceBundleEha.getObject("amba").toString();
%>
...
.jqx-chart-axis-text, .jqx-chart-legend-text,
	...
	.jqx-chart-title-description, .jqx-chart-label-text {
	font-size: 13px;
}
</style>
<style>
...
<script type="text/javascript">
	...
	function setVaccineGivenDatePatient(jsObjVaccinationList) {
		...
		for ( var i = 0; i < (jsObjVaccinationList.vaccineDTOList.length); i++) {
			new JsDatePick(
					{
						useMode : 2,
						target : "vaccineGivenDatePatient__"
								+ (jsObjVaccinationList.vaccineDTOList[i].saveUpdateImmunizationID),
...
<%ResourceBundle resourceBundleEhat2 = ResourceBundle.getBundle("EhatEnterpriseConfigurationFile");%>
	...
	getIvfPatientInfoByIVFTreatId(<%=request.getParameter("IVF_TreatmentId")%>);
	/* consulting doctor list */
	...
	//tabsetdepartmentwise();
	tabsetdepartmentwiseIVF();
	...
	fetchAddIPDHistory("IPD_DoctorStation");
	...
	getSumAssueredAmountByTreatmentIdForDoctorStation();
	fetchHospitalAccDetailsForDoctorStation();
	getTotalBillInfoByTreatmentIdForDoctorStation();
	getCoupleIdForIVF();
	//GFG_Fun();
...
<script type="text/javascript">
	 ...
	 function setGivenDate(jsObjList) {
		 //alert(jsObjList.lstHimsReport.length);
		for ( var i = 0; i < (jsObjList.lstHimsReport.length); i++) {
...
function toCreateDiv(RowCount) {
	...
	document.getElementById(divId).innerHTML = '<td	style="height: 21.5px; width: 52px; text-align: center;">'
			...
			+ rowCount
			+ '" value="" onmouseover="click2(this)" /></td><td style="height: 21.5px; width: 195px;"><select class="form-control input-SmallText TextFont" id="tn'
			+ rowCount
	...
	var tempDRT = "<option value='0'>--Select--</option>{#foreach $T.listDRT as ldrt}<option value='{$T.ldrt.templateId}' onclick=fillDRT({$T.ldrt.templateId},'"+rowCount+"')>{$T.ldrt.templateName}</option>{#/for}";
...
<%
	...
	String todays_date3 = formatter.format(currentDate.getTime());
		...
		<c:if test="${ sessionScope.userType != null }">
			...
			<div id="outer" class="container-main" style="width: 100%;">
				...
				<header class="navbar clearfix" id="header">
					...
					<%@include file="pharma_alternate_product.jsp"%>
			...
			<%@include file="left_menu_ivf.jsp"%>
				<div id="main-content">
					<div class="container">
						<div class="row">
							<div id="content" class="col-lg-12" style="min-height: 1935.4px;">

								<!-- Page Date Print Discards-->
								<div class="row">
									<div class="col-sm-12">
										<input type="hidden" id="depttId" value="<%=deptid%>">
										<div class="page-header">
											<ul class="breadcrumb col-md-12-1"
												...
												<li>Date : <%=todays_date%></li>
													...
													<li><a href="IVF_DoctorStation.jsp">IVF Doctor Station</a></li>
													<li>Doctor Desk</li>
								...
								<div class="col-md-11">
									<div class="col-md-12">
										<div class="col-md-2">
											...
											<input type="hidden"  id="IVFTreatmentId" value="<%=request.getParameter("IVF_TreatmentId")%>">
										...
										<div class="col-md-4" >
                                    	 ...
                                    	 <div class="col-md-4">
                                    	  ...
                                    	  <div id="finalAdvancediv" class="col-md-4">
                                              <div class="form-group">
                                                    <!-- <label class="control-label lblBold">Hall(HType):</label> <label id="hallName" class="control-label"></label> -->
                                                       <label class="control-label lblBold">Comman Advance :</label> <label id="finalAdvance" class="control-label"></label> 
                                              </div>
                                    	</div>	
									</div>
								</div>
									...
									<div class="box border col-md-12-1">
										...
										<div class="tabbable col-md-12-1">
											<ul class="nav nav-tabs">
												...
												<li  class="ehatList"  id="coverSheet" onclick="setNewtempDoctorDeskForIvf(this.id);" style="display: none"><a 
														><span class="hidden-inline-mobile">Cover
																Sheet</span></a></li>	
																
													 <li class="ehatList"  id="History" onclick="setNewtempDoctorDeskForIvf(this.id);"><a ><span
												...
												<li class="ehatList"  id="Assessment" onclick="setIvfDignosisTemplateForIVFDoctorStation(this.id);" ><a ><span
														class="hidden-inline-mobile">Diagnosis</span></a></li>
														
														<li  class="active ehatList" id="drround" onclick="setDoctorRoundTempForIvf(this.id);" style="display: none"><a ><span
														class="hidden-inline-mobile">Doctor Round</span></a></li>
														
														<li class="ehatList" id="cpoe" onclick="setServiceAdviceTemplateForIvf(this.id);" style="display: none"><a ><span
														class="hidden-inline-mobile">Services Advised</span></a></li>
														
														<li class="ehatList" id="prescription"   onclick="setNewtempDoctorDeskForIvf(this.id);" style="display: none"><a ><span
															class="hidden-inline-mobile">Prescription</span></a></li>
												
         <!-- <li class="ehatList"  id="OrderForm" onclick="setNewtempDoctorDeskForIvf(this.id);featchOrderFormByDate();"style="display: none"><a ><span
                     class="hidden-inline-mobile">Prescription</span></a></li> -->
												
										<li class="ehatList"  id="OrderForm" onclick="setPrescriptionTempForIvf(this.id);"style="display: none"><a ><span
                                                        class="hidden-inline-mobile">Prescription</span></a></li>
                                                        					
															<li class="ehatList" id="SurgeryAdvices" onclick="setSXAdviceTemplateForAdvice(this.id);" style="display: none"><a ><span
															class="hidden-inline-mobile">Sx Advice</span></a></li>
															
															<li class="ehatList" id="instructiontab"   onclick="setNewtempDoctorDeskForIvf(this.id);" style="display: none"><a ><span
															class="hidden-inline-mobile">Instruction</span></a></li>
															
															<li class="ehatList" id="diet"   onclick="getDietTemplateForIVFDoctorStation(this.id);" style="display: none"><a ><span
															class="hidden-inline-mobile">Diet</span></a></li>

												<li class="ehatList" id="ADNOTE2"
													onclick="ivfadmissionotetemp(this.id);"
													style="display: none"><a><span
														class="hidden-inline-mobile">Admission Note</span></a></li>
														
														
														<li class="ehatList" id="staging" onclick="setNewtempDoctorDeskForIvf(this.id);"><a ><span
															class="hidden-inline-mobile">Clinical Staging</span></a></li>
															
															<li class="ehatList"  id="subObj" onclick="SettemForIvfClinicalEvaluation(this.id);getAllBodyPart();fetchAllSubobjTemplate();FetchEMRAssignedCompFind(0);fetchCKEditorDocterDesk1();"><a ><span
														class="hidden-inline-mobile">Clinical Evaluation</span></a></li>
															

                                                     <li class="ehatList" id="IVF_INDENT" onclick="setNewtempDoctorDeskForIvf(this.id);"  style="display: none"><a><span
														class="hidden-inline-mobile">Indent</span></a></li>
												
												<li class="ehatList" id="IVF_Upload_Document" onclick="setNewtempDoctorDeskForIvf(this.id);"  ><a  ><span
															class="hidden-inline-mobile">Upload Document</span></a></li>

                                                
                                                <li class="ehatList" id="iStudy"   onclick="setNewtempDoctorDeskForIvf(this.id);"><a  ><span
															class="hidden-inline-mobile"> FM Study</span></a></li> 
															
												<li class="ehatList" id="ivfCalender"   onclick="setNewtempDoctorDeskForIvf(this.id);getCoupleIdForIVF();"><a  ><span
															class="hidden-inline-mobile"> IVF Calender</span></a></li> 			
										
											</ul>
											<div class="divide-10"></div>
											<div id="ipdDoctorStationJSPHeadDiv" class="tab-content">
                                        
												<!-- START IVF INDENT GUI -->
												<div ID="IVF_INDENT" class="tab-pane fade">
																			...
																			<div style="padding-top: 10px;" class="col-md-12-1">
																				<div class="col-md-12-1">
																					<div style="margin-top: 0px;" class="col-sm-12-1">
																						...
																						<!--Start Table Body -->
																						<div
																							style="overflow-y: scroll;  height: 290px; maxheight: auto; overflow-x: scroll; margin-top: -21px;"
												...
												<div id="IVF_Upload_Document" class="tab-pane fade">
													<form>
														<div class="centered">
															<div class="divide-10"></div>
															...
															<button type="button" name="fileUp" 
																id="ifileUp" onclick="uploadDocumentForIVF()" class="btn btn-xs btn-success editUserAccess"
                                        ...
                                        <!-- Start Code for #History(Date:-08/10/2016) GUI -->
												...
												<div class="col-md-12-1"
                                                  ...
                                                  <div class="col-md-12-1"
													...
													<div class="col-md-12-1"
														style="padding-right: 8px; margin-top: 3%; display:none">
														<div class="divide-10"></div>
														<div class="col-md-6-1">
                                 ...
                                 <!-- End Code for #History GUI -->
											...
											<!-- End Code for tab-content GUI -->
												...
												<div class="col-md-5-1"
													...
													<!-- Sanjay Kumar Shah -->
													<button data-target="#ViewBMIDetailsPopup" data-toggle="modal" onclick="viewBMIDetailsFromDoctorDesk('onclick');" id="viewBMI" class="btn btn-xs btn-success">BMI &amp; BSA</button>
														 <label class="TextFont col-sm-1">Template</label> <select
															id="customizeTemplatesdietForIVFDiet" class="col-sm-4-1"
															style="margin-left: 34px;"
															onchange="getTemplateDataByTemplateID();">
...
<!-- end of Diet template -->
												...
												<!-- Start Code for #Prescription GUI -->
																	...
																	<div class="col-md-12-1" style="margin-top: 0px;">
																		...
																		<div class="col-md-4-1" style="margin-top: 0px;">
																			...
																			<div class="col-md-2-1" style="margin-top: 6px;">
																				<select id="noOf"
																					onchange="getInstruction(),savefollowUpForPatient('SAVE')"
																					class="col-md-12-1 form-control input-SmallText">
																					<option value="">-SELECT-</option>
																			...
																			<div class="col-md-9-1 pull-right"
																				style="margin-top: 6px;margin-right:17px;">
																		...
																		<div class="col-md-1-2 pull-right"
																			...
																			<button id="printPrescriptionNewOpd" class="btn btn-xs btn-warning" style="" onclick="printPrepDataOPD()" title="Print " data-placement="left" data-toggle="tooltip">
																			<i class="fa fa-print"></i>
																			</button>
																		</div>
																	</div>
																				...
																				<div class="form-group Remove-Padding col-md-12-1"
																					...
																					<div	style="background-color: #EEEEEE; padding: 5px; height: 34px;">
																						<div style="width: 20%; float: left;">
																							<select		onchange="refreshFetchDocPrescriptionTemplate()"
																						...
																						<div style="float: right;">
																							<button class="btn btn-xs btn-success editUserAccess"
																								onclick="saveUpdateDocPrescriptionTemplateByID()" disabled="disabled">
																						...
																						<div id="col2" class="col-sm-1-1"
																							...
																							<div
																								...
																								<label class="TextFont">Prep<b
																									...
																									id="prepDoc"
																									class="form-control input-SmallText"
																									onchange="fetchRouteTypeList('DoctorDesk_DocTempPopup')">
																								</select>
																							</div>
																						</div>
																						<div id="col3" class="col-sm-2-1"
													...
													<div id="InstructionTab" class="tab-pane fade in " style="display: none;">
														<div class="divide-10"></div>
																...
																<div style="float: left; padding-top: 5px;">
																	<div id="divTagPCTreatmentInstructionName">
																		<input type="text" id="PCTreatmentInstructionName"
																			...
																			class="typeahead form-control input-SmallText"
																			onkeyup="setPCTreatmentInstructionAutocomplete(this.id, 'afterLoad');"
																			 />
																	</div>
																			...
																			<div class="box-title" style="margin-bottom: -1px;">
																				...
																				<div class="form-group col-md-2-1"
																					...
																					<button class="btn btn-xs btn-success editUserAccess"
																						...
																						onclick="savePCAdminInstruction('instructions')" disabled="disabled">Save</button>
																					<button type="button"
																					...
																					<div
																						...
																						<div style="width: 30%; float: left;">
																							<input type="text"
																								...
																								name="inputPCAdminInstructionTempName"
																				...
																				<th class='col-md-10-1 center'>Instructions
																					...
																					<div style="float: right; margin-right: 5px;">
																						<input class="btn btn-xs btn-success"
																							type="button"
																							onclick="saveIndividualTreatmentInstruction()"
					...
					<div id="ICD10ButtonPopup" class="modal fade in">
						<div class="modal-dialog col-md-10-1"
								...
								<div class="col-md-12-1"
									...
									<div style="float: right;">
										<button id="a" class="btn btn-xs btn-success editUserAccess"
											onclick="saveICDDiagnosisLevel1('ICD10')" disabled="disabled">
											<i class="fa fa-save"></i> Save Level1 ICD
										</button>
									</div>
									<div style="float: right;">
										<button id="b" class="btn btn-xs btn-success editUserAccess"
											onclick="saveICDDiagnosisLevel1('ICDO')" disabled="disabled">
											<i class="fa fa-save"></i> Save Level1 ICD
										</button>
									</div>
								</div>
								...
								<div class='col-md-12-1' style="margin-top: 20px">
									...
									<div class="col-md-3-1 ">
										<input style="width: 100%;" name="byName" type="text"
											class="form-control input-SmallText " id="byName" onkeyup="fetchICD10Level1('search')"/>
									</div>
									...
									<table class="table table-condensed" style="margin-top: 10px;">
										<thead>
											<tr>
												...
												<th class='col-md-1-1 center'><div class='TextFont'>ICD
														Code</div></th>
												<th class='col-md-3-1 center'><div class='TextFont'>ICD
														Diagnosis</div></th>
												<th class='col-md-1-1 center'><div class='TextFont'>UPDATE</div></th>
													...
													<div class="box border red">
														<div class="box-title">
															...
															<div id="updateAdmissionNoteDiv" class="tools hidden-xs">
																...
																<a id="updateAdmissionNote1" class="updateAdmissionNoteClass"><i
																	class="fa fa-floppy-o" title="Save Note" onclick="saveoperationnoteivf()"></i> </a> <a
																	href="#box-config" data-toggle="modal" class="config">
																	<i class="fa fa-cog"></i>
																</a> <a href="javascript:;" class="reload"> <i
																	class="fa fa-refresh"></i>
																...
																<input type="hidden" id="admissionNoteIDIVF" value="0">
													...
													<!-- /MARKDOWN -->
															...
															<div class="modal-body" class="panel panel-info col-md-12-1">
																				<div style="margin-top: 0px;">
																						<div class="panel-body" id="studyModalTableIVFF" style="margin-bottom: -4%;">
																						<!-- <div class="pull-right"><input type="button" value="Save" onclick="saveFollicualrStudyBasicInfo()"  id="createdivF" class="btn btn-xs btn-success editUserAccess"  style="margin-top: -33px"> </div> -->
																							 <div class="pull-right" style="margin-top: -43px"><input type="button" value="+" onclick="createRowForFollicular()" id="savebasicinfoF" class="btn btn-xs btn-success" /> <input type="button" value="-" onclick="deleteBasicInfoOfFollicular('follicularStudyTabel','chkfm')" id="deletebasicinfoF" class="btn btn-xs btn-danger" />&nbsp; <input type="button" value="Save" onclick="saveFollicualrStudyBasicInfo()"  id="createdivF" class="btn btn-xs btn-success editUserAccess"  style="margin-top: -3px" /></div>
																							<div  id="moveF">
																								<div  class="col-sm-12-1 dynamicstructurescroll">
																									<table  class="table table-bordered " id="follicularStudyTabel">
																									<thead>
																									<tr>
																									<th >#</th>
																									<th >Select</th>
																				...
																				<div style="margin-top: 0px;">
																						<div class="panel-body" id="studyModalTable" style="margin-bottom: -4%;">
																							<div style="width: 100%; height: 200px;" id="move">
																								<div style="margin-top: 0px;overflow-y: scroll;max-height:200px" class="col-sm-12-1">
																									<table style="width : 100%; margin-top: 10px;" class="table table-bordered table-condensed header-fixed cf" id="follicularbasicinfotabel">
																									<thead>
																									<tr>
																									<th ><div class="TextFont">#</div></th>
																									...
																									<th ><div class="TextFont"><input type="button" value="+" onclick="toCreateStudyDiv()" class="editUserAccess" disabled="disabled"></div></th>
																									</tr>
																									</thead>
					...
					<div class="modal-content col-md-6-1"
						...
						<div class="modal-body">
							...
							<div class="divide-40"></div>
													...
													<!-- -----------------------IVF Calender Start--------------- -->
													<div class="modal fade bs-example-modal-lg" id="viewStudyTablePopupIVF"
																	tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
																	aria-hidden="true">
																	<div class="modal-dialog modal-dialog modal-lg" style="width: 90%;" >
																		<div class="modal-content">
																			<div class="modal-header">
																				<div class="col-md-1-1 li pull-right" style="margin-right: 121px">
																					<button type="button" id="saveStudyRecordbtnIVF" onclick="saveStudyRecordForIVF()" data-placement="left" data-toggle="tooltip" class="btn btn-xs btn-success editUserAccess" data-original-title="Save" style="margin-left: 0px;margin-top: 3px;" disabled="disabled">
																						<i class="fa fa-save"></i>
																					</button>
																					<button type="button" id="closeStudyRecordtbnIVF" onclick="closeStudyRecordForIVF()"  title='close'    data-placement="down" value="Close" class="btn btn-xs btn-primary editUserAccess" data-toggle="tooltip"  data-original-title="Close Study" Style="margin-top: 3px;" disabled="disabled">
																						<i class="fa fa-times"></i>
																					</button>
																					<button id="studyPrintBtnIVF" data-original-title="Print" data-toggle="tooltip" data-placement="left" title="" onclick="printStudyDataForIVF('PRINT');" class="btn btn-xs btn-warning" style="margin-top: 3px;">
                                            											<i class="fa fa-print"></i>
  																					</button>
																				</div>
																				<div class="col-md-1-1 li pull-right" style="margin-right: -178px">
																				<button class="btn btn-xs btn-danger" id="closePopUpbtnIVF" onclick="closePopUpbtnForIVF()"    aria-label="Close" data-dismiss="modal" type="button" style="margin-top: 3px;" title="Close Pop Up">
																						<i class="fa fa-times"></i>
																					</button>
																					<button  id="cancelbtnIVF" onclick="cancelIVFCycle()" title='cancel'   aria-label="Close"  type="button" style="margin-top: 3px; background-color: #FFC0CB" >
																						<i class="fa fa-times"></i>
																					</button>
																					<button type="button" id="ovampickupbtnIVF"  data-placement="left" data-toggle="tooltip" class="btn btn-xs btn-info" data-original-title="Ovam Pick Up "  onclick="openOvamPickUpForm()"   style="margin-left: 0px;margin-top: 3px;" title="Ovam Pick Up">
																				...
																				<div class="row" >
																					<div class="col-md-4 col-xs-11">
																						<h3 class="modal-title" id="myModalLabel">IVF Calender</h3>
																					</div><br><br>
																					<div id="lmpDateDiv" class="col-md-3 col-xs-11">
																						<h5>LMP Date: </h5>
																					<input type="text" style="margin-top: -25px;margin-left: 100px;" class="form-control input-SmallText TextFont" placeholder="LMP Date" name="lmpdtivf" id="lmpdtivf"   >
																					</div>
																					
																			</div>
																			<div  id="basicStudyInfoTableIVF" style="height: 100px;" >
															...
															<br><br>
																	<div class="modal-body" class="panel panel-info col-md-12-1">
																				<div style="margin-top: 0px;">
																						<div class="panel-body" id="studyModalTableF" style="margin-bottom: -4%;">
																						<!-- <div class="pull-right"><input type="button" value="Save" onclick="saveCalenderInfoIVF()"  id="createdivF" class="btn btn-xs btn-success editUserAccess"  style="margin-top: -33px"> </div> -->
																							 <div class="pull-right" style="margin-top: -43px"><input type="button" value="+" onclick="createRowForFollicularIVF()" id="savebasicinfoivF" class="btn btn-xs btn-success" /> <input type="button" value="-" onclick="deleteBasicInfoIVFCalender('follicularStudyTabelivf','chkIvf')" id="deletebasicinfoivF" class="btn btn-xs btn-danger" />&nbsp;</div> 
																							<div  id="moveIVF">
																								<div  class="col-sm-12-1 dynamicstructurescroll" >
																									<table   class="table table-bordered table-striped table-condensed table-responsive"      id="follicularStudyTabelivf" style="height: 90px">
																									<thead>
																									<tr>
																									<th >#</th>
																									<th >Select</th>
																				...
																				<div style="margin-top: 0px;">
																						<div class="panel-body" id="studyModalTableF" style="margin-bottom: -4%;">
																							<div style="width: 100%; height: 200px;" id="moveIVFC">
																								<div  class="col-sm-12-1 dynamicstructurescroll">
																									<table  class="table table-bordered table-striped table-condensed table-responsive" id="follicularStudyTabelivfC">
																									<thead>
																									<tr id="ivfbasicinfo2">
																									<!-- <th ></th> -->
																									</tr>
													...
													<!--------------- IVF Calender END ------------------>
										<div id="ivfCancelPopUp" class="modal fade in" tabindex="-1">
											<div class="modal-dialog">
												<div class="modal-content col-md-6-1"
													style="margin-top: 123px; margin-left: 213px;">
													<div class="modal-header">
														<button class="btn btn-xs" aria-label="Close"
															type="button"
															style="margin-top: -5px;; margin-left: 388px"
															onclick="HideNarrationPopUpIVF()">
															<i class="fa fa-times"></i>
														</button>
														<button class="btn btn-xs btn-save" title="Save"
															style="margin-top: -37px; margin-left: 360px"
															" data-original-title="Save" data-toggle="tooltip"
															data-placement="left" onclick="cancelStudyRecordForIVF();">
															<i class="fa fa-save"></i>
														</button>
														<h4 id="testHeadivf" style="margin-top: -36px;">Narration:</h4>
													</div>
													<div class="modal-body">
														<div class="col-md-12-1">
															<div class="col-md-6-1"
																style="background-color: #ccffeb;">
																<textarea rows="3" cols="50" id="narrationIVF"
			...
			<input type='hidden' id='IVFflag' value='Y' />
			...
			<!-- For IPD_BedWard -->
			<input id="pname" type="hidden"	value="0" style="display: none;" />				
			<input id="dbirth" type="hidden"	value="0" 	style="display: none;" />				
			<input id="weight1" type="hidden"	value="0" style="display: none;" />				
			<input id="height1" type="hidden"	value="0" style="display: none;" />
			<input id="drid" type="hidden"		value="0" style="display: none;" />
			<input id="tid" type="hidden"	value="<%=request.getParameter("treatmentId")%>" style="display: none;" />
			<input id="pid" type="hidden"	value="0" style="display: none;" />
			<input id="treatmentId" type="hidden"	value="<%=request.getParameter("treatmentId")%>" style="display: none;" />
			<input id="bedAllocated" type="hidden" 	value="<%=request.getParameter("bedallocated")%>" style="display: none;" />
			<input id="ht" type="hidden" value="<%=request.getParameter("ht")%>" style="display: none;" />
			<input id="pattype" type="hidden" 		value="<%=request.getParameter("pattype")%>" style="display: none;" />
			...
			<input type="hidden" style="display: none;" id="icd10_id_forAssmnt" 	value="0" />
			<input type="hidden" style="display: none;" id="diagno_slave_id"				value="0" />
			<div id="allergyAlertsDetails" style="display: none;"></div>
			<div id="customizeTemplateIvf" style="display: none;"></div>
			<div id="routeDetails" style="display: none;"></div>
			<input id="callFor" type="hidden"	value="<%=request.getParameter("callFor")%>" style="display: none;" />
			<!-- For Prescription -->
	...
	<!-- department id added by paras -->
		...
		<input type="hidden" id="stdRowCntF" value="0"/>
	    <input type="hidden" id="studyidR" value="0"/>
	     <input type="hidden" id="studyidRF" value="0"/>
	   ...
	   <input type="hidden" style="display: none;" id="prescription_id"	value="0" />
	...
	<input type="hidden" id="rowIdIVF" value="0"/>
	...
	<input type="hidden" name="indentRowCount" id="indentRowCount"
		...
		value="0">
	<input type="hidden" name="DRRaddCount" id="DRRaddCount"
		value="1">
...
<div id="iPrintBill" class="modal fade in" tabindex="-1"> </div>
			...
			<div class="modal-content col-md-9"
				...
				<div class="modal-header">
					<div class="box-title">
						...
						<div class="form-group col-md-6-1" style="float: right;">
							<button class="btn btn-xs btn-warning"
								onclick="printPrescriptionNewOpd('PRINT','HF');" type="button">
								<i class="fa fa-print"></i> Print(H/F)
							</button>
							<button class="btn btn-xs btn-warning"
								onclick="printPrescriptionNewOpd('PRINT','Plain');" type="button">
								<i class="fa fa-print"></i> Print
							</button>
								<button class="btn btn-xs btn-warning"
								onclick="printPrescriptionNewOpd('PRINT','NR');" type="button">
	...
	<!-- Test Template Modal -->
				...
				<!-- /Test Template Modal -->	
															<div id="AddUpdateOrderformTemplatePopupForIpda"
																...
																<div id="AddTemplatePopupForIpda"
																class="modal fade in">
																
															</div>
							<!--End #AddTemplatePopupForIpda Popup -->
				...
				<table border="1" id="tblData1"
					...
					<tbody>
						<tr>
							...
							<td style="width: 150px"><select id="iConsDoc" onchange="setSpecilizationAndDepartment(0)" style="width: 98%; font-size: 11px;"></select></td>
							<td style="width: 150px"><select id="iConsSpec" onkeypress="" style="width: 98%; font-size: 11px;"></select></td>
							<td style="width: 150px"><select id="iConsDept" onkeypress="" style="width: 98%; font-size: 11px;"></select></td>
						</tr>
					</tbody>
				</table>
...
<input type="hidden" id="txtHeadId" value=0 /> 
<input type="hidden" id="headId" value=0 /> 
<input type="hidden" id="queryType" value="insert" /> 
<input type="hidden" id="userId" value="<%=session.getAttribute("userId1")%>">
<input type="hidden" id="unitId" value="<%=session.getAttribute("uId")%>">
<input type="hidden" id="ancDateToday" value="<%=todays_date3%>">
<input type='hidden' value='0' id='sumAssueredAmt'/>
<input type='hidden' value='0' id='spPayAlertAmt'/>
<input type='hidden' value='0' id='selfyPayAlertAmt'/>
<input type="hidden" id="iniproc" value="0" />
<input type="hidden" id="ivfCoupleId" value="0" />
<input type="hidden" id="cycleNo" value="0" />
<input type="hidden" id="saveFrom" value="0" />
<input type="hidden" id="saveFromCall" value="0" />
<input type="hidden" id="ivfbatchCreationId" value="0" />
<div id="follicularDetails" style="display: none;"></div>
