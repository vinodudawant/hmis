									...
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a
												href="ehat_center_master.jsp">District Master</a></li>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="col-sm-1">
										...
										<div class="input-group col-md-4" id="documentByName">
											<input class="form-control"
												title="Please enter District name" id="searchId" type="text"
												placeholder="District  Name"
												onkeyup="searchDistrictByName(this.value)">
												...
												<div class="col-md-12">
													<div class="container">
														<div class="panel panel-primary">
															<div class="panel-heading" id="divEhatContent">District
																Master</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-4">
																				<input type="button" class="btn btn-success"
																					onclick="saveDistrict();" value="Submit">
																			</div>
																			<div class="col-sm-4">
																				<input type="button" class="btn btn-warning"
																					onclick="resetDistrictForm();" value="Refresh">
																			</div>
																		</div>
																	</form>
																</div>
