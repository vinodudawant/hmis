...
<!-- include js for development -->
<script type="text/javascript" src="js/room_master.js"></script>
</head>
<body>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<li><i class="fa fa-home"></i> <a href="room_master.jsp">Room Master</a>
										</li>	
                                                ...
                                                <div class="box-body big" id="divEhatContent">
													...
													<form class="form-horizontal col-md-3" role="form">													
														<div class="form-group">
															...
															<div class="col-sm-4">
																<input type="button" class="btn btn-success editUserAccess" disabled onclick="saveroomMaster()" value="Submit"></div>
															<div class="col-sm-4">
																<input type="button"  class="btn btn-info" onclick="refreshroomDoc()" value="Refresh">
															</div> 
														</div>
													</form>
                                                </div>                                                
											...
											<div class="row" style="margin-top: 10px">
												<div class="col-md-12">
													...
													<div class="box border green" id="div1">
														<div class="box-title">
															<h4>
																<i class="fa fa-table"></i>Room Details
															</h4>
