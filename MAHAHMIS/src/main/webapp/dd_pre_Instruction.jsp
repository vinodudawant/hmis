...
<!-- include js for development -->
<script type="text/javascript" src="js/dd_preIns.js"></script>
</head>
<body>
								...
								<div class="col-sm-12">
									<div class="page-header" style="height: 92%;">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a
												href="dd_pre_Instruction.jsp">Prescription Master</a></li>
											<li class="pull-right">
												...
												<button class="btn btn-xs btn-warning pull-right"
													type="button" onclick="selectInst()" data-toggle="modal" data-target="#md1">
								...
								<div class="col-md-12 form-group">
									...
									<div class="col-md-2 form-group">
										<input type="text" class="form-control form-control-sm"
											id="searchById"  onkeypress="return validateNumber(event)" placeholder="search By Id">
									</div>
									...
									<div id="templateEditDiv" class="form-group col-md-3" style="display: none;">

										<div class="col-md-12 form-group">
											<button class="btn btn-success btn-xs"
												onclick="getPreInstDataForModal()" data-toggle="modal"
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="panel panel-primary">
										<div class="panel-heading">Prescription Master</div>
												...
												<div class="panel-body">
													...
													<form class="col-md-12 form-group" id="preInsForm">
														...
														<div class="form-row align-items-center">
															...
															<div class="col-md-2">
																<label for="inlineFormInput">Marati Unicode</label> <input
																	type="text" class="form-control  form-control-sm mb-2"
															...
															<div class="col-md-2">
																...
																<button class="btn btn-xs btn-success" type="button"
																	onclick="savePreDetails()">Save</button>
															</div>
														</div>
													</form>
												</div>
												...
												<table class="table table-bordered table-responsive table-striped">
													<thead>
														<tr>
															...
															<th  id="checkFlag"><input type="checkbox"  id="chkAllCheck" onclick="checkUncheckAll('chkAllCheck','checkInst')"></th>															
														</tr>
													</thead>
													<tbody id="preDetailList">
													</tbody>
												</table>
											</div>
