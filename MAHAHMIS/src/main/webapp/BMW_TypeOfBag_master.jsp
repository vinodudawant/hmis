...
<script type="text/javascript" src="js/bmw_type_of_bag.js"></script>
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><a href="BMW_TypeOfBag_master.jsp">Type Of Bag</a></li>
										</ul>
									...
									<div class="panel panel-default">
										<div class="panel-body">										
											...
											<div class="panel panel-primary">
												<div class="panel-heading">Type Of Bag
													:</div>
												<div class="panel-body">
														...
														<div class="row" >
															...
															<div class="col-md-2" style=display:none>
																<div class="form-group">
																	<input type="text" name="bag_id" id="bag_ID"
																		placeholder="Bag Id" class="form-control">
																</div>
															</div>
															<div class="col-md-2" >
																<label> <span class="required-field"></span>
															...
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" name="bag_type" id="bagType"
																		placeholder="Bag Type" class="form-control">
																</div>
															</div>
														<div class="function-buttons" style="float: center;">
															<div class="buttons">
																<button type="submit" class="btn btn-success"
																	onclick="saveTypeOfBagMaster()">
																	<i class="fa fa-save"></i> Save
																</button>
																<button type="button" class="btn btn-warning"
																	onclick="clearTypeOfBagMaster()">Clear</button>
															</div>
														</div>																					
													</div>
													</form>
										...
										<div class="panel panel-primary"
											...
											<div class="panel-heading" id="divEhatContent">Type Of Bag</div>
											<div class="panel-body"
											...
											<thead id="">
												<tr>
													<th class="col-md-1 center" id="bag_ID">Type Of Bag ID</th>
													<th class="col-md-1 center" id="bagType">Type Of Bag</th>
													<th class="col-md-1 center">Edit</th>
													<th class="col-md-1 center">Delete</th>
												</tr>
											</thead>
											<tbody id="typeOfBagMasterList">
