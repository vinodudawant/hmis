...
<title>IPD Updation Report</title>
...
<script type="text/javascript" src="js/ipd_updation_report.js"></script>
									...
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><i class="fa fa-home"></i> <a
												href="">Finance</a></li>
											<li><a href="ehat_ipd_updation_report.jsp">Ipd Updation Report</a></li>
											<li class="pull-right">
												...
												<button id="btnPrint" class="btn btn-xs btn-warning"
													...
													<script type="text/javascript">
														...
														var clonedContent = $('div[id$=diveMain]').clone();
														    ...
														    var link = document.createElement("a");
														    document.body.appendChild(link);
														    link.download = "IPD Updation Report.xls";
														    link.href = result;
														    link.click();
													});
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getIpdUpdationData();"
																 ...
																 style="background: Scrollbar; border-bottom: 1px solid black; border-top: 1px solid black;">
																	...
																	<thead class="cf">
																		<tr>
																			...
																			<th style="height: 21.5px;width: 7%" >Category Type</th>
																			<th style="height: 21.5px;width: 12%" >Company Name</th>
																			<th style="height: 21.5px;width: 13%" >Bed Name</th>	
																			<th style="height: 21.5px;width: 8%" >IPD No</th>
																			<th style="height: 21.5px;width: 6%" >Admit Date</th>
																			<th style="height: 21.5px;width: 6%" >Discharge Date</th>
																			<th style="height: 21.5px;width: 10%" >Incharge Dr.</th>
																			<th style="height: 21.5px;width: 10%" >Ref. Doctor</th>	
																			<th style="height: 21.5px;width: 10%" >Total Bill Amt</th>	
																			<th style="height: 21.5px;width: 6%" >Outstanding Amount</th>
																			<th style="height: 21.5px;width: 6%" >Advance Paid</th>
																			<th style="height: 21.5px;width: 5%" >refund amount</th>			
																			<th style="height: 21.5px;width: 6%" >total discount</th>	
																			<th style="height: 21.5px;width: 4%" >Credit Letter Recd.</th>
																			<th style="height: 21.5px;width: 10%" >Approve Remark</th>
																			<th style="height: 21.5px;width: 10%" >Approve By</th>																										
																		</tr>
																	</thead>
