...
<body>
	<%
		...
		String pName = patientName1[0].replaceAll("\\s", "");
		String pNamee = patientName1[0].replaceAll("  ", " ");
		System.out.println("pName==="+pName);
		System.out.println("pNamee==="+pNamee);
		//final String DEST = FilePath.getLabReportPath() + File.separator + sampleIds[0] + File.separator + pName + File.separator +pName+".pdf";
	  String realPath=application.getRealPath("labTestPDF/Documents");
		final String DEST = realPath + File.separator + sampleIds[0] + File.separator + pName + File.separator +pName+".pdf";
		final String DESTForSmsLink=ReportUrlSmsLink + File.separator + sampleIds[0] + File.separator + pName + File.separator +pName+".pdf";
