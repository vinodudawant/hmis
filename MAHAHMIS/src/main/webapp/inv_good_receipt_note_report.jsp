									...
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a
												href="inv_good_receipt_note_report.jsp">Good Receipt Note Report</a></li>
										</ul>
										<!-- /BREADCRUMBS -->
										...
										$("[id$=btnExportReport]")
												.click(
														function(e) {
													        ...
													        var table_div = document.getElementById('grnExcelReportInfo');
													        var table_html = table_div.outerHTML.replace(/ /g, '%20');
													        a.href = data_type + ', ' + table_html;
													        //setting the file name
													        a.download = 'Good Receipt Note' + postfix + '.xls';
												...
												<div class="col-md-12">
													<div class="tabbable header-tabs">
														<div class="row" style="margin-top: 5px">
															...
															<div class="form-group col-md-2" id="patientDivId">
																<!-- <input type="radio" 
																	class="custom-control custom-radio custom-control-inline"
																	name="rdDept" value="0" id="allCategory" checked  onclick="getCategoryDiv('all')"/> All -->
																
																<!-- <input type="radio" 
																	class="custom-control custom-radio custom-control-inline"
																	id="singleCategory" name="rdDept" value="1" onclick="getCategoryDiv('single')"/>Single Category --> 
															</div>


															<div class="col-md-4" style="display:none" id="categoryDivId">
																<div class="input-group" id="searchcategoryDivId">
															...
															<div class="col-md-12">
																...
																<div class="panel panel-primary" style="overflow: auto; ">
																	<div class="panel-heading" id="divEhatContent"> Good Receipt Note Report Table</div>
																	<div class="panel-body"
																		style="height: 300px"
																		id="grnExcelReportInfo">
																		<table
																			...
																			<thead id="ehatTHead">
																				<tr>
																					...
																					<th style="display: none;">Mfg Date</th>
																					<th style="display: none;">Total Stock Qty</th>
																					<th style="display: none;">Added Qty</th>
																					<!-- <th class="col-md-1 center" style="display: none;">Total Qty</th> -->
																					...
																					<th style="display: none;">Added Via</th>
																					<th style="display: none;">PO/ReO.PoId</th>
																			...
																			<tbody id="goodReceiptNoteExcelReportList">
																			</tbody>
																		</table>
