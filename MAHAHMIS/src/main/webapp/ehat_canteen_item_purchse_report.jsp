...
<script src="js/ehat_canteen_report.js"></script>
<script type="text/javascript">
	onload = function() {		
									...
									<div class="col-md-12-1">
										...
										<div
											...
											<div style="margin-top: 0%" class="col-md-12-1">
												...
												<div style="margin-top: 0px; margin-bottom: 10px; display: none;"
													class="col-md-4-1 ">
													<div style="margin-top: 9px;" class="col-md-2-1">
														<b>Item Name:</b>
													</div>
													<div style="margin-top: 9px;" class="col-md-4-1">
														<input type="text"
															onkeyup="getcateenservices(this.id);"
															placeholder="Customer Name" name="searchBox4"
															autocomplete="off"
												...
												<div class="col-md-1-1"
													...
													<div style="margin-top: 9px;" class="col-md-4-1">
														<button class="btn btn-xs btn-success" type="button"
															id="getReportdata" onclick="getReportitemdataforPurchase()"
										...
										<div id="reportlistcanteenm"
											...
											<div style="margin-bottom: 10px;" class="col-md-12-1 center">
												<h4 id="canteenreport">Purchase Report By Item</h4>
