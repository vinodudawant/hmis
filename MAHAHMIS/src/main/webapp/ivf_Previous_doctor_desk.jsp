...
<meta charset="utf-8">
<title>IVF Previous Doctor Desk</title>
<meta name="viewport"
	...
	<c:if test="${ sessionScope.userType != null }">
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><a href="ivf_doctor_desk.jsp">IVF Previous Doctor Desk</a></li>
											<li><a></a></li>
										</ul>
										<!-- /BREADCRUMBS -->
									</div>
							...
							<div class="col-md-12-1" style="margin-top: -20px;">
								...
								<div class="col-md-4 TextFont" id="divbyName">
									<input name="byName" type="text" id="byName" class="form-control input-SmallText"
										onkeyup="setIvfAutoPatientName(this.id,'prevIvfDD')" placeholder="Patient UHID,Name,Mobileno"/>																		
								</div>								
								...
								<div class="col-md-12"
																	...
																	<div class="col-md-12-1"
																		...
																		<table class="table table-condensed cf"
																			style="Width: 100%;">
																			<tbody id="ivfPreviousDoctorDeskTabelBody">
		...
		<script>
			jQuery(document).ready(function() {
				...
				getListIVFRegPatientDTO('doctorDesk','previous');
