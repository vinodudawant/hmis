...
<title>Opd Package Report</title>
								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><a href="ehat_package_report.jsp">Opd Package Report</a></li>
											<li class="pull-right">
												...
												<button id="btnPrint" class="btn btn-xs btn-warning"
													...
													To Excel</button> <script type="text/javascript">
														$("[id$=btnPrint]").click(function(e) {
													        ...
													        a.download = 'Package_Report_' + postfix + '.xls';
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getPackageReport();"
														...
														<form class="form-horizontal col-md-12"
															...
															<div style="width: 2700px;">													
																<table class="datatable table table-bordered table-striped table-condensed cf" id="hisabTbl"
																	...
																	<thead class="cf">
																		<tr>
																			<th style="height: 21.5px;width: 3%" >Bill No</th>
																			<th style="height: 21.5px;width: 3%" >Bill Date</th>
																			<th style="height: 21.5px;width: 7%" >Patient Name</th>	
																			<th style="height: 21.5px;width: 3%" >Mobile</th>	
																			<th style="height: 21.5px;width: 5%" >Reffered Dr.</th>	
																			<th style="height: 21.5px;width: 3%" >Bill Amount</th>	
																			<th style="height: 21.5px;width: 3%" >Discount</th>	
																			<th style="height: 21.5px;width: 3%" >Paid Amount</th>	
																			<th style="height: 21.5px;width: 3%" >Balance</th>	
																			<th style="height: 21.5px;width: 5%" >Source Name</th>		
																			<th style="height: 21.5px;width: 5%" >Service Group</th>	
																			<th style="height: 21.5px;width: 5%" >Category</th>	
																			<th style="height: 21.5px;width: 5%" >Service Name</th>	
																			<th style="height: 21.5px;width: 3%" >Price</th>	
																			<th style="height: 21.5px;width: 3%" >Qty</th>		
																			<th style="height: 21.5px;width: 3%" >Amount</th>																			
																			<th style="height: 21.5px;width: 3%" >Concession</th>																																						
																			<th style="height: 21.5px;width: 5%" >Treat Dr.</th>			
																			<th style="height: 21.5px;width: 2%" >Cost</th>		
																			<th style="height: 21.5px;width: 5%" >Sponsor Name</th>		
																			<th style="height: 21.5px;width: 5%" >User</th>		
																			<th style="height: 21.5px;width: 5%" >Unit</th>		
																			<th style="height: 21.5px;width: 7%" >Package Name</th>		
																			<th style="height: 21.5px;width: 3%" >Pkg Amount</th>																														
																		</tr>
																	</thead>
															...
															<!-- <div
																style="margin-top: -21px; ;width: 2700px"
