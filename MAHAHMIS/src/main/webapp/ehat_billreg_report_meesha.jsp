								...
								<div class="col-sm-12">
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
												...
												<button id="btnPrint" class="btn btn-xs btn-warning"
													...
													<script type="text/javascript">
														$("[id$=btnPrint]").click(function(e) {
													        ...
													        a.download = 'Bill_Register_Report_' + postfix + '.xls';
											...
											<li class="pull-right">	
												<button id="btnPrint" class="btn btn-xs btn-primary" onclick="getBillRegisterReport();"
														...
														<form class="form-horizontal col-md-12"
															...
															<div style="width: 1900px;">													
																<table class="datatable table table-bordered table-striped table-condensed cf" id="hisabTbl"
																	...
																	<thead class="cf">
																		<tr>
																			<th style="height: 21.5px;width: 4%">Bill Id</th>
																			<th style="height: 21.5px;width: 4%">Bill Date</th>																		
																			...
																			<th style="height: 21.5px;width: 18%">Service Name</th>	
																			<th style="height: 21.5px;width: 5%">GST Amt</th>	
																			...
																			<th style="height: 21.5px;width: 5%">Balance Amt</th>																																							
																			<th style="height: 21.5px;width: 5%">Source</th>
																			<th style="height: 21.5px;width: 9%">Sponsor</th>
																			<th style="height: 21.5px;width: 7%">Unit Name</th>																																							
																			<!-- <th style="height: 21.5px;width: 15%">Doctor Name</th> -->																																																	
																		</tr>
																	</thead>
