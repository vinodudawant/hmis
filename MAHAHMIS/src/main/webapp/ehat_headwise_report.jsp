...
<title>Headwise Collection From Charges Sheet</title>
									...
									<div class="page-header" style="margin-bottom: 4px">
										...
										<ul class="breadcrumb" style="margin-top: -10px;">
											...
											<li><i class="fa fa-home"></i> <a
												href="">Finance</a></li>
											<li><a href="ehat_headwise_report.jsp">Headwise Collection From Charges Sheet</a></li>
											<li class="pull-right">
													 ...
													 <script type="text/javascript">
													 	...
													 	$(document).on('click', '#btnPrint', function (e) {
															var clonedContent = $('div[id$=diveMain]').clone();
															    ...
															    link.download = "Headwise Collection Report.xls";
															    link.href = result;
															    link.click();
															});
								...
								<div class="panel-body">
									...
									<div class="col-md-12">
										...
										<div class="col-md-3" style="margin-top: 2px">
											...
											<div class="col-md-10">
												<select id="servId" class="form-control input-SmallText"></select>
											</div>
										</div>									

										<div class="col-md-1" style="margin-top: 2px">
											<input type="button" onclick="getHeadwiseReport();"
																...
																<table class="datatable table table-bordered table-striped table-condensed cf" id="hisabTbl"
																	...
																	<thead class="cf">
																		<tr>
																			...
																			<th style="height: 21.5px;width: 25%" >Patient Type</th>																			
																			<th style="height: 21.5px;width: 25%" >Doctor Name</th>	
																			<th style="height: 21.5px;width: 15%" >Charges</th>																																																															
																		</tr>
																	</thead>
