...
<script type="text/javascript" src="js/bmw_status.js"></script>
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><a href="BMW_Status_master.jsp">Status</a></li>
										</ul>
									...
									<div class="panel panel-default">
										<div class="panel-body">										
											...
											<div class="panel panel-primary">
												<div class="panel-heading">Status Type
													:</div>
												<div class="panel-body">
													<form action="#" method="POST">
														...
														<div class="row" >
															...
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" name="bag_status" id="bag_Status"
														...
														<div class="function-buttons" style="float: center;">
															<div class="buttons">
																<button type="submit" class="btn btn-success"
																	onclick="savebmwStatusMaster()">
																	<i class="fa fa-save"></i> Save
																</button>
																<button type="button" class="btn btn-warning"
																	onclick="clearStatusTypeMaster()">Clear</button>
															</div>
														</div>																					
													</div>
												</form>
