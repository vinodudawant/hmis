...
<title>Sponsor and Company List</title>
								...
								<div class="col-sm-12">
									<div class="page-header" style="">
										...
										<ul class="breadcrumb col-md-12-1"
											...
											<li><a href="sponsor_hall_package_report.jsp">Sponsor Hall Package Report</a></li>
											<li class="pull-right">
												<button id="btnExport"
												...
												$(document).on('click', '#btnExport', function (e) {
													var clonedContent = $('div[id$=reportListsponsorpackage]').clone();
												    ...
												    link.download = "Sponsor Hall Package Report.xls";
												    link.href = result;
												    link.click();
												});
											</script>
									...
									<div class="col-md-12-1">
										...
										<div
											style="height: 50%; margin-top: -1%; padding-left: 38px; border: 1px solid #b8b8b8;"
												...
												<div class="col-md-1-1"
													...
													<div style="margin-top: 0px;" class="col-md-0-1">
														<button class="btn btn-xs btn-success" type="button"
															id="getproductData" onclick="getsponsorHallpackageReport()"
										...
										<div 
											...
											<div style="margin-bottom: 10px;" class="col-md-12-1 center">
												<h4 id="serviceName">Charges information</h4>
											</div>
											...
											<div
												...
												<div class="tab-content" id="reportListsponsorpackage">
													<div class="tab-pane fade in active">
														...
														<table border="1"
															...
															<tbody id="sponsorhallpackagedetails">
															</tbody>
