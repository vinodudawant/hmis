...
<meta charset="utf-8">
<title>Charges Configuration</title>
						...
						<div id="content" class="col-lg-12">
								...
								<div class="col-sm-12">
									<div class="page-header">
										...
										<ul class="breadcrumb">
											...
											<li><i class="fa fa-home"></i> <a href="demoConfiguration.jsp">Charges Configuration</a></li>
											...
											<div class="pull-right">
												...
												<button class="btn btn-xs btn-success editSubService"
													...
													onclick="saveConfigurationService()">
												...
												<input type="button" class="btn btn-xs btn-success"
													...
													onclick="fetchConfigurationChargesList('all',1)">
												<!-- Edit Button for Configuratio -->
							...
							<div id="divLine10" class=" box border col-md-12" style="padding: 10px">
								<form class="form-horizontal col-md-12" id="myform">
									...
									<div class="col-md-3">
										<div class="row">
											<label class="TextFont">Department Name</label> 
									...
									<div class="col-md-3">
										<div class="row">
											<label class="TextFont">To Date </label> 
											<input id="toDate" class="form-control input-SmallText"
												type="text" onclick="displayCalendar(document.getElementById('toDate'),'yyyy-mm-dd',this)"
												onchange ="getDataWithDate()" readonly="readonly" name="date" placeholder="To Date" value="">
										</div>
									</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content" style="width: min-content;">
				...
				<div class="modal-body" style="width: min-content;">
					...
					<div class="pull-right">
						<input class="form-control input-sm" id="byName2" onkeyup="searchall(this.id,1)" 
								...
								<div class="panel-body">
									<div class="tabbable">
										...
										<li class="active" id="allCharges" >
												<a onclick="fetchConfigurationChargesList('all',1)" data-toggle="tab" style="cursor: pointer"><i class="fa fa-user-md"></i>
													AllCharges</a></li>
													
											<li  id="combination" >
												<a onclick="getConfigurationdata('combination',1)" data-toggle="tab" style="cursor: pointer"><i class="fa fa-user-md"></i>
													Combination</a></li>
											<li>
												<a onclick="getConfigurationdata('sponsor',1)" data-toggle="tab" style="cursor: pointer"><i class="fa fa-user-md"></i>
													Sponsor Wise</a></li>
											<li>
