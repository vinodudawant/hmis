<%@page import="com.hms.inventory.dto.PurchaseReturnMasterDto"%>
<%@page import="com.hms.inventory.service.PurchaseReturnService"%>
...
<%@ page import="com.hms.inventory.service.GoodReceiptNoteService"%>
<%@ page import="com.hms.inventory.dto.GoodReceiptNoteItemDto"%>
<%@ page import="com.hms.inventory.dto.GoodReceiptNoteDto"%>
...
<body>
	<%
		...
		PdfPTable HeaderTable45 = new PdfPTable(3);
			...
			HeaderTable45.addCell(new Phrase("Purchase Return" ,header));
		...
		/*******************************************/	
			...
			PurchaseReturnService puservice=(ApplicationContextUtils.getApplicationContext()).getBean(PurchaseReturnService.class);
			PurchaseReturnMasterDto lstpurchaseobj=puservice.editPurchaseReturnMaster(pId);
		...
		HeaderTable01.getDefaultCell().setBorder(Rectangle.NO_BORDER);
			      ...
			      nestedTable1.addCell(new Paragraph("  Return No",subheader ));
			     ...
			     /*  if(lstpurchaseobj.getIsWithoutPoGrn().equalsIgnoreCase("Y")){
			    	  nestedTable25.addCell(new Paragraph("P.O.NO",subheader));
			    	  nestedTable25.addCell(new Paragraph(": " ,tabletext));
			      }else{
			      	nestedTable25.addCell(new Paragraph("P.O.NO",subheader));
			      	nestedTable25.addCell(new Paragraph(": "+lstpurchaseobj.getPurchaseOrderNumber(),tabletext));
			      } */
		...
		HeaderTable012.getDefaultCell().setBorder(Rectangle.NO_BORDER);
			      ...
			      nestedTable3.addCell(new Paragraph("  Return DATE",subheader));		      	
			      nestedTable3.addCell(new Paragraph(": "+ lstpurchaseobj.getReturnDate(),tabletext));
			      ...
			      nestedTable26.addCell(new Paragraph("P.O.Date",subheader));
			     /*  if(lstpurchaseobj.getIsWithoutPoGrn().equalsIgnoreCase("Y")){
			    	  nestedTable26.addCell(new Paragraph(": "+"NA",tabletext));
			      }else{
			    	  nestedTable26.addCell(new Paragraph(": "+ lstpurchaseobj.getGrnDate(),tabletext));
		...
		HeaderTable152.getDefaultCell().setBorder(Rectangle.NO_BORDER);
			      ...
			      nestedTable511.addCell(new Paragraph(": "+ lstpurchaseobj.getReturnDate(),tabletext));
		...
		HeaderTable182.getDefaultCell().setBorder(Rectangle.NO_BORDER);
			      ...
			      nestedTable911.addCell(new Paragraph("  D.C No",subheader));
			     // nestedTable911.addCell(new Paragraph(": "+lstpurchaseobj.getGrnDeliveryChallanNumber(),tabletext));
			      ...
			      nestedTable412.addCell(new Paragraph("D.C Date",subheader));
			      nestedTable412.addCell(new Paragraph(": "+lstpurchaseobj.getDeleviryDate(),tabletext));
		...
		HeaderTable016.getDefaultCell().setBorder(Rectangle.NO_BORDER);
		  ...
		  if(lstpurchaseobj.getPartymasterdto().getPartyMasterAddressInfoDto()!=null){
		 	 for(PartyMasterAddressInfoDto partyMasterAddressInfoDto :lstpurchaseobj.getPartymasterdto().getPartyMasterAddressInfoDto()){
			    ...
			    //  nestedTable11.addCell(new Paragraph(": "+supplierStreet+",  "+supplierArea+",  "+supplierCity+" - "+supplierPin+",  "+lstpurchaseobj.getGrnSupplierState()+", "+ lstpurchaseobj.getGrnSupplierMobile()+", Vendor ID:"+lstpurchaseobj.getId(),tabletext));
			    	...
			    	nestedTable11.addCell(new Paragraph(": "+lstpurchaseobj.getSupplierAddress() ,tabletext));
		...
		HeaderTable015.getDefaultCell().setBorder(Rectangle.NO_BORDER);
			      ...
			      String pgstno = "";//lstpurchaseobj.getPartyGstNo();
			      
			     if(lstpurchaseobj.getPartymasterdto().getPartyMasterGeneralInfoDto()!=null){
				 	 for(PartyMasterGeneralInfoDto partyMasterGeneralInfoDto :lstpurchaseobj.getPartymasterdto().getPartyMasterGeneralInfoDto()){
				 		pgstno =  partyMasterGeneralInfoDto.getGstTransactionNo();
				     }
			  	 }
			      ...
			      if(pgstno==null){
			      	...
			      	nestedTable9.addCell(new Paragraph(": "+pgstno ,tabletext));
			      }
			  	...
			  	int[] invoiceCode7 = {38,82}; 
				PdfPTable HeaderTableInvoiceCode = new PdfPTable(2);
				int[] headerwidthInvoiceCode = {45,45}; 
				HeaderTableInvoiceCode.setWidths(headerwidthInvoiceCode);
				HeaderTableInvoiceCode.setWidthPercentage(96f);
				HeaderTableInvoiceCode.getDefaultCell().setBorder(Rectangle.NO_BORDER);

					      PdfPCell cellInvoiceCode = new PdfPCell();
					      cellInvoiceCode.setBorder(Rectangle.LEFT | Rectangle.RIGHT );
					      PdfPTable nestedTableInvoiceCode = new PdfPTable(2);
					      nestedTableInvoiceCode.setWidths(invoiceCode7);
					      nestedTableInvoiceCode.setWidthPercentage(96f);
					      nestedTableInvoiceCode.getDefaultCell().setBorder(Rectangle.NO_BORDER);
					      nestedTableInvoiceCode.addCell(new Paragraph("Invoice Code",subheader));
					      
					      String invoiceCode = "";//lstpurchaseobj.getPartyGstNo();
					      
					     if(lstpurchaseobj.getPartymasterdto()!=null){
						 	invoiceCode =  lstpurchaseobj.getPartymasterdto().getInvoiceCode();
					  	 }
					      
					      if(invoiceCode==null || invoiceCode == ""){
					    	  nestedTableInvoiceCode.addCell(new Paragraph(": NA", tabletext));
					      }else{
					    	  nestedTableInvoiceCode.addCell(new Paragraph(": "+invoiceCode ,tabletext));
					      }
				      cellInvoiceCode.addElement(nestedTableInvoiceCode);
				      PdfPCell cellInvoice10 = new PdfPCell();
				      cellInvoice10.setBorder(Rectangle.LEFT | Rectangle.RIGHT );
				      PdfPTable nestedTableInvoice10 = new PdfPTable(2);
				      int[] hWInvoice10 = {44,80}; 
				      nestedTableInvoice10.setWidths(hWInvoice10);
				      nestedTableInvoice10.setWidthPercentage(96f);
				      nestedTableInvoice10.getDefaultCell().setBorder(Rectangle.NO_BORDER);
				      nestedTableInvoice10.addCell(new Paragraph("",subheader));
				      nestedTableInvoice10.addCell(new Paragraph(" ",tabletext));
				      cellInvoice10.addElement(nestedTableInvoice10);
				      HeaderTableInvoiceCode.addCell(cellInvoiceCode);
				      HeaderTableInvoiceCode.addCell(cellInvoice10);
				  	  document.add(HeaderTableInvoiceCode);
					  HeaderTableInvoiceCode.flushContent();
			  	// this is for end invoice code
	 ...
	 PdfPTable HeaderTableMain = new PdfPTable(14);
			int[] headerwidth6 = { 15, 25, 15, 15, 15, 15, 15, 15, 20,
			  15, 15,15,12,20};
			...
			PdfPCell itemba = new PdfPCell(new Paragraph("Batch no.",subheader));
			itemba.setHorizontalAlignment(Element.ALIGN_CENTER);
			itemba.setRowspan(2);
			HeaderTableMain.addCell(itemba);
			
			PdfPCell itemExpirayDate = new PdfPCell(new Paragraph("Expiry Date.",subheader));
		...
		for(int i=0;i<=lstpurchaseobj.getLstpurchasereturnitemInfoDto().size()-1;i++)
			{
			String hsnCode=lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getHsnName();
		...
		HeaderTableMain.addCell(new Phrase(""+lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemName(),	tabletext));
		PdfPCell cell13= null;
		if(lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemBatchNo()==0){
			 cell13 = new PdfPCell(new Phrase(	"NA", tabletext));
		}else{
			 cell13 = new PdfPCell(new Phrase(	""+lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemBatchNo(), tabletext));
		}
		
		cell13.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(cell13);
		
		PdfPCell cell131 = null;
		
		SimpleDateFormat formatter22 = new SimpleDateFormat("yyyy-MM-dd");
		String itemBatchExpDate = formatter22.format(lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getExpiryDate());
		
		if(itemBatchExpDate.equals("1970-01-01")){
			cell131 = new PdfPCell(new Phrase(	"NA", tabletext));
		}else{
			cell131 = new PdfPCell(new Phrase(	""+itemBatchExpDate, tabletext));
		}
			
		cell131.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(cell131);
		PdfPCell cell132 = new PdfPCell(new Phrase(	""+lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemUnitName(), tabletext));
		cell132.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(cell132);

		PdfPCell batchCodeCells = new PdfPCell(new Phrase(""+lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemQuantity(), tabletext));
		batchCodeCells.setHorizontalAlignment(Element.ALIGN_CENTER);
		HeaderTableMain.addCell(batchCodeCells);


		PdfPCell cell222 = new PdfPCell(new Phrase("" +lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemUnitPrice() ,tabletext));
		cell222.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(cell222);

		

		PdfPCell prcell = new PdfPCell(new Phrase("" +df2.format(lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemDiscountAmt()) ,tabletext));
		prcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(prcell);

		PdfPCell cell42 = new PdfPCell(	new Phrase("" + df2.format(lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemBaseAmt()),	tabletext));
		cell42.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(cell42);

			/* 	PdfPCell cell56 = new PdfPCell(new Phrase(""+lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemBaseAmt(), tabletext));
		...
		totalgst = totalgst + lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemGst();
		PdfPCell gst3 = new PdfPCell(new Phrase(""+df2.format(lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemGst()),	tabletext));
		gst3.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(gst3);
		totalgstAmt = totalgstAmt + lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemGstAmt();
		PdfPCell gst31 = new PdfPCell(new Phrase(""+df2.format(lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemGstAmt()),	tabletext));
		gst31.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(gst31);
		
		PdfPCell gst212 = new PdfPCell(new Phrase(""+df2.format(lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemIgst()),	tabletext));
		gst212.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(gst212);
		totaligst = totaligst + lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemIgst();
		PdfPCell gst2 = new PdfPCell(new Phrase(" "+df2.format(lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemIGstAmt()),tabletext));
		gst2.setHorizontalAlignment(Element.ALIGN_RIGHT);
		HeaderTableMain.addCell(gst2);
		totaligstAmt = totaligstAmt+lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemIGstAmt();
		totalAmt = totalAmt +lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemTotalAmt();
		PdfPCell gst21 = new PdfPCell(new Phrase(""+df2.format(lstpurchaseobj.getLstpurchasereturnitemInfoDto().get(i).getItemTotalAmt()),	tabletext));
	...
	float[] headerwidthA1= {15, 25, 15, 15, 15, 15, 15, 15, 20,
			  15, 15,15,12,20}; 
	...
	PdfPCell cellA6 = new PdfPCell(new Phrase(" "+ df2.format( lstpurchaseobj.getGrossAmount()),subheader));
	cellA6.setHorizontalAlignment(Element.ALIGN_RIGHT);
	cellA6.setBorder(Rectangle.LEFT | Rectangle.RIGHT |Rectangle.BOTTOM );

	PdfPCell cellA7 = new PdfPCell(new Phrase(" "+   df2.format(totalgst),subheader));
	cellA7.setBorder( Rectangle.LEFT | Rectangle.RIGHT |Rectangle.BOTTOM  );
	cellA7.setHorizontalAlignment(Element.ALIGN_RIGHT);
	
	PdfPCell cellA8 = new PdfPCell(new Phrase("   "+  df2.format(totalgstAmt),subheader));
	cellA8.setBorder(Rectangle.LEFT | Rectangle.RIGHT |Rectangle.BOTTOM );
	cellA8.setHorizontalAlignment(Element.ALIGN_RIGHT);

	PdfPCell cellA88 = new PdfPCell(new Phrase(" "+df2.format(totaligst),subheader));
	...
	PdfPCell cellA10 = new PdfPCell(new Phrase(" "+ df2.format(totaligstAmt),subheader));
	...
	PdfPCell cellA9 = new PdfPCell(new Phrase(" "+ df2.format(totalAmt),subheader));
	 ...
	 */
	PdfPCell cellB1  = new PdfPCell(new Phrase("     "+df2.format(lstpurchaseobj.getGrossAmount()) ,subheader));//lstpurchaseobj.getGrossTaxes()
	...
	/* PdfPCell cellB1  = new PdfPCell(new Phrase("     "+lstpurchaseobj.getIgstTotalAmount() ,subheader));
	 */
	PdfPCell cellB111  = new PdfPCell(new Phrase("     "+df2.format(lstpurchaseobj.getLess()) ,subheader));
	...
	/* PdfPCell cellB1  = new PdfPCell(new Phrase("     "+lstpurchaseobj.getIgstTotalAmount() ,subheader));
	 */
	PdfPCell cellB111a  = new PdfPCell(new Phrase("     "+df2.format(lstpurchaseobj.getAddAmount()) ,subheader));
	...
	/*-------------------------------------------------------Add End---------------------------------------  */
		  ...
		  PdfPTable HeaderTableC = new PdfPTable(12);
		   ...
		   PdfPCell cellC1  = new PdfPCell(new Phrase("  "+ df2.format(lstpurchaseobj.getIgstTotalAmount()),subheader));
	  ...
	  //r0w5
		  ...
		  PdfPTable HeaderTableD = new PdfPTable(12);
		    ...
		    //PdfPCell cellD1  = new PdfPCell(new Phrase("            "+ lstpurchaseobj.getGrossTotalAmount(),subheader));
		    	    ...
		    	    PdfPCell cellD1  = new PdfPCell(new Phrase("            "+ df2.format(lstpurchaseobj.getGrossTotalAmount()),subheader));
