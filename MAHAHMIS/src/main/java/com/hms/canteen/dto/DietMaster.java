...
public class DietMaster implements Serializable {
	...
	@Transient
	private List<DietMaster> lstDietMaster;
	...
	public List<DietMaster> getLstDietMaster() {
		return lstDietMaster;
	}

	public void setLstDietMaster(List<DietMaster> lstDietMaster) {
