...
@Entity
@Table(name = "opd_advice_master")
public class OPDCareAdviceDTO {
	@Id
	...
	@Transient
	List<OPDCareAdviceDTO>  getListOfOPDCareAdviceDTO;
	...
	public List<OPDCareAdviceDTO> getGetListOfOPDCareAdviceDTO() {
		return getListOfOPDCareAdviceDTO;
	}

	public void setGetListOfOPDCareAdviceDTO(List<OPDCareAdviceDTO> getListOfOPDCareAdviceDTO) {
