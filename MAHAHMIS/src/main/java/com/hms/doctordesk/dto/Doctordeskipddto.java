...
@Entity 
@Immutable
@Table(name = "doctordesk_queueipd_details")
public class Doctordeskipddto {
...
/*	@Column(name = "total_remain")
	...
	@Transient
	private List<Doctordeskipddto> listRegTreBillDto;
	...
	public List<Doctordeskipddto> getListRegTreBillDto() {
		return listRegTreBillDto;
	}

	public void setListRegTreBillDto(List<Doctordeskipddto> listRegTreBillDto) {
	...
	public String toString() {
		return "Doctordeskipddto [billId=" + billId + ", patientId=" + patientId + ", centerPatientId="
				...
				+ ", dischargeTime=" + dischargeTime + ", bedName=" + bedName + ", totBill=" + totBill + ", totPaid="
				+ totPaid + ", totBal=" + totBal + ", docName=" + docName + ", physicalDisFlag=" + physicalDisFlag
				...
				+ ", oldPatientId=" + oldPatientId + ", departmentNameDoc=" + departmentNameDoc + ", mlc_id=" + mlc_id
				+ ", healthId=" + healthId + ", healthIdNumber=" + healthIdNumber + ", totDisc=" + totDisc
				+ ", visitNo=" + visitNo + ", listEhatBillPrefix=" + listEhatBillPrefix + ", listDistDates="
				+ listDistDates + ", listRegTreBillDto=" + listRegTreBillDto + ", lstDoctorDto=" + lstDoctorDto
				+ ", patientCount=" + patientCount + ", age2=" + age2 + "]";
	}
