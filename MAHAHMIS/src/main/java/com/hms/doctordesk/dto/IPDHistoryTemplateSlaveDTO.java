...
@Entity
@Table(name = "ipd_history_template_slave_info")
public class IPDHistoryTemplateSlaveDTO {
	...
	@Transient
	List<IPDHistoryTemplateSlaveDTO>  getListOfHistorySlaveDTO;
	...
	public String toString() {
		return "IPDHistoryTemplateSlaveDTO [historySalveId=" + historySalveId + ", chiefComplaints=" + chiefComplaints
