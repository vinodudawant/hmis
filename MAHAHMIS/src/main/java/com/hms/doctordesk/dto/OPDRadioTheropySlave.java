...
@Entity
@Table(name = "opd_radiothorapy_salve")
public class OPDRadioTheropySlave {

	@Id
	@GeneratedValue(strategy=GenerationType.AUTO)
	@Column(name = "radio_theropy_slave_id")
	private int radioTheropySlaveId;
	...
	@Transient
	List<OPDRadioTheropySlave>  getListOfTheropySlaveDTO;

	public int getRadioTheropySlaveId() {
		return radioTheropySlaveId;
	}

	public void setRadioTheropySlaveId(int radioTheropySlaveId) {
		this.radioTheropySlaveId = radioTheropySlaveId;
	}
