...
@Entity
@Table(name = "opd_bmi_master")
public class OPDBmiMasterDTO {
	...
	@Transient
	List<OPDBmiMasterDTO>  getListOfOPDBmiDTO;
	...
	public List<OPDBmiMasterDTO> getGetListOfOPDBmiDTO() {
		return getListOfOPDBmiDTO;
	}

	public void setGetListOfOPDBmiDTO(List<OPDBmiMasterDTO> getListOfOPDBmiDTO) {
