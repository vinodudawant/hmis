...
@Entity
@Table(name = "opd_coversheet_vital_info")
public class OPDCoverSheetVitalDTO {
	@Id
	...
	@Transient
	List<OPDCoverSheetVitalDTO>  getListOfOPDCoversheetVitalDTO;
	...
	public List<OPDCoverSheetVitalDTO> getGetListOfOPDCoversheetVitalDTO() {
		return getListOfOPDCoversheetVitalDTO;
	}


	public void setGetListOfOPDCoversheetVitalDTO(List<OPDCoverSheetVitalDTO> getListOfOPDCoversheetVitalDTO) {
	...
	public String toString() {
		return "OPDCoverSheetVitalDTO [vitalMasterId=" + vitalMasterId + ", vitalValue=" + vitalValue + ", result="
				+ result + ", vitalDate=" + vitalDate + ", createdDateTime=" + createdDateTime + ", updatedDateTime="
				...
				+ ", userId=" + userId + ", treatObj=" + treatObj + ", patientObj=" + patientObj
				+ ", getListOfOPDCoversheetVitalDTO=" + getListOfOPDCoversheetVitalDTO + "]";
	}
