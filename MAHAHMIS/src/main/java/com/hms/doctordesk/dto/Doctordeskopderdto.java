...
@Entity 
@Immutable
@Table(name = "doctordesk_queueopder_details")
public class Doctordeskopderdto {
...
/*	@Column(name = "total_remain")
	...
	@Transient
	private List<Doctordeskopderdto> listRegTreBillDto;
	@Transient
	private List<Doctordeskipddto> listRegTreBillDto1;
	...
	public List<Doctordeskopderdto> getListRegTreBillDto() {
		return listRegTreBillDto;
	}

	public void setListRegTreBillDto(List<Doctordeskopderdto> listRegTreBillDto) {
		this.listRegTreBillDto = listRegTreBillDto;
	}

	public List<Doctordeskipddto> getListRegTreBillDto1() {
		return listRegTreBillDto1;
	}

	public void setListRegTreBillDto1(List<Doctordeskipddto> listRegTreBillDto1) {
	...
	public String toString() {
		return "Doctordeskopderdto [billId=" + billId + ", patientId=" + patientId + ", centerPatientId="
				...
				+ ", numbr=" + numbr + ", docNameChan=" + docNameChan + ", bedName=" + bedName + ", totBill=" + totBill
				+ ", totPaid=" + totPaid + ", totBal=" + totBal + ", docName=" + docName + ", physicalDisFlag="
				+ physicalDisFlag + ", perAddress=" + perAddress + ", pertalukaId=" + pertalukaId + ", pertownId="
				+ pertownId + ", perdistrictId=" + perdistrictId + ", perstateId=" + perstateId + ", percountryId="
				+ percountryId + ", perareaCode=" + perareaCode + ", relativeName=" + relativeName + ", relationId="
				+ relationId + ", oldPatientId=" + oldPatientId + ", departmentNameDoc=" + departmentNameDoc
				+ ", mlc_id=" + mlc_id + ", healthId=" + healthId + ", healthIdNumber=" + healthIdNumber + ", totDisc="
				+ totDisc + ", visitNo=" + visitNo + ", p_age=" + p_age + ", age_months=" + age_months + ", age_days="
				+ age_days + ", mlc=" + mlc + ", ref_doc_name=" + ref_doc_name + ", listEhatBillPrefix="
				+ listEhatBillPrefix + ", listDistDates=" + listDistDates + ", listRegTreBillDto=" + listRegTreBillDto
				+ ", listRegTreBillDto1=" + listRegTreBillDto1 + ", lstDoctorDto=" + lstDoctorDto + ", patientCount="
				+ patientCount + ", consultingDoctor=" + consultingDoctor + ", refBillNo=" + refBillNo + ", age2="
				+ age2 + "]";
	}
