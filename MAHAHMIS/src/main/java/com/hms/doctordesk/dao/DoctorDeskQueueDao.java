...
public interface DoctorDeskQueueDao {
	...
	List<Doctordeskipddto> serachDateWiseQuqueIpd(Integer depid,Integer unitId,Integer userId1,String userType,String fadte,String tdate);
