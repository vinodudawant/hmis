...
public interface MedicationDao {
	...
	String saveMedication(MedicationMaster medicationMaster,HttpServletRequest request);
    ...
    MedicationMaster medicineAutoSuggestion(String productName, String prepName,String comName,String callFrom);
    
    List<MedicationMaster>  getUnitAndStrength(int id);
    
    String deleteMedicines(int id,HttpServletRequest request);
    
    List<MedicationMaster> medSuggesstionForSearch(String productName,String callFrom,HttpServletRequest request);
