...
public interface BillService {
	...
	Integer saveBillDetails(String masterIdsChecked,String servIdsChecked,Integer refDocId,BillReceiptMasterDTO billRecMaster,String multiPayDetails);
	Integer saveRefundBillDetails(String servIdsChecked,Integer refDocId,BillReceiptMasterDTO billRecMaster);
	...
	Integer saveBulkDetails(BulkSettlementMasterDTO billRecMaster,String multiPayDetails,String bulkSlaveDetails);
	...
	BillReceiptMasterDTO searchDailyCollectionReport(String callFrom,int unitId,int deptId,int userId,String fromDate,String toDate);
...
//	Integer getSettledBillCount();
	...
	Integer saveRefundBillDetailsNew(String servIdsChecked,Integer refDocId,BillReceiptMasterDTO billRecMaster);
