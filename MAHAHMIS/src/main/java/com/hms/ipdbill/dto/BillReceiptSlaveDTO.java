...
@Entity
@Table(name = "ehat_receipt_slave")
public class BillReceiptSlaveDTO {
	...
	@Column(name = "token_no",columnDefinition="int default 0")
	...
	@Column(name = "profeesPercentage",columnDefinition="double default 0.0")
	private double profeesPercentage=0.0;
	...
	@Column(name = "sponsor_con" ,columnDefinition="double default 0.0")
	private double sponsorConcession=0.0;
	
	@Column(name = "sponsor_con_per" ,columnDefinition="double default 0.0")
	private double sponsorConPer=0.0;
	...
	public double getSponsorConcession() {
		return sponsorConcession;
	}

	public void setSponsorConcession(double sponsorConcession) {
		this.sponsorConcession = sponsorConcession;
	}

	public double getSponsorConPer() {
		return sponsorConPer;
	}

	public void setSponsorConPer(double sponsorConPer) {
		this.sponsorConPer = sponsorConPer;
	}
