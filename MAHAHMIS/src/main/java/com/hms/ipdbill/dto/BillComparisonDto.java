...
public class BillComparisonDto {
	...
	@Transient
	private List<BillComparisonDto> lstIpdbillPatients;
	...
	public List<BillComparisonDto> getLstIpdbillPatients() {
		return lstIpdbillPatients;
	}

	public void setLstIpdbillPatients(List<BillComparisonDto> lstIpdbillPatients) {
