...
@Entity
@Table(name = "ehat_refund_master")
public class BillRefundMasterDTO {
	...
	@Transient
	private List<BillRefundSlaveDTO> listBillRefundSlave;
	...
	public List<BillRefundSlaveDTO> getListBillRefundSlave() {
		return listBillRefundSlave;
	}

	public void setListBillRefundSlave(List<BillRefundSlaveDTO> listBillRefundSlave) {
