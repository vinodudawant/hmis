...
@Controller
@RequestMapping(value = "/ipdpharamabill")
public class IpdPharmaBillController {

	private static final Logger LOGGER = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass().getSimpleName());
	
	private @Autowired
	IpdPharmaBillService ipdPharmaBillService;
	...
	public int saveOrUpdateBedMaster(@RequestBody ChargesMasterSlave chargesMasterSlave) {
		...
		int response = ipdPharmaBillService.saveOrUpdateBedMaster(chargesMasterSlave);
		return response;
	}
	...
	public ChargesMasterSlave getBedMasterList() {
		...
		ltchragesSlave = ipdPharmaBillService.getBedMasterList();
	...
	public int deleteHallById(@RequestParam("hallId") int hallId, HttpServletRequest request) {
		...
		int response = ipdPharmaBillService.deleteHallById(hallId,request);
		return response;
	}
	...
	public ChargesMasterSlave viewBedsOfHall(@RequestParam("hallId") int hallId) {
		...
		return ipdPharmaBillService.viewBedsOfHall(hallId);
	}
	...
	public int deleteBedById(@RequestParam("hallId") int hallId, @RequestParam("bedId") int bedId, HttpServletRequest request) {
		...
		int response = ipdPharmaBillService.deleteBedById(hallId,bedId,request);
		return response;
	}
	...
	public ChargesMasterSlave autoSuggestionsubCharges(@RequestParam String letter) {
		...
		ltChargesSlave = ipdPharmaBillService.autoSuggestionsubCharges(letter);
		ChargesMasterSlave obj = new ChargesMasterSlave();
