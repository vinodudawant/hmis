...
@Entity
@Component
@Table(name = "intraOpNotesDto")
public class IntraOpNotesDto {

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name = "id")
	private int IntraOpNotesDtoId;
	...
	private String IntraOpNotes;
	 ...
	 @Column(name = "created_by", updatable = false)
		...
		public int getIntraOpNotesDtoId() {
			return IntraOpNotesDtoId;
		}

		public void setIntraOpNotesDtoId(int intraOpNotesDtoId) {
			IntraOpNotesDtoId = intraOpNotesDtoId;
		}

		public String getIntraOpNotes() {
			return IntraOpNotes;
		}

		public void setIntraOpNotes(String intraOpNotes) {
