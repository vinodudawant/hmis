...
public interface OperationThService {
	...
	String savePreAnaestheticDetails(PreAnaestheticRequest preAnaesthetic);
	...
	List<ConductAnaesthesia> fetchAddConductAnaesthesia(String tretID, String anaesID);
