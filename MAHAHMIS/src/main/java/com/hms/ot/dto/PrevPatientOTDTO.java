...
public class PrevPatientOTDTO {
	...
	@Transient
	private List<PrevPatientOTDTO> lstRegviewDto;
	...
	public List<PrevPatientOTDTO> getLstRegviewDto() {
		return lstRegviewDto;
	}

	public void setLstRegviewDto(List<PrevPatientOTDTO> lstRegviewDto) {
