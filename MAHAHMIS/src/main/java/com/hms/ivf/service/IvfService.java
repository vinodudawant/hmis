...
public interface IvfService {
	...
	int changeStatusOfIvfCouple(int coupleID, String coupleFlag, String narration, HttpServletRequest request);
	
	IVFcoupleViewDto autoSuggestionForCoupleDetails(String findingName,int patSearchType,String callFrom);
	
	IVFcoupleViewDto autoSuggestionForCoupleDetails1(int coupleId,String callFrom);
	
	int getBedAllocatedStatus(int treatmentId, HttpServletRequest request);
	
	int generateBatch(String ivfBatchMasterDetails,IVFBatchSlave ivfBatchSlaveDetails,String ivfBatcInsertType,HttpServletRequest request);
	...
	int CancelIVFBatch(int batchID, String BatchCancelNarration, HttpServletRequest request);
	...
	String fetchNarrationOfCouple(int ivfCoupleId, HttpServletRequest request);
	...
	List<IVFClinicalEvaluationForAllergyAlertDTO> fetchRecordClinicalEvaluationForIVF(Integer treatmentId);
	...
	List<IvfQueueDTO> viewIVFQueue(Integer unitId);	
