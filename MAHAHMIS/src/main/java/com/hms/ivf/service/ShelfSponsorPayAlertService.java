...
public interface ShelfSponsorPayAlertService {
	...
	Integer getCoupleId(Integer patientId);
...
int saveEmbryoTransperForm(EmbryoTransferMasterDTO obj,String  freshEmbryoSlaveList,String frozenEmbryoSlaveList);
...
int saveOvamPickUpSlaveInfo(String  ovamPickUpSlaveList);
