...
public interface IVFDoctorDeskService {
	...
	int savecpoeForIVF(IvfBillDetailsDto billDetailsDto, HttpServletRequest request,
			String queryType);
	
	List<IVFCpoeServdetails> getlistbiil(Integer pID, String callform,Integer servid, HttpServletRequest request);
