...
@Entity 
@Immutable
@Table(name = "ehat_view_ivf_patient_details")
public class IvfTreBillDto implements Serializable{
...
/*	@Column(name = "total_remain")
	...
	@Column
	private String admsn_can_date_time;
	...
	@Transient
	private List<IvfTreBillDto> listIvfTreBillDto;
	...
	public List<IvfTreBillDto> getListIvfTreBillDto() {
		return listIvfTreBillDto;
	}

	public void setListIvfTreBillDto(List<IvfTreBillDto> listIvfTreBillDto) {
		this.listIvfTreBillDto = listIvfTreBillDto;
	}
	...
	public String getAdmsn_can_date_time() {
		return admsn_can_date_time;
	}

	public void setAdmsn_can_date_time(String admsn_can_date_time) {
	...
	public String toString() {
		return "RegTreBillDto [billId=" + billId + ", patientId=" + patientId
				...
				+ ", listIvfTreBillDto=" + listIvfTreBillDto
				+ ", lstDoctorDto=" + lstDoctorDto + ", centerPatientId=" + centerPatientId + ", age2=" + age2 + "]";
	}
