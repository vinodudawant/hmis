...
@Entity
@Table(name="ivf_history_temp_slave")
public class IvfHistorySlaveDto {
	...
	@Transient
	List<IvfHistorySlaveDto>  getListOfHistorySlaveDTO;
	...
	public String toString() {
		return "IvfHistorySlaveDto [historySalveId=" + historySalveId + ", chiefComplaints=" + chiefComplaints
