...
@Entity
@Table(name="ehat_view_ivf_patient_bed_details")
@Immutable
public class EhatViewPatientBedDetailsIvfDto implements Serializable{
	...
	@Transient
	private List<EhatViewPatientBedDetailsIvfDto> listBedIvfDto;
	...
	public List<EhatViewPatientBedDetailsIvfDto> getListBedIvfDto() {
		return listBedIvfDto;
	}

	public void setListBedIvfDto(List<EhatViewPatientBedDetailsIvfDto> listBedIvfDto) {
		this.listBedIvfDto = listBedIvfDto;
	}
