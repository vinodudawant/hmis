...
@Entity
@Table(name = "ivf_sx_adviced_master")
public class IVFSxAdvicedDTO {
	...
	@Transient
	List<IVFSxAdvicedDTO>  getListOfOPDSxAdviceDTO;
	...
	public List<IVFSxAdvicedDTO> getGetListOfOPDSxAdviceDTO() {
		return getListOfOPDSxAdviceDTO;
	}

	public void setGetListOfOPDSxAdviceDTO(List<IVFSxAdvicedDTO> getListOfOPDSxAdviceDTO) {
