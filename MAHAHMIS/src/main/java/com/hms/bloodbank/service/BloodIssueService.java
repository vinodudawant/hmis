...
public interface BloodIssueService {
	...
	int saveSampleDispatch(SampleDispatch sampleDispatchDetails, HttpServletRequest request);
	...
	int deleteBloosIssueById(int id, HttpServletRequest request);
	...
	int deleteBloodTransfusionById(int id, HttpServletRequest request);
