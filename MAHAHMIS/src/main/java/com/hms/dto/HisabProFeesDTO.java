...
@Entity
@Table(name = "ehat_profees_hisab")
public class HisabProFeesDTO {
	...
	@Transient
	private List<HisabProFeesDTO> listVoucher;
	...
	public List<HisabProFeesDTO> getListVoucher() {
		return listVoucher;
	}

	public void setListVoucher(List<HisabProFeesDTO> listVoucher) {
