...
public interface OrganDonorStockInwardDao {
	
	int saveOrganDonorStockInward(OrganDonorStockInwardDto obj,Integer organDonorId,Integer treatmentId,Integer organCollectionId,HttpServletRequest request);
	...
	boolean deleteOrganDonorStockInward(Integer stockInwardId,
