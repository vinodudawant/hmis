...
public interface OrganDonorConsentFormDao {
	
	int saveOrganDonorConsentForm(OrganDonorConsentFormDto obj,Integer organDonorId,Integer treatmentId,Integer checkupListId,
			MultipartFile[] uploadGrnDocs,HttpServletRequest request);

	OrganDonorConsentFormDto editOrganDonorConsentForm(Integer consentFormId);
	...
	OrganDonationRegistrationDto getOrganDonorById(Integer organDonorId,
			HttpServletRequest request);
