...
public interface OrganDonationService {
	...
	RegistrationViewDto searchPatientByStoredProcedurefororganrequest(String findText, int parseInt, String callFrom,
			Integer fromYear);

	RegistrationViewDto searchPatientByStoredProcedurefororganDonor(String findText, int parseInt, String callFrom,
			Integer fromYear);
}
