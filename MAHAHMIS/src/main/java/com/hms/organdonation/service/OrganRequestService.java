...
public interface OrganRequestService {
	...
	List<OrganRequestDto> requestAutoSuggestion(Integer organRequestId, String callFrom);

	List<OrganRequestDto> getAllOrganRequestList(HttpServletRequest request,String fromDate,String lastDate);
	
	RegistrationDto getPatientDetailsWithMaxTreatmentId(Integer patientId, HttpServletRequest request);
