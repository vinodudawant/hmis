...
@Entity
@Component
@Table(name="inv_purchase_reorder_item_slave")
public class PurchaseReOrderItemSlaveDto implements Serializable{
	...
	@Transient
	private List<PurchaseReOrderItemSlaveDto> lstPurchaseReOrderItemSlaveDto;
	...
	public List<PurchaseReOrderItemSlaveDto> getLstPurchaseReOrderItemSlaveDto() {
		return lstPurchaseReOrderItemSlaveDto;
	}

	public void setLstPurchaseReOrderItemSlaveDto(
			List<PurchaseReOrderItemSlaveDto> lstPurchaseReOrderItemSlaveDto) {
		this.lstPurchaseReOrderItemSlaveDto = lstPurchaseReOrderItemSlaveDto;
	}
	...
	public String toString() {
		return "PurchaseReOrderItemSlaveDto [id=" + id + ", createdDateTime="
				...
				+ ", unitId=" + unitId + ", item_master_id=" + item_master_id
				...
				+ ", totalAmount=" + totalAmount + ", itemPurchaseFactorUom1="
				...
				+ itemActualQuantity + ", itemPendingQuantity="
				+ itemPendingQuantity + ", igstAmountValue=" + igstAmountValue
				+ ", gstAmountValue=" + gstAmountValue + ", hsnName=" + hsnName
				+ ", hsnNameValue=" + hsnNameValue + ", taxCode=" + taxCode
				...
				+ ", itemUnitName=" + itemUnitName + ", itemAssetStatus="
				+ itemAssetStatus + ", isItemBatchWise=" + isItemBatchWise
				+ ", itemReagentStatus=" + itemReagentStatus
				+ ", manufactureName=" + manufactureName + ", amcVal=" + amcVal
				+ ", pmVal=" + pmVal + ", amcYear=" + amcYear + ", pmYear="
				+ pmYear + ", productWarranty=" + productWarranty
