...
@Entity
@Component
@Table(name="inv_purchase_expense_item_slave")
public class PurchaseExpenseItemSlaveDto implements Serializable{
	...
	@Transient
	private List<PurchaseExpenseItemSlaveDto> lstPurchaseExpenseItemSlaveDto;
	...
	public List<PurchaseExpenseItemSlaveDto> getLstPurchaseExpenseItemSlaveDto() {
		return lstPurchaseExpenseItemSlaveDto;
	}

	public void setLstPurchaseExpenseItemSlaveDto(
			List<PurchaseExpenseItemSlaveDto> lstPurchaseExpenseItemSlaveDto) {
		this.lstPurchaseExpenseItemSlaveDto = lstPurchaseExpenseItemSlaveDto;
	}
