...
public List<ItemAssetMaintenanceMasterDto> getAllItemAssetMaintenance(HttpServletRequest request,Integer unitId);
...
public LocationAssetMaintenanceSlaveDto getLocationAssetMaintenanceDetailsByMasterId(Integer masterId,HttpServletRequest request);
//upload asset maintenance documents
public int uploadAssetMaintenanceDocument(String document,HttpServletRequest request);
...
public boolean deleteAssetMaintenanceDetails(Integer id,String assetDeletionReason,HttpServletRequest request);
