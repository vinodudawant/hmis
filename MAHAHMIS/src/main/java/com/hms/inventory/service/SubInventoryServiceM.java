...
public interface SubInventoryServiceM {
    ...
    //to update sub inventory batch stock quantity
  	...
  	//generated mrn all data for indent tab GoodsIssueMrnItemSlaveDto
    ...
    //This function is created for to update the MRN status after receiving full quantity of product
