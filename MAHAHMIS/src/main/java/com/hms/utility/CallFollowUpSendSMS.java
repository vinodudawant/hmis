...
@WebListener
public class CallFollowUpSendSMS implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent servletContextEvent) {
		...
		{
			String startTime = bundle.getObject("startTimeForFollowUp").toString();
		...
		public void run() {
			...
			//	if((ApplicationContextUtils.getApplicationContext())!=null)
				//{
					...
					enterpriseUtil.sendFollowScheduleSMS();
				//}
			} catch (Exception e) {
				e.printStackTrace();
			}
