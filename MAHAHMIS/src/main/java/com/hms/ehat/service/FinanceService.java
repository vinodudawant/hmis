...
public interface FinanceService {
	...
	List<OpdDiagnoReportBilllWiseDTO> fetchOpdDiagnoPatientsbillwise(int unitId,int userId,String fDate,String tDate);
	...
	//List<OpdBillDto> getAllOpdServicesByTrId(int treatId);
	...
	List<ServiceWiseBusinessReportDTO> fetchServiceWiseHeadReport2(Date fromDate,Date toDate,Integer unitId,String serviceId,
			String deptId,String checkType,String subserviceId,String mutlischemeIds,String multiSchemeChild,String type,String isPackage);
