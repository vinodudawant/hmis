...
public interface ConfigureServiceDao {

	/**
	 * @author Bilal
	 * @param isComServlastId 
	 * @param isComServId 
	 * @date 30_May_2017
	 * @code Methods declared for sub services String configurationlist
	 ***/
	...
	List<ConfigurationViewServiceDto2> getConfigurationListFromViewForSub(
			Integer chargesId, Integer chargesSlaveId, Integer hallId, Integer hallSlaveId, Integer isComServId, Integer isComServlastId);
	...
	//fetching id of hall name from old software 
	...
	int saveOrUpdateConfigService2(ConfigurServicesDto configurServicesDto,
			HttpServletRequest request, String configurationlist,
			String queryType, String hallandhallslave, Integer masterId, Integer serviceLastId);
	...
	List<YearWiseConfigureDto> saveandupdateYearWise(HttpServletRequest request,
	...
	int importSponsor(String file, HttpServletRequest request);

	int importhall(String file, HttpServletRequest request);
