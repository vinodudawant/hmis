...
public interface ProfeesDao {
	...
	int savePercentMaster(String percentMasterList, Integer userId, int doctorId, int unitId,
			String callFrom, int caseType,int drDeptId,String drDeptFlag,int chargesId,int chargesSlaveId);
	...
	PercentMasterDto updateDrDeptPercentMaster(int drDeptId, int unitId,
	...
	//Irfan Khan @date: 24-July-2017 @reason : To fetch paid records of single doctor opd.
	...
	//Irfan Khan @date: 24-July-2017 @reason : To fetch paid records of single doctor ipd.
	...
	ProfeesDoctorsPaymentDto proFeesDoctorsReportIpd(int doctorId, Date fromDate,
			Date toDate, int unitId, int deptId, int serviceId, Integer userId);
	...
	/*// Irfan Khan @date: 16-Aug-2017 @reason : To fetch doctors report
	ProfeesDoctorsPaymentDto proFeesAllDocReportIpd(int doctorId,
	...
	//@author : Irfan Khan @date: 28-Sep-2017 @reason : Autosuggestion for doctor
	List<DoctorDto> setAutoSugForDoctorListDocType(String letter,
			String callFrom);
	...
	List<DoctorDto> setAutoSugForDocListSpcl(String letter, String callFrom,
	...
	ProfeesDoctorsPaymentDto proFeesDoctorPaymentForAllDocIpd(int doctorId,
			Date fromDate, Date toDate, int unitId, int deptId,
			String serviceId, Integer userId, int specialisationId,
			int billTypeId);
	...
	int deleteForDrDeps(Integer drDeptId, Integer userId,Integer caseType,Integer unitId);

	int deleteDoctAndGroup(Integer docId, Integer userId,Integer caseType,Integer unitId);

	int deleteDynamicGroupMaster(Integer dMasterId, Integer userId);
	...
	List<DoctorDto> fetchDoctorListAutoSug(String letter, String callFrom,
				int specialisationId,int unitId);
	...
	ProfeesDoctorsPaymentDto fetchProfeesVoucherReport(Date fromDate,
...
// Ajay khandare @date: 5-07-2019 @reason : Fetch year report for ipd,// opd,plastic surgery, uro, etc..
...
// Ajay khandare @date: 5-07-2019 @reason : Fetch  monthy and progresive  Hospital Activities Performance report for ipd, opd,ICU,NICU etc..
	List<HospitalReport> getMonthyHospitalActivitiesPerformanceReport(String fromYear, String fromMonth);
 ...
 // Ajay khandare @date: 09-08-2019 @reason : Fetch  monthy and progresive report for Death Information Sexwise Report ..
 ...
 // Ajay khandare @date: 026-08-2019 @reason : Fetch  monthy and progresive report for monthly out put format ipd, opd,operation hospital activites report 3..
    ...
    int saveGroupDetails1(Doctor doctorDetails,String groupSlaveDetails, String
	  groupMasterDetails, Integer userId,String callFrom);
    ...
    int deleteDoctAndGroupById(Integer docId, Integer userId,Integer caseType,Integer unitId,Integer chargesSlaveId);
