...
public interface DialysisDao {
	...
	List<HemodialysisCarePlanDto> getListCarePlanDialysis(Integer treatmentId);
	...
	List<VirologyVaccinationDTO> getVirologyVaccninationListById(Integer treatmentId);
	...
	int uploadDocumentOnDialysis(UploadDocumentDialysisDto updocs);
	...
	List<AutosugeestionDto> autoSuggestionForTestNameDialysis(String testname);
	...
	List<DialysisAdviceDto> autoSuggestionPatientByNameDialysis(String patiename);
