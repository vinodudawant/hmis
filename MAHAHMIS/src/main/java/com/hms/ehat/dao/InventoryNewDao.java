...
public interface InventoryNewDao {

	List<InventoryNewDto> getDispachlist(Integer unitId, Integer userId1, 
			String callfrom, String callPartyName, String startDate, String endDate, String letter);
