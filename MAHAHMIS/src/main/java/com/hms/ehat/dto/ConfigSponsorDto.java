...
@Entity
@Table(name="ehat_config_sponsor_view")
@Immutable
public class ConfigSponsorDto {
	...
	@Transient
	private Integer sponsorWiseCount;
	
	@Transient
	private Integer sponCountSearch;
	
	@Transient
    private List<ConfigSponsorDto> lstConfigurations;
	...
	public List<ConfigSponsorDto> getLstConfigurations() {
		return lstConfigurations;
	}

	public void setLstConfigurations(List<ConfigSponsorDto> lstConfigurations) {
		this.lstConfigurations = lstConfigurations;
	}

	public Integer getSponsorWiseCount() {
		return sponsorWiseCount;
	}

	public void setSponsorWiseCount(Integer sponsorWiseCount) {
		this.sponsorWiseCount = sponsorWiseCount;
	}

	public Integer getSponCountSearch() {
		return sponCountSearch;
	}

	public void setSponCountSearch(Integer sponCountSearch) {
		this.sponCountSearch = sponCountSearch;
	}
