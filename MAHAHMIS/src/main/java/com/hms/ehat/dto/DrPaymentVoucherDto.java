...
@Entity
@Table(name = "ehat_doctors_payment_voucher")
public class DrPaymentVoucherDto {
	...
	@Transient
	private List<DrPaymentVoucherDto> listVoucher;
	...
	public List<DrPaymentVoucherDto> getListVoucher() {
		return listVoucher;
	}

	public void setListVoucher(List<DrPaymentVoucherDto> listVoucher) {
