...
@Entity
@Immutable
@Table(name = "area_wise_patient_view2")
public class AreaWisePatientViewDto2 {
	@Id
	@GeneratedValue
	...
	@Transient
	private List<AreaWisePatientViewDto2> listAreaWisePatientView;
	...
	public List<AreaWisePatientViewDto2> getListAreaWisePatientView() {
		return listAreaWisePatientView;
	}

	public void setListAreaWisePatientView(
			List<AreaWisePatientViewDto2> listAreaWisePatientView) {
