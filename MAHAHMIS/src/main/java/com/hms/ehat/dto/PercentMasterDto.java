...
@Entity
@Table(name = "percent_master")
public class PercentMasterDto {
	...
	@Transient
	private List<PercentMasterDto> listPerMaster;
	...
	public List<PercentMasterDto> getListPerMaster() {
		return listPerMaster;
	}

	public void setListPerMaster(List<PercentMasterDto> listPerMaster) {
