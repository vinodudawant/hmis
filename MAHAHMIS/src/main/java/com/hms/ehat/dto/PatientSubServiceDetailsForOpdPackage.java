...
@Entity 
@Immutable
@Table(name = "patient_sub_service_details_for_opdpackage")
public class PatientSubServiceDetailsForOpdPackage {
	...
	@Transient
	private List<PatientSubServiceDetailsForOpdPackage> listOpdPackageDto;
	...
	public List<PatientSubServiceDetailsForOpdPackage> getListOpdPackageDto() {
		return listOpdPackageDto;
	}

	public void setListOpdPackageDto(
			List<PatientSubServiceDetailsForOpdPackage> listOpdPackageDto) {
