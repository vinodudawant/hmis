...
@Entity 
@Table(name = "ehat_ipd_nursing_care_plan")
public class NursingCarePlanDTO implements Serializable{
	...
	@Transient
	private List<NursingCarePlanDTO> listNCP;
	...
	public List<NursingCarePlanDTO> getListNCP() {
		return listNCP;
	}

	public void setListNCP(List<NursingCarePlanDTO> listNCP) {
