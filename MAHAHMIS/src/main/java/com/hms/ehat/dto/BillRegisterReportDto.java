...
@Entity 
@Immutable
@Table(name = "bill_register_report_details")
public class BillRegisterReportDto {
	...
	@Column(name = "specilization_name")
...
//	private Date receiptCreatedDatetime;
	...
	private double totalConcession=0;
	...
	@Transient
	private List<BillRegisterReportDto> lstOpd;
	
	@Transient
	private List<BillRegisterReportDto> lstIpd;
	
	@Transient
	private List<BillRegisterReportDto> lstDaigno;
	
	@Transient
	private List<BillRegisterReportDto> listBillRegister;
	...
	@Column(name="pathoBillAmt")
	private double  pathoBillAmt;
	
	@Column(name="pathoDiscountAmt")
	private double  pathoDiscountAmt;
	
	@Column(name="pathoConcessionAmt")
	private double  pathoConcessionAmt;
	
	@Column(name="pathoNetAmt")
	private double  pathoNetAmt;
	
	@Column(name = "pathoPaidAmt")
	private double  pathoPaidAmt;
	
	@Column(name="pathoRefundAmt")
	private double  pathoRefundAmt;
	
	@Column(name="pathoDuesAmt")
	private double  pathoDuesAmt;
	...
	public List<BillRegisterReportDto> getLstOpd() {
		return lstOpd;
	}

	public void setLstOpd(List<BillRegisterReportDto> lstOpd) {
		this.lstOpd = lstOpd;
	}

	public List<BillRegisterReportDto> getLstIpd() {
		return lstIpd;
	}

	public void setLstIpd(List<BillRegisterReportDto> lstIpd) {
		this.lstIpd = lstIpd;
	}

	public List<BillRegisterReportDto> getLstDaigno() {
		return lstDaigno;
	}

	public void setLstDaigno(List<BillRegisterReportDto> lstDaigno) {
		this.lstDaigno = lstDaigno;
	}
	
	

	public List<BillRegisterReportDto> getListBillRegister() {
		return listBillRegister;
	}

	public void setListBillRegister(List<BillRegisterReportDto> listBillRegister) {
		this.listBillRegister = listBillRegister;
	}
	...
	public double getPathoBillAmt() {
		return pathoBillAmt;
	}

	public void setPathoBillAmt(double pathoBillAmt) {
		this.pathoBillAmt = pathoBillAmt;
	}

	public double getPathoDiscountAmt() {
		return pathoDiscountAmt;
	}

	public void setPathoDiscountAmt(double pathoDiscountAmt) {
		this.pathoDiscountAmt = pathoDiscountAmt;
	}

	public double getPathoConcessionAmt() {
		return pathoConcessionAmt;
	}

	public void setPathoConcessionAmt(double pathoConcessionAmt) {
		this.pathoConcessionAmt = pathoConcessionAmt;
	}

	public double getPathoNetAmt() {
		return pathoNetAmt;
	}

	public void setPathoNetAmt(double pathoNetAmt) {
		this.pathoNetAmt = pathoNetAmt;
	}

	public double getPathoPaidAmt() {
		return pathoPaidAmt;
	}

	public void setPathoPaidAmt(double pathoPaidAmt) {
		this.pathoPaidAmt = pathoPaidAmt;
	}

	public double getPathoRefundAmt() {
		return pathoRefundAmt;
	}

	public void setPathoRefundAmt(double pathoRefundAmt) {
		this.pathoRefundAmt = pathoRefundAmt;
	}

	public double getPathoDuesAmt() {
		return pathoDuesAmt;
	}

	public void setPathoDuesAmt(double pathoDuesAmt) {
		this.pathoDuesAmt = pathoDuesAmt;
	}

	@Override
	public String toString() {
		return "BillRegisterReportDto [billId=" + billId + ", billNo=" + billNo + ", patientId=" + patientId
				+ ", doctorName=" + doctorName + ", specilizationName=" + specilizationName + ", centerPatientId="
				...
				+ ", createdDateTime=" + createdDateTime + ", invoiceDateTime=" + invoiceDateTime + ", billDateTime="
				+ billDateTime + ", recCreatedDateTime=" + recCreatedDateTime + ", dob=" + dob + ", weight=" + weight
				+ ", height=" + height + ", urineVol=" + urineVol + ", lmpDate=" + lmpDate + ", trcount=" + trcount
				+ ", opdipdno=" + opdipdno + ", tokenno=" + tokenno + ", mrnno=" + mrnno + ", stateId=" + stateId
				+ ", townId=" + townId + ", districtId=" + districtId + ", talukaId=" + talukaId + ", refSrcId="
				+ refSrcId + ", refSrcDocId=" + refSrcDocId + ", emergency=" + emergency + ", categoryName="
				+ categoryName + ", isPpn=" + isPpn + ", numbr=" + numbr + ", docNameChan=" + docNameChan
				+ ", businessType=" + businessType + ", customerType=" + customerType + ", customerId=" + customerId
				+ ", dischargeDate=" + dischargeDate + ", dischargeTime=" + dischargeTime + ", visitType=" + visitType
				+ ", prefix=" + prefix + ", age3=" + age3 + ", f_name=" + f_name + ", m_name=" + m_name + ", l_name="
				+ l_name + ", emailId=" + emailId + ", emergencyflag=" + emergencyflag + ", specialcasename="
				+ specialcasename + ", collectionDate=" + collectionDate + ", collectionTime=" + collectionTime
				+ ", patientBarcode=" + patientBarcode + ", registeredAt=" + registeredAt + ", referredBy=" + referredBy
				+ ", customerTypeName=" + customerTypeName + ", refDoctorName=" + refDoctorName + ", bedName=" + bedName
				+ ", totBill=" + totBill + ", totPaid=" + totPaid + ", totBal=" + totBal + ", deposit=" + deposit
				+ ", netAmt=" + netAmt + ", docName=" + docName + ", physicalDisFlag=" + physicalDisFlag
				...
				+ referSource + ", nationality=" + nationality + ", totDisc=" + totDisc + ", totalConcession="
				+ totalConcession + ", totalRefund=" + totalRefund + ", visitNo=" + visitNo + ", employeeId="
				+ employeeId + ", employeeName=" + employeeName + ", lstOpd=" + lstOpd + ", lstIpd=" + lstIpd
				+ ", lstDaigno=" + lstDaigno + ", listBillRegister=" + listBillRegister + ", lstDoctorDto="
				+ lstDoctorDto + ", patientCount=" + patientCount + ", approveBy=" + approveBy + ", approveRemark="
				+ approveRemark + ", pathoBillAmt=" + pathoBillAmt + ", pathoDiscountAmt=" + pathoDiscountAmt
				+ ", pathoConcessionAmt=" + pathoConcessionAmt + ", pathoNetAmt=" + pathoNetAmt + ", pathoPaidAmt="
				+ pathoPaidAmt + ", pathoRefundAmt=" + pathoRefundAmt + ", pathoDuesAmt=" + pathoDuesAmt + ", age2="
				+ age2 + ", queue_status=" + queue_status + "]";
	}
