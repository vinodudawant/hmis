...
@Entity
@Table(name = "ehat_multi_bulkreceipt_master")
public class MultiBulkReceiptMasterDTO {
	...
	@Transient
	private List<MultiBulkReceiptMasterDTO> listMultiBillReceiptMaster;
	...
	public Integer getBulkReceiptId() {
		return bulkReceiptId;
	}

	public void setBulkReceiptId(Integer bulkReceiptId) {
		this.bulkReceiptId = bulkReceiptId;
	}
	...
	public List<MultiBulkReceiptMasterDTO> getListMultiBillReceiptMaster() {
		return listMultiBillReceiptMaster;
	}

	public void setListMultiBillReceiptMaster(
			List<MultiBulkReceiptMasterDTO> listMultiBillReceiptMaster) {
