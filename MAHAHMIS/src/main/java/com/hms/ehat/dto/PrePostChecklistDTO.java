...
@Entity
@Table(name = "nursingprepostchecklist")
public class PrePostChecklistDTO implements Serializable{
...
@Column(name = "preot2",columnDefinition="varchar(2)")
private String preOT2;

@Column(name = "preot3",columnDefinition="varchar(2)")
private String preOT3;

@Column(name = "preot4",columnDefinition="varchar(2)")
private String preOT4;

@Column(name = "preot5",columnDefinition="varchar(2)")
private String preOT5;

@Column(name = "preot6",columnDefinition="varchar(2)")
private String preOT6;

@Column(name = "preot7",columnDefinition="varchar(2)")
private String preOT7;

@Column(name = "preot8",columnDefinition="varchar(2)")
private String preOT8;

@Column(name = "preot9",columnDefinition="varchar(2)")
private String preOT9;

@Column(name = "preot10",columnDefinition="varchar(2)")
private String preOT10;

@Column(name = "preot11",columnDefinition="varchar(2)")
private String preOT11;

@Column(name = "preot12",columnDefinition="varchar(2)")
private String preOT12;

@Column(name = "preot13",columnDefinition="varchar(2)")
private String preOT13;

@Column(name = "preot14",columnDefinition="varchar(2)")
private String preOT14;

@Column(name = "preot15",columnDefinition="varchar(2)")
private String preOT15;

@Column(name = "preot16",columnDefinition="varchar(2)")
private String preOT16;

@Column(name = "preot17",columnDefinition="varchar(2)")
private String preOT17;

@Column(name = "preot18",columnDefinition="varchar(2)")
private String preOT18;

@Column(name = "preot19",columnDefinition="varchar(2)")
private String preOT19;

@Column(name = "preot20",columnDefinition="varchar(2)")
private String preOT20;

@Column(name = "preot21",columnDefinition="varchar(2)")
private String preOT21;

@Column(name = "preot22",columnDefinition="varchar(2)")
private String preOT22;

@Column(name = "preot23",columnDefinition="varchar(2)")
private String preOT23;

@Column(name = "preot24",columnDefinition="varchar(2)")
private String preOT24;

@Column(name = "preot25",columnDefinition="varchar(2)")
private String preOT25;

@Column(name = "preot26",columnDefinition="varchar(2)")
private String preOT26;

@Column(name = "preot27",columnDefinition="varchar(2)")
private String preOT27;

@Column(name = "preot28",columnDefinition="varchar(2)")
private String preOT28;


@Column(name = "afterot2",columnDefinition="varchar(2)")
private String afterOT2;

@Column(name = "afterot3",columnDefinition="varchar(2)")
private String afterOT3;

@Column(name = "afterot4",columnDefinition="varchar(2)")
private String afterOT4;

@Column(name = "afterot5",columnDefinition="varchar(2)")
private String afterOT5;

@Column(name = "afterot6",columnDefinition="varchar(2)")
private String afterOT6;

@Column(name = "afterot7",columnDefinition="varchar(2)")
private String afterOT7;

@Column(name = "afterot8",columnDefinition="varchar(2)")
private String afterOT8;

@Column(name = "afterot9",columnDefinition="varchar(2)")
private String afterOT9;

@Column(name = "afterot10",columnDefinition="varchar(2)")
private String afterOT10;

@Column(name = "afterot11",columnDefinition="varchar(2)")
private String afterOT11;

@Column(name = "afterot12",columnDefinition="varchar(2)")
private String afterOT12;

@Column(name = "afterot13",columnDefinition="varchar(2)")
private String afterOT13;

@Column(name = "afterot14",columnDefinition="varchar(2)")
private String afterOT14;

@Column(name = "afterot15",columnDefinition="varchar(2)")
private String afterOT15;

@Column(name = "afterot16",columnDefinition="varchar(2)")
private String afterOT16;

@Column(name = "afterot17",columnDefinition="varchar(2)")
private String afterOT17;

@Column(name = "afterot18",columnDefinition="varchar(2)")
private String afterOT18;

@Column(name = "afterot19",columnDefinition="varchar(2)")
private String afterOT19;

@Column(name = "afterot20",columnDefinition="varchar(2)")
private String afterOT20;

@Column(name = "afterot21",columnDefinition="varchar(2)")
private String afterOT21;

@Column(name = "afterot22",columnDefinition="varchar(2)")
private String afterOT22;

@Column(name = "afterot23",columnDefinition="varchar(2)")
private String afterOT23;

@Column(name = "afterot24",columnDefinition="varchar(2)")
private String afterOT24;

@Column(name = "afterot25",columnDefinition="varchar(2)")
private String afterOT25;

@Column(name = "afterot26",columnDefinition="varchar(2)")
private String afterOT26;

@Column(name = "afterot27",columnDefinition="varchar(2)")
private String afterOT27;

@Column(name = "afterot28",columnDefinition="varchar(2)")
...
@Column(name = "xray",columnDefinition="varchar(2)")
private String xray;

@Column(name = "usg",columnDefinition="varchar(2)")
private String uSG;

@Column(name = "ct",columnDefinition="varchar(2)")
private String ct;

@Column(name = "pet_ct",columnDefinition="varchar(2)")
private String pet_ct;

@Column(name = "mri",columnDefinition="varchar(2)")
private String mri;

@Column(name = "mammo",columnDefinition="varchar(2)")
private String mammo;

@Column(name = "ecg",columnDefinition="varchar(2)")
private String ecg;

@Column(name = "echo",columnDefinition="varchar(2)")
private String echo;
...
@Transient
private List<PrePostChecklistDTO> nursinAssesmentList;
...
public List<PrePostChecklistDTO> getNursinAssesmentList() {
	return nursinAssesmentList;
}


  public void setNursinAssesmentList(List<PrePostChecklistDTO>
  nursinAssesmentList) 
  { 
