...
@Entity 
@Table(name = "ehat_ipd_mfra_score_page4")
public class MFRAScorePage4DTO implements Serializable {
	...
	@Transient
	private List<MFRAScorePage4DTO> listMFRA;
	...
	public List<MFRAScorePage4DTO> getListMFRA() {
		return listMFRA;
	}

	public void setListMFRA(List<MFRAScorePage4DTO> listMFRA) {
