...
@Entity
@Table(name="ehat_config_combination_view")
@Immutable
public class ConfigCombinationDto {
	...
	@Transient
	private Integer combinationCntSearch;
	
	@Transient
    private List<ConfigCombinationDto> lstConfigurations;
	...
	public List<ConfigCombinationDto> getLstConfigurations() {
		return lstConfigurations;
	}

	public void setLstConfigurations(List<ConfigCombinationDto> lstConfigurations) {
	...
	public Integer getCombinationCntSearch() {
		return combinationCntSearch;
	}

	public void setCombinationCntSearch(Integer combinationCntSearch) {
		this.combinationCntSearch = combinationCntSearch;
	}
