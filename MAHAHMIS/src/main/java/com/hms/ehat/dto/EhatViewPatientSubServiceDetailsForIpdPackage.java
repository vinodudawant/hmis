...
@Entity 
@Immutable
@Table(name = "ehat_view_patient_sub_service_details_for_ipdpackage")
public class EhatViewPatientSubServiceDetailsForIpdPackage {
	...
	@Column(name = "other_pay",columnDefinition="int default 0.0")
	private double otherPay;
	
	@Column(name = "other_concession",columnDefinition="int default 0.0")
	private double otherConcession;
	
	@Column(name = "other_co_pay",columnDefinition="int default 0.0")
	private double otherCoPay;
	
	@Transient
	private List<EhatViewPatientSubServiceDetailsForIpdPackage> listIpdPackageDto;
...
/*---------------------Getters And Setters---------------------------------*/
	...
	public List<EhatViewPatientSubServiceDetailsForIpdPackage> getListIpdPackageDto() {
		return listIpdPackageDto;
	}

	public void setListIpdPackageDto(
			List<EhatViewPatientSubServiceDetailsForIpdPackage> listIpdPackageDto) {
