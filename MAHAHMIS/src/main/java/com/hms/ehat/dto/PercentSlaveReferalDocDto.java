...
@Entity
@Table(name = "percent_slave_referal_doc")
public class PercentSlaveReferalDocDto {
	...
	@Transient
	private List<PercentSlaveReferalDocDto> listPerSlave;
	...
	public List<PercentSlaveReferalDocDto> getListPerSlave() {
		return listPerSlave;
	}
	public void setListPerSlave(List<PercentSlaveReferalDocDto> listPerSlave) {
