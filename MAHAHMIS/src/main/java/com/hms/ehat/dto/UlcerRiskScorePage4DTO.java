...
@Entity 
@Table(name = "ehat_ipd_ulcer_risk_score_page4")
public class UlcerRiskScorePage4DTO implements Serializable {
	...
	@Transient
	private List<UlcerRiskScorePage4DTO> listURS;
	...
	public List<UlcerRiskScorePage4DTO> getListURS() {
		return listURS;
	}

	public void setListURS(List<UlcerRiskScorePage4DTO> listURS) {
