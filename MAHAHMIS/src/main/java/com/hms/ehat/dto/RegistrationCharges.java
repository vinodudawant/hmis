...
@Entity
@Table(name = "ehat_registration_master")
public class RegistrationCharges  implements Serializable{
	@Id
	@GeneratedValue
	...
	@Transient
	private List<RegistrationCharges> lstDocroundDetails;
	@Transient
	String Sponsername;
	...
	public List<RegistrationCharges> getLstDocroundDetails() {
		return lstDocroundDetails;
	}

	public void setLstDocroundDetails(List<RegistrationCharges> lstDocroundDetails) {
