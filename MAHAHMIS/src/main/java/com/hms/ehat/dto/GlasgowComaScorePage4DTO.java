...
@Entity 
@Table(name = "ehat_ipd_glasgow_coma_score_page4")
public class GlasgowComaScorePage4DTO implements Serializable{
	...
	@Transient
	private List<GlasgowComaScorePage4DTO> listGCS;
	...
	public List<GlasgowComaScorePage4DTO> getListGCS() {
		return listGCS;
	}

	public void setListGCS(List<GlasgowComaScorePage4DTO> listGCS) {
