...
public class TempEventHandlerIPDDischargePDF extends PdfPageEventHelper implements PdfPageEvent {
	...
	public void onStartPage(PdfWriter writer, Document document) {
		...
		if(printType.equalsIgnoreCase("DischargeSummery")) {	
			...
			if (headerFlag.equalsIgnoreCase("No")) {
				...
				patientDetailsHeader.addCell(new Phrase("Admission Date Time", subheader));
				patientDetailsHeader.addCell(new Phrase(": " + regDate, tabletext));
				patientDetailsHeader.addCell(new Phrase("Discharge Date  Tilme", subheader));
