...
public class TempEventHandlerIPDPDF extends PdfPageEventHelper implements PdfPageEvent{
...
//	Font font;
	...
	public void onStartPage(PdfWriter writer, Document document) {
		...
		if(printType.equalsIgnoreCase("IPDPrint")) {	
			...
			if(printType.equalsIgnoreCase("prepostChecklist") || printType.equalsIgnoreCase("oneDayAsses") ) {
				patientDetailsHeader.addCell(new Phrase("MRN No", subheader));
			...
			if(printType.equalsIgnoreCase("TreatmentAtDischarge")) {
				String opdipdno = rtd.getOpdipdno();
				patientDetailsHeader.addCell(new Phrase("IPD No", subheader));
				patientDetailsHeader.addCell(new Phrase(": " + opdipdno, tabletext));
			}
			else {
				patientDetailsHeader.addCell(new Phrase("", subheader));
				patientDetailsHeader.addCell(new Phrase("", tabletext));
